...
`;function Mg(e={}){const{onMessage:t,onConnect:n,onDisconnect:a,onError:s,reconnectInterval:o=2e3,pingInterval:i=5e3}=e,l=p.useRef(null),c=p.useRef(null),d=p.useRef(null),h=p.useRef(t),[g,u]=p.useState({connected:!1,connecting:!1,lastMessageTime:0});h.current=t;const v=p.useCallback(()=>{const m=window.location.protocol==="https:"?"wss:":"ws:",f=window.location.host;return`${m}//${f}/ws`},[]),y=p.useCallback(()=>{var f;if(((f=l.current)==null?void 0:f.readyState)===WebSocket.OPEN)return;u(x=>({...x,connecting:!0}));const m=new WebSocket(v());l.current=m,m.onopen=()=>{u({connected:!0,connecting:!1,lastMessageTime:Date.now()}),n==null||n(),d.current&&clearInterval(d.current),d.current=window.setInterval(()=>{m.readyState===WebSocket.OPEN&&m.send(JSON.stringify({type:"ping"}))},i)},m.onmessage=x=>{var j;try{const N=JSON.parse(x.data);u(C=>({...C,lastMessageTime:Date.now()})),(N.type==="initial"||N.type==="update")&&(j=N.data)!=null&&j.clusters&&h.current&&h.current(N.data.clusters)}catch(N){console.error("[WS] Failed to parse message:",N)}},m.onerror=x=>{console.error("[WS] Error:",x),s==null||s(x)},m.onclose=()=>{u(x=>({...x,connected:!1,connecting:!1})),a==null||a(),d.current&&(clearInterval(d.current),d.current=null),c.current&&clearTimeout(c.current),c.current=window.setTimeout(()=>{y()},o)}},[v,n,a,s,o,i]),w=p.useCallback(()=>{c.current&&(clearTimeout(c.current),c.current=null),d.current&&(clearInterval(d.current),d.current=null),l.current&&(l.current.close(),l.current=null)},[]),b=p.useCallback(m=>{var f;((f=l.current)==null?void 0:f.readyState)===WebSocket.OPEN&&l.current.send(JSON.stringify(m))},[]);return p.useEffect(()=>(y(),()=>{w()}),[y,w]),p.useEffect(()=>{const m=setInterval(()=>{const x=Date.now()-g.lastMessageTime;g.connected&&x>15e3&&(w(),y())},5e3);return()=>clearInterval(m)},[g.connected,g.lastMessageTime,y,w]),{connected:g.connected,connecting:g.connecting,lastMessageTime:g.lastMessageTime,send:b,reconnect:y,disconnect:w}}const $g="/api";async function Ee(e,t){const n=await fetch(`${$g}${e}`,{credentials:"same-origin",headers:{"Content-Type":"application/json"},...t});if(n.status===401&&!e.startsWith("/auth/"))throw typeof window<"u"&&window.location.pathname!=="/login"&&window.location.replace("/login"),new Error("auth_required");if(!n.ok){const a=await n.text();throw new Error(a||`HTTP ${n.status}`)}return n.json()}const We={authMe:()=>Ee("/auth/me"),authLogin:(e,t)=>Ee("/auth/login",{method:"POST",body:JSON.stringify({username:e,password:t})}),authLogout:()=>Ee("/auth/logout",{method:"POST"}),totpEnrollInit:()=>Ee("/auth/totp/enroll-init",{method:"POST"}),totpEnrollVerify:e=>Ee("/auth/totp/enroll-verify",{method:"POST",body:JSON.stringify({code:e})}),totpDisable:e=>Ee("/auth/totp/disable",{method:"POST",body:JSON.stringify({code:e})}),getConfig:()=>Ee("/config"),updateConfig:e=>Ee("/config",{method:"POST",body:JSON.stringify(e)}),getClusters:()=>Ee("/clusters"),getCluster:e=>Ee(`/clusters/${e}`),getSummary:()=>Ee("/summary"),getNodes:e=>Ee(`/nodes${e?`?cluster=${e}`:""}`),getVMs:e=>Ee(`/vms${e?`?cluster=${e}`:""}`),getStorages:e=>Ee(`/storages${e?`?cluster=${e}`:""}`),getCeph:e=>Ee(`/ceph${e?`?cluster=${e}`:""}`),getHealth:()=>Ee("/health"),vmAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/${a}`,{method:"POST"}),ctAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/cts/${n}/${a}`,{method:"POST"}),guestAction:(e,t,n,a,s)=>a==="lxc"?We.ctAction(e,t,n,s):We.vmAction(e,t,n,s),vmMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),ctMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/cts/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),bulkAction:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/bulk`,{method:"POST",body:JSON.stringify(t)}),taskStatus:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/tasks/${encodeURIComponent(n)}`),listSnapshots:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`),createSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`,{method:"POST",body:JSON.stringify(n)}),deleteSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}`,{method:"DELETE"}),rollbackSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}/rollback`,{method:"POST"}),vmReset:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/reset`,{method:"POST"}),cloneVm:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/clone`,{method:"POST",body:JSON.stringify(n)}),listRemoteEndpoints:e=>Ee(`/clusters/${encodeURIComponent(e)}/remote-endpoints`),fetchRemoteFingerprint:(e,t=8006)=>Ee(`/remote-fingerprint?host=${encodeURIComponent(e)}&port=${t}`),triggerBackup:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/backup`,{method:"POST",body:JSON.stringify(n)}),setClusterSecret:(e,t,n)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"POST",body:JSON.stringify({value:n})}),deleteClusterSecret:(e,t)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"DELETE"}),consolePrepare:e=>Ee("/console/prepare",{method:"POST",body:JSON.stringify(e)}),migrationPrecheck:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-precheck?target_cluster_id=${encodeURIComponent(n)}&target_node=${encodeURIComponent(a)}`),getMigrationSource:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-source`),getMigrationTargets:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/migration-targets`),remoteMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/remote-migrate`,{method:"POST",body:JSON.stringify(n)})};function Ie(e,t=1){if(e===0)return"0 B";const n=1024,a=["B","KB","MB","GB","TB","PB"],s=Math.floor(Math.log(e)/Math.log(n));return`${parseFloat((e/Math.pow(n,s)).toFixed(t))} ${a[s]}`}function ct(e,t=1){return`${e.toFixed(t)}%`}function ui(e){const t=Math.floor(e/86400),n=Math.floor(e%86400/3600),a=Math.floor(e%3600/60),s=[];return t>0&&s.push(`${t}d`),n>0&&s.push(`${n}h`),a>0&&s.push(`${a}m`),s.length>0?s.join(" "):"< 1m"}function _e(e,t=80,n=95){return e>=n?"danger":e>=t?"warning":"success"}function Gl(e){switch(e.toLowerCase()){case"running":case"online":case"healthy":case"health_ok":return"success";case"warning":case"health_warn":return"warning";case"stopped":case"offline":case"critical":case"health_err":return"danger";default:return"muted"}}function Eg({value:e,suffix:t="",className:n=""}){const a=v=>{if(typeof v=="number")return{left:v,isRatio:!1};const y=String(v).match(/^(\d+)\/(\d+)$/);if(y)return{left:parseInt(y[1]),right:parseInt(y[2]),isRatio:!0};const w=parseFloat(String(v));return isNaN(w)?{left:0,isRatio:!1}:{left:w,isRatio:!1}},s=a(e),[o,i]=p.useState(0),[l,c]=p.useState(s.right||0),d=p.useRef(null),h=p.useRef(0),g=p.useRef(!0);p.useEffect(()=>{const v=a(e);if(!g.current){i(v.left),v.right!==void 0&&c(v.right);return}const y=800,w=0,b=0;g.current=!1,d.current=null;const m=f=>{d.current||(d.current=f);const x=f-d.current,j=Math.min(x/y,1),N=1-Math.pow(1-j,3),C=w+(v.left-w)*N;if(i(Math.round(C)),v.isRatio&&v.right!==void 0){const S=b+(v.right-b)*N;c(Math.round(S))}j<1?h.current=requestAnimationFrame(m):(i(v.left),v.right!==void 0&&c(v.right))};return h.current=requestAnimationFrame(m),()=>{h.current&&cancelAnimationFrame(h.current)}},[e]);const u=s.isRatio?`${o}/${l}`:o;return r.jsxs("span",{className:`metric-value ${n}`,children:[u,t&&r.jsx("span",{style:{fontSize:"0.6em",opacity:.7},children:t})]})}function hp({value:e,decimals:t=0,className:n=""}){const[a,s]=p.useState(0),o=p.useRef(null),i=p.useRef(0),l=p.useRef(!0);return p.useEffect(()=>{if(!l.current){s(e);return}const c=800,d=0;l.current=!1,o.current=null;const h=g=>{o.current||(o.current=g);const u=g-o.current,v=Math.min(u/c,1),y=1-Math.pow(1-v,3),w=d+(e-d)*y;s(w),v<1?i.current=requestAnimationFrame(h):s(e)};return i.current=requestAnimationFrame(h),()=>{i.current&&cancelAnimationFrame(i.current)}},[e]),r.jsxs("span",{className:n,children:[a.toFixed(t),"%"]})}function Ui({left:e,right:t,className:n=""}){const[a,s]=p.useState(0),[o,i]=p.useState(0),l=p.useRef(null),c=p.useRef(0),d=p.useRef(!0);return p.useEffect(()=>{if(!d.current){s(e),i(t);return}const h=800,g=0,u=0;d.current=!1,l.current=null;const v=y=>{l.current||(l.current=y);const w=y-l.current,b=Math.min(w/h,1),m=1-Math.pow(1-b,3);s(Math.round(g+(e-g)*m)),i(Math.round(u+(t-u)*m)),b<1?c.current=requestAnimationFrame(v):(s(e),i(t))};return c.current=requestAnimationFrame(v),()=>{c.current&&cancelAnimationFrame(c.current)}},[e,t]),r.jsxs("span",{className:n,children:[a,"/",o]})}function Ks({label:e,value:t,suffix:n,subValue:a,color:s="primary",icon:o}){return r.jsxs("div",{className:`stat-card ${s!=="primary"?`stat-${s}`:""}`,children:[o&&r.jsx("div",{className:"stat-icon",children:o}),r.jsxs("div",{className:"stat-content",children:[r.jsx("div",{className:"stat-label",children:e}),r.jsx(Eg,{value:t,suffix:n,className:s!=="primary"?`text-${s}`:""}),a&&r.jsx("div",{className:"stat-sub",children:a})]})]})}function Vi({value:e,label:t,color:n,size:a=100}){const[s,o]=p.useState(0),i=p.useRef(null),l=p.useRef(0),c=p.useRef(!0);p.useEffect(()=>{if(!c.current){o(e);return}const b=1e3,m=0;c.current=!1,i.current=null;const f=x=>{i.current||(i.current=x);const j=x-i.current,N=Math.min(j/b,1),C=1-Math.pow(1-N,3),S=m+(e-m)*C;o(S),N<1?l.current=requestAnimationFrame(f):o(e)};return l.current=requestAnimationFrame(f),()=>{l.current&&cancelAnimationFrame(l.current)}},[e]);const d=5,h=(a-d*4)/2-8,g=(a-d)/2,u=h+(g-h)/2,v=2*Math.PI*u,y=v-s/100*v,w=Array.from({length:36},(b,m)=>{const f=(m*10-90)*(Math.PI/180),x=m%3===0,j=x?6:3,N=g-2,C=N-j;return{x1:a/2+Math.cos(f)*N,y1:a/2+Math.sin(f)*N,x2:a/2+Math.cos(f)*C,y2:a/2+Math.sin(f)*C,isMajor:x}});return r.jsxs("div",{className:"ring-gauge",children:[r.jsxs("svg",{viewBox:`0 0 ${a} ${a}`,className:"ring-svg",children:[r.jsx("circle",{className:"ring-outer-deco",cx:a/2,cy:a/2,r:g,strokeWidth:1}),w.map((b,m)=>r.jsx("line",{x1:b.x1,y1:b.y1,x2:b.x2,y2:b.y2,className:`ring-tick ${b.isMajor?"major":""}`},m)),r.jsx("circle",{className:"ring-bg",cx:a/2,cy:a/2,r:u,strokeWidth:d}),r.jsx("circle",{className:"ring-inner-deco",cx:a/2,cy:a/2,r:h,strokeWidth:1}),r.jsx("circle",{className:`ring-fill ${n}`,cx:a/2,cy:a/2,r:u,strokeWidth:d,strokeDasharray:v,strokeDashoffset:y,transform:`rotate(-90 ${a/2} ${a/2})`}),r.jsx("line",{className:"ring-sweep",x1:a/2,y1:a/2,x2:a/2,y2:a/2-u-4,transform:`rotate(${s/100*360-90} ${a/2} ${a/2})`})]}),r.jsxs("div",{className:"ring-content",children:[r.jsxs("span",{className:`ring-value text-${n}`,children:[s.toFixed(0),r.jsx("span",{className:"ring-percent",children:"%"})]}),r.jsx("span",{className:"ring-label",children:t})]})]})}function Tg({cluster:e,onClick:t}){var c,d;const{t:n}=Ce(),a=e.summary;if(!a)return null;const s=_e(a.total_cpu_usage),o=_e(a.total_memory_usage),i=a.alerts_warning>0,l=a.alerts_critical>0;return r.jsxs("div",{className:`cluster-hex-card ${l?"critical":i?"warning":""}`,onClick:t,children:[r.jsxs("div",{className:"cluster-hex-inner",children:[r.jsxs("div",{className:"cluster-hex-header",children:[r.jsxs("div",{className:"cluster-hex-title",children:[r.jsx("span",{className:"cluster-hex-name",children:e.name||e.id}),a.is_standalone&&r.jsx("span",{className:"standalone-badge",children:n("dashboard.standalone")})]}),r.jsx("span",{className:`cluster-hex-status ${a.status==="connected"?"online":"offline"}`})]}),r.jsxs("div",{className:"cluster-hex-metrics",children:[r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"CPU"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${s}`,style:{width:`${a.total_cpu_usage}%`}})}),r.jsx(hp,{value:a.total_cpu_usage,decimals:0,className:`metric-value small text-${s}`})]}),r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"MEM"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${o}`,style:{width:`${a.total_memory_usage}%`}})}),r.jsx(hp,{value:a.total_memory_usage,decimals:0,className:`metric-value small text-${o}`})]})]}),r.jsxs("div",{className:"cluster-hex-stats",children:[r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.nodes_online,right:a.node_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.nodes")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.vms_running,right:a.vm_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.vms_short")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.cts_running,right:a.ct_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.cts_short")})]})]}),a.has_ceph&&r.jsx("div",{className:"cluster-hex-ceph",children:r.jsxs("span",{className:`ceph-badge ${((c=a.ceph_health)==null?void 0:c.toLowerCase().replace("health_",""))||"unknown"}`,children:["CEPH: ",((d=a.ceph_health)==null?void 0:d.replace("HEALTH_",""))||"N/A"]})})]}),r.jsx("div",{className:"corner-decoration top-left"}),r.jsx("div",{className:"corner-decoration top-right"}),r.jsx("div",{className:"corner-decoration bottom-left"}),r.jsx("div",{className:"corner-decoration bottom-right"})]})}function gp({clusters:e,globalSummary:t,onSelectCluster:n,isPaused:a=!1}){const{t:s}=Ce(),o=p.useMemo(()=>Object.entries(e),[e]),i=p.useMemo(()=>{let l=0,c=0,d=0,h=0;return Object.values(e).forEach(g=>{g.summary&&(l+=g.summary.total_cpu_usage||0,c+=g.summary.total_memory_usage||0,d+=g.summary.total_storage_usage||0,h++)}),{avgCpu:h>0?l/h:0,avgMem:h>0?c/h:0,avgStorage:h>0?d/h:0}},[e]);return r.jsxs("div",{className:"command-center",children:[r.jsx("div",{className:"grid-floor"}),r.jsxs("div",{className:"cc-header",children:[r.jsx("h1",{className:"cc-title font-display",children:r.jsx("span",{className:"glitch-text","data-text":s("dashboard.title"),children:s("dashboard.title")})}),r.jsx("div",{className:"cc-subtitle",children:s("dashboard.subtitle")})]}),r.jsxs("div",{className:"cc-content",children:[r.jsxs("div",{className:"cc-top-row",children:[r.jsxs("div",{className:"cc-gauges panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.resource_usage")})}),r.jsxs("div",{className:"gauges-container",children:[r.jsx(Vi,{value:i.avgCpu,label:s("metric.cpu"),color:_e(i.avgCpu),size:110}),r.jsx(Vi,{value:i.avgMem,label:s("metric.memory"),color:_e(i.avgMem),size:110}),r.jsx(Vi,{value:i.avgStorage,label:s("metric.disk"),color:_e(i.avgStorage),size:110})]})]}),r.jsxs("div",{className:"cc-stats-panel panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.infrastructure")})}),r.jsxs("div",{className:"stats-grid",children:[r.jsx(Ks,{label:s("cluster.total"),value:t.total_clusters,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("circle",{cx:"12",cy:"12",r:"4"})]})}),r.jsx(Ks,{label:s("cluster.nodes_online"),value:`${t.total_nodes_online}/${t.total_nodes}`,color:t.total_nodes_online<t.total_nodes?"warning":"success",icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("path",{d:"M8 21h8M12 17v4"})]})}),r.jsx(Ks,{label:s("cluster.vms_running"),value:`${t.total_vms_running}/${t.total_vms}`,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M3 9h18M9 3v18"})]})}),r.jsx(Ks,{label:s("cluster.cts_running"),value:`${t.total_cts_running}/${t.total_cts}`,icon:r.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"})})})]})]})]}),r.jsxs("div",{className:"cc-galaxy",children:[r.jsx("div",{className:"galaxy-title font-display",children:s("cluster.galaxy")}),r.jsx("div",{className:"galaxy-container",children:o.length===0?r.jsxs("div",{className:"no-clusters",children:[r.jsx("div",{className:"no-clusters-icon",children:r.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 6v6l4 2"})]})}),r.jsx("div",{className:"no-clusters-text",children:s("loading.connecting")}),r.jsx("div",{className:"no-clusters-hint",children:"Configure clusters in config.yaml"})]}):r.jsx("div",{className:"cluster-grid",children:o.map(([l,c])=>r.jsx(Tg,{cluster:c,onClick:()=>n(l)},l))})})]})]}),r.jsx("style",{children:`
      ...
      `})]})}const Ig=["hour","day","week","month","year"],Kl=e=>{if(!isFinite(e)||e===0)return"0";const t=["B","K","M","G","T"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=10?0:1)}${t[n]}`},Gn=e=>Kl(e)+"/s",xp=e=>`${(e*100).toFixed(0)}%`;function xf({open:e,onClose:t,clusterId:n,node:a,vmid:s,kind:o,title:i}){const{t:l,language:c}=Ce(),[d,h]=p.useState("hour"),[g,u]=p.useState([]),[v,y]=p.useState(!1),[w,b]=p.useState(null);return p.useEffect(()=>{if(!e)return;let m=!0;return(async()=>{y(!0),b(null);try{const f=encodeURIComponent(n),x=encodeURIComponent(a),j=o==="node"?`/api/clusters/${f}/nodes/${x}/rrddata`:o==="qemu"?`/api/clusters/${f}/nodes/${x}/qemu/${s}/rrddata`:`/api/clusters/${f}/nodes/${x}/lxc/${s}/rrddata`,N=await fetch(`${j}?timeframe=${d}`,{credentials:"same-origin"});if(!N.ok){const S=await N.json().catch(()=>({}));throw new Error(S.error||`HTTP ${N.status}`)}const C=await N.json();if(!m)return;u((C.samples||[]).filter(S=>S&&S.time))}catch(f){m&&b(f.message||String(f))}finally{m&&y(!1)}})(),()=>{m=!1}},[e,n,a,s,o,d]),e?r.jsx("div",{className:"rrd-back",onClick:t,children:r.jsxs("div",{className:"rrd-modal",onClick:m=>m.stopPropagation(),children:[r.jsxs("div",{className:"rrd-head",children:[r.jsxs("div",{className:"rrd-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"3 17 9 11 13 15 21 7"}),r.jsx("polyline",{points:"14 7 21 7 21 14"})]}),r.jsx("span",{children:l("rrd.title")}),i&&r.jsx("span",{className:"rrd-target",children:i})]}),r.jsxs("div",{className:"rrd-tfs",children:[Ig.map(m=>r.jsx("button",{className:`rrd-tf ${m===d?"on":""}`,onClick:()=>h(m),children:l(`rrd.tf.${m}`)},m)),r.jsx("button",{className:"rrd-close",onClick:t,"aria-label":"close",children:"×"})]})]}),r.jsxs("div",{className:"rrd-body",children:[w&&r.jsx("div",{className:"rrd-error",children:w}),v&&g.length===0&&r.jsx("div",{className:"rrd-loading",children:l("rrd.loading")}),!v&&g.length===0&&!w&&r.jsx("div",{className:"rrd-loading",children:l("rrd.empty")}),g.length>0&&r.jsxs("div",{className:"rrd-grid",children:[r.jsx(Xs,{title:l("rrd.chart.cpu"),samples:g,color:"#00f0ff",series:[{key:"cpu",label:"CPU",fmt:xp,scale:m=>m.cpu??null}],yMax:1,yFmt:xp}),r.jsx(Xs,{title:l("rrd.chart.mem"),samples:g,color:"#00ff88",series:[{key:"mem",label:"Mem",fmt:m=>Kl(m),scale:m=>m.mem??null}],yFmt:Kl,fillTop:m=>m.maxmem}),r.jsx(Xs,{title:l("rrd.chart.net"),samples:g,color:"#ff8a3c",series:[{key:"netin",label:"In",fmt:Gn,scale:m=>m.netin??null,color:"#ff8a3c"},{key:"netout",label:"Out",fmt:Gn,scale:m=>m.netout??null,color:"#bf00ff"}],yFmt:Gn}),r.jsx(Xs,{title:l("rrd.chart.disk"),samples:g,color:"#bf00ff",series:[{key:"diskread",label:"Read",fmt:Gn,scale:m=>m.diskread??null,color:"#00f0ff"},{key:"diskwrite",label:"Write",fmt:Gn,scale:m=>m.diskwrite??null,color:"#bf00ff"}],yFmt:Gn})]})]}),r.jsx("style",{children:`
        ...
        `})]})}):null}function Xs({title:e,samples:t,series:n,yMax:a,yFmt:s,fillTop:o}){var j,N;const{width:i,height:l}={width:460,height:160},c=48,d=8,h=10,g=22,u=p.useMemo(()=>{if(typeof a=="number")return a;let C=1;for(const S of t){const k=o==null?void 0:o(S);k&&k>C&&(C=k);for(const R of n){const I=R.scale(S);I!=null&&I>C&&(C=I)}}return C*1.1},[t,n,o,a]),v=((j=t[0])==null?void 0:j.time)||0,y=((N=t[t.length-1])==null?void 0:N.time)||v+1,w=Math.max(1,y-v),b=C=>c+(C-v)/w*(i-c-d),m=C=>h+(1-C/u)*(l-h-g),f=C=>{let S="",k=!1;for(const R of t){const I=C.scale(R);if(I==null||!isFinite(I)){k=!1;continue}const T=b(R.time),P=m(I);S+=(k?" L ":" M ")+T.toFixed(1)+","+P.toFixed(1),k=!0}return S},x=[0,.25,.5,.75,1].map(C=>u*(1-C));return r.jsxs("div",{className:"rrd-card",children:[r.jsxs("div",{className:"rrd-card-head",children:[r.jsx("div",{className:"rrd-card-title",children:e}),r.jsx("div",{className:"rrd-card-legend",children:n.map(C=>r.jsxs("span",{children:[r.jsx("span",{className:"dot",style:{background:C.color||"#00f0ff"}}),C.label]},C.key))})]}),r.jsxs("svg",{viewBox:`0 0 ${i} ${l}`,className:"rrd-svg",children:[x.map((C,S)=>{const k=h+S/4*(l-h-g);return r.jsxs("g",{children:[r.jsx("line",{x1:c,y1:k,x2:i-d,y2:k,stroke:"rgba(0,240,255,.08)"}),r.jsx("text",{x:c-4,y:k+3,textAnchor:"end",fontSize:"9",fill:"rgba(160,180,200,.6)",fontFamily:"Share Tech Mono, monospace",children:s(C)})]},S)}),n.map(C=>r.jsx("path",{d:f(C),fill:"none",stroke:C.color||"#00f0ff",strokeWidth:"1.3",opacity:"0.95"},C.key))]}),r.jsx("style",{children:`
      ...
      `})]})}function Sa(){const[e,t]=p.useState(!0),[n,a]=p.useState(null),[s,o]=p.useState(!1),i=async()=>{try{const c=await We.authMe();c.authenticated&&c.user?(a(c.user),o(!0)):(a(null),o(!1))}catch{a(null),o(!1)}finally{t(!1)}},l=async()=>{try{await We.authLogout()}catch{}window.location.replace("/login")};return p.useEffect(()=>{i()},[]),{loading:e,user:n,authEnforced:s,refresh:i,logout:l}}function Lg({open:e,onClose:t,clusterId:n,node:a}){var T;const{t:s,language:o}=Ce(),i=Pr(),c=((T=Sa().user)==null?void 0:T.role_global)==="admin",[d,h]=p.useState([]),[g,u]=p.useState(!1),[v,y]=p.useState(null),[w,b]=p.useState(null),[m,f]=p.useState(null),[x,j]=p.useState(""),N=async()=>{if(!(!n||!a)){u(!0),y(null);try{const P=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt`,{credentials:"same-origin"});if(!P.ok){const A=await P.json().catch(()=>({}));throw new Error(A.error||`HTTP ${P.status}`)}const K=await P.json();h(K.updates||[])}catch(P){y(P.message||String(P))}finally{u(!1)}}};p.useEffect(()=>{e&&N()},[e,n,a]);const C=P=>{f(P),setTimeout(()=>f(null),3e3)},S=async()=>{var P,K;if(c){b("refresh");try{const A=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt/refresh`,{method:"POST",credentials:"same-origin"}),E=await A.json().catch(()=>({}));if(!A.ok)throw new Error(E.error||`HTTP ${A.status}`);C(o==="zh-TW"?`已啟動 apt update（${((P=E.upid)==null?void 0:P.slice(0,24))||""}）`:`apt update kicked off (${((K=E.upid)==null?void 0:K.slice(0,24))||""})`),setTimeout(N,8e3)}catch(A){i.alert(A.message||String(A))}finally{b(null)}}},k=async()=>{var K,A;if(!(!c||!await i.confirm(o==="zh-TW"?`確定在 ${a} 上執行 apt dist-upgrade？此操作會將節點上所有可升級套件一次升級，建議先在備援節點測試。`:`Run apt dist-upgrade on ${a}? This upgrades every pending package on the node — test on a spare node first.`,{destructive:!0}))){b("upgrade");try{const E=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt/upgrade`,{method:"POST",credentials:"same-origin"}),G=await E.json().catch(()=>({}));if(!E.ok)throw new Error(G.error||`HTTP ${E.status}`);C(o==="zh-TW"?`升級作業啟動（${((K=G.upid)==null?void 0:K.slice(0,24))||""}） — 可在 /tasks 追蹤`:`upgrade kicked off (${((A=G.upid)==null?void 0:A.slice(0,24))||""}) — track on /tasks`)}catch(E){i.alert(E.message||String(E))}finally{b(null)}}};if(!e)return null;const R=x.trim().toLowerCase(),I=R?d.filter(P=>(P.Package||"").toLowerCase().includes(R)||(P.Description||"").toLowerCase().includes(R)):d;return r.jsx("div",{className:"apt-back",onClick:t,children:r.jsxs("div",{className:"apt-modal",onClick:P=>P.stopPropagation(),children:[r.jsxs("div",{className:"apt-head",children:[r.jsxs("div",{className:"apt-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),r.jsx("polyline",{points:"7 10 12 15 17 10"}),r.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),r.jsx("span",{children:s("apt.title")}),r.jsx("span",{className:"apt-target",children:a})]}),r.jsxs("div",{className:"apt-actions",children:[r.jsx("input",{className:"apt-filter",value:x,onChange:P=>j(P.target.value),placeholder:s("apt.filter_ph")}),r.jsxs("button",{className:"apt-btn",onClick:N,disabled:g||w!==null,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:s("apt.btn_reload")})]}),c&&r.jsxs(r.Fragment,{children:[r.jsx("button",{className:"apt-btn",onClick:S,disabled:w!==null,children:r.jsx("span",{children:s("apt.btn_refresh")})}),r.jsx("button",{className:"apt-btn primary",onClick:k,disabled:w!==null||d.length===0,children:r.jsx("span",{children:s("apt.btn_upgrade")})})]}),r.jsx("button",{className:"apt-close",onClick:t,children:"×"})]})]}),r.jsxs("div",{className:"apt-meta",children:[r.jsxs("span",{children:[I.length,x&&` / ${d.length}`," ",s("apt.pkgs")]}),!c&&r.jsx("span",{className:"apt-readonly",children:s("apt.readonly")}),m&&r.jsx("span",{className:"apt-toast",children:m})]}),r.jsxs("div",{className:"apt-body",children:[v&&r.jsx("div",{className:"apt-error",children:v}),g&&d.length===0&&r.jsx("div",{className:"apt-empty",children:s("apt.loading")}),!g&&d.length===0&&!v&&r.jsx("div",{className:"apt-empty",children:s("apt.uptodate")}),I.length>0&&r.jsxs("table",{className:"apt-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:s("apt.col.package")}),r.jsx("th",{children:s("apt.col.from")}),r.jsx("th",{children:s("apt.col.to")}),r.jsx("th",{children:s("apt.col.section")})]})}),r.jsx("tbody",{children:I.map(P=>r.jsxs("tr",{title:P.Description||"",children:[r.jsx("td",{className:"apt-mono apt-name",children:P.Package}),r.jsx("td",{className:"apt-mono",children:P.OldVersion||"—"}),r.jsx("td",{className:"apt-mono apt-newver",children:P.Version||"—"}),r.jsx("td",{className:"apt-mono apt-section",children:P.Section||""})]},P.Package))})]})]}),r.jsx("style",{children:`
        ...
        `})]})})}function Ag({open:e,onClose:t,clusterId:n}){const{t:a}=Ce(),[s,o]=p.useState([]),[i,l]=p.useState(!1),[c,d]=p.useState(null),[h,g]=p.useState(null),[u,v]=p.useState({});p.useEffect(()=>{if(!e)return;let w=!0;return(async()=>{l(!0),d(null);try{const b=await fetch(`/api/clusters/${encodeURIComponent(n)}/pools`,{credentials:"same-origin"});if(!b.ok){const f=await b.json().catch(()=>({}));throw new Error(f.error||`HTTP ${b.status}`)}const m=await b.json();w&&o(m.pools||[])}catch(b){w&&d(b.message||String(b))}finally{w&&l(!1)}})(),()=>{w=!1}},[e,n]);const y=async w=>{if(h===w){g(null);return}if(g(w),!u[w])try{const b=await fetch(`/api/clusters/${encodeURIComponent(n)}/pools/${encodeURIComponent(w)}`,{credentials:"same-origin"});if(!b.ok)throw new Error(`HTTP ${b.status}`);const m=await b.json();v(f=>{var x;return{...f,[w]:((x=m.pool)==null?void 0:x.members)||[]}})}catch{v(b=>({...b,[w]:[]}))}};return e?r.jsx("div",{className:"po-back",onClick:t,children:r.jsxs("div",{className:"po-modal",onClick:w=>w.stopPropagation(),children:[r.jsxs("div",{className:"po-head",children:[r.jsxs("div",{className:"po-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"6",cy:"6",r:"2"}),r.jsx("circle",{cx:"6",cy:"18",r:"2"}),r.jsx("circle",{cx:"18",cy:"6",r:"2"}),r.jsx("circle",{cx:"18",cy:"18",r:"2"}),r.jsx("line",{x1:"8",y1:"6",x2:"16",y2:"6"}),r.jsx("line",{x1:"8",y1:"18",x2:"16",y2:"18"}),r.jsx("line",{x1:"6",y1:"8",x2:"6",y2:"16"}),r.jsx("line",{x1:"18",y1:"8",x2:"18",y2:"16"})]}),r.jsx("span",{children:a("pools.title")})]}),r.jsx("button",{className:"po-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"po-body",children:[c&&r.jsx("div",{className:"po-error",children:c}),i&&s.length===0&&r.jsx("div",{className:"po-empty",children:a("pools.loading")}),!i&&s.length===0&&!c&&r.jsx("div",{className:"po-empty",children:a("pools.empty")}),s.map(w=>{const b=w.poolid||"",m=h===b,f=u[b]||[];return r.jsxs("div",{className:"po-row",children:[r.jsxs("div",{className:"po-row-head",onClick:()=>y(b),children:[r.jsx("span",{className:"po-chevron",children:m?"▾":"▸"}),r.jsx("span",{className:"po-name",children:b}),w.comment&&r.jsx("span",{className:"po-comment",children:w.comment}),r.jsx("span",{className:"po-count",children:w.members_count!=null?`${w.members_count} ${a("pools.members")}`:""})]}),m&&r.jsx("div",{className:"po-members",children:f.length===0?r.jsx("div",{className:"po-empty-inline",children:a("pools.no_members")}):r.jsxs("table",{children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:a("pools.col.type")}),r.jsx("th",{children:a("pools.col.id")}),r.jsx("th",{children:a("pools.col.name")}),r.jsx("th",{children:a("pools.col.node")}),r.jsx("th",{children:a("pools.col.status")})]})}),r.jsx("tbody",{children:f.map((x,j)=>r.jsxs("tr",{children:[r.jsx("td",{className:"po-mono",children:r.jsx("span",{className:`po-kind po-kind-${x.type}`,children:x.type})}),r.jsx("td",{className:"po-mono",children:x.vmid||x.storage||x.id}),r.jsx("td",{className:"po-mono",children:x.name||x.storage||""}),r.jsx("td",{className:"po-mono",children:x.node||""}),r.jsx("td",{className:"po-mono",children:x.status||""})]},`${x.type}-${x.id||j}`))})]})})]},b)})]}),r.jsx("style",{children:`
...
`;function wf({open:e,cluster_id:t,vm:n,onClose:a}){const{t:s}=Ce(),[o,i]=p.useState([]),[l,c]=p.useState(!1),[d,h]=p.useState(""),[g,u]=p.useState("snapshot"),[v,y]=p.useState("zstd"),[w,b]=p.useState(""),[m,f]=p.useState(""),[x,j]=p.useState(!1);if(p.useEffect(()=>{!e||!n||(b(""),f(""),h(""),c(!0),We.getCluster(t).then(S=>{const R=Object.values(S.storages||{}).filter(I=>{var P;if(!((P=I.content)!=null&&P.includes("backup")))return!1;const T=I.allowed_nodes||[];return T.length>0&&!T.includes(n.node)||!I.shared&&I.node!==n.node?!1:I.enabled!==!1});i(R),R.length>0&&h(R[0].storage)}).catch(S=>b(S.message||String(S))).finally(()=>c(!1)))},[e,t,n==null?void 0:n.vmid,n==null?void 0:n.node]),p.useEffect(()=>{if(!e)return;const S=k=>{k.key==="Escape"&&!x&&a()};return document.addEventListener("keydown",S),()=>document.removeEventListener("keydown",S)},[e,x,a]),!e||!n)return null;const N=o.length>0,C=async()=>{if(d){j(!0),b("");try{const S=await We.triggerBackup(t,n.node,{vmid:n.vmid,storage:d,mode:g,compress:v});f(S.upid)}catch(S){b(S instanceof Error?S.message:String(S))}finally{j(!1)}}};return r.jsxs("div",{onClick:()=>!x&&a(),style:ax,children:[r.jsx("style",{children:sx}),r.jsxs("div",{className:"bm-modal",onClick:S=>S.stopPropagation(),children:[r.jsxs("div",{className:"bm-eyebrow",children:["// backup · ",t," · ",n.node]}),r.jsx("h3",{className:"bm-title",children:s("backup.title",{vmid:n.vmid,name:n.name})}),!m&&r.jsxs(r.Fragment,{children:[r.jsx("label",{children:s("backup.storage")}),l?r.jsx("div",{className:"bm-empty",children:"…"}):N?r.jsx("select",{value:d,onChange:S=>h(S.target.value),children:o.map(S=>r.jsxs("option",{value:S.storage,children:[S.storage," (",S.type,S.shared?", shared":"",")"]},S.storage))}):r.jsx("div",{className:"bm-err",children:s("backup.no_backup_storage")}),r.jsx("label",{children:s("backup.mode")}),r.jsxs("select",{value:g,onChange:S=>u(S.target.value),children:[r.jsx("option",{value:"snapshot",children:s("backup.mode_snapshot")}),r.jsx("option",{value:"suspend",children:s("backup.mode_suspend")}),r.jsx("option",{value:"stop",children:s("backup.mode_stop")})]}),r.jsx("label",{children:s("backup.compress")}),r.jsxs("select",{value:v,onChange:S=>y(S.target.value),children:[r.jsx("option",{value:"zstd",children:"zstd"}),r.jsx("option",{value:"lzo",children:"lzo"}),r.jsx("option",{value:"gzip",children:"gzip"}),r.jsx("option",{value:"0",children:"none"})]}),w&&r.jsx("div",{className:"bm-err",children:w}),r.jsxs("div",{className:"bm-actions",children:[r.jsx("button",{className:"bm-btn ghost",onClick:a,disabled:x,children:s("action.cancel")}),r.jsx("button",{className:"bm-btn primary",disabled:x||!d,onClick:C,children:x?"…":s("backup.start")})]})]}),m&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"bm-ok",children:s("backup.started")}),r.jsx("div",{className:"bm-review",children:r.jsxs("div",{children:[r.jsx("span",{children:s("rmm.done.upid")}),r.jsx("code",{style:{userSelect:"all"},children:m})]})}),r.jsx("div",{className:"bm-actions",children:r.jsx("button",{className:"bm-btn primary",onClick:a,children:s("action.close")})})]})]})]})}const ax={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"bmFade .18s ease"},sx=`
...
`,wp=e=>{if(!e||!isFinite(e))return"—";const t=["B","KB","MB","GB","TB"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=100?0:a>=10?1:2)} ${t[n]}`},kp=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}`},jp=(e,t)=>{if(!e)return"—";const n=Math.floor(Date.now()/1e3)-e,a=Math.floor(n/86400);if(a===0)return t==="zh-TW"?"今天":"today";if(a===1)return t==="zh-TW"?"昨天":"yesterday";if(a<30)return t==="zh-TW"?`${a} 天前`:`${a}d ago`;const s=Math.floor(a/30);return t==="zh-TW"?`${s} 個月前`:`${s}mo ago`},Np=e=>{if(!e)return"unknown";const t=(Date.now()/1e3-e)/86400;return t>30?"stale":t>7?"aging":"fresh"};function ox({open:e,onClose:t,clusterId:n,vmid:a,vmName:s}){var w;const{t:o,language:i}=Ce(),[l,c]=p.useState([]),[d,h]=p.useState(!1),[g,u]=p.useState(null);if(p.useEffect(()=>{if(!e)return;let b=!0;return(async()=>{h(!0),u(null);try{const m=await fetch(`/api/clusters/${encodeURIComponent(n)}/vms/${a}/backups`,{credentials:"same-origin"});if(!m.ok){const x=await m.json().catch(()=>({}));throw new Error(x.error||`HTTP ${m.status}`)}const f=await m.json();b&&c(f.backups||[])}catch(m){b&&u(m.message||String(m))}finally{b&&h(!1)}})(),()=>{b=!1}},[e,n,a]),!e)return null;const v=l.reduce((b,m)=>b+(m.size||0),0),y=(w=l[0])==null?void 0:w.ctime;return r.jsx("div",{className:"bh-back",onClick:t,children:r.jsxs("div",{className:"bh-modal",onClick:b=>b.stopPropagation(),children:[r.jsxs("div",{className:"bh-head",children:[r.jsxs("div",{className:"bh-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),r.jsx("span",{children:o("bh.title")}),s&&r.jsxs("span",{className:"bh-target",children:[a," — ",s]})]}),r.jsx("button",{className:"bh-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"bh-stats",children:[r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.count")})," ",l.length]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.total_size")})," ",wp(v)]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.newest")})," ",y?kp(y):"—",y&&r.jsx("span",{className:`bh-age bh-age-${Np(y)}`,children:jp(y,i)})]})]}),r.jsxs("div",{className:"bh-body",children:[g&&r.jsx("div",{className:"bh-error",children:g}),d&&l.length===0&&r.jsx("div",{className:"bh-loading",children:o("bh.loading")}),!d&&l.length===0&&!g&&r.jsxs("div",{className:"bh-empty",children:[r.jsx("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"})}),r.jsx("div",{children:o("bh.empty")})]}),l.length>0&&r.jsxs("table",{className:"bh-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:o("bh.col.ctime")}),r.jsx("th",{children:o("bh.col.age")}),r.jsx("th",{children:o("bh.col.storage")}),r.jsx("th",{children:o("bh.col.node")}),r.jsx("th",{className:"num",children:o("bh.col.size")}),r.jsx("th",{children:o("bh.col.flags")}),r.jsx("th",{children:o("bh.col.notes")})]})}),r.jsx("tbody",{children:l.map(b=>{var m,f;return r.jsxs("tr",{children:[r.jsx("td",{children:kp(b.ctime)}),r.jsx("td",{children:r.jsx("span",{className:`bh-age bh-age-${Np(b.ctime)}`,children:jp(b.ctime,i)})}),r.jsx("td",{children:b.storage||"—"}),r.jsx("td",{children:b.node||"—"}),r.jsx("td",{className:"num",children:wp(b.size)}),r.jsxs("td",{children:[b.protected&&r.jsx("span",{className:"bh-flag protected",children:o("bh.protected")}),((m=b.verification)==null?void 0:m.state)==="ok"&&r.jsx("span",{className:"bh-flag verified",children:o("bh.verified")}),((f=b.verification)==null?void 0:f.state)==="failed"&&r.jsx("span",{className:"bh-flag failed",children:o("bh.verify_failed")})]}),r.jsx("td",{className:"bh-notes",title:b.notes,children:b.notes||""})]},b.volid)})})]})]}),r.jsx("style",{children:`
        ...
        `})]})})}const ix=/^(scsi|virtio|sata|ide)\d+$/,lx=/^net\d+$/,cx=/^(mp|rootfs)\d*$/,dx=e=>{const t=/size=([^,]+)/.exec(e);return t?t[1]:""},_p=e=>{const t={};if(!e)return t;const n=e.split(",");n[0]&&n[0].indexOf("=")<0&&(t._head=n[0],n.shift());for(const a of n){const s=a.indexOf("=");s>0&&(t[a.slice(0,s).trim()]=a.slice(s+1).trim())}return t};function px({open:e,onClose:t,clusterId:n,node:a,vmid:s,kind:o,title:i}){const{t:l,language:c}=Ce(),[d,h]=p.useState(null),[g,u]=p.useState(!1),[v,y]=p.useState(null);p.useEffect(()=>{if(!e)return;let b=!0;return(async()=>{u(!0),y(null);try{const m=o==="qemu"?"qemu":"lxc",f=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/${m}/${s}/config`,{credentials:"same-origin"});if(!f.ok){const j=await f.json().catch(()=>({}));throw new Error(j.error||`HTTP ${f.status}`)}const x=await f.json();b&&h(x.config||{})}catch(m){b&&y(m.message||String(m))}finally{b&&u(!1)}})(),()=>{b=!1}},[e,n,a,s,o]);const w=p.useMemo(()=>{if(!d)return null;const b=[],m=[],f=[],x=[],j=[],N=new Set(["name","hostname","cores","sockets","cpu","cpulimit","cpuunits","memory","balloon","shares","ostype","agent","boot","bios","machine","numa","tablet","onboot","protection","startup","arch","description","tags","unprivileged","features","parent","lock","swap","vga"]);for(const[C,S]of Object.entries(d)){const k=String(S);if(!(C.startsWith("digest")||C==="_error")){if(N.has(C)){b.push([C,k]);continue}if(ix.test(C)){const R=_p(k),I=R._head||k.split(",")[0],T=R.size||dx(k),P=Object.entries(R).filter(([K])=>K!=="_head"&&K!=="size");m.push({id:C,bus:C,volid:I,size:T,opts:P.map(([K,A])=>`${K}=${A}`).join(", ")});continue}if(cx.test(C)){f.push([C,k]);continue}if(lx.test(C)){const R=_p(k),I=(R._head||"").split("="),T=I[0]||"",P=I[1]||"";x.push({id:C,model:T||R.model||"",bridge:R.bridge||"",mac:P,vlan:R.tag||"",firewall:R.firewall||""});continue}j.push([C,k])}}return b.sort((C,S)=>C[0].localeCompare(S[0])),j.sort((C,S)=>C[0].localeCompare(S[0])),{general:b,disks:m,mounts:f,nics:x,other:j}},[d]);return e?r.jsx("div",{className:"vc-back",onClick:t,children:r.jsxs("div",{className:"vc-modal",onClick:b=>b.stopPropagation(),children:[r.jsxs("div",{className:"vc-head",children:[r.jsxs("div",{className:"vc-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),r.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}),r.jsx("span",{children:l("vmcfg.title")}),i&&r.jsx("span",{className:"vc-target",children:i})]}),r.jsx("button",{className:"vc-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"vc-body",children:[g&&!d&&r.jsx("div",{className:"vc-loading",children:l("vmcfg.loading")}),v&&r.jsx("div",{className:"vc-error",children:v}),w&&r.jsxs(r.Fragment,{children:[w.general.length>0&&r.jsx(Ia,{title:l("vmcfg.section.general"),children:r.jsx("div",{className:"vc-kv",children:w.general.map(([b,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:b}),r.jsx("span",{className:"vc-kv-val",children:m})]},b))})}),w.disks.length>0&&r.jsx(Ia,{title:l("vmcfg.section.disks"),children:r.jsxs("table",{className:"vc-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:l("vmcfg.col.bus")}),r.jsx("th",{children:l("vmcfg.col.volid")}),r.jsx("th",{children:l("vmcfg.col.size")}),r.jsx("th",{children:l("vmcfg.col.opts")})]})}),r.jsx("tbody",{children:w.disks.map(b=>r.jsxs("tr",{children:[r.jsx("td",{className:"vc-mono",children:b.bus}),r.jsx("td",{className:"vc-mono",children:b.volid}),r.jsx("td",{className:"vc-mono",children:b.size}),r.jsx("td",{className:"vc-mono vc-trunc",title:b.opts,children:b.opts})]},b.id))})]})}),w.nics.length>0&&r.jsx(Ia,{title:l("vmcfg.section.nics"),children:r.jsxs("table",{className:"vc-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:l("vmcfg.col.id")}),r.jsx("th",{children:l("vmcfg.col.model")}),r.jsx("th",{children:l("vmcfg.col.bridge")}),r.jsx("th",{children:l("vmcfg.col.mac")}),r.jsx("th",{children:l("vmcfg.col.vlan")}),r.jsx("th",{children:l("vmcfg.col.firewall")})]})}),r.jsx("tbody",{children:w.nics.map(b=>r.jsxs("tr",{children:[r.jsx("td",{className:"vc-mono",children:b.id}),r.jsx("td",{className:"vc-mono",children:b.model}),r.jsx("td",{className:"vc-mono",children:b.bridge}),r.jsx("td",{className:"vc-mono",children:b.mac}),r.jsx("td",{className:"vc-mono",children:b.vlan||"—"}),r.jsx("td",{className:"vc-mono",children:b.firewall==="1"?"on":"—"})]},b.id))})]})}),w.mounts.length>0&&r.jsx(Ia,{title:l("vmcfg.section.mounts"),children:r.jsx("div",{className:"vc-kv",children:w.mounts.map(([b,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:b}),r.jsx("span",{className:"vc-kv-val vc-trunc",title:m,children:m})]},b))})}),w.other.length>0&&r.jsx(Ia,{title:l("vmcfg.section.other"),children:r.jsx("div",{className:"vc-kv",children:w.other.map(([b,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:b}),r.jsx("span",{className:"vc-kv-val vc-trunc",title:m,children:m})]},b))})})]})]}),r.jsx("style",{children:`
...
`)})]})]}),r.jsx("style",{children:`
      ...
      `})]})}function e2({clusters:e,onNavigate:t}){const{t:n,language:a}=Ce(),[s,o]=p.useState(!1),[i,l]=p.useState(""),[c,d]=p.useState(0),h=p.useRef(null),g=p.useRef(null);p.useEffect(()=>{const b=m=>{if((m.metaKey||m.ctrlKey)&&m.key.toLowerCase()==="k"){m.preventDefault(),o(f=>!f);return}m.key==="Escape"&&s&&o(!1)};return window.addEventListener("keydown",b),()=>window.removeEventListener("keydown",b)},[s]),p.useEffect(()=>{s?setTimeout(()=>{var b;return(b=h.current)==null?void 0:b.focus()},30):(l(""),d(0))},[s]);const u=(b,m)=>{if(!m)return 0;const f=b.toLowerCase(),x=m.toLowerCase();if(f===x)return 100;if(f.startsWith(x))return 80;if(f.indexOf(" "+x)>=0)return 70;const N=f.indexOf(x);return N>=0?50-Math.min(20,N):0},v=p.useMemo(()=>{const b=i.trim();if(!b)return[];const m=[];for(const[f,x]of Object.entries(e)){const j=x.name||f;for(const N of Object.values(x.vms||{})){const C=N.type==="lxc",S=`${N.vmid} ${N.name||""} ${N.node||""} ${j}`,k=Math.max(u(String(N.vmid),b),u(N.name||"",b),u(S,b));k>0&&m.push({kind:C?"ct":"vm",cluster:f,clusterName:j,name:`${C?"CT":"VM"} ${N.vmid} — ${N.name||"(unnamed)"}`,meta:`${j} · ${N.node||"?"} · ${N.status||"unknown"}`,score:k+(N.status==="running"?2:0),go:()=>{t("holo-matrix",{cluster:f})}})}for(const N of Object.values(x.nodes||{})){const C=Math.max(u(N.node||"",b),u(`${N.node} ${j}`,b));C>0&&m.push({kind:"node",cluster:f,clusterName:j,name:N.node,meta:`${j} · ${N.status||"?"} · ${N.vm_count||0}+${N.ct_count||0}`,score:C,go:()=>t("cluster-core",{cluster:f})})}for(const N of Object.values(x.storages||{})){const C=Math.max(u(N.storage||"",b),u(`${N.storage} ${N.node||""} ${j}`,b));C>0&&m.push({kind:"storage",cluster:f,clusterName:j,name:N.storage,meta:`${j} · ${N.node||"?"} · ${N.type||""}`,score:C,go:()=>t("storage",{cluster:f})})}}return m.sort((f,x)=>x.score-f.score),m.slice(0,30)},[i,e,t]);if(p.useEffect(()=>{d(0)},[i]),p.useEffect(()=>{const b=g.current;if(!b)return;const m=b.querySelector(`[data-idx="${c}"]`);m==null||m.scrollIntoView({block:"nearest"})},[c]),!s)return null;const y=b=>{if(b.key==="ArrowDown")b.preventDefault(),d(m=>Math.min(v.length-1,m+1));else if(b.key==="ArrowUp")b.preventDefault(),d(m=>Math.max(0,m-1));else if(b.key==="Enter"){b.preventDefault();const m=v[c];m&&(m.go(),o(!1))}},w=b=>b==="vm"||b==="ct"?r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),r.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}):b==="node"?r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"2",width:"20",height:"8",rx:"2"}),r.jsx("rect",{x:"2",y:"14",width:"20",height:"8",rx:"2"}),r.jsx("circle",{cx:"6",cy:"6",r:"1",fill:"currentColor"})]}):r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"5",rx:"9",ry:"3"}),r.jsx("path",{d:"M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"}),r.jsx("path",{d:"M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"})]});return r.jsx("div",{className:"cp-back",onClick:()=>o(!1),children:r.jsxs("div",{className:"cp-modal",onClick:b=>b.stopPropagation(),children:[r.jsxs("div",{className:"cp-input-row",children:[r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"11",cy:"11",r:"8"}),r.jsx("path",{d:"M21 21l-4.35-4.35"})]}),r.jsx("input",{ref:h,value:i,placeholder:n("cmdk.placeholder"),onChange:b=>l(b.target.value),onKeyDown:y}),r.jsx("span",{className:"cp-hint",children:"↑↓ ⏎"}),r.jsx("button",{className:"cp-x",onClick:()=>o(!1),children:"×"})]}),r.jsxs("div",{className:"cp-list",ref:g,children:[v.length===0&&i&&r.jsx("div",{className:"cp-empty",children:n("cmdk.empty")}),v.length===0&&!i&&r.jsx("div",{className:"cp-empty",children:n("cmdk.tip")}),v.map((b,m)=>r.jsxs("div",{"data-idx":m,className:`cp-item ${m===c?"cp-active":""}`,onClick:()=>{b.go(),o(!1)},onMouseEnter:()=>d(m),children:[r.jsx("span",{className:`cp-kind cp-kind-${b.kind}`,children:w(b.kind)}),r.jsx("span",{className:"cp-name",children:b.name}),r.jsx("span",{className:"cp-meta",children:b.meta})]},`${b.kind}:${b.cluster}:${b.name}:${m}`))]}),r.jsxs("div",{className:"cp-foot",children:[r.jsx("span",{className:"cp-foot-key",children:"⌘K"}),r.jsx("span",{children:n("cmdk.toggle")})]}),r.jsx("style",{children:`
        ...
        `})]})})}function t2({open:e,cluster_id:t,kind:n,title:a,body:s,label:o,onClose:i,onSaved:l}){const{t:c}=Ce(),[d,h]=p.useState(""),[g,u]=p.useState(!1),[v,y]=p.useState(""),w=p.useRef(null);if(p.useEffect(()=>{e&&(h(""),y(""),u(!1),setTimeout(()=>{var m;return(m=w.current)==null?void 0:m.focus()},50))},[e]),p.useEffect(()=>{if(!e)return;const m=f=>{f.key==="Escape"&&!g&&i()};return document.addEventListener("keydown",m),()=>document.removeEventListener("keydown",m)},[e,g,i]),!e)return null;const b=async()=>{if(d){u(!0),y("");try{await We.setClusterSecret(t,n,d),l()}catch(m){y(m instanceof Error?m.message:String(m)),u(!1)}}};return r.jsxs("div",{onClick:()=>!g&&i(),style:r2,children:[r.jsx("style",{children:n2}),r.jsxs("div",{className:"ssm-modal",onClick:m=>m.stopPropagation(),children:[r.jsxs("div",{className:"ssm-eyebrow",children:["// secret · ",t]}),r.jsx("h3",{className:"ssm-title",children:a}),r.jsx("p",{className:"ssm-body",children:s}),r.jsx("label",{children:o}),r.jsx("input",{ref:w,type:"password",value:d,onChange:m=>h(m.target.value),onKeyDown:m=>{m.key==="Enter"&&b()},autoComplete:"new-password",spellCheck:!1}),v&&r.jsx("div",{className:"ssm-err",children:v}),r.jsxs("div",{className:"ssm-actions",children:[r.jsx("button",{className:"ghost",onClick:i,disabled:g,children:c("action.cancel")}),r.jsx("button",{className:"primary",onClick:b,disabled:g||!d,children:g?"…":c("action.save")})]})]})]})}const r2={position:"fixed",inset:0,zIndex:400,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"ssmFade .18s ease"},n2=`
