 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(W,V){var Q=W.length;W.push(V);e:for(;0<Q;){var K=Q-1>>>1,C=W[K];if(0<s(C,V))W[K]=V,W[Q]=C,Q=K;else break e}}function n(W){return W.length===0?null:W[0]}function a(W){if(W.length===0)return null;var V=W[0],Q=W.pop();if(Q!==V){W[0]=Q;e:for(var K=0,C=W.length,Ne=C>>>1;K<Ne;){var _e=2*(K+1)-1,Ke=W[_e],G=_e+1,de=W[G];if(0>s(Ke,Q))G<C&&0>s(de,Ke)?(W[K]=de,W[G]=Q,K=G):(W[K]=Ke,W[_e]=Q,K=_e);else if(G<C&&0>s(de,Q))W[K]=de,W[G]=Q,K=G;else break e}}return V}function s(W,V){var Q=W.sortIndex-V.sortIndex;return Q!==0?Q:W.id-V.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,c=i.now();e.unstable_now=function(){return i.now()-c}}var l=[],d=[],h=1,g=null,u=3,x=!1,v=!1,k=!1,y=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,m=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function b(W){for(var V=n(d);V!==null;){if(V.callback===null)a(d);else if(V.startTime<=W)a(d),V.sortIndex=V.expirationTime,t(l,V);else break;V=n(d)}}function j(W){if(k=!1,b(W),!v)if(n(l)!==null)v=!0,q(w);else{var V=n(d);V!==null&&I(j,V.startTime-W)}}function w(W,V){v=!1,k&&(k=!1,f(M),M=-1),x=!0;var Q=u;try{for(b(V),g=n(l);g!==null&&(!(g.expirationTime>V)||W&&!T());){var K=g.callback;if(typeof K=="function"){g.callback=null,u=g.priorityLevel;var C=K(g.expirationTime<=V);V=e.unstable_now(),typeof C=="function"?g.callback=C:g===n(l)&&a(l),b(V)}else a(l);g=n(l)}if(g!==null)var Ne=!0;else{var _e=n(d);_e!==null&&I(j,_e.startTime-V),Ne=!1}return Ne}finally{g=null,u=Q,x=!1}}var S=!1,z=null,M=-1,D=5,P=-1;function T(){return!(e.unstable_now()-P<D)}function R(){if(z!==null){var W=e.unstable_now();P=W;var V=!0;try{V=z(!0,W)}finally{V?te():(S=!1,z=null)}}else S=!1}var te;if(typeof m=="function")te=function(){m(R)};else if(typeof MessageChannel<"u"){var U=new MessageChannel,L=U.port2;U.port1.onmessage=R,te=function(){L.postMessage(null)}}else te=function(){y(R,0)};function q(W){z=W,S||(S=!0,te())}function I(W,V){M=y(function(){W(e.unstable_now())},V)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(W){W.callback=null},e.unstable_continueExecution=function(){v||x||(v=!0,q(w))},e.unstable_forceFrameRate=function(W){0>W||125<W?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):D=0<W?Math.floor(1e3/W):5},e.unstable_getCurrentPriorityLevel=function(){return u},e.unstable_getFirstCallbackNode=function(){return n(l)},e.unstable_next=function(W){switch(u){case 1:case 2:case 3:var V=3;break;default:V=u}var Q=u;u=V;try{return W()}finally{u=Q}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(W,V){switch(W){case 1:case 2:case 3:case 4:case 5:break;default:W=3}var Q=u;u=W;try{return V()}finally{u=Q}},e.unstable_scheduleCallback=function(W,V,Q){var K=e.unstable_now();switch(typeof Q=="object"&&Q!==null?(Q=Q.delay,Q=typeof Q=="number"&&0<Q?K+Q:K):Q=K,W){case 1:var C=-1;break;case 2:C=250;break;case 5:C=1073741823;break;case 4:C=1e4;break;default:C=5e3}return C=Q+C,W={id:h++,callback:V,priorityLevel:W,startTime:Q,expirationTime:C,sortIndex:-1},Q>K?(W.sortIndex=Q,t(d,W),n(l)===null&&W===n(d)&&(k?(f(M),M=-1):k=!0,I(j,Q-K))):(W.sortIndex=C,t(l,W),v||x||(v=!0,q(w))),W},e.unstable_shouldYield=T,e.unstable_wrapCallback=function(W){var V=u;return function(){var Q=u;u=V;try{return W.apply(this,arguments)}finally{u=Q}}}})(pu);du.exports=pu;var x0=du.exports;/**
 * @license React
...
`;function _g(e={}){const{onMessage:t,onConnect:n,onDisconnect:a,onError:s,reconnectInterval:o=2e3,pingInterval:i=5e3}=e,c=p.useRef(null),l=p.useRef(null),d=p.useRef(null),h=p.useRef(t),[g,u]=p.useState({connected:!1,connecting:!1,lastMessageTime:0});h.current=t;const x=p.useCallback(()=>{const f=window.location.protocol==="https:"?"wss:":"ws:",m=window.location.host;return`${f}//${m}/ws`},[]),v=p.useCallback(()=>{var m;if(((m=c.current)==null?void 0:m.readyState)===WebSocket.OPEN)return;u(b=>({...b,connecting:!0}));const f=new WebSocket(x());c.current=f,f.onopen=()=>{u({connected:!0,connecting:!1,lastMessageTime:Date.now()}),n==null||n(),d.current&&clearInterval(d.current),d.current=window.setInterval(()=>{f.readyState===WebSocket.OPEN&&f.send(JSON.stringify({type:"ping"}))},i)},f.onmessage=b=>{var j;try{const w=JSON.parse(b.data);u(S=>({...S,lastMessageTime:Date.now()})),(w.type==="initial"||w.type==="update")&&(j=w.data)!=null&&j.clusters&&h.current&&h.current(w.data.clusters)}catch(w){console.error("[WS] Failed to parse message:",w)}},f.onerror=b=>{console.error("[WS] Error:",b),s==null||s(b)},f.onclose=()=>{u(b=>({...b,connected:!1,connecting:!1})),a==null||a(),d.current&&(clearInterval(d.current),d.current=null),l.current&&clearTimeout(l.current),l.current=window.setTimeout(()=>{v()},o)}},[x,n,a,s,o,i]),k=p.useCallback(()=>{l.current&&(clearTimeout(l.current),l.current=null),d.current&&(clearInterval(d.current),d.current=null),c.current&&(c.current.close(),c.current=null)},[]),y=p.useCallback(f=>{var m;((m=c.current)==null?void 0:m.readyState)===WebSocket.OPEN&&c.current.send(JSON.stringify(f))},[]);return p.useEffect(()=>(v(),()=>{k()}),[v,k]),p.useEffect(()=>{const f=setInterval(()=>{const b=Date.now()-g.lastMessageTime;g.connected&&b>15e3&&(k(),v())},5e3);return()=>clearInterval(f)},[g.connected,g.lastMessageTime,v,k]),{connected:g.connected,connecting:g.connecting,lastMessageTime:g.lastMessageTime,send:y,reconnect:v,disconnect:k}}const Sg="/api";async function Ee(e,t){const n=await fetch(`${Sg}${e}`,{credentials:"same-origin",headers:{"Content-Type":"application/json"},...t});if(n.status===401&&!e.startsWith("/auth/"))throw typeof window<"u"&&window.location.pathname!=="/login"&&window.location.replace("/login"),new Error("auth_required");if(!n.ok){const a=await n.text();throw new Error(a||`HTTP ${n.status}`)}return n.json()}const Be={authMe:()=>Ee("/auth/me"),authLogin:(e,t)=>Ee("/auth/login",{method:"POST",body:JSON.stringify({username:e,password:t})}),authLogout:()=>Ee("/auth/logout",{method:"POST"}),totpEnrollInit:()=>Ee("/auth/totp/enroll-init",{method:"POST"}),totpEnrollVerify:e=>Ee("/auth/totp/enroll-verify",{method:"POST",body:JSON.stringify({code:e})}),totpDisable:e=>Ee("/auth/totp/disable",{method:"POST",body:JSON.stringify({code:e})}),getConfig:()=>Ee("/config"),updateConfig:e=>Ee("/config",{method:"POST",body:JSON.stringify(e)}),getClusters:()=>Ee("/clusters"),getCluster:e=>Ee(`/clusters/${e}`),getSummary:()=>Ee("/summary"),getNodes:e=>Ee(`/nodes${e?`?cluster=${e}`:""}`),getVMs:e=>Ee(`/vms${e?`?cluster=${e}`:""}`),getStorages:e=>Ee(`/storages${e?`?cluster=${e}`:""}`),getCeph:e=>Ee(`/ceph${e?`?cluster=${e}`:""}`),getHealth:()=>Ee("/health"),vmAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/${a}`,{method:"POST"}),ctAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/cts/${n}/${a}`,{method:"POST"}),guestAction:(e,t,n,a,s)=>a==="lxc"?Be.ctAction(e,t,n,s):Be.vmAction(e,t,n,s),vmMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),ctMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/cts/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),bulkAction:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/bulk`,{method:"POST",body:JSON.stringify(t)}),taskStatus:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/tasks/${encodeURIComponent(n)}`),listSnapshots:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`),createSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`,{method:"POST",body:JSON.stringify(n)}),deleteSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}`,{method:"DELETE"}),rollbackSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}/rollback`,{method:"POST"}),vmReset:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/reset`,{method:"POST"}),cloneVm:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/clone`,{method:"POST",body:JSON.stringify(n)}),listRemoteEndpoints:e=>Ee(`/clusters/${encodeURIComponent(e)}/remote-endpoints`),fetchRemoteFingerprint:(e,t=8006)=>Ee(`/remote-fingerprint?host=${encodeURIComponent(e)}&port=${t}`),triggerBackup:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/backup`,{method:"POST",body:JSON.stringify(n)}),setClusterSecret:(e,t,n)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"POST",body:JSON.stringify({value:n})}),deleteClusterSecret:(e,t)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"DELETE"}),consolePrepare:e=>Ee("/console/prepare",{method:"POST",body:JSON.stringify(e)}),migrationPrecheck:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-precheck?target_cluster_id=${encodeURIComponent(n)}&target_node=${encodeURIComponent(a)}`),getMigrationSource:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-source`),getMigrationTargets:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/migration-targets`),remoteMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/remote-migrate`,{method:"POST",body:JSON.stringify(n)})};function Pe(e,t=1){if(e===0)return"0 B";const n=1024,a=["B","KB","MB","GB","TB","PB"],s=Math.floor(Math.log(e)/Math.log(n));return`${parseFloat((e/Math.pow(n,s)).toFixed(t))} ${a[s]}`}function lt(e,t=1){return`${e.toFixed(t)}%`}function ci(e){const t=Math.floor(e/86400),n=Math.floor(e%86400/3600),a=Math.floor(e%3600/60),s=[];return t>0&&s.push(`${t}d`),n>0&&s.push(`${n}h`),a>0&&s.push(`${a}m`),s.length>0?s.join(" "):"< 1m"}function Se(e,t=80,n=95){return e>=n?"danger":e>=t?"warning":"success"}function Vl(e){switch(e.toLowerCase()){case"running":case"online":case"healthy":case"health_ok":return"success";case"warning":case"health_warn":return"warning";case"stopped":case"offline":case"critical":case"health_err":return"danger";default:return"muted"}}function Cg({value:e,suffix:t="",className:n=""}){const a=x=>{if(typeof x=="number")return{left:x,isRatio:!1};const v=String(x).match(/^(\d+)\/(\d+)$/);if(v)return{left:parseInt(v[1]),right:parseInt(v[2]),isRatio:!0};const k=parseFloat(String(x));return isNaN(k)?{left:0,isRatio:!1}:{left:k,isRatio:!1}},s=a(e),[o,i]=p.useState(0),[c,l]=p.useState(s.right||0),d=p.useRef(null),h=p.useRef(0),g=p.useRef(!0);p.useEffect(()=>{const x=a(e);if(!g.current){i(x.left),x.right!==void 0&&l(x.right);return}const v=800,k=0,y=0;g.current=!1,d.current=null;const f=m=>{d.current||(d.current=m);const b=m-d.current,j=Math.min(b/v,1),w=1-Math.pow(1-j,3),S=k+(x.left-k)*w;if(i(Math.round(S)),x.isRatio&&x.right!==void 0){const z=y+(x.right-y)*w;l(Math.round(z))}j<1?h.current=requestAnimationFrame(f):(i(x.left),x.right!==void 0&&l(x.right))};return h.current=requestAnimationFrame(f),()=>{h.current&&cancelAnimationFrame(h.current)}},[e]);const u=s.isRatio?`${o}/${c}`:o;return r.jsxs("span",{className:`metric-value ${n}`,children:[u,t&&r.jsx("span",{style:{fontSize:"0.6em",opacity:.7},children:t})]})}function up({value:e,decimals:t=0,className:n=""}){const[a,s]=p.useState(0),o=p.useRef(null),i=p.useRef(0),c=p.useRef(!0);return p.useEffect(()=>{if(!c.current){s(e);return}const l=800,d=0;c.current=!1,o.current=null;const h=g=>{o.current||(o.current=g);const u=g-o.current,x=Math.min(u/l,1),v=1-Math.pow(1-x,3),k=d+(e-d)*v;s(k),x<1?i.current=requestAnimationFrame(h):s(e)};return i.current=requestAnimationFrame(h),()=>{i.current&&cancelAnimationFrame(i.current)}},[e]),r.jsxs("span",{className:n,children:[a.toFixed(t),"%"]})}function Di({left:e,right:t,className:n=""}){const[a,s]=p.useState(0),[o,i]=p.useState(0),c=p.useRef(null),l=p.useRef(0),d=p.useRef(!0);return p.useEffect(()=>{if(!d.current){s(e),i(t);return}const h=800,g=0,u=0;d.current=!1,c.current=null;const x=v=>{c.current||(c.current=v);const k=v-c.current,y=Math.min(k/h,1),f=1-Math.pow(1-y,3);s(Math.round(g+(e-g)*f)),i(Math.round(u+(t-u)*f)),y<1?l.current=requestAnimationFrame(x):(s(e),i(t))};return l.current=requestAnimationFrame(x),()=>{l.current&&cancelAnimationFrame(l.current)}},[e,t]),r.jsxs("span",{className:n,children:[a,"/",o]})}function Hs({label:e,value:t,suffix:n,subValue:a,color:s="primary",icon:o}){return r.jsxs("div",{className:`stat-card ${s!=="primary"?`stat-${s}`:""}`,children:[o&&r.jsx("div",{className:"stat-icon",children:o}),r.jsxs("div",{className:"stat-content",children:[r.jsx("div",{className:"stat-label",children:e}),r.jsx(Cg,{value:t,suffix:n,className:s!=="primary"?`text-${s}`:""}),a&&r.jsx("div",{className:"stat-sub",children:a})]})]})}function Bi({value:e,label:t,color:n,size:a=100}){const[s,o]=p.useState(0),i=p.useRef(null),c=p.useRef(0),l=p.useRef(!0);p.useEffect(()=>{if(!l.current){o(e);return}const y=1e3,f=0;l.current=!1,i.current=null;const m=b=>{i.current||(i.current=b);const j=b-i.current,w=Math.min(j/y,1),S=1-Math.pow(1-w,3),z=f+(e-f)*S;o(z),w<1?c.current=requestAnimationFrame(m):o(e)};return c.current=requestAnimationFrame(m),()=>{c.current&&cancelAnimationFrame(c.current)}},[e]);const d=5,h=(a-d*4)/2-8,g=(a-d)/2,u=h+(g-h)/2,x=2*Math.PI*u,v=x-s/100*x,k=Array.from({length:36},(y,f)=>{const m=(f*10-90)*(Math.PI/180),b=f%3===0,j=b?6:3,w=g-2,S=w-j;return{x1:a/2+Math.cos(m)*w,y1:a/2+Math.sin(m)*w,x2:a/2+Math.cos(m)*S,y2:a/2+Math.sin(m)*S,isMajor:b}});return r.jsxs("div",{className:"ring-gauge",children:[r.jsxs("svg",{viewBox:`0 0 ${a} ${a}`,className:"ring-svg",children:[r.jsx("circle",{className:"ring-outer-deco",cx:a/2,cy:a/2,r:g,strokeWidth:1}),k.map((y,f)=>r.jsx("line",{x1:y.x1,y1:y.y1,x2:y.x2,y2:y.y2,className:`ring-tick ${y.isMajor?"major":""}`},f)),r.jsx("circle",{className:"ring-bg",cx:a/2,cy:a/2,r:u,strokeWidth:d}),r.jsx("circle",{className:"ring-inner-deco",cx:a/2,cy:a/2,r:h,strokeWidth:1}),r.jsx("circle",{className:`ring-fill ${n}`,cx:a/2,cy:a/2,r:u,strokeWidth:d,strokeDasharray:x,strokeDashoffset:v,transform:`rotate(-90 ${a/2} ${a/2})`}),r.jsx("line",{className:"ring-sweep",x1:a/2,y1:a/2,x2:a/2,y2:a/2-u-4,transform:`rotate(${s/100*360-90} ${a/2} ${a/2})`})]}),r.jsxs("div",{className:"ring-content",children:[r.jsxs("span",{className:`ring-value text-${n}`,children:[s.toFixed(0),r.jsx("span",{className:"ring-percent",children:"%"})]}),r.jsx("span",{className:"ring-label",children:t})]})]})}function Mg({cluster:e,onClick:t}){var l,d;const{t:n}=$e(),a=e.summary;if(!a)return null;const s=Se(a.total_cpu_usage),o=Se(a.total_memory_usage),i=a.alerts_warning>0,c=a.alerts_critical>0;return r.jsxs("div",{className:`cluster-hex-card ${c?"critical":i?"warning":""}`,onClick:t,children:[r.jsxs("div",{className:"cluster-hex-inner",children:[r.jsxs("div",{className:"cluster-hex-header",children:[r.jsxs("div",{className:"cluster-hex-title",children:[r.jsx("span",{className:"cluster-hex-name",children:e.name||e.id}),a.is_standalone&&r.jsx("span",{className:"standalone-badge",children:n("dashboard.standalone")})]}),r.jsx("span",{className:`cluster-hex-status ${a.status==="connected"?"online":"offline"}`})]}),r.jsxs("div",{className:"cluster-hex-metrics",children:[r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"CPU"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${s}`,style:{width:`${a.total_cpu_usage}%`}})}),r.jsx(up,{value:a.total_cpu_usage,decimals:0,className:`metric-value small text-${s}`})]}),r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"MEM"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${o}`,style:{width:`${a.total_memory_usage}%`}})}),r.jsx(up,{value:a.total_memory_usage,decimals:0,className:`metric-value small text-${o}`})]})]}),r.jsxs("div",{className:"cluster-hex-stats",children:[r.jsxs("div",{className:"hex-stat",children:[r.jsx(Di,{left:a.nodes_online,right:a.node_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.nodes")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Di,{left:a.vms_running,right:a.vm_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.vms_short")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Di,{left:a.cts_running,right:a.ct_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.cts_short")})]})]}),a.has_ceph&&r.jsx("div",{className:"cluster-hex-ceph",children:r.jsxs("span",{className:`ceph-badge ${((l=a.ceph_health)==null?void 0:l.toLowerCase().replace("health_",""))||"unknown"}`,children:["CEPH: ",((d=a.ceph_health)==null?void 0:d.replace("HEALTH_",""))||"N/A"]})})]}),r.jsx("div",{className:"corner-decoration top-left"}),r.jsx("div",{className:"corner-decoration top-right"}),r.jsx("div",{className:"corner-decoration bottom-left"}),r.jsx("div",{className:"corner-decoration bottom-right"})]})}function mp({clusters:e,globalSummary:t,onSelectCluster:n,isPaused:a=!1}){const{t:s}=$e(),o=p.useMemo(()=>Object.entries(e),[e]),i=p.useMemo(()=>{let c=0,l=0,d=0,h=0;return Object.values(e).forEach(g=>{g.summary&&(c+=g.summary.total_cpu_usage||0,l+=g.summary.total_memory_usage||0,d+=g.summary.total_storage_usage||0,h++)}),{avgCpu:h>0?c/h:0,avgMem:h>0?l/h:0,avgStorage:h>0?d/h:0}},[e]);return r.jsxs("div",{className:"command-center",children:[r.jsx("div",{className:"grid-floor"}),r.jsxs("div",{className:"cc-header",children:[r.jsx("h1",{className:"cc-title font-display",children:r.jsx("span",{className:"glitch-text","data-text":s("dashboard.title"),children:s("dashboard.title")})}),r.jsx("div",{className:"cc-subtitle",children:s("dashboard.subtitle")})]}),r.jsxs("div",{className:"cc-content",children:[r.jsxs("div",{className:"cc-top-row",children:[r.jsxs("div",{className:"cc-gauges panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.resource_usage")})}),r.jsxs("div",{className:"gauges-container",children:[r.jsx(Bi,{value:i.avgCpu,label:s("metric.cpu"),color:Se(i.avgCpu),size:110}),r.jsx(Bi,{value:i.avgMem,label:s("metric.memory"),color:Se(i.avgMem),size:110}),r.jsx(Bi,{value:i.avgStorage,label:s("metric.disk"),color:Se(i.avgStorage),size:110})]})]}),r.jsxs("div",{className:"cc-stats-panel panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.infrastructure")})}),r.jsxs("div",{className:"stats-grid",children:[r.jsx(Hs,{label:s("cluster.total"),value:t.total_clusters,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("circle",{cx:"12",cy:"12",r:"4"})]})}),r.jsx(Hs,{label:s("cluster.nodes_online"),value:`${t.total_nodes_online}/${t.total_nodes}`,color:t.total_nodes_online<t.total_nodes?"warning":"success",icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("path",{d:"M8 21h8M12 17v4"})]})}),r.jsx(Hs,{label:s("cluster.vms_running"),value:`${t.total_vms_running}/${t.total_vms}`,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M3 9h18M9 3v18"})]})}),r.jsx(Hs,{label:s("cluster.cts_running"),value:`${t.total_cts_running}/${t.total_cts}`,icon:r.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"})})})]})]})]}),r.jsxs("div",{className:"cc-galaxy",children:[r.jsx("div",{className:"galaxy-title font-display",children:s("cluster.galaxy")}),r.jsx("div",{className:"galaxy-container",children:o.length===0?r.jsxs("div",{className:"no-clusters",children:[r.jsx("div",{className:"no-clusters-icon",children:r.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 6v6l4 2"})]})}),r.jsx("div",{className:"no-clusters-text",children:s("loading.connecting")}),r.jsx("div",{className:"no-clusters-hint",children:"Configure clusters in config.yaml"})]}):r.jsx("div",{className:"cluster-grid",children:o.map(([c,l])=>r.jsx(Mg,{cluster:l,onClick:()=>n(c)},c))})})]})]}),r.jsx("style",{children:`
      ...
      `})]})}function zg(e,t,n){const a=Math.min(e,100)/100,s=.1+a*.6,o=t;let i=(Math.random()-.5)*.02;if(o>.08&&o<.22){const c=(o-.08)/.14;i+=s*.2*Math.sin(c*Math.PI)}if(o>.24&&o<.4){const c=(o-.24)/.16;if(c<.2)i-=s*.15*Math.sin(c*5*Math.PI);else if(c<.5){const l=(c-.2)/.3;i+=s*(1+a*.5)*Math.sin(l*Math.PI)}else if(c<.7){const l=(c-.5)/.2;i-=s*.25*Math.sin(l*Math.PI)}}if(o>.48&&o<.72){const c=(o-.48)/.24;i+=s*.35*Math.sin(c*Math.PI)}return i*n}function Wi({value:e,label:t,color:n,isOnline:a,width:s=180,height:o=35,isPaused:i=!1}){const c=p.useRef(null),l=p.useRef(null),d=p.useRef([]),h=p.useRef(0),g=p.useRef(0),u=p.useRef(0),x=p.useRef(0),v=p.useRef(!i),k=p.useRef(!1),f=6e4/(50+e/100*50),m=12;p.useEffect(()=>{v.current=!i},[i]);const b=p.useCallback(()=>{const w=l.current;if(!w)return;w.fillStyle="rgba(5, 8, 15, 0.95)",w.fillRect(0,0,s,o),w.strokeStyle="rgba(0, 240, 255, 0.08)",w.lineWidth=.5;for(let R=0;R<o;R+=10)w.beginPath(),w.moveTo(0,R),w.lineTo(s,R),w.stroke();for(let R=0;R<s;R+=10)w.beginPath(),w.moveTo(R,0),w.lineTo(R,o),w.stroke();const S=o/2,z=o*.45,D=!a||e>90?"#ff0040":e>70?"#ff6b00":n;w.shadowColor=D,w.shadowBlur=6,w.strokeStyle=D,w.lineWidth=1.5,w.lineCap="round",w.lineJoin="round",w.beginPath();let P=!1;for(let R=0;R<s;R++){const te=(R-h.current+s)%s;if(te<8&&te>0)continue;const U=S-d.current[R]*z;P?w.lineTo(R,U):(w.moveTo(R,U),P=!0)}w.stroke(),w.shadowBlur=0,w.strokeStyle=`${D}60`,w.lineWidth=2,w.beginPath(),w.moveTo(h.current,0),w.lineTo(h.current,o),w.stroke();const T=w.createLinearGradient(h.current-15,0,h.current,0);T.addColorStop(0,"transparent"),T.addColorStop(1,`${D}30`),w.fillStyle=T,w.fillRect(h.current-15,0,15,o)},[s,o,e,a,n]);p.useEffect(()=>{const w=c.current;if(!w)return;const S=w.getContext("2d");if(!S)return;const z=window.devicePixelRatio||1;w.width=s*z,w.height=o*z,S.scale(z,z),l.current=S,d.current.length!==s&&(d.current=new Array(s).fill(0)),k.current=!0,b()},[s,o,b]),p.useEffect(()=>{if(!k.current||!l.current)return;const S=z=>{x.current||(x.current=z);const M=z-x.current;x.current=z;const D=M/1e3*m;g.current+=M/f,g.current>=1&&(g.current-=1);const P=Math.ceil(D);for(let T=0;T<P;T++){const te=(g.current+T/P*(M/f))%1;let U;a?U=zg(e,te,1):U=(Math.random()-.5)*.01,h.current=(h.current+1)%s,d.current[h.current]=U;const L=(h.current+1)%s;for(let q=0;q<8;q++){const I=(L+q)%s;d.current[I]=0}}b(),v.current&&(u.current=requestAnimationFrame(S))};return i||(x.current=0,u.current=requestAnimationFrame(S)),()=>{cancelAnimationFrame(u.current)}},[s,o,e,a,f,m,i,b]);const j=()=>!a||e>90?"#ff0040":e>70?"#ff6b00":n;return r.jsxs("div",{className:"ecg-trace",children:[r.jsxs("div",{className:"ecg-trace-header",children:[r.jsx("span",{className:"ecg-trace-label",style:{color:j()},children:t}),r.jsx("span",{className:"ecg-trace-value",style:{color:j()},children:a?`${Math.round(e)}%`:"--"})]}),r.jsx("canvas",{ref:c,style:{width:s,height:o,display:"block"}}),r.jsx("style",{children:`
        .ecg-trace {
          position: relative;
        }
      ...
      `})]})}const Eg=["hour","day","week","month","year"],Hl=e=>{if(!isFinite(e)||e===0)return"0";const t=["B","K","M","G","T"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=10?0:1)}${t[n]}`},Yn=e=>Hl(e)+"/s",fp=e=>`${(e*100).toFixed(0)}%`;function mf({open:e,onClose:t,clusterId:n,node:a,vmid:s,kind:o,title:i}){const{t:c,language:l}=$e(),[d,h]=p.useState("hour"),[g,u]=p.useState([]),[x,v]=p.useState(!1),[k,y]=p.useState(null);return p.useEffect(()=>{if(!e)return;let f=!0;return(async()=>{v(!0),y(null);try{const m=encodeURIComponent(n),b=encodeURIComponent(a),j=o==="node"?`/api/clusters/${m}/nodes/${b}/rrddata`:o==="qemu"?`/api/clusters/${m}/nodes/${b}/qemu/${s}/rrddata`:`/api/clusters/${m}/nodes/${b}/lxc/${s}/rrddata`,w=await fetch(`${j}?timeframe=${d}`,{credentials:"same-origin"});if(!w.ok){const z=await w.json().catch(()=>({}));throw new Error(z.error||`HTTP ${w.status}`)}const S=await w.json();if(!f)return;u((S.samples||[]).filter(z=>z&&z.time))}catch(m){f&&y(m.message||String(m))}finally{f&&v(!1)}})(),()=>{f=!1}},[e,n,a,s,o,d]),e?r.jsx("div",{className:"rrd-back",onClick:t,children:r.jsxs("div",{className:"rrd-modal",onClick:f=>f.stopPropagation(),children:[r.jsxs("div",{className:"rrd-head",children:[r.jsxs("div",{className:"rrd-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"3 17 9 11 13 15 21 7"}),r.jsx("polyline",{points:"14 7 21 7 21 14"})]}),r.jsx("span",{children:c("rrd.title")}),i&&r.jsx("span",{className:"rrd-target",children:i})]}),r.jsxs("div",{className:"rrd-tfs",children:[Eg.map(f=>r.jsx("button",{className:`rrd-tf ${f===d?"on":""}`,onClick:()=>h(f),children:c(`rrd.tf.${f}`)},f)),r.jsx("button",{className:"rrd-close",onClick:t,"aria-label":"close",children:"×"})]})]}),r.jsxs("div",{className:"rrd-body",children:[k&&r.jsx("div",{className:"rrd-error",children:k}),x&&g.length===0&&r.jsx("div",{className:"rrd-loading",children:c("rrd.loading")}),!x&&g.length===0&&!k&&r.jsx("div",{className:"rrd-loading",children:c("rrd.empty")}),g.length>0&&r.jsxs("div",{className:"rrd-grid",children:[r.jsx(Ys,{title:c("rrd.chart.cpu"),samples:g,color:"#00f0ff",series:[{key:"cpu",label:"CPU",fmt:fp,scale:f=>f.cpu??null}],yMax:1,yFmt:fp}),r.jsx(Ys,{title:c("rrd.chart.mem"),samples:g,color:"#00ff88",series:[{key:"mem",label:"Mem",fmt:f=>Hl(f),scale:f=>f.mem??null}],yFmt:Hl,fillTop:f=>f.maxmem}),r.jsx(Ys,{title:c("rrd.chart.net"),samples:g,color:"#ff8a3c",series:[{key:"netin",label:"In",fmt:Yn,scale:f=>f.netin??null,color:"#ff8a3c"},{key:"netout",label:"Out",fmt:Yn,scale:f=>f.netout??null,color:"#bf00ff"}],yFmt:Yn}),r.jsx(Ys,{title:c("rrd.chart.disk"),samples:g,color:"#bf00ff",series:[{key:"diskread",label:"Read",fmt:Yn,scale:f=>f.diskread??null,color:"#00f0ff"},{key:"diskwrite",label:"Write",fmt:Yn,scale:f=>f.diskwrite??null,color:"#bf00ff"}],yFmt:Yn})]})]}),r.jsx("style",{children:`
        ...
        `})]})}):null}function Ys({title:e,samples:t,series:n,yMax:a,yFmt:s,fillTop:o}){var j,w;const{width:i,height:c}={width:460,height:160},l=48,d=8,h=10,g=22,u=p.useMemo(()=>{if(typeof a=="number")return a;let S=1;for(const z of t){const M=o==null?void 0:o(z);M&&M>S&&(S=M);for(const D of n){const P=D.scale(z);P!=null&&P>S&&(S=P)}}return S*1.1},[t,n,o,a]),x=((j=t[0])==null?void 0:j.time)||0,v=((w=t[t.length-1])==null?void 0:w.time)||x+1,k=Math.max(1,v-x),y=S=>l+(S-x)/k*(i-l-d),f=S=>h+(1-S/u)*(c-h-g),m=S=>{let z="",M=!1;for(const D of t){const P=S.scale(D);if(P==null||!isFinite(P)){M=!1;continue}const T=y(D.time),R=f(P);z+=(M?" L ":" M ")+T.toFixed(1)+","+R.toFixed(1),M=!0}return z},b=[0,.25,.5,.75,1].map(S=>u*(1-S));return r.jsxs("div",{className:"rrd-card",children:[r.jsxs("div",{className:"rrd-card-head",children:[r.jsx("div",{className:"rrd-card-title",children:e}),r.jsx("div",{className:"rrd-card-legend",children:n.map(S=>r.jsxs("span",{children:[r.jsx("span",{className:"dot",style:{background:S.color||"#00f0ff"}}),S.label]},S.key))})]}),r.jsxs("svg",{viewBox:`0 0 ${i} ${c}`,className:"rrd-svg",children:[b.map((S,z)=>{const M=h+z/4*(c-h-g);return r.jsxs("g",{children:[r.jsx("line",{x1:l,y1:M,x2:i-d,y2:M,stroke:"rgba(0,240,255,.08)"}),r.jsx("text",{x:l-4,y:M+3,textAnchor:"end",fontSize:"9",fill:"rgba(160,180,200,.6)",fontFamily:"Share Tech Mono, monospace",children:s(S)})]},z)}),n.map(S=>r.jsx("path",{d:m(S),fill:"none",stroke:S.color||"#00f0ff",strokeWidth:"1.3",opacity:"0.95"},S.key))]}),r.jsx("style",{children:`
...
`;function Ug({open:e,title:t,details:n,typeToConfirm:a,destructive:s=!1,confirmLabel:o="Confirm",cancelLabel:i="Cancel",onConfirm:c,onCancel:l}){const[d,h]=Go.useState(""),g=p.useRef(null),u=p.useRef(null);if(p.useEffect(()=>{e&&(h(""),setTimeout(()=>{var v,k;a?(v=u.current)==null||v.focus():(k=g.current)==null||k.focus()},50))},[e,a]),p.useEffect(()=>{if(!e)return;const v=k=>{k.key==="Escape"&&(k.preventDefault(),l()),k.key==="Enter"&&(!a||d===a)&&(k.preventDefault(),c())};return document.addEventListener("keydown",v),()=>document.removeEventListener("keydown",v)},[e,d,a,c,l]),!e)return null;const x=!a||d===a;return r.jsxs("div",{onClick:l,style:{position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"cmFade .18s ease"},children:[r.jsx("style",{children:`
...
`;function Xg(e){if(!e)return"—";try{return new Date(e*1e3).toLocaleString()}catch{return String(e)}}function gf({open:e,cluster_id:t,vm:n,onClose:a}){const{t:s}=$e(),o=Kr(),[i,c]=p.useState([]),[l,d]=p.useState(!1),[h,g]=p.useState(!1),[u,x]=p.useState(""),[v,k]=p.useState(""),[y,f]=p.useState(!1),[m,b]=p.useState(""),j=async()=>{if(n){d(!0),b("");try{const M=await Be.listSnapshots(t,n.vmid);c((M.snapshots||[]).filter(D=>D.name!=="current"))}catch(M){b(M instanceof Error?M.message:String(M))}finally{d(!1)}}};if(p.useEffect(()=>{e&&(x(""),k(""),f(!1),b(""),j())},[e,t,n==null?void 0:n.vmid]),p.useEffect(()=>{if(!e)return;const M=D=>{D.key==="Escape"&&a()};return document.addEventListener("keydown",M),()=>document.removeEventListener("keydown",M)},[e,a]),!e||!n)return null;const w=async()=>{if(u){if(!/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(u)){b("snapshot name must match [a-zA-Z][a-zA-Z0-9_-]*");return}g(!0),b("");try{await Be.createSnapshot(t,n.vmid,{snapname:u,description:v,vmstate:y}),x(""),k(""),f(!1),await j()}catch(M){b(M instanceof Error?M.message:String(M))}finally{g(!1)}}},S=async M=>{if(await o.confirm(s("snap.confirm_delete",{name:M.name}),{destructive:!0})){b("");try{await Be.deleteSnapshot(t,n.vmid,M.name),await j()}catch(D){b(D instanceof Error?D.message:String(D))}}},z=async M=>{if(await o.confirm(s("snap.confirm_rollback",{name:M.name}),{destructive:!0})){b("");try{await Be.rollbackSnapshot(t,n.vmid,M.name),await j()}catch(D){b(D instanceof Error?D.message:String(D))}}};return r.jsxs("div",{onClick:a,style:qg,children:[r.jsx("style",{children:Qg}),r.jsxs("div",{className:"sm-modal",onClick:M=>M.stopPropagation(),children:[r.jsxs("div",{className:"sm-eyebrow",children:["// snapshots · ",t]}),r.jsx("h3",{className:"sm-title",children:s("snap.title",{vmid:n.vmid,name:n.name})}),r.jsxs("div",{className:"sm-create",children:[r.jsxs("div",{className:"sm-row",children:[r.jsx("label",{children:s("snap.name")}),r.jsx("input",{type:"text",value:u,onChange:M=>x(M.target.value),placeholder:"my-snap",spellCheck:!1})]}),r.jsxs("div",{className:"sm-row",children:[r.jsx("label",{children:s("snap.description")}),r.jsx("input",{type:"text",value:v,onChange:M=>k(M.target.value)})]}),r.jsxs("div",{className:"sm-row sm-check-row",children:[r.jsxs("label",{className:"sm-check",children:[r.jsx("input",{type:"checkbox",checked:y,onChange:M=>f(M.target.checked)}),r.jsx("span",{children:s("snap.include_state")})]}),r.jsx("button",{className:"sm-btn primary",disabled:h||!u,onClick:w,children:h?"…":s("snap.create")})]})]}),m&&r.jsx("div",{className:"sm-err",children:m}),r.jsxs("div",{className:"sm-list",children:[l&&r.jsx("div",{className:"sm-empty",children:"…"}),!l&&i.length===0&&r.jsx("div",{className:"sm-empty",children:s("snap.empty")}),!l&&i.map(M=>r.jsxs("div",{className:"sm-item",children:[r.jsxs("div",{className:"sm-item-head",children:[r.jsx("code",{className:"sm-name",children:M.name}),M.parent&&r.jsxs("span",{className:"sm-meta",children:[s("snap.parent"),": ",r.jsx("code",{children:M.parent})]}),r.jsxs("span",{className:"sm-meta",children:[s("snap.taken"),": ",Xg(M.snaptime)]}),M.vmstate?r.jsx("span",{className:"sm-tag",children:"RAM"}):null]}),M.description&&r.jsx("div",{className:"sm-desc",children:M.description}),r.jsxs("div",{className:"sm-item-actions",children:[r.jsx("button",{className:"sm-btn ghost",onClick:()=>z(M),children:s("snap.rollback")}),r.jsx("button",{className:"sm-btn danger",onClick:()=>S(M),children:s("snap.delete")})]})]},M.name))]}),r.jsx("div",{className:"sm-actions",children:r.jsx("button",{className:"sm-btn ghost",onClick:a,children:s("action.close")})})]})]})}const qg={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"smFade .18s ease"},Qg=`
...
`;function xf({open:e,cluster_id:t,vm:n,onClose:a}){const{t:s}=$e(),[o,i]=p.useState([]),[c,l]=p.useState(!1),[d,h]=p.useState(""),[g,u]=p.useState("snapshot"),[x,v]=p.useState("zstd"),[k,y]=p.useState(""),[f,m]=p.useState(""),[b,j]=p.useState(!1);if(p.useEffect(()=>{!e||!n||(y(""),m(""),h(""),l(!0),Be.getCluster(t).then(z=>{const D=Object.values(z.storages||{}).filter(P=>{var R;if(!((R=P.content)!=null&&R.includes("backup")))return!1;const T=P.allowed_nodes||[];return T.length>0&&!T.includes(n.node)||!P.shared&&P.node!==n.node?!1:P.enabled!==!1});i(D),D.length>0&&h(D[0].storage)}).catch(z=>y(z.message||String(z))).finally(()=>l(!1)))},[e,t,n==null?void 0:n.vmid,n==null?void 0:n.node]),p.useEffect(()=>{if(!e)return;const z=M=>{M.key==="Escape"&&!b&&a()};return document.addEventListener("keydown",z),()=>document.removeEventListener("keydown",z)},[e,b,a]),!e||!n)return null;const w=o.length>0,S=async()=>{if(d){j(!0),y("");try{const z=await Be.triggerBackup(t,n.node,{vmid:n.vmid,storage:d,mode:g,compress:x});m(z.upid)}catch(z){y(z instanceof Error?z.message:String(z))}finally{j(!1)}}};return r.jsxs("div",{onClick:()=>!b&&a(),style:Jg,children:[r.jsx("style",{children:Zg}),r.jsxs("div",{className:"bm-modal",onClick:z=>z.stopPropagation(),children:[r.jsxs("div",{className:"bm-eyebrow",children:["// backup · ",t," · ",n.node]}),r.jsx("h3",{className:"bm-title",children:s("backup.title",{vmid:n.vmid,name:n.name})}),!f&&r.jsxs(r.Fragment,{children:[r.jsx("label",{children:s("backup.storage")}),c?r.jsx("div",{className:"bm-empty",children:"…"}):w?r.jsx("select",{value:d,onChange:z=>h(z.target.value),children:o.map(z=>r.jsxs("option",{value:z.storage,children:[z.storage," (",z.type,z.shared?", shared":"",")"]},z.storage))}):r.jsx("div",{className:"bm-err",children:s("backup.no_backup_storage")}),r.jsx("label",{children:s("backup.mode")}),r.jsxs("select",{value:g,onChange:z=>u(z.target.value),children:[r.jsx("option",{value:"snapshot",children:s("backup.mode_snapshot")}),r.jsx("option",{value:"suspend",children:s("backup.mode_suspend")}),r.jsx("option",{value:"stop",children:s("backup.mode_stop")})]}),r.jsx("label",{children:s("backup.compress")}),r.jsxs("select",{value:x,onChange:z=>v(z.target.value),children:[r.jsx("option",{value:"zstd",children:"zstd"}),r.jsx("option",{value:"lzo",children:"lzo"}),r.jsx("option",{value:"gzip",children:"gzip"}),r.jsx("option",{value:"0",children:"none"})]}),k&&r.jsx("div",{className:"bm-err",children:k}),r.jsxs("div",{className:"bm-actions",children:[r.jsx("button",{className:"bm-btn ghost",onClick:a,disabled:b,children:s("action.cancel")}),r.jsx("button",{className:"bm-btn primary",disabled:b||!d,onClick:S,children:b?"…":s("backup.start")})]})]}),f&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"bm-ok",children:s("backup.started")}),r.jsx("div",{className:"bm-review",children:r.jsxs("div",{children:[r.jsx("span",{children:s("rmm.done.upid")}),r.jsx("code",{style:{userSelect:"all"},children:f})]})}),r.jsx("div",{className:"bm-actions",children:r.jsx("button",{className:"bm-btn primary",onClick:a,children:s("action.close")})})]})]})]})}const Jg={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"bmFade .18s ease"},Zg=`
...
`,vp=e=>{if(!e||!isFinite(e))return"—";const t=["B","KB","MB","GB","TB"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=100?0:a>=10?1:2)} ${t[n]}`},bp=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}`},yp=(e,t)=>{if(!e)return"—";const n=Math.floor(Date.now()/1e3)-e,a=Math.floor(n/86400);if(a===0)return t==="zh-TW"?"今天":"today";if(a===1)return t==="zh-TW"?"昨天":"yesterday";if(a<30)return t==="zh-TW"?`${a} 天前`:`${a}d ago`;const s=Math.floor(a/30);return t==="zh-TW"?`${s} 個月前`:`${s}mo ago`},wp=e=>{if(!e)return"unknown";const t=(Date.now()/1e3-e)/86400;return t>30?"stale":t>7?"aging":"fresh"};function ex({open:e,onClose:t,clusterId:n,vmid:a,vmName:s}){var k;const{t:o,language:i}=$e(),[c,l]=p.useState([]),[d,h]=p.useState(!1),[g,u]=p.useState(null);if(p.useEffect(()=>{if(!e)return;let y=!0;return(async()=>{h(!0),u(null);try{const f=await fetch(`/api/clusters/${encodeURIComponent(n)}/vms/${a}/backups`,{credentials:"same-origin"});if(!f.ok){const b=await f.json().catch(()=>({}));throw new Error(b.error||`HTTP ${f.status}`)}const m=await f.json();y&&l(m.backups||[])}catch(f){y&&u(f.message||String(f))}finally{y&&h(!1)}})(),()=>{y=!1}},[e,n,a]),!e)return null;const x=c.reduce((y,f)=>y+(f.size||0),0),v=(k=c[0])==null?void 0:k.ctime;return r.jsx("div",{className:"bh-back",onClick:t,children:r.jsxs("div",{className:"bh-modal",onClick:y=>y.stopPropagation(),children:[r.jsxs("div",{className:"bh-head",children:[r.jsxs("div",{className:"bh-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),r.jsx("span",{children:o("bh.title")}),s&&r.jsxs("span",{className:"bh-target",children:[a," — ",s]})]}),r.jsx("button",{className:"bh-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"bh-stats",children:[r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.count")})," ",c.length]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.total_size")})," ",vp(x)]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.newest")})," ",v?bp(v):"—",v&&r.jsx("span",{className:`bh-age bh-age-${wp(v)}`,children:yp(v,i)})]})]}),r.jsxs("div",{className:"bh-body",children:[g&&r.jsx("div",{className:"bh-error",children:g}),d&&c.length===0&&r.jsx("div",{className:"bh-loading",children:o("bh.loading")}),!d&&c.length===0&&!g&&r.jsxs("div",{className:"bh-empty",children:[r.jsx("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"})}),r.jsx("div",{children:o("bh.empty")})]}),c.length>0&&r.jsxs("table",{className:"bh-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:o("bh.col.ctime")}),r.jsx("th",{children:o("bh.col.age")}),r.jsx("th",{children:o("bh.col.storage")}),r.jsx("th",{children:o("bh.col.node")}),r.jsx("th",{className:"num",children:o("bh.col.size")}),r.jsx("th",{children:o("bh.col.flags")}),r.jsx("th",{children:o("bh.col.notes")})]})}),r.jsx("tbody",{children:c.map(y=>{var f,m;return r.jsxs("tr",{children:[r.jsx("td",{children:bp(y.ctime)}),r.jsx("td",{children:r.jsx("span",{className:`bh-age bh-age-${wp(y.ctime)}`,children:yp(y.ctime,i)})}),r.jsx("td",{children:y.storage||"—"}),r.jsx("td",{children:y.node||"—"}),r.jsx("td",{className:"num",children:vp(y.size)}),r.jsxs("td",{children:[y.protected&&r.jsx("span",{className:"bh-flag protected",children:o("bh.protected")}),((f=y.verification)==null?void 0:f.state)==="ok"&&r.jsx("span",{className:"bh-flag verified",children:o("bh.verified")}),((m=y.verification)==null?void 0:m.state)==="failed"&&r.jsx("span",{className:"bh-flag failed",children:o("bh.verify_failed")})]}),r.jsx("td",{className:"bh-notes",title:y.notes,children:y.notes||""})]},y.volid)})})]})]}),r.jsx("style",{children:`
...
Allocated: ${Pe(g)}`}),u&&r.jsx("rect",{width:d.width,height:d.height,fill:"none",stroke:S(),strokeWidth:3,rx:4,ry:4,className:"glow-pulse",style:{filter:"blur(4px)",opacity:x?1:.6}}),u&&d.width>30&&d.height>25&&r.jsx("rect",{width:d.width,height:d.height,fill:"none",stroke:w(),strokeWidth:1,strokeDasharray:"8 4",rx:4,ry:4,className:"data-stream",style:{opacity:.5}}),r.jsx("rect",{className:"main-cell",width:d.width,height:d.height,fill:j(),stroke:w(),strokeWidth:x?2:1,rx:4,ry:4,style:{filter:x?`drop-shadow(0 0 12px ${S()}) drop-shadow(0 0 4px ${w()})`:`drop-shadow(0 0 3px ${S()})`,transition:"all 0.2s ease"}}),u&&d.width>20&&d.height>15&&r.jsx("line",{x1:2,y1:2,x2:Math.min(d.width*.4,30),y2:2,stroke:w(),strokeWidth:1,opacity:.6}),u&&d.width>50&&d.height>40&&r.jsxs(r.Fragment,{children:[r.jsx("path",{d:`M ${d.width-8} ${d.height-2} L ${d.width-2} ${d.height-2} L ${d.width-2} ${d.height-8}`,fill:"none",stroke:w(),strokeWidth:1,opacity:.4,className:"circuit-line"}),r.jsx("circle",{cx:d.width-5,cy:d.height-5,r:2,fill:w(),opacity:.8,className:"energy-dot"})]}),u&&r.jsx("rect",{x:0,y:0,width:d.width,height:d.height,fill:"url(#scanlinePattern)",opacity:.15,rx:4,ry:4,style:{pointerEvents:"none"}}),v&&!k&&r.jsx("text",{x:d.width/2,y:d.height/2,textAnchor:"middle",dominantBaseline:"middle",fill:z(),fontSize:Math.min(10,Math.max(7,d.width/6)),fontFamily:"var(--font-mono)",fontWeight:600,style:{textShadow:u?`0 0 6px ${S()}`:"none"},children:d.vm.name.slice(0,Math.max(1,Math.min(3,Math.floor(d.width/10))))}),k&&(()=>{const P=d.width,T=d.height,R=Math.min(16,Math.max(9,Math.min(P/8,T/5))),te=Math.min(12,Math.max(8,Math.min(P/10,T/7))),U=Math.min(10,Math.max(7,Math.min(P/12,T/8))),L=Math.floor((P-8)/(R*.6)),q=d.vm.name.length>L?d.vm.name.slice(0,Math.max(1,L-1))+"…":d.vm.name,I=R+(y?te+2:0)+(f?U+2:0),W=(T-I)/2+R/2;return r.jsxs(r.Fragment,{children:[r.jsx("text",{x:P/2,y:W,textAnchor:"middle",dominantBaseline:"middle",fill:z(),fontSize:R,fontFamily:"var(--font-mono)",fontWeight:600,style:{textShadow:u?`0 0 8px ${S()}`:"none",filter:u?`drop-shadow(0 0 2px ${S()})`:"none"},children:q}),y&&r.jsx("text",{x:P/2,y:W+R*.8+2,textAnchor:"middle",dominantBaseline:"middle",fill:u?"rgba(180, 200, 220, 0.8)":"rgba(100, 110, 130, 0.6)",fontSize:te,fontFamily:"var(--font-mono)",children:Pe(g)}),f&&r.jsxs("text",{x:P/2,y:W+R*.8+(y?te*.8+4:2),textAnchor:"middle",dominantBaseline:"middle",fill:z(),fontSize:U,fontFamily:"var(--font-mono)",fontWeight:700,style:{filter:u?`drop-shadow(0 0 3px ${S()})`:"none"},children:["#",d.vm.vmid]})]})})()]},`${d.vm.node}-${d.vm.vmid}`)})]})}function yy({vmDiskData:e,totals:t,storages:n}){const{t:a,language:s}=$e(),o=p.useRef(null),[i,c]=p.useState({width:0,height:0}),[l,d]=p.useState(!0),[h,g]=p.useState(null);p.useEffect(()=>{const x=()=>{if(o.current){const k=o.current.getBoundingClientRect();c({width:k.width,height:k.height})}};x();const v=new ResizeObserver(x);return o.current&&v.observe(o.current),()=>v.disconnect()},[]),p.useEffect(()=>{if(l&&e.length>0){const x=setTimeout(()=>{d(!1)},e.length*30+500);return()=>clearTimeout(x)}},[l,e.length]);const u=p.useMemo(()=>e.map(x=>{var v;return{vm:x,value:((v=x.disk)==null?void 0:v.total_bytes)||0}}).filter(x=>x.value>0),[e]);return r.jsxs("div",{className:"treemap-container",children:[r.jsxs("div",{className:"treemap-header",children:[r.jsx("h3",{className:"treemap-title font-display",children:"VM DISK ALLOCATION TREEMAP"}),r.jsxs("div",{className:"treemap-stats",children:[r.jsxs("span",{children:[e.length," VMs"]}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsxs("span",{children:["Total Allocated: ",Pe(e.reduce((x,v)=>{var k;return x+(((k=v.disk)==null?void 0:k.total_bytes)||0)},0))]})]})]}),r.jsx("div",{ref:o,className:"treemap-grid",onClick:()=>g(null),children:i.width>0&&i.height>0&&r.jsx(by,{data:u,width:i.width,height:i.height,isInitialLoad:l,onVMClick:(x,v)=>g({vm:x,position:v})})}),h&&r.jsx(vy,{vm:h.vm,position:h.position,onClose:()=>g(null)}),r.jsxs("div",{className:"treemap-legend",children:[r.jsxs("div",{className:"legend-item",children:[r.jsx("span",{className:"legend-color running"}),r.jsx("span",{children:a("vm.running")})]}),r.jsxs("div",{className:"legend-item",children:[r.jsx("span",{className:"legend-color stopped"}),r.jsx("span",{children:a("vm.stopped")})]}),r.jsx("div",{className:"legend-note",children:s==="zh-TW"?"方塊大小 = 磁碟配置容量":"Block size = Disk allocation"})]})]})}function wy({storage:e,position:t,sourcePos:n,onClose:a,onManage:s}){const{t:o}=$e();if(!e||!t)return null;const i=e.totalBytes>0?e.usedBytes/e.totalBytes*100:0,c=n||{x:t.x-20,y:t.y+50},l={x:t.x,y:t.y+50};return r.jsxs(r.Fragment,{children:[r.jsxs("svg",{className:"tooltip-connector",style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:999},children:[r.jsx("defs",{children:r.jsxs("linearGradient",{id:"lineGradient",x1:"0%",y1:"0%",x2:"100%",y2:"0%",children:[r.jsx("stop",{offset:"0%",stopColor:"rgba(80, 140, 180, 0)",stopOpacity:"0"}),r.jsx("stop",{offset:"30%",stopColor:"rgba(80, 160, 200, 0.6)",stopOpacity:"1"}),r.jsx("stop",{offset:"100%",stopColor:"rgba(80, 160, 200, 0.6)",stopOpacity:"1"})]})}),r.jsx("line",{x1:c.x,y1:c.y,x2:l.x,y2:l.y,stroke:"url(#lineGradient)",strokeWidth:"1",className:"connector-line"}),r.jsx("circle",{cx:l.x,cy:l.y,r:"3",fill:"rgba(80, 180, 200, 0.7)",className:"connector-dot"})]}),r.jsxs("div",{className:"storage-tooltip",style:{left:t.x,top:t.y},children:[r.jsx("div",{className:"tooltip-grid"}),r.jsx("div",{className:"tooltip-scan-line"}),r.jsx("div",{className:"tooltip-corner tl"}),r.jsx("div",{className:"tooltip-corner tr"}),r.jsx("div",{className:"tooltip-corner bl"}),r.jsx("div",{className:"tooltip-corner br"}),r.jsxs("div",{className:"tooltip-header",children:[r.jsx("span",{className:"tooltip-name",children:e.name}),r.jsx("button",{className:"tooltip-close",onClick:a,children:"×"})]}),r.jsx("div",{className:"tooltip-type-row",children:r.jsx("span",{className:`tooltip-badge ${e.isShared?"shared":"local"}`,children:e.isShared?o("storage.filter_shared"):o("storage.filter_local")})}),r.jsxs("div",{className:"tooltip-content",children:[r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("table.type"),":"]}),r.jsx("span",{children:e.type.toUpperCase()})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("storage.content"),":"]}),r.jsx("div",{className:"tooltip-labels",children:e.content.map((d,h)=>r.jsx("span",{className:"tooltip-label",children:d},h))})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.used"),":"]}),r.jsx("span",{children:Pe(e.usedBytes)})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.total"),":"]}),r.jsx("span",{children:Pe(e.totalBytes)})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.usage"),":"]}),r.jsx("span",{className:`text-${Se(i)}`,children:lt(i,1)})]}),e.isShared&&e.connectedNodes.length>0&&r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("cluster.nodes"),":"]}),r.jsx("div",{className:"tooltip-labels",children:e.connectedNodes.map((d,h)=>r.jsx("span",{className:"tooltip-label node",children:d},h))})]})]}),s&&r.jsx("div",{className:"tooltip-actions",children:r.jsxs("button",{className:"tooltip-action-btn",onClick:d=>{d.stopPropagation(),s(e)},children:[r.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M3 12h18M3 18h12"})}),r.jsx("span",{children:o("storage.manage")})]})})]})]})}function ky({cluster:e,clusters:t}){const{t:n,language:a}=$e(),[s,o]=p.useState(()=>{if(typeof window>"u")return"tanks";const L=window.location.pathname.split("/").filter(Boolean)[1];return L==="treemap"||L==="tanks"?L:"tanks"});p.useEffect(()=>{if(typeof window>"u")return;const L=window.location.pathname.split("/").filter(Boolean);if(L[0]!=="storage"||L.length>=4)return;const q=`/storage/${s}`;window.location.pathname!==q&&window.history.replaceState(null,"",q)},[s]),p.useEffect(()=>{const L=()=>{const q=window.location.pathname.split("/").filter(Boolean);if(q[0]!=="storage"||q.length>=4)return;const I=q[1];(I==="tanks"||I==="treemap")&&o(I)};return window.addEventListener("popstate",L),()=>window.removeEventListener("popstate",L)},[]);const[i,c]=p.useState("all"),[l,d]=p.useState(""),[h,g]=p.useState(null),[u,x]=p.useState(null),[v,k]=p.useState(null),[y,f]=p.useState(null),[m,b]=p.useState(null),j=p.useCallback(L=>{let q=(e==null?void 0:e.id)||"",I="";if(L.isShared)I=L.connectedNodes[0]||"";else{const V=L.nodeInstances.find(Q=>Q.active)||L.nodeInstances[0];I=(V==null?void 0:V.node)||""}if(!q&&t){for(const[V,Q]of Object.entries(t))if(Q.nodes&&Q.nodes[I]){q=V;break}}if(!q||!I)return;const W=`/storage/${encodeURIComponent(q)}/${encodeURIComponent(I)}/${encodeURIComponent(L.name)}`;window.history.pushState(null,"",W),window.dispatchEvent(new PopStateEvent("popstate")),x(null),k(null),f(null),b(null)},[e,t]),w=p.useCallback((L,q)=>{L.preventDefault(),L.stopPropagation();const I=Math.min(L.clientX,window.innerWidth-180),W=Math.min(L.clientY,window.innerHeight-80);b({x:I,y:W,storage:q})},[]),S=!e&&t&&Object.keys(t).length>0,z=p.useMemo(()=>{const L=[],q=(I,W)=>{Object.values(I.vms).forEach(V=>{var Q;(Q=V.disk)!=null&&Q.total_bytes&&V.disk.total_bytes>0&&!V.template&&L.push({...V,clusterName:W})})};return S?Object.entries(t).forEach(([I,W])=>{q(W,W.name||I)}):e&&q(e,e.name||""),L.sort((I,W)=>{var V,Q;return(((V=W.disk)==null?void 0:V.total_bytes)||0)-(((Q=I.disk)==null?void 0:Q.total_bytes)||0)})},[e,t,S]),{sharedStorages:M,localStoragesByNode:D,allNodes:P,totals:T,warnings:R}=p.useMemo(()=>{const L=new Map;let q=0,I=0,W=0;const V=new Set,Q=G=>{Object.values(G.storages).forEach(de=>{V.add(de.node);const me=de.storage;L.has(me)||L.set(me,{name:de.storage,type:de.type,content:de.content,allowedNodes:de.allowed_nodes||[],nodes:[]}),L.get(me).nodes.push({node:de.node,totalBytes:de.disk.total_bytes,usedBytes:de.disk.used_bytes,active:de.enabled!==!1})})};S?Object.values(t).forEach(G=>Q(G)):e&&Q(e);const K=[],C={};V.forEach(G=>{C[G]=[]}),L.forEach(G=>{const de=xy.includes(G.type),me=G.nodes[0].totalBytes,Z=G.nodes.length>1&&me>0&&G.nodes.every(se=>Math.abs(se.totalBytes-me)/me<.01);if(de||Z){const se=G.nodes[0],O=G.allowedNodes.length>0?G.allowedNodes:G.nodes.map(_=>_.node);K.push({name:G.name,type:G.type,content:G.content,isShared:!0,totalBytes:se.totalBytes,usedBytes:se.usedBytes,connectedNodes:O,nodeInstances:G.nodes})}else G.nodes.forEach(se=>{C[se.node]||(C[se.node]=[]),C[se.node].push({name:G.name,type:G.type,content:G.content,isShared:!1,totalBytes:se.totalBytes,usedBytes:se.usedBytes,connectedNodes:[],nodeInstances:[se]})})});const Ne=G=>{if(i==="local"&&G.isShared||i==="shared"&&!G.isShared)return!1;if(l){const de=l.toLowerCase();if(!G.name.toLowerCase().includes(de)&&!G.type.toLowerCase().includes(de))return!1}return!0},_e=K.filter(Ne).sort((G,de)=>G.name.localeCompare(de.name)),Ke={};return Object.entries(C).forEach(([G,de])=>{const me=de.filter(Ne).sort((Z,se)=>Z.name.localeCompare(se.name));me.length>0&&(Ke[G]=me)}),_e.forEach(G=>{(G.totalBytes>0?G.usedBytes/G.totalBytes*100:0)>=85&&W++,q+=G.usedBytes,I+=G.totalBytes}),Object.values(Ke).flat().forEach(G=>{(G.totalBytes>0?G.usedBytes/G.totalBytes*100:0)>=85&&W++,q+=G.usedBytes,I+=G.totalBytes}),{sharedStorages:_e,localStoragesByNode:Ke,allNodes:Array.from(V).sort(),totals:{totalUsed:q,totalCapacity:I},warnings:W}},[e,t,S,i,l]),te=(L,q)=>{if(u&&u.name===L.name&&u.isShared===L.isShared){x(null),k(null),f(null);return}const I=q.getBoundingClientRect(),W=240,V=200,Q=I.top+I.height/2;let K=I.right+30,C=!1;K+W>window.innerWidth&&(K=I.left-W-30,C=!0);let Ne=I.top;Ne+V>window.innerHeight&&(Ne=window.innerHeight-V-10),Ne<10&&(Ne=10),x(L),k({x:K,y:Ne}),f({x:C?I.left:I.right,y:Q})};if(!e&&!S)return r.jsx("div",{className:"storage-vault empty",children:r.jsxs("div",{className:"empty-message",children:[r.jsx("span",{className:"loading-spinner"}),r.jsx("span",{children:n("cluster.select")})]})});const U=T.totalCapacity>0?T.totalUsed/T.totalCapacity*100:0;return r.jsxs("div",{className:"storage-vault",children:[r.jsx("div",{className:"grid-floor"}),r.jsxs("div",{className:"vault-header",children:[r.jsxs("div",{className:"header-title-section",children:[r.jsxs("h1",{className:"vault-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"5",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5"}),r.jsx("path",{d:"M4 12c0 1.66 3.58 3 8 3s8-1.34 8-3"}),r.jsx("ellipse",{cx:"12",cy:"19",rx:"3",ry:"1",fill:"currentColor",opacity:"0.3"})]}),n("storage.title")]}),r.jsxs("div",{className:"vault-stats",children:[r.jsx("span",{className:"stat-item",children:n("storage.count",{n:M.length+Object.values(D).flat().length})}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsx("span",{className:"stat-item",children:n("storage.shared_count",{n:M.length})}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsx("span",{className:"stat-item",children:n("storage.local_count",{n:Object.values(D).flat().length})}),R>0&&r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"stat-divider",children:"|"}),r.jsxs("span",{className:"stat-warning",children:["⚠️ ",R," ",n("settings.warning")]})]})]})]}),r.jsxs("div",{className:"header-controls",children:[r.jsxs("div",{className:"search-box",children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"11",cy:"11",r:"8"}),r.jsx("path",{d:"M21 21l-4.35-4.35"})]}),r.jsx("input",{type:"text",placeholder:n("storage.search"),value:l,onChange:L=>d(L.target.value)})]}),r.jsxs("div",{className:"filter-tabs",children:[r.jsx("button",{className:`filter-tab ${i==="all"?"active":""}`,onClick:()=>c("all"),children:n("storage.filter_all")}),r.jsx("button",{className:`filter-tab ${i==="shared"?"active":""}`,onClick:()=>c("shared"),children:n("storage.filter_shared")}),r.jsx("button",{className:`filter-tab ${i==="local"?"active":""}`,onClick:()=>c("local"),children:n("storage.filter_local")})]}),r.jsxs("div",{className:"view-toggle",children:[r.jsx("button",{className:`view-btn ${s==="tanks"?"active":""}`,onClick:()=>o("tanks"),title:a==="zh-TW"?"能量槽檢視":"Tank view",children:r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"7",height:"18",rx:"2"}),r.jsx("rect",{x:"14",y:"8",width:"7",height:"13",rx:"2"})]})}),r.jsx("button",{className:`view-btn ${s==="treemap"?"active":""}`,onClick:()=>o("treemap"),title:a==="zh-TW"?"VM 矩陣檢視":"VM Treemap",children:r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"10",height:"8"}),r.jsx("rect",{x:"15",y:"3",width:"6",height:"5"}),r.jsx("rect",{x:"15",y:"10",width:"6",height:"6"}),r.jsx("rect",{x:"3",y:"13",width:"10",height:"8"})]})})]})]})]}),r.jsxs("div",{className:"summary-indicator-container",children:[r.jsx("div",{className:"indicator-title",children:n("storage.total_capacity")}),r.jsx(gy,{percent:U,usedBytes:T.totalUsed,totalBytes:T.totalCapacity,duration:1500})]}),r.jsx("div",{className:"vault-content",children:s==="treemap"?r.jsx(yy,{vmDiskData:z,totals:T,storages:[...M.map(L=>L.name),...Object.values(D).flat().map(L=>L.name)]}):r.jsxs("div",{className:"tanks-layout",children:[(i==="all"||i==="shared")&&M.length>0&&r.jsxs("div",{className:"storage-section shared-section",children:[r.jsxs("div",{className:"section-header",children:[r.jsxs("div",{className:"section-title shared",children:[r.jsxs("svg",{className:"section-icon",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"})]}),r.jsx("span",{children:n("storage.section_shared")})]}),r.jsx("span",{className:"section-count shared",children:n(M.length>1?"storage.storages_plural":"storage.storages_count",{n:M.length})})]}),r.jsx("div",{className:"tanks-grid shared-grid",children:M.map((L,q)=>r.jsx("div",{onClick:I=>te(L,I.currentTarget),onContextMenu:I=>w(I,L),style:{cursor:"pointer"},children:r.jsx(Wp,{name:L.name,usedBytes:L.usedBytes,totalBytes:L.totalBytes,type:L.type,isShared:!0,connectedNodes:L.connectedNodes,width:140,height:220,animationDelay:q*80})},L.name))})]}),(i==="all"||i==="local")&&Object.keys(D).length>0&&r.jsxs("div",{className:"storage-section local-section",children:[r.jsxs("div",{className:"section-header",children:[r.jsxs("div",{className:"section-title local",children:[r.jsxs("svg",{className:"section-icon",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"4",width:"20",height:"16",rx:"2"}),r.jsx("path",{d:"M6 8h.01M6 12h.01M6 16h.01M10 8h8M10 12h8M10 16h8"})]}),r.jsx("span",{children:n("storage.section_local")})]}),r.jsxs("span",{className:"section-count local",children:[n(Object.values(D).flat().length>1?"storage.storages_plural":"storage.storages_count",{n:Object.values(D).flat().length})," ",n(Object.keys(D).length>1?"storage.across_nodes_plural":"storage.across_nodes",{n:Object.keys(D).length})]})]}),r.jsx("div",{className:"tanks-grid local-grid",children:(()=>{let L=M.length;return Object.entries(D).sort(([q],[I])=>q.localeCompare(I)).flatMap(([q,I])=>I.map(W=>{const V=W.nodeInstances[0],Q=L++;return r.jsx("div",{onClick:K=>te(W,K.currentTarget),onContextMenu:K=>w(K,W),style:{cursor:"pointer"},children:r.jsx(Wp,{name:W.name,usedBytes:V.usedBytes,totalBytes:V.totalBytes,type:W.type,isShared:!1,nodeName:q,isOffline:!V.active,width:120,height:200,animationDelay:Q*80})},`${q}-${W.name}`)}))})()})]}),M.length===0&&Object.keys(D).length===0&&r.jsx("div",{className:"no-storage",children:l?r.jsxs("span",{children:[n("error.no_data"),': "',l,'"']}):r.jsx("span",{children:n("error.no_data")})})]})}),r.jsx(wy,{storage:u,position:v,sourcePos:y,onClose:()=>{x(null),k(null),f(null)},onManage:j}),m&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"storage-ctx-shield",onClick:()=>b(null),onContextMenu:L=>{L.preventDefault(),b(null)}}),r.jsx("div",{className:"storage-ctx-menu",style:{left:m.x,top:m.y},onClick:L=>L.stopPropagation(),children:r.jsxs("button",{className:"storage-ctx-item",onClick:()=>{j(m.storage),b(null)},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"})]}),r.jsx("span",{children:n("storage.content")})]})})]}),r.jsx("style",{children:`
      ...
      `})]})}const Py={0:"crit",1:"crit",2:"crit",3:"err",4:"warn",5:"notice",6:"info",7:"debug"},Ry=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`};function Iy({open:e,onClose:t,clusterId:n}){const{t:a}=$e(),[s,o]=p.useState([]),[i,c]=p.useState(!1),[l,d]=p.useState(null),[h,g]=p.useState(""),[u,x]=p.useState(!0),v=p.useRef(null),k=async()=>{if(n){c(!0),d(null);try{const m=await fetch(`/api/clusters/${encodeURIComponent(n)}/log?max=500`,{credentials:"same-origin"});if(!m.ok){const j=await m.json().catch(()=>({}));throw new Error(j.error||`HTTP ${m.status}`)}const b=await m.json();o(b.lines||[])}catch(m){d(m.message||String(m))}finally{c(!1)}}};p.useEffect(()=>{e&&k()},[e,n]),p.useEffect(()=>{if(!e||!u)return;const m=setInterval(k,5e3);return()=>clearInterval(m)},[e,u,n]);const y=h.trim().toLowerCase(),f=y?s.filter(m=>(m.msg||"").toLowerCase().includes(y)||(m.node||"").toLowerCase().includes(y)||(m.user||"").toLowerCase().includes(y)||(m.tag||"").toLowerCase().includes(y)):s;return e?r.jsx("div",{className:"cl-back",onClick:t,children:r.jsxs("div",{className:"cl-modal",onClick:m=>m.stopPropagation(),children:[r.jsxs("div",{className:"cl-head",children:[r.jsxs("div",{className:"cl-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"}),r.jsx("line",{x1:"9",y1:"13",x2:"15",y2:"13"}),r.jsx("line",{x1:"9",y1:"17",x2:"15",y2:"17"})]}),r.jsx("span",{children:a("clog.title")})]}),r.jsxs("div",{className:"cl-actions",children:[r.jsx("input",{className:"cl-filter",value:h,onChange:m=>g(m.target.value),placeholder:a("clog.filter_ph")}),r.jsxs("label",{className:"cl-auto",children:[r.jsx("input",{type:"checkbox",checked:u,onChange:m=>x(m.target.checked)}),a("tasks.auto_refresh")]}),r.jsxs("button",{className:"cl-btn",onClick:k,disabled:i,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:a("tasks.refresh")})]}),r.jsx("button",{className:"cl-close",onClick:t,children:"×"})]})]}),r.jsx("div",{className:"cl-meta",children:r.jsxs("span",{children:[f.length,h&&` / ${s.length}`]})}),r.jsxs("div",{className:"cl-body",ref:v,children:[l&&r.jsx("div",{className:"cl-error",children:l}),f.length===0&&!i&&r.jsx("div",{className:"cl-empty",children:a(h?"clog.no_match":"clog.empty")}),f.map((m,b)=>r.jsxs("div",{className:`cl-row cl-pri-${Py[m.pri??6]||"info"}`,children:[r.jsx("span",{className:"cl-time",children:Ry(m.time)}),r.jsx("span",{className:"cl-node",children:m.node||"—"}),r.jsx("span",{className:"cl-user",children:m.user||""}),r.jsx("span",{className:"cl-tag",children:m.tag||""}),r.jsx("span",{className:"cl-msg",children:m.msg||""})]},m.n??b))]}),r.jsx("style",{children:`
        ...
        `})]})}):null}const Ly={running:"tasks.filter.running",ok:"tasks.filter.ok",error:"tasks.filter.error"},Gf=(e,t)=>{if(!e)return"—";const a=(t??Math.floor(Date.now()/1e3))-e;if(a<0)return"—";if(a<60)return`${a}s`;if(a<3600)return`${Math.floor(a/60)}m ${a%60}s`;const s=Math.floor(a/3600),o=Math.floor(a%3600/60);return`${s}h ${o}m`},Kf=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`},Ay=()=>{if(typeof window>"u")return{vmid:"",cluster:null};const e=new URLSearchParams(window.location.search);return{vmid:e.get("vmid")||"",cluster:e.get("cluster")}};function Oy({clusters:e,selectedCluster:t}){const{t:n,language:a}=$e(),s=Kr(),o=p.useRef(Ay()),i=p.useMemo(()=>Object.keys(e),[e]),[c,l]=p.useState(()=>o.current.cluster&&e[o.current.cluster]?o.current.cluster:t&&t!=="__all__"&&e[t]?t:i[0]||"");p.useEffect(()=>{!t||t==="__all__"||e[t]&&t!==c&&l(t)},[t]);const[d,h]=p.useState(""),[g,u]=p.useState("all"),[x,v]=p.useState(o.current.vmid),[k,y]=p.useState(""),[f,m]=p.useState([]),[b,j]=p.useState([]),[w,S]=p.useState([]),[z,M]=p.useState(!1),[D,P]=p.useState(null),[T,R]=p.useState(!0),[te,U]=p.useState(null),[L,q]=p.useState(!1),I=p.useRef(new Set),W=p.useRef(new Map),V=p.useRef(!0),[Q,K]=p.useState(new Set),[C,Ne]=p.useState(new Set),_e=p.useCallback(async(G=!1)=>{if(!c)return;M(!0),P(null);const de=new URLSearchParams;d&&de.set("type",d),g!=="all"&&de.set("status",g),x&&de.set("vmid",x),k&&de.set("user",k),de.set("limit","300"),G&&de.set("force","1");try{const me=await fetch(`/api/clusters/${encodeURIComponent(c)}/tasks?`+de.toString(),{credentials:"same-origin"});if(!me.ok){const H=await me.json().catch(()=>({}));throw new Error(H.error||`HTTP ${me.status}`)}const Z=await me.json(),se=Z.tasks||[],O=new Set,_=new Set;if(!V.current)for(const H of se)if(!I.current.has(H.upid))O.add(H.upid);else{const oe=W.current.get(H.upid);oe&&oe!==H._status&&_.add(H.upid)}for(const H of se)I.current.add(H.upid),W.current.set(H.upid,H._status);I.current.size>5e3&&(I.current=new Set(se.map(H=>H.upid)),W.current=new Map(se.map(H=>[H.upid,H._status]))),V.current=!1,m(se),j(Z.types||[]),S(Z.users||[]),O.size>0&&(K(O),setTimeout(()=>K(new Set),900)),_.size>0&&(Ne(_),setTimeout(()=>Ne(new Set),900))}catch(me){P(me.message||String(me))}finally{M(!1)}},[c,d,g,x,k]);p.useEffect(()=>{_e(!1)},[_e]),p.useEffect(()=>{if(!T)return;const G=setInterval(()=>_e(!0),5e3);return()=>clearInterval(G)},[T,_e]);const Ke=p.useMemo(()=>f.filter(G=>G._status==="running").length,[f]);return r.jsxs("div",{className:"pt-page",children:[r.jsxs("div",{className:"pt-header",children:[r.jsxs("div",{className:"pt-title-section",children:[r.jsxs("h1",{className:"pt-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M9 7h8M9 12h8M9 17h5"}),r.jsx("circle",{cx:"6",cy:"7",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"12",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"17",r:"1",fill:"currentColor"})]}),n("tasks.title")]}),r.jsx("div",{className:"pt-sub",children:n("tasks.subtitle")})]}),r.jsxs("div",{className:"pt-actions",children:[r.jsxs("label",{className:"pt-auto",children:[r.jsx("input",{type:"checkbox",checked:T,onChange:G=>R(G.target.checked)}),n("tasks.auto_refresh")]}),r.jsxs("button",{className:"pt-btn",onClick:()=>{const G=["starttime","endtime","duration_s","type","id","node","user","status","upid"],de=f.map(H=>[H.starttime?new Date(H.starttime*1e3).toISOString():"",H.endtime?new Date(H.endtime*1e3).toISOString():"",H.starttime&&H.endtime?String(H.endtime-H.starttime):"",H.type||"",H.id||"",H.node||"",H.user||"",H._status,H.upid]),me=H=>/[",\n]/.test(H)?'"'+H.replace(/"/g,'""')+'"':H,Z=[G.join(","),...de.map(H=>H.map(me).join(","))].join(`
`),se=new Blob([Z],{type:"text/csv;charset=utf-8"}),O=document.createElement("a");O.href=URL.createObjectURL(se);const _=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);O.download=`pve-tasks-${c}-${_}.csv`,document.body.appendChild(O),O.click(),O.remove(),setTimeout(()=>URL.revokeObjectURL(O.href),1e3)},disabled:f.length===0,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),r.jsx("polyline",{points:"7 10 12 15 17 10"}),r.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),r.jsx("span",{children:"CSV"})]}),r.jsxs("button",{className:"pt-btn",onClick:()=>q(!0),children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"}),r.jsx("line",{x1:"9",y1:"13",x2:"15",y2:"13"}),r.jsx("line",{x1:"9",y1:"17",x2:"15",y2:"17"})]}),r.jsx("span",{children:n("clog.button")})]}),r.jsxs("button",{className:"pt-btn",onClick:()=>_e(!0),disabled:z,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:n("tasks.refresh")})]})]})]}),r.jsx(Iy,{open:L,clusterId:c,onClose:()=>q(!1)}),r.jsxs("div",{className:"pt-filters",children:[r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.cluster")}),r.jsx("select",{value:c,onChange:G=>l(G.target.value),children:i.map(G=>{var de;return r.jsx("option",{value:G,children:((de=e[G])==null?void 0:de.name)||G},G)})})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.type")}),r.jsxs("select",{value:d,onChange:G=>h(G.target.value),children:[r.jsx("option",{value:"",children:n("tasks.filter.all")}),b.map(G=>r.jsx("option",{value:G,children:G},G))]})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.status")}),r.jsxs("select",{value:g,onChange:G=>u(G.target.value),children:[r.jsx("option",{value:"all",children:n("tasks.filter.all")}),r.jsx("option",{value:"running",children:n("tasks.filter.running")}),r.jsx("option",{value:"ok",children:n("tasks.filter.ok")}),r.jsx("option",{value:"error",children:n("tasks.filter.error")})]})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.vmid")}),r.jsx("input",{type:"text",inputMode:"numeric",value:x,onChange:G=>v(G.target.value.replace(/[^\d]/g,"")),placeholder:"e.g. 102"})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.user")}),r.jsxs("select",{value:k,onChange:G=>y(G.target.value),children:[r.jsx("option",{value:"",children:n("tasks.filter.all")}),w.map(G=>r.jsx("option",{value:G,children:G},G))]})]}),r.jsxs("span",{className:"pt-count",children:[f.length," / ",Ke?`${Ke} ${n("tasks.filter.running").toLowerCase()}`:""]})]}),D&&r.jsx("div",{className:"pt-error",children:D}),r.jsx("div",{className:"pt-tablewrap",children:r.jsxs("table",{className:"vm-table pt-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:n("tasks.col.starttime")}),r.jsx("th",{children:n("tasks.col.duration")}),r.jsx("th",{children:n("tasks.col.type")}),r.jsx("th",{children:n("tasks.col.target")}),r.jsx("th",{children:n("tasks.col.node")}),r.jsx("th",{children:n("tasks.col.user")}),r.jsx("th",{children:n("tasks.col.status")})]})}),r.jsxs("tbody",{children:[f.length===0&&!z&&r.jsx("tr",{children:r.jsx("td",{colSpan:7,className:"pt-empty",children:n("tasks.empty")})}),f.map(G=>{const de=[G===te?"pt-active":"",Q.has(G.upid)?"pt-new":""].filter(Boolean).join(" "),me=["pt-st",`pt-st-${G._status}`,C.has(G.upid)?"pt-st-pulse":""].join(" ");return r.jsxs("tr",{className:de,onClick:()=>U(G),children:[r.jsx("td",{className:"pt-mono",children:Kf(G.starttime)}),r.jsx("td",{className:"pt-mono",children:Gf(G.starttime,G.endtime)}),r.jsx("td",{children:r.jsx("span",{className:`pt-type pt-type-${G.type}`,children:G.type})}),r.jsx("td",{className:"pt-mono",children:G.id||"—"}),r.jsx("td",{className:"pt-mono",children:G.node}),r.jsx("td",{className:"pt-mono",children:G.user||"—"}),r.jsx("td",{children:r.jsx("span",{className:me,children:n(Ly[G._status]||"tasks.filter.all")})})]},G.upid)})]})]})}),te&&r.jsx(Fy,{clusterId:c,task:te,onClose:()=>U(null),onCopyUpid:async()=>{try{await navigator.clipboard.writeText(te.upid),s.alert(a==="zh-TW"?"UPID 已複製":"UPID copied")}catch{}}}),r.jsx("style",{children:`
        .pt-page {
          padding: 24px 32px;
          height: 100%;
          display: flex; flex-direction: column;
...
`)})]})]}),r.jsx("style",{children:`
      ...
      `})]})}const Vp={critical:0,warning:1,info:2,ok:3};function Dy({clusters:e,onNavigate:t}){const{t:n,language:a}=$e(),[s,o]=p.useState({}),[i,c]=p.useState([]),[l,d]=p.useState([]),[h,g]=p.useState(0),u=p.useCallback(async()=>{const y={},f=[],m=[],b=[];for(const[j,w]of Object.entries(e)){const S=w.name||j;b.push((async()=>{try{const z=await fetch(`/api/clusters/${encodeURIComponent(j)}/tasks?status=error&limit=200`,{credentials:"same-origin"});if(z.ok){const M=await z.json(),D=Math.floor(Date.now()/1e3)-86400;y[j]=(M.tasks||[]).filter(P=>(P.starttime||0)>D).length}}catch{}})());for(const z of Object.keys(w.nodes||{}))b.push((async()=>{try{const M=await fetch(`/api/clusters/${encodeURIComponent(j)}/nodes/${encodeURIComponent(z)}/certificates`,{credentials:"same-origin"});if(M.ok){const P=(await M.json()).certificates||[];let T=null;for(const R of P){const te=R.notafter||R["notafter-formatted"];if(!te)continue;const U=typeof te=="number"?te:Date.parse(String(te))/1e3;!U||isNaN(U)||(!T||U<T.ts)&&(T={ts:U,subj:R.subject||R.filename||"cert"})}if(T){const R=Math.floor((T.ts-Date.now()/1e3)/86400);R<90&&f.push({cluster:S,clusterId:j,node:z,days:R,subject:T.subj})}}}catch{}})()),b.push((async()=>{try{const M=await fetch(`/api/clusters/${encodeURIComponent(j)}/nodes/${encodeURIComponent(z)}/updates`,{credentials:"same-origin"});if(M.ok){const D=await M.json();(D.count??0)>0&&m.push({cluster:S,clusterId:j,node:z,count:D.count})}}catch{}})())}await Promise.all(b),o(y),c(f),d(m),g(Date.now())},[e]);p.useEffect(()=>{u()},[u]),p.useEffect(()=>{const y=setInterval(u,6e4);return()=>clearInterval(y)},[u]);const x=p.useMemo(()=>{var f,m,b;const y=[];for(const[j,w]of Object.entries(e)){const S=w.name||j;for(const[D,P]of Object.entries(w.nodes||{})){const T=P;T.status&&T.status!=="online"&&y.push({sev:"critical",cluster:S,target:`node:${D}`,category:n("health.cat.node_down"),msg:a==="zh-TW"?`${D} 狀態 ${T.status}`:`${D} is ${T.status}`,navView:"cluster-core",navParams:{cluster:j}});const R=((f=T.cpu)==null?void 0:f.usage_percent)||0,te=((m=T.memory)==null?void 0:m.usage_percent)||0;R>92&&y.push({sev:"warning",cluster:S,target:`node:${D}`,category:n("health.cat.high_cpu"),msg:`${D} CPU ${R.toFixed(0)}%`,navView:"cluster-core",navParams:{cluster:j}}),te>92&&y.push({sev:"warning",cluster:S,target:`node:${D}`,category:n("health.cat.high_mem"),msg:`${D} ${a==="zh-TW"?"記憶體":"memory"} ${te.toFixed(0)}%`,navView:"cluster-core",navParams:{cluster:j}})}for(const[D,P]of Object.entries(w.storages||{})){const T=P,R=T.usage_percent??T.used_pct??0;R>=95?y.push({sev:"critical",cluster:S,target:`storage:${D}`,category:n("health.cat.storage_full"),msg:`${T.storage||D} ${R.toFixed(0)}% `+(a==="zh-TW"?"已用":"used"),navView:"storage",navParams:{cluster:j}}):R>=85&&y.push({sev:"warning",cluster:S,target:`storage:${D}`,category:n("health.cat.storage_high"),msg:`${T.storage||D} ${R.toFixed(0)}% `+(a==="zh-TW"?"已用":"used"),navView:"storage",navParams:{cluster:j}})}const z=w.ceph;if(z){const D=(z.status||((b=z.health)==null?void 0:b.status)||"").toUpperCase();D.includes("ERR")?y.push({sev:"critical",cluster:S,target:"ceph",category:n("health.cat.ceph_err"),msg:D,navView:"ceph-constellation",navParams:{cluster:j}}):D.includes("WARN")&&y.push({sev:"warning",cluster:S,target:"ceph",category:n("health.cat.ceph_warn"),msg:D,navView:"ceph-constellation",navParams:{cluster:j}})}const M=s[j]||0;M>0&&y.push({sev:M>=10?"warning":"info",cluster:S,target:"tasks",category:n("health.cat.task_failures"),msg:a==="zh-TW"?`過去 24h 共 ${M} 筆作業失敗`:`${M} task error(s) in the last 24h`,navView:"tasks",navParams:{cluster:j}})}for(const j of i){let w="info";if(j.days<0)w="critical";else if(j.days<14)w="critical";else if(j.days<30)w="warning";else if(j.days<60)w="info";else continue;y.push({sev:w,cluster:j.cluster,target:`cert:${j.node}`,category:j.days<0?n("health.cat.cert_expired"):n("health.cat.cert_expiring"),msg:a==="zh-TW"?`${j.node}: ${j.subject} (${j.days<0?`已過期 ${Math.abs(j.days)} 天`:`${j.days} 天`})`:`${j.node}: ${j.subject} (${j.days<0?`expired ${Math.abs(j.days)}d ago`:`${j.days}d`})`,navView:"cluster-core",navParams:{cluster:j.clusterId}})}for(const j of l)y.push({sev:j.count>=50?"warning":"info",cluster:j.cluster,target:`updates:${j.node}`,category:n("health.cat.updates"),msg:a==="zh-TW"?`${j.node}: ${j.count} 個套件待更新`:`${j.node}: ${j.count} package update(s) pending`,navView:"cluster-core",navParams:{cluster:j.clusterId}});return y.sort((j,w)=>Vp[j.sev]-Vp[w.sev]),y},[e,s,i,l,a,n]),v=p.useMemo(()=>{const y={critical:0,warning:0,info:0,ok:0};for(const f of x)y[f.sev]++;return y},[x]),k=p.useMemo(()=>{let y=0,f=0,m=0,b=0,j=0,w=0,S=0;for(const z of Object.values(e)){for(const M of Object.values(z.nodes||{}))y++,M.status==="online"&&f++;for(const M of Object.values(z.vms||{}))M.type==="lxc"?(j++,M.status==="running"&&w++):(m++,M.status==="running"&&b++);S+=Object.keys(z.storages||{}).length}return{nodes:y,online:f,vms:m,running:b,cts:j,ctsRunning:w,storages:S}},[e]);return r.jsxs("div",{className:"hm-page",children:[r.jsxs("div",{className:"hm-header",children:[r.jsxs("div",{className:"title-section",children:[r.jsxs("h1",{className:"hm-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),r.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),n("health.title")]}),r.jsxs("div",{className:"hm-sub",children:[n("health.subtitle"),h?` · ${n("health.updated")} ${new Date(h).toLocaleTimeString()}`:""]})]}),r.jsxs("div",{className:"hm-tally",children:[r.jsxs("span",{className:"hm-pill hm-pill-critical",children:[v.critical," ",n("health.sev.critical")]}),r.jsxs("span",{className:"hm-pill hm-pill-warning",children:[v.warning," ",n("health.sev.warning")]}),r.jsxs("span",{className:"hm-pill hm-pill-info",children:[v.info," ",n("health.sev.info")]})]})]}),r.jsxs("div",{className:"hm-stats",children:[r.jsxs("div",{className:"hm-stat",onClick:()=>t("cluster-core"),children:[r.jsxs("div",{className:"hm-stat-num",children:[k.online,r.jsxs("span",{className:"hm-stat-of",children:["/",k.nodes]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.nodes")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("holo-matrix"),children:[r.jsxs("div",{className:"hm-stat-num",children:[k.running,r.jsxs("span",{className:"hm-stat-of",children:["/",k.vms]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.vms")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("holo-matrix"),children:[r.jsxs("div",{className:"hm-stat-num",children:[k.ctsRunning,r.jsxs("span",{className:"hm-stat-of",children:["/",k.cts]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.cts")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("storage"),children:[r.jsx("div",{className:"hm-stat-num",children:k.storages}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.storages")})]})]}),x.length===0?r.jsxs("div",{className:"hm-empty",children:[r.jsxs("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),r.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),r.jsx("div",{className:"hm-empty-title",children:n("health.empty.title")}),r.jsx("div",{className:"hm-empty-sub",children:n("health.empty.sub")})]}):r.jsx("div",{className:"hm-grid",children:x.map((y,f)=>r.jsxs("div",{className:`hm-card hm-card-${y.sev}`,onClick:()=>{var m;return y.navView&&t(y.navView,{cluster:(m=y.navParams)==null?void 0:m.cluster})},children:[r.jsxs("div",{className:"hm-card-head",children:[r.jsx("span",{className:"hm-card-sev",children:y.sev.toUpperCase()}),r.jsx("span",{className:"hm-card-cluster",children:y.cluster})]}),r.jsx("div",{className:"hm-card-cat",children:y.category}),r.jsx("div",{className:"hm-card-msg",children:y.msg})]},f))}),r.jsx("style",{children:`
        .hm-page {
      ...
      `})]})}function Uy({open:e,cluster_id:t,kind:n,title:a,body:s,label:o,onClose:i,onSaved:c}){const{t:l}=$e(),[d,h]=p.useState(""),[g,u]=p.useState(!1),[x,v]=p.useState(""),k=p.useRef(null);if(p.useEffect(()=>{e&&(h(""),v(""),u(!1),setTimeout(()=>{var f;return(f=k.current)==null?void 0:f.focus()},50))},[e]),p.useEffect(()=>{if(!e)return;const f=m=>{m.key==="Escape"&&!g&&i()};return document.addEventListener("keydown",f),()=>document.removeEventListener("keydown",f)},[e,g,i]),!e)return null;const y=async()=>{if(d){u(!0),v("");try{await Be.setClusterSecret(t,n,d),c()}catch(f){v(f instanceof Error?f.message:String(f)),u(!1)}}};return r.jsxs("div",{onClick:()=>!g&&i(),style:Vy,children:[r.jsx("style",{children:Hy}),r.jsxs("div",{className:"ssm-modal",onClick:f=>f.stopPropagation(),children:[r.jsxs("div",{className:"ssm-eyebrow",children:["// secret · ",t]}),r.jsx("h3",{className:"ssm-title",children:a}),r.jsx("p",{className:"ssm-body",children:s}),r.jsx("label",{children:o}),r.jsx("input",{ref:k,type:"password",value:d,onChange:f=>h(f.target.value),onKeyDown:f=>{f.key==="Enter"&&y()},autoComplete:"new-password",spellCheck:!1}),x&&r.jsx("div",{className:"ssm-err",children:x}),r.jsxs("div",{className:"ssm-actions",children:[r.jsx("button",{className:"ghost",onClick:i,disabled:g,children:l("action.cancel")}),r.jsx("button",{className:"primary",onClick:y,disabled:g||!d,children:g?"…":l("action.save")})]})]})]})}const Vy={position:"fixed",inset:0,zIndex:400,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"ssmFade .18s ease"},Hy=`
