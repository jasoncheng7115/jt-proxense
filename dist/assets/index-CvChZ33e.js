 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(W,B){var q=W.length;W.push(B);e:for(;0<q;){var J=q-1>>>1,z=W[J];if(0<s(z,B))W[J]=B,W[q]=z,q=J;else break e}}function n(W){return W.length===0?null:W[0]}function a(W){if(W.length===0)return null;var B=W[0],q=W.pop();if(q!==B){W[0]=q;e:for(var J=0,z=W.length,ge=z>>>1;J<ge;){var je=2*(J+1)-1,Oe=W[je],X=je+1,ue=W[X];if(0>s(Oe,q))X<z&&0>s(ue,Oe)?(W[J]=ue,W[X]=q,J=X):(W[J]=Oe,W[je]=q,J=je);else if(X<z&&0>s(ue,q))W[J]=ue,W[X]=q,J=X;else break e}}return B}function s(W,B){var q=W.sortIndex-B.sortIndex;return q!==0?q:W.id-B.id}if(typeof performance=="object"&&typeof performance.now=="function"){var o=performance;e.unstable_now=function(){return o.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var c=[],d=[],h=1,g=null,u=3,x=!1,b=!1,k=!1,y=typeof setTimeout=="function"?setTimeout:null,m=typeof clearTimeout=="function"?clearTimeout:null,f=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function v(W){for(var B=n(d);B!==null;){if(B.callback===null)a(d);else if(B.startTime<=W)a(d),B.sortIndex=B.expirationTime,t(c,B);else break;B=n(d)}}function j(W){if(k=!1,v(W),!b)if(n(c)!==null)b=!0,K(w);else{var B=n(d);B!==null&&O(j,B.startTime-W)}}function w(W,B){b=!1,k&&(k=!1,m(N),N=-1),x=!0;var q=u;try{for(v(B),g=n(c);g!==null&&(!(g.expirationTime>B)||W&&!P());){var J=g.callback;if(typeof J=="function"){g.callback=null,u=g.priorityLevel;var z=J(g.expirationTime<=B);B=e.unstable_now(),typeof z=="function"?g.callback=z:g===n(c)&&a(c),v(B)}else a(c);g=n(c)}if(g!==null)var ge=!0;else{var je=n(d);je!==null&&O(j,je.startTime-B),ge=!1}return ge}finally{g=null,u=q,x=!1}}var S=!1,C=null,N=-1,L=5,I=-1;function P(){return!(e.unstable_now()-I<L)}function E(){if(C!==null){var W=e.unstable_now();I=W;var B=!0;try{B=C(!0,W)}finally{B?G():(S=!1,C=null)}}else S=!1}var G;if(typeof f=="function")G=function(){f(E)};else if(typeof MessageChannel<"u"){var A=new MessageChannel,T=A.port2;A.port1.onmessage=E,G=function(){T.postMessage(null)}}else G=function(){y(E,0)};function K(W){C=W,S||(S=!0,G())}function O(W,B){N=y(function(){W(e.unstable_now())},B)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(W){W.callback=null},e.unstable_continueExecution=function(){b||x||(b=!0,K(w))},e.unstable_forceFrameRate=function(W){0>W||125<W?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):L=0<W?Math.floor(1e3/W):5},e.unstable_getCurrentPriorityLevel=function(){return u},e.unstable_getFirstCallbackNode=function(){return n(c)},e.unstable_next=function(W){switch(u){case 1:case 2:case 3:var B=3;break;default:B=u}var q=u;u=B;try{return W()}finally{u=q}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(W,B){switch(W){case 1:case 2:case 3:case 4:case 5:break;default:W=3}var q=u;u=W;try{return B()}finally{u=q}},e.unstable_scheduleCallback=function(W,B,q){var J=e.unstable_now();switch(typeof q=="object"&&q!==null?(q=q.delay,q=typeof q=="number"&&0<q?J+q:J):q=J,W){case 1:var z=-1;break;case 2:z=250;break;case 5:z=1073741823;break;case 4:z=1e4;break;default:z=5e3}return z=q+z,W={id:h++,callback:B,priorityLevel:W,startTime:q,expirationTime:z,sortIndex:-1},q>J?(W.sortIndex=q,t(d,W),n(c)===null&&W===n(d)&&(k?(m(N),N=-1):k=!0,O(j,q-J))):(W.sortIndex=z,t(c,W),b||x||(b=!0,K(w))),W},e.unstable_shouldYield=P,e.unstable_wrapCallback=function(W){var B=u;return function(){var q=u;u=B;try{return W.apply(this,arguments)}finally{u=q}}}})(hu);fu.exports=hu;var w0=fu.exports;/**
 * @license React
...
`;function zg(e={}){const{onMessage:t,onConnect:n,onDisconnect:a,onError:s,reconnectInterval:o=2e3,pingInterval:i=5e3}=e,l=p.useRef(null),c=p.useRef(null),d=p.useRef(null),h=p.useRef(t),[g,u]=p.useState({connected:!1,connecting:!1,lastMessageTime:0});h.current=t;const x=p.useCallback(()=>{const m=window.location.protocol==="https:"?"wss:":"ws:",f=window.location.host;return`${m}//${f}/ws`},[]),b=p.useCallback(()=>{var f;if(((f=l.current)==null?void 0:f.readyState)===WebSocket.OPEN)return;u(v=>({...v,connecting:!0}));const m=new WebSocket(x());l.current=m,m.onopen=()=>{u({connected:!0,connecting:!1,lastMessageTime:Date.now()}),n==null||n(),d.current&&clearInterval(d.current),d.current=window.setInterval(()=>{m.readyState===WebSocket.OPEN&&m.send(JSON.stringify({type:"ping"}))},i)},m.onmessage=v=>{var j;try{const w=JSON.parse(v.data);u(S=>({...S,lastMessageTime:Date.now()})),(w.type==="initial"||w.type==="update")&&(j=w.data)!=null&&j.clusters&&h.current&&h.current(w.data.clusters)}catch(w){console.error("[WS] Failed to parse message:",w)}},m.onerror=v=>{console.error("[WS] Error:",v),s==null||s(v)},m.onclose=()=>{u(v=>({...v,connected:!1,connecting:!1})),a==null||a(),d.current&&(clearInterval(d.current),d.current=null),c.current&&clearTimeout(c.current),c.current=window.setTimeout(()=>{b()},o)}},[x,n,a,s,o,i]),k=p.useCallback(()=>{c.current&&(clearTimeout(c.current),c.current=null),d.current&&(clearInterval(d.current),d.current=null),l.current&&(l.current.close(),l.current=null)},[]),y=p.useCallback(m=>{var f;((f=l.current)==null?void 0:f.readyState)===WebSocket.OPEN&&l.current.send(JSON.stringify(m))},[]);return p.useEffect(()=>(b(),()=>{k()}),[b,k]),p.useEffect(()=>{const m=setInterval(()=>{const v=Date.now()-g.lastMessageTime;g.connected&&v>15e3&&(k(),b())},5e3);return()=>clearInterval(m)},[g.connected,g.lastMessageTime,b,k]),{connected:g.connected,connecting:g.connecting,lastMessageTime:g.lastMessageTime,send:y,reconnect:b,disconnect:k}}const $g="/api";async function Ee(e,t){const n=await fetch(`${$g}${e}`,{credentials:"same-origin",headers:{"Content-Type":"application/json"},...t});if(n.status===401&&!e.startsWith("/auth/"))throw typeof window<"u"&&window.location.pathname!=="/login"&&window.location.replace("/login"),new Error("auth_required");if(!n.ok){const a=await n.text();throw new Error(a||`HTTP ${n.status}`)}return n.json()}const We={authMe:()=>Ee("/auth/me"),authLogin:(e,t)=>Ee("/auth/login",{method:"POST",body:JSON.stringify({username:e,password:t})}),authLogout:()=>Ee("/auth/logout",{method:"POST"}),totpEnrollInit:()=>Ee("/auth/totp/enroll-init",{method:"POST"}),totpEnrollVerify:e=>Ee("/auth/totp/enroll-verify",{method:"POST",body:JSON.stringify({code:e})}),totpDisable:e=>Ee("/auth/totp/disable",{method:"POST",body:JSON.stringify({code:e})}),getConfig:()=>Ee("/config"),updateConfig:e=>Ee("/config",{method:"POST",body:JSON.stringify(e)}),getClusters:()=>Ee("/clusters"),getCluster:e=>Ee(`/clusters/${e}`),getSummary:()=>Ee("/summary"),getNodes:e=>Ee(`/nodes${e?`?cluster=${e}`:""}`),getVMs:e=>Ee(`/vms${e?`?cluster=${e}`:""}`),getStorages:e=>Ee(`/storages${e?`?cluster=${e}`:""}`),getCeph:e=>Ee(`/ceph${e?`?cluster=${e}`:""}`),getHealth:()=>Ee("/health"),vmAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/${a}`,{method:"POST"}),ctAction:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/cts/${n}/${a}`,{method:"POST"}),guestAction:(e,t,n,a,s)=>a==="lxc"?We.ctAction(e,t,n,s):We.vmAction(e,t,n,s),vmMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),ctMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/cts/${t}/migrate`,{method:"POST",body:JSON.stringify(n)}),bulkAction:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/bulk`,{method:"POST",body:JSON.stringify(t)}),taskStatus:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/tasks/${encodeURIComponent(n)}`),listSnapshots:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`),createSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots`,{method:"POST",body:JSON.stringify(n)}),deleteSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}`,{method:"DELETE"}),rollbackSnapshot:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/snapshots/${encodeURIComponent(n)}/rollback`,{method:"POST"}),vmReset:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/vms/${n}/reset`,{method:"POST"}),cloneVm:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/clone`,{method:"POST",body:JSON.stringify(n)}),listRemoteEndpoints:e=>Ee(`/clusters/${encodeURIComponent(e)}/remote-endpoints`),fetchRemoteFingerprint:(e,t=8006)=>Ee(`/remote-fingerprint?host=${encodeURIComponent(e)}&port=${t}`),triggerBackup:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/backup`,{method:"POST",body:JSON.stringify(n)}),setClusterSecret:(e,t,n)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"POST",body:JSON.stringify({value:n})}),deleteClusterSecret:(e,t)=>Ee(`/secrets/cluster/${encodeURIComponent(e)}/${encodeURIComponent(t)}`,{method:"DELETE"}),consolePrepare:e=>Ee("/console/prepare",{method:"POST",body:JSON.stringify(e)}),migrationPrecheck:(e,t,n,a)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-precheck?target_cluster_id=${encodeURIComponent(n)}&target_node=${encodeURIComponent(a)}`),getMigrationSource:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/migration-source`),getMigrationTargets:(e,t)=>Ee(`/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/migration-targets`),remoteMigrate:(e,t,n)=>Ee(`/clusters/${encodeURIComponent(e)}/vms/${t}/remote-migrate`,{method:"POST",body:JSON.stringify(n)})};function Ie(e,t=1){if(e===0)return"0 B";const n=1024,a=["B","KB","MB","GB","TB","PB"],s=Math.floor(Math.log(e)/Math.log(n));return`${parseFloat((e/Math.pow(n,s)).toFixed(t))} ${a[s]}`}function ct(e,t=1){return`${e.toFixed(t)}%`}function ui(e){const t=Math.floor(e/86400),n=Math.floor(e%86400/3600),a=Math.floor(e%3600/60),s=[];return t>0&&s.push(`${t}d`),n>0&&s.push(`${n}h`),a>0&&s.push(`${a}m`),s.length>0?s.join(" "):"< 1m"}function _e(e,t=80,n=95){return e>=n?"danger":e>=t?"warning":"success"}function Gl(e){switch(e.toLowerCase()){case"running":case"online":case"healthy":case"health_ok":return"success";case"warning":case"health_warn":return"warning";case"stopped":case"offline":case"critical":case"health_err":return"danger";default:return"muted"}}function Eg({value:e,suffix:t="",className:n=""}){const a=x=>{if(typeof x=="number")return{left:x,isRatio:!1};const b=String(x).match(/^(\d+)\/(\d+)$/);if(b)return{left:parseInt(b[1]),right:parseInt(b[2]),isRatio:!0};const k=parseFloat(String(x));return isNaN(k)?{left:0,isRatio:!1}:{left:k,isRatio:!1}},s=a(e),[o,i]=p.useState(0),[l,c]=p.useState(s.right||0),d=p.useRef(null),h=p.useRef(0),g=p.useRef(!0);p.useEffect(()=>{const x=a(e);if(!g.current){i(x.left),x.right!==void 0&&c(x.right);return}const b=800,k=0,y=0;g.current=!1,d.current=null;const m=f=>{d.current||(d.current=f);const v=f-d.current,j=Math.min(v/b,1),w=1-Math.pow(1-j,3),S=k+(x.left-k)*w;if(i(Math.round(S)),x.isRatio&&x.right!==void 0){const C=y+(x.right-y)*w;c(Math.round(C))}j<1?h.current=requestAnimationFrame(m):(i(x.left),x.right!==void 0&&c(x.right))};return h.current=requestAnimationFrame(m),()=>{h.current&&cancelAnimationFrame(h.current)}},[e]);const u=s.isRatio?`${o}/${l}`:o;return r.jsxs("span",{className:`metric-value ${n}`,children:[u,t&&r.jsx("span",{style:{fontSize:"0.6em",opacity:.7},children:t})]})}function hp({value:e,decimals:t=0,className:n=""}){const[a,s]=p.useState(0),o=p.useRef(null),i=p.useRef(0),l=p.useRef(!0);return p.useEffect(()=>{if(!l.current){s(e);return}const c=800,d=0;l.current=!1,o.current=null;const h=g=>{o.current||(o.current=g);const u=g-o.current,x=Math.min(u/c,1),b=1-Math.pow(1-x,3),k=d+(e-d)*b;s(k),x<1?i.current=requestAnimationFrame(h):s(e)};return i.current=requestAnimationFrame(h),()=>{i.current&&cancelAnimationFrame(i.current)}},[e]),r.jsxs("span",{className:n,children:[a.toFixed(t),"%"]})}function Ui({left:e,right:t,className:n=""}){const[a,s]=p.useState(0),[o,i]=p.useState(0),l=p.useRef(null),c=p.useRef(0),d=p.useRef(!0);return p.useEffect(()=>{if(!d.current){s(e),i(t);return}const h=800,g=0,u=0;d.current=!1,l.current=null;const x=b=>{l.current||(l.current=b);const k=b-l.current,y=Math.min(k/h,1),m=1-Math.pow(1-y,3);s(Math.round(g+(e-g)*m)),i(Math.round(u+(t-u)*m)),y<1?c.current=requestAnimationFrame(x):(s(e),i(t))};return c.current=requestAnimationFrame(x),()=>{c.current&&cancelAnimationFrame(c.current)}},[e,t]),r.jsxs("span",{className:n,children:[a,"/",o]})}function Ks({label:e,value:t,suffix:n,subValue:a,color:s="primary",icon:o}){return r.jsxs("div",{className:`stat-card ${s!=="primary"?`stat-${s}`:""}`,children:[o&&r.jsx("div",{className:"stat-icon",children:o}),r.jsxs("div",{className:"stat-content",children:[r.jsx("div",{className:"stat-label",children:e}),r.jsx(Eg,{value:t,suffix:n,className:s!=="primary"?`text-${s}`:""}),a&&r.jsx("div",{className:"stat-sub",children:a})]})]})}function Vi({value:e,label:t,color:n,size:a=100}){const[s,o]=p.useState(0),i=p.useRef(null),l=p.useRef(0),c=p.useRef(!0);p.useEffect(()=>{if(!c.current){o(e);return}const y=1e3,m=0;c.current=!1,i.current=null;const f=v=>{i.current||(i.current=v);const j=v-i.current,w=Math.min(j/y,1),S=1-Math.pow(1-w,3),C=m+(e-m)*S;o(C),w<1?l.current=requestAnimationFrame(f):o(e)};return l.current=requestAnimationFrame(f),()=>{l.current&&cancelAnimationFrame(l.current)}},[e]);const d=5,h=(a-d*4)/2-8,g=(a-d)/2,u=h+(g-h)/2,x=2*Math.PI*u,b=x-s/100*x,k=Array.from({length:36},(y,m)=>{const f=(m*10-90)*(Math.PI/180),v=m%3===0,j=v?6:3,w=g-2,S=w-j;return{x1:a/2+Math.cos(f)*w,y1:a/2+Math.sin(f)*w,x2:a/2+Math.cos(f)*S,y2:a/2+Math.sin(f)*S,isMajor:v}});return r.jsxs("div",{className:"ring-gauge",children:[r.jsxs("svg",{viewBox:`0 0 ${a} ${a}`,className:"ring-svg",children:[r.jsx("circle",{className:"ring-outer-deco",cx:a/2,cy:a/2,r:g,strokeWidth:1}),k.map((y,m)=>r.jsx("line",{x1:y.x1,y1:y.y1,x2:y.x2,y2:y.y2,className:`ring-tick ${y.isMajor?"major":""}`},m)),r.jsx("circle",{className:"ring-bg",cx:a/2,cy:a/2,r:u,strokeWidth:d}),r.jsx("circle",{className:"ring-inner-deco",cx:a/2,cy:a/2,r:h,strokeWidth:1}),r.jsx("circle",{className:`ring-fill ${n}`,cx:a/2,cy:a/2,r:u,strokeWidth:d,strokeDasharray:x,strokeDashoffset:b,transform:`rotate(-90 ${a/2} ${a/2})`}),r.jsx("line",{className:"ring-sweep",x1:a/2,y1:a/2,x2:a/2,y2:a/2-u-4,transform:`rotate(${s/100*360-90} ${a/2} ${a/2})`})]}),r.jsxs("div",{className:"ring-content",children:[r.jsxs("span",{className:`ring-value text-${n}`,children:[s.toFixed(0),r.jsx("span",{className:"ring-percent",children:"%"})]}),r.jsx("span",{className:"ring-label",children:t})]})]})}function Tg({cluster:e,onClick:t}){var c,d;const{t:n}=Ce(),a=e.summary;if(!a)return null;const s=_e(a.total_cpu_usage),o=_e(a.total_memory_usage),i=a.alerts_warning>0,l=a.alerts_critical>0;return r.jsxs("div",{className:`cluster-hex-card ${l?"critical":i?"warning":""}`,onClick:t,children:[r.jsxs("div",{className:"cluster-hex-inner",children:[r.jsxs("div",{className:"cluster-hex-header",children:[r.jsxs("div",{className:"cluster-hex-title",children:[r.jsx("span",{className:"cluster-hex-name",children:e.name||e.id}),a.is_standalone&&r.jsx("span",{className:"standalone-badge",children:n("dashboard.standalone")})]}),r.jsx("span",{className:`cluster-hex-status ${a.status==="connected"?"online":"offline"}`})]}),r.jsxs("div",{className:"cluster-hex-metrics",children:[r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"CPU"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${s}`,style:{width:`${a.total_cpu_usage}%`}})}),r.jsx(hp,{value:a.total_cpu_usage,decimals:0,className:`metric-value small text-${s}`})]}),r.jsxs("div",{className:"cluster-hex-metric",children:[r.jsx("span",{className:"metric-label",children:"MEM"}),r.jsx("div",{className:"metric-bar",children:r.jsx("div",{className:`metric-bar-fill ${o}`,style:{width:`${a.total_memory_usage}%`}})}),r.jsx(hp,{value:a.total_memory_usage,decimals:0,className:`metric-value small text-${o}`})]})]}),r.jsxs("div",{className:"cluster-hex-stats",children:[r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.nodes_online,right:a.node_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.nodes")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.vms_running,right:a.vm_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.vms_short")})]}),r.jsxs("div",{className:"hex-stat",children:[r.jsx(Ui,{left:a.cts_running,right:a.ct_count,className:"hex-stat-value"}),r.jsx("span",{className:"hex-stat-label",children:n("cluster.cts_short")})]})]}),a.has_ceph&&r.jsx("div",{className:"cluster-hex-ceph",children:r.jsxs("span",{className:`ceph-badge ${((c=a.ceph_health)==null?void 0:c.toLowerCase().replace("health_",""))||"unknown"}`,children:["CEPH: ",((d=a.ceph_health)==null?void 0:d.replace("HEALTH_",""))||"N/A"]})})]}),r.jsx("div",{className:"corner-decoration top-left"}),r.jsx("div",{className:"corner-decoration top-right"}),r.jsx("div",{className:"corner-decoration bottom-left"}),r.jsx("div",{className:"corner-decoration bottom-right"})]})}function gp({clusters:e,globalSummary:t,onSelectCluster:n,isPaused:a=!1}){const{t:s}=Ce(),o=p.useMemo(()=>Object.entries(e),[e]),i=p.useMemo(()=>{let l=0,c=0,d=0,h=0;return Object.values(e).forEach(g=>{g.summary&&(l+=g.summary.total_cpu_usage||0,c+=g.summary.total_memory_usage||0,d+=g.summary.total_storage_usage||0,h++)}),{avgCpu:h>0?l/h:0,avgMem:h>0?c/h:0,avgStorage:h>0?d/h:0}},[e]);return r.jsxs("div",{className:"command-center",children:[r.jsx("div",{className:"grid-floor"}),r.jsxs("div",{className:"cc-header",children:[r.jsx("h1",{className:"cc-title font-display",children:r.jsx("span",{className:"glitch-text","data-text":s("dashboard.title"),children:s("dashboard.title")})}),r.jsx("div",{className:"cc-subtitle",children:s("dashboard.subtitle")})]}),r.jsxs("div",{className:"cc-content",children:[r.jsxs("div",{className:"cc-top-row",children:[r.jsxs("div",{className:"cc-gauges panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.resource_usage")})}),r.jsxs("div",{className:"gauges-container",children:[r.jsx(Vi,{value:i.avgCpu,label:s("metric.cpu"),color:_e(i.avgCpu),size:110}),r.jsx(Vi,{value:i.avgMem,label:s("metric.memory"),color:_e(i.avgMem),size:110}),r.jsx(Vi,{value:i.avgStorage,label:s("metric.disk"),color:_e(i.avgStorage),size:110})]})]}),r.jsxs("div",{className:"cc-stats-panel panel panel-scan",children:[r.jsx("div",{className:"panel-header",children:r.jsx("h2",{className:"panel-title font-display",children:s("dashboard.infrastructure")})}),r.jsxs("div",{className:"stats-grid",children:[r.jsx(Ks,{label:s("cluster.total"),value:t.total_clusters,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("circle",{cx:"12",cy:"12",r:"4"})]})}),r.jsx(Ks,{label:s("cluster.nodes_online"),value:`${t.total_nodes_online}/${t.total_nodes}`,color:t.total_nodes_online<t.total_nodes?"warning":"success",icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("path",{d:"M8 21h8M12 17v4"})]})}),r.jsx(Ks,{label:s("cluster.vms_running"),value:`${t.total_vms_running}/${t.total_vms}`,icon:r.jsxs("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M3 9h18M9 3v18"})]})}),r.jsx(Ks,{label:s("cluster.cts_running"),value:`${t.total_cts_running}/${t.total_cts}`,icon:r.jsx("svg",{width:"18",height:"18",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"})})})]})]})]}),r.jsxs("div",{className:"cc-galaxy",children:[r.jsx("div",{className:"galaxy-title font-display",children:s("cluster.galaxy")}),r.jsx("div",{className:"galaxy-container",children:o.length===0?r.jsxs("div",{className:"no-clusters",children:[r.jsx("div",{className:"no-clusters-icon",children:r.jsxs("svg",{width:"64",height:"64",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 6v6l4 2"})]})}),r.jsx("div",{className:"no-clusters-text",children:s("loading.connecting")}),r.jsx("div",{className:"no-clusters-hint",children:"Configure clusters in config.yaml"})]}):r.jsx("div",{className:"cluster-grid",children:o.map(([l,c])=>r.jsx(Tg,{cluster:c,onClick:()=>n(l)},l))})})]})]}),r.jsx("style",{children:`
      ...
      `})]})}function Pg(e,t,n){const a=Math.min(e,100)/100,s=.1+a*.6,o=t;let i=(Math.random()-.5)*.02;if(o>.08&&o<.22){const l=(o-.08)/.14;i+=s*.2*Math.sin(l*Math.PI)}if(o>.24&&o<.4){const l=(o-.24)/.16;if(l<.2)i-=s*.15*Math.sin(l*5*Math.PI);else if(l<.5){const c=(l-.2)/.3;i+=s*(1+a*.5)*Math.sin(c*Math.PI)}else if(l<.7){const c=(l-.5)/.2;i-=s*.25*Math.sin(c*Math.PI)}}if(o>.48&&o<.72){const l=(o-.48)/.24;i+=s*.35*Math.sin(l*Math.PI)}return i*n}function Hi({value:e,label:t,color:n,isOnline:a,width:s=180,height:o=35,isPaused:i=!1}){const l=p.useRef(null),c=p.useRef(null),d=p.useRef([]),h=p.useRef(0),g=p.useRef(0),u=p.useRef(0),x=p.useRef(0),b=p.useRef(!i),k=p.useRef(!1),m=6e4/(50+e/100*50),f=12;p.useEffect(()=>{b.current=!i},[i]);const v=p.useCallback(()=>{const w=c.current;if(!w)return;w.fillStyle="rgba(5, 8, 15, 0.95)",w.fillRect(0,0,s,o),w.strokeStyle="rgba(0, 240, 255, 0.08)",w.lineWidth=.5;for(let E=0;E<o;E+=10)w.beginPath(),w.moveTo(0,E),w.lineTo(s,E),w.stroke();for(let E=0;E<s;E+=10)w.beginPath(),w.moveTo(E,0),w.lineTo(E,o),w.stroke();const S=o/2,C=o*.45,L=!a||e>90?"#ff0040":e>70?"#ff6b00":n;w.shadowColor=L,w.shadowBlur=6,w.strokeStyle=L,w.lineWidth=1.5,w.lineCap="round",w.lineJoin="round",w.beginPath();let I=!1;for(let E=0;E<s;E++){const G=(E-h.current+s)%s;if(G<8&&G>0)continue;const A=S-d.current[E]*C;I?w.lineTo(E,A):(w.moveTo(E,A),I=!0)}w.stroke(),w.shadowBlur=0,w.strokeStyle=`${L}60`,w.lineWidth=2,w.beginPath(),w.moveTo(h.current,0),w.lineTo(h.current,o),w.stroke();const P=w.createLinearGradient(h.current-15,0,h.current,0);P.addColorStop(0,"transparent"),P.addColorStop(1,`${L}30`),w.fillStyle=P,w.fillRect(h.current-15,0,15,o)},[s,o,e,a,n]);p.useEffect(()=>{const w=l.current;if(!w)return;const S=w.getContext("2d");if(!S)return;const C=window.devicePixelRatio||1;w.width=s*C,w.height=o*C,S.scale(C,C),c.current=S,d.current.length!==s&&(d.current=new Array(s).fill(0)),k.current=!0,v()},[s,o,v]),p.useEffect(()=>{if(!k.current||!c.current)return;const S=C=>{x.current||(x.current=C);const N=C-x.current;x.current=C;const L=N/1e3*f;g.current+=N/m,g.current>=1&&(g.current-=1);const I=Math.ceil(L);for(let P=0;P<I;P++){const G=(g.current+P/I*(N/m))%1;let A;a?A=Pg(e,G,1):A=(Math.random()-.5)*.01,h.current=(h.current+1)%s,d.current[h.current]=A;const T=(h.current+1)%s;for(let K=0;K<8;K++){const O=(T+K)%s;d.current[O]=0}}v(),b.current&&(u.current=requestAnimationFrame(S))};return i||(x.current=0,u.current=requestAnimationFrame(S)),()=>{cancelAnimationFrame(u.current)}},[s,o,e,a,m,f,i,v]);const j=()=>!a||e>90?"#ff0040":e>70?"#ff6b00":n;return r.jsxs("div",{className:"ecg-trace",children:[r.jsxs("div",{className:"ecg-trace-header",children:[r.jsx("span",{className:"ecg-trace-label",style:{color:j()},children:t}),r.jsx("span",{className:"ecg-trace-value",style:{color:j()},children:a?`${Math.round(e)}%`:"--"})]}),r.jsx("canvas",{ref:l,style:{width:s,height:o,display:"block"}}),r.jsx("style",{children:`
        .ecg-trace {
          position: relative;
        }
      ...
      `})]})}const Ig=["hour","day","week","month","year"],Kl=e=>{if(!isFinite(e)||e===0)return"0";const t=["B","K","M","G","T"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=10?0:1)}${t[n]}`},Gn=e=>Kl(e)+"/s",xp=e=>`${(e*100).toFixed(0)}%`;function xf({open:e,onClose:t,clusterId:n,node:a,vmid:s,kind:o,title:i}){const{t:l,language:c}=Ce(),[d,h]=p.useState("hour"),[g,u]=p.useState([]),[x,b]=p.useState(!1),[k,y]=p.useState(null);return p.useEffect(()=>{if(!e)return;let m=!0;return(async()=>{b(!0),y(null);try{const f=encodeURIComponent(n),v=encodeURIComponent(a),j=o==="node"?`/api/clusters/${f}/nodes/${v}/rrddata`:o==="qemu"?`/api/clusters/${f}/nodes/${v}/qemu/${s}/rrddata`:`/api/clusters/${f}/nodes/${v}/lxc/${s}/rrddata`,w=await fetch(`${j}?timeframe=${d}`,{credentials:"same-origin"});if(!w.ok){const C=await w.json().catch(()=>({}));throw new Error(C.error||`HTTP ${w.status}`)}const S=await w.json();if(!m)return;u((S.samples||[]).filter(C=>C&&C.time))}catch(f){m&&y(f.message||String(f))}finally{m&&b(!1)}})(),()=>{m=!1}},[e,n,a,s,o,d]),e?r.jsx("div",{className:"rrd-back",onClick:t,children:r.jsxs("div",{className:"rrd-modal",onClick:m=>m.stopPropagation(),children:[r.jsxs("div",{className:"rrd-head",children:[r.jsxs("div",{className:"rrd-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"3 17 9 11 13 15 21 7"}),r.jsx("polyline",{points:"14 7 21 7 21 14"})]}),r.jsx("span",{children:l("rrd.title")}),i&&r.jsx("span",{className:"rrd-target",children:i})]}),r.jsxs("div",{className:"rrd-tfs",children:[Ig.map(m=>r.jsx("button",{className:`rrd-tf ${m===d?"on":""}`,onClick:()=>h(m),children:l(`rrd.tf.${m}`)},m)),r.jsx("button",{className:"rrd-close",onClick:t,"aria-label":"close",children:"×"})]})]}),r.jsxs("div",{className:"rrd-body",children:[k&&r.jsx("div",{className:"rrd-error",children:k}),x&&g.length===0&&r.jsx("div",{className:"rrd-loading",children:l("rrd.loading")}),!x&&g.length===0&&!k&&r.jsx("div",{className:"rrd-loading",children:l("rrd.empty")}),g.length>0&&r.jsxs("div",{className:"rrd-grid",children:[r.jsx(Xs,{title:l("rrd.chart.cpu"),samples:g,color:"#00f0ff",series:[{key:"cpu",label:"CPU",fmt:xp,scale:m=>m.cpu??null}],yMax:1,yFmt:xp}),r.jsx(Xs,{title:l("rrd.chart.mem"),samples:g,color:"#00ff88",series:[{key:"mem",label:"Mem",fmt:m=>Kl(m),scale:m=>m.mem??null}],yFmt:Kl,fillTop:m=>m.maxmem}),r.jsx(Xs,{title:l("rrd.chart.net"),samples:g,color:"#ff8a3c",series:[{key:"netin",label:"In",fmt:Gn,scale:m=>m.netin??null,color:"#ff8a3c"},{key:"netout",label:"Out",fmt:Gn,scale:m=>m.netout??null,color:"#bf00ff"}],yFmt:Gn}),r.jsx(Xs,{title:l("rrd.chart.disk"),samples:g,color:"#bf00ff",series:[{key:"diskread",label:"Read",fmt:Gn,scale:m=>m.diskread??null,color:"#00f0ff"},{key:"diskwrite",label:"Write",fmt:Gn,scale:m=>m.diskwrite??null,color:"#bf00ff"}],yFmt:Gn})]})]}),r.jsx("style",{children:`
        ...
        `})]})}):null}function Xs({title:e,samples:t,series:n,yMax:a,yFmt:s,fillTop:o}){var j,w;const{width:i,height:l}={width:460,height:160},c=48,d=8,h=10,g=22,u=p.useMemo(()=>{if(typeof a=="number")return a;let S=1;for(const C of t){const N=o==null?void 0:o(C);N&&N>S&&(S=N);for(const L of n){const I=L.scale(C);I!=null&&I>S&&(S=I)}}return S*1.1},[t,n,o,a]),x=((j=t[0])==null?void 0:j.time)||0,b=((w=t[t.length-1])==null?void 0:w.time)||x+1,k=Math.max(1,b-x),y=S=>c+(S-x)/k*(i-c-d),m=S=>h+(1-S/u)*(l-h-g),f=S=>{let C="",N=!1;for(const L of t){const I=S.scale(L);if(I==null||!isFinite(I)){N=!1;continue}const P=y(L.time),E=m(I);C+=(N?" L ":" M ")+P.toFixed(1)+","+E.toFixed(1),N=!0}return C},v=[0,.25,.5,.75,1].map(S=>u*(1-S));return r.jsxs("div",{className:"rrd-card",children:[r.jsxs("div",{className:"rrd-card-head",children:[r.jsx("div",{className:"rrd-card-title",children:e}),r.jsx("div",{className:"rrd-card-legend",children:n.map(S=>r.jsxs("span",{children:[r.jsx("span",{className:"dot",style:{background:S.color||"#00f0ff"}}),S.label]},S.key))})]}),r.jsxs("svg",{viewBox:`0 0 ${i} ${l}`,className:"rrd-svg",children:[v.map((S,C)=>{const N=h+C/4*(l-h-g);return r.jsxs("g",{children:[r.jsx("line",{x1:c,y1:N,x2:i-d,y2:N,stroke:"rgba(0,240,255,.08)"}),r.jsx("text",{x:c-4,y:N+3,textAnchor:"end",fontSize:"9",fill:"rgba(160,180,200,.6)",fontFamily:"Share Tech Mono, monospace",children:s(S)})]},C)}),n.map(S=>r.jsx("path",{d:f(S),fill:"none",stroke:S.color||"#00f0ff",strokeWidth:"1.3",opacity:"0.95"},S.key))]}),r.jsx("style",{children:`
      ...
      `})]})}function Sa(){const[e,t]=p.useState(!0),[n,a]=p.useState(null),[s,o]=p.useState(!1),i=async()=>{try{const c=await We.authMe();c.authenticated&&c.user?(a(c.user),o(!0)):(a(null),o(!1))}catch{a(null),o(!1)}finally{t(!1)}},l=async()=>{try{await We.authLogout()}catch{}window.location.replace("/login")};return p.useEffect(()=>{i()},[]),{loading:e,user:n,authEnforced:s,refresh:i,logout:l}}function Lg({open:e,onClose:t,clusterId:n,node:a}){var P;const{t:s,language:o}=Ce(),i=Pr(),c=((P=Sa().user)==null?void 0:P.role_global)==="admin",[d,h]=p.useState([]),[g,u]=p.useState(!1),[x,b]=p.useState(null),[k,y]=p.useState(null),[m,f]=p.useState(null),[v,j]=p.useState(""),w=async()=>{if(!(!n||!a)){u(!0),b(null);try{const E=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt`,{credentials:"same-origin"});if(!E.ok){const A=await E.json().catch(()=>({}));throw new Error(A.error||`HTTP ${E.status}`)}const G=await E.json();h(G.updates||[])}catch(E){b(E.message||String(E))}finally{u(!1)}}};p.useEffect(()=>{e&&w()},[e,n,a]);const S=E=>{f(E),setTimeout(()=>f(null),3e3)},C=async()=>{var E,G;if(c){y("refresh");try{const A=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt/refresh`,{method:"POST",credentials:"same-origin"}),T=await A.json().catch(()=>({}));if(!A.ok)throw new Error(T.error||`HTTP ${A.status}`);S(o==="zh-TW"?`已啟動 apt update（${((E=T.upid)==null?void 0:E.slice(0,24))||""}）`:`apt update kicked off (${((G=T.upid)==null?void 0:G.slice(0,24))||""})`),setTimeout(w,8e3)}catch(A){i.alert(A.message||String(A))}finally{y(null)}}},N=async()=>{var G,A;if(!(!c||!await i.confirm(o==="zh-TW"?`確定在 ${a} 上執行 apt dist-upgrade？此操作會將節點上所有可升級套件一次升級，建議先在備援節點測試。`:`Run apt dist-upgrade on ${a}? This upgrades every pending package on the node — test on a spare node first.`,{destructive:!0}))){y("upgrade");try{const T=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/apt/upgrade`,{method:"POST",credentials:"same-origin"}),K=await T.json().catch(()=>({}));if(!T.ok)throw new Error(K.error||`HTTP ${T.status}`);S(o==="zh-TW"?`升級作業啟動（${((G=K.upid)==null?void 0:G.slice(0,24))||""}） — 可在 /tasks 追蹤`:`upgrade kicked off (${((A=K.upid)==null?void 0:A.slice(0,24))||""}) — track on /tasks`)}catch(T){i.alert(T.message||String(T))}finally{y(null)}}};if(!e)return null;const L=v.trim().toLowerCase(),I=L?d.filter(E=>(E.Package||"").toLowerCase().includes(L)||(E.Description||"").toLowerCase().includes(L)):d;return r.jsx("div",{className:"apt-back",onClick:t,children:r.jsxs("div",{className:"apt-modal",onClick:E=>E.stopPropagation(),children:[r.jsxs("div",{className:"apt-head",children:[r.jsxs("div",{className:"apt-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),r.jsx("polyline",{points:"7 10 12 15 17 10"}),r.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),r.jsx("span",{children:s("apt.title")}),r.jsx("span",{className:"apt-target",children:a})]}),r.jsxs("div",{className:"apt-actions",children:[r.jsx("input",{className:"apt-filter",value:v,onChange:E=>j(E.target.value),placeholder:s("apt.filter_ph")}),r.jsxs("button",{className:"apt-btn",onClick:w,disabled:g||k!==null,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:s("apt.btn_reload")})]}),c&&r.jsxs(r.Fragment,{children:[r.jsx("button",{className:"apt-btn",onClick:C,disabled:k!==null,children:r.jsx("span",{children:s("apt.btn_refresh")})}),r.jsx("button",{className:"apt-btn primary",onClick:N,disabled:k!==null||d.length===0,children:r.jsx("span",{children:s("apt.btn_upgrade")})})]}),r.jsx("button",{className:"apt-close",onClick:t,children:"×"})]})]}),r.jsxs("div",{className:"apt-meta",children:[r.jsxs("span",{children:[I.length,v&&` / ${d.length}`," ",s("apt.pkgs")]}),!c&&r.jsx("span",{className:"apt-readonly",children:s("apt.readonly")}),m&&r.jsx("span",{className:"apt-toast",children:m})]}),r.jsxs("div",{className:"apt-body",children:[x&&r.jsx("div",{className:"apt-error",children:x}),g&&d.length===0&&r.jsx("div",{className:"apt-empty",children:s("apt.loading")}),!g&&d.length===0&&!x&&r.jsx("div",{className:"apt-empty",children:s("apt.uptodate")}),I.length>0&&r.jsxs("table",{className:"apt-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:s("apt.col.package")}),r.jsx("th",{children:s("apt.col.from")}),r.jsx("th",{children:s("apt.col.to")}),r.jsx("th",{children:s("apt.col.section")})]})}),r.jsx("tbody",{children:I.map(E=>r.jsxs("tr",{title:E.Description||"",children:[r.jsx("td",{className:"apt-mono apt-name",children:E.Package}),r.jsx("td",{className:"apt-mono",children:E.OldVersion||"—"}),r.jsx("td",{className:"apt-mono apt-newver",children:E.Version||"—"}),r.jsx("td",{className:"apt-mono apt-section",children:E.Section||""})]},E.Package))})]})]}),r.jsx("style",{children:`
      ...
      `})]})}function vf({state:e,onClose:t,onShowDetails:n,onPowerAction:a,onOpenConsole:s,onOpenSnapshots:o,onBackupNow:i,onRemoteMigrate:l,onShowPerf:c,onShowBackupHistory:d,onShowConfig:h,getNodeHealth:g,userRole:u,consoleMode:x,consolePasswordSet:b,hideSnapshots:k,hideBackup:y,hideRemoteMigrate:m,hideConsole:f}){const{t:v}=Ce(),j=Pr();if(p.useEffect(()=>{const P=()=>t(),E=()=>t(),G=A=>{A.key==="Escape"&&t()};return e.visible&&(document.addEventListener("click",P),document.addEventListener("scroll",E,!0),document.addEventListener("keydown",G)),()=>{document.removeEventListener("click",P),document.removeEventListener("scroll",E,!0),document.removeEventListener("keydown",G)}},[e.visible,t]),!e.visible||!e.vm)return null;const w=e.vm,S=g(e.clusterId,w.node),C=S?`https://${S.host}:${S.port}/#v1:0:=${w.type}/${w.vmid}`:null,N=P=>{P.stopPropagation(),C&&window.open(C,"_blank","noopener,noreferrer"),t()},L=P=>{P.stopPropagation(),n(),t()},I=r.jsxs("div",{className:"vm-context-menu",style:{left:e.x,top:e.y},onClick:P=>P.stopPropagation(),children:[r.jsxs("div",{className:"context-menu-header",children:[r.jsx("span",{className:"context-menu-name",children:w.name}),r.jsxs("span",{className:"context-menu-id",children:["#",w.vmid]})]}),r.jsx("div",{className:"context-menu-divider"}),r.jsxs("button",{className:"context-menu-item",onClick:L,children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 16v-4M12 8h.01"})]}),r.jsx("span",{children:v("vm.details")})]}),C&&r.jsxs("button",{className:"context-menu-item",onClick:N,children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"}),r.jsx("polyline",{points:"15,3 21,3 21,9"}),r.jsx("line",{x1:"10",y1:"14",x2:"21",y2:"3"})]}),r.jsx("span",{children:v("vm.open_pve")})]}),!f&&(u==="operator"||u==="admin")&&(()=>{const P=x==="disabled"?"console.disabled":w.status!=="running"?"console.vm_not_running":null,E=!!P;return r.jsxs("button",{className:`context-menu-item ${E?"is-disabled":""}`,title:E?v(P):void 0,onClick:G=>{if(G.stopPropagation(),E){t(),j.alert(v(P));return}s(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"4",width:"20",height:"14",rx:"2"}),r.jsx("polyline",{points:"8 21 16 21 12 17 8 21"}),r.jsx("polyline",{points:"6 8 9 11 6 14"}),r.jsx("line",{x1:"11",y1:"14",x2:"14",y2:"14"})]}),r.jsx("span",{children:v("vm.console")})]})})(),!k&&(u==="operator"||u==="admin")&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),o(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"9"}),r.jsx("path",{d:"M12 7v5l3 2"})]}),r.jsx("span",{children:v("vm.snapshots")})]}),r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation();const E=`/tasks?vmid=${encodeURIComponent(String(w.vmid))}&cluster=${encodeURIComponent(e.clusterId)}`;window.history.pushState(null,"",E),window.dispatchEvent(new PopStateEvent("popstate")),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M9 7h8M9 12h8M9 17h5"})]}),r.jsx("span",{children:v("vm.task_history")})]}),c&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),c(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"3 17 9 11 13 15 21 7"}),r.jsx("polyline",{points:"14 7 21 7 21 14"})]}),r.jsx("span",{children:v("vm.perf_charts")})]}),d&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),d(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),r.jsx("span",{children:v("vm.backup_history")})]}),h&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),h(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),r.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}),r.jsx("span",{children:v("vm.config_view")})]}),!y&&(u==="operator"||u==="admin")&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),i(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),r.jsx("span",{children:v("vm.backup_now")})]}),(u==="operator"||u==="admin")&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"context-menu-divider"}),w.status!=="running"&&r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),a({vm:w,clusterId:e.clusterId,action:"start"}),t()},children:[r.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("polygon",{points:"6,4 20,12 6,20"})}),r.jsx("span",{children:v("vm.start")})]}),w.status==="running"&&r.jsxs(r.Fragment,{children:[r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),a({vm:w,clusterId:e.clusterId,action:"shutdown"}),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M18.36 6.64A9 9 0 0 1 6.64 18.36"}),r.jsx("line",{x1:"12",y1:"2",x2:"12",y2:"12"})]}),r.jsx("span",{children:v("vm.shutdown_acpi")})]}),r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),a({vm:w,clusterId:e.clusterId,action:"reboot"}),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23,4 23,10 17,10"}),r.jsx("path",{d:"M20.49 15a9 9 0 1 1-2.12-9.36L23 10"})]}),r.jsx("span",{children:v("vm.reboot")})]}),r.jsxs("button",{className:"context-menu-item danger",onClick:P=>{P.stopPropagation(),a({vm:w,clusterId:e.clusterId,action:"stop"}),t()},children:[r.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"currentColor",children:r.jsx("rect",{x:"6",y:"6",width:"12",height:"12",rx:"1"})}),r.jsx("span",{children:v("vm.stop_hard")})]})]})]}),!m&&u==="admin"&&w.type!=="lxc"&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"context-menu-divider"}),r.jsxs("button",{className:"context-menu-item",onClick:P=>{P.stopPropagation(),l(),t()},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M3 12h12"}),r.jsx("polyline",{points:"13 6 19 12 13 18"}),r.jsx("circle",{cx:"20",cy:"6",r:"2"}),r.jsx("circle",{cx:"20",cy:"18",r:"2"})]}),r.jsx("span",{children:v("vm.migrate_remote")})]})]}),r.jsx("style",{children:`
        .vm-context-menu {
          position: fixed;
          z-index: 1000;
          min-width: 220px;
...
`,qg=e=>{if(!e)return"—";const t=e/1024**3;return t>=100?`${t.toFixed(0)}G`:`${t.toFixed(1)}G`};function bf({open:e,cluster_id:t,vm:n,onClose:a,onMigrationStarted:s}){const{t:o}=Ce(),[i,l]=p.useState("endpoint"),[c,d]=p.useState([]),[h,g]=p.useState(""),[u,x]=p.useState(""),[b,k]=p.useState(!1),[y,m]=p.useState(null),[f,v]=p.useState(null),[j,w]=p.useState(!1),[S,C]=p.useState({}),[N,L]=p.useState({}),[I,P]=p.useState(""),[E,G]=p.useState(""),[A,T]=p.useState(!0),[K,O]=p.useState(!1),[W,B]=p.useState(""),[q,J]=p.useState(""),[z,ge]=p.useState(""),[je,Oe]=p.useState(null),[X,ue]=p.useState(!1),ke=async()=>{if(!(!n||!te)){ue(!0),Oe(null),J("");try{const V=await We.migrationPrecheck(t,n.vmid,te.cluster_id,te.node_name||te.node_host);Oe({ok:V.ok,blockers:V.blockers,warnings:V.warnings})}catch(V){const ce=V instanceof Error?V.message:String(V);J(`pre-flight check failed: ${ce}`)}finally{ue(!1)}}};p.useEffect(()=>{e&&(l("endpoint"),d([]),g(""),x(""),m(null),v(null),C({}),L({}),P(""),G(n?String(n.vmid):""),B(""),J(""),ge(""),Oe(null),We.listRemoteEndpoints(t).then(V=>d(V.endpoints)).catch(V=>J(`could not list target clusters: ${V.message||V}`)),n&&We.getMigrationSource(t,n.vmid).then(m).catch(V=>J(`could not introspect source VM: ${V.message||V}`)))},[e,t,n]),p.useEffect(()=>{if(!e)return;const V=ce=>{ce.key==="Escape"&&i!=="submitting"&&a()};return document.addEventListener("keydown",V),()=>document.removeEventListener("keydown",V)},[e,i,a]);const te=c.find(V=>Yi(V)===h),Z=async V=>{var me;g(V);const ce=c.find(pe=>Yi(pe)===V);if(ce){k(!0),w(!0),J(""),v(null),P("");try{const pe=await We.fetchRemoteFingerprint(ce.node_host,ce.node_port);x(pe.fingerprint)}catch(pe){const ye=pe instanceof Error?pe.message:String(pe);J(`could not auto-fetch fingerprint (${ye}); paste manually`),x("")}finally{k(!1)}try{const pe=ce.node_name||ce.node_host,ye=await We.getMigrationTargets(ce.cluster_id,pe);v(ye);const Fe=ye.ips.find(Je=>Je.address===ce.node_host);P(Fe?Fe.address:((me=ye.ips[0])==null?void 0:me.address)||ce.node_host)}catch(pe){const ye=pe instanceof Error?pe.message:String(pe);J(`could not enumerate target node resources: ${ye}`)}finally{w(!1)}}};p.useEffect(()=>{!y||!f||(C(V=>{const ce={...V};return y.disks.forEach(me=>{var pe;if(!ce[me.key]){const ye=f.storages.find(Fe=>Fe.storage===me.storage);ce[me.key]=((pe=ye||f.storages[0])==null?void 0:pe.storage)||""}}),ce}),L(V=>{const ce={...V};return y.nics.forEach(me=>{var pe;if(!ce[me.key]){const ye=f.bridges.find(Fe=>Fe.iface===me.bridge);ce[me.key]=((pe=ye||f.bridges[0])==null?void 0:pe.iface)||""}}),ce}))},[y,f]);const F=p.useMemo(()=>{if(!y)return"";const V=new Set,ce=new Map;return y.disks.forEach(me=>{const pe=S[me.key];me.storage&&pe&&(ce.set(me.storage,pe),V.add(pe))}),V.size===1?Array.from(V)[0]:Array.from(ce.entries()).map(([me,pe])=>`${me}=${pe}`).join(",")},[y,S]),M=p.useMemo(()=>{if(!y)return"";const V=new Set,ce=new Map;return y.nics.forEach(me=>{const pe=N[me.key];me.bridge&&pe&&(ce.set(me.bridge,pe),V.add(pe))}),V.size===1?Array.from(V)[0]:Array.from(ce.entries()).map(([me,pe])=>`${me}=${pe}`).join(",")},[y,N]),Y=async()=>{if(!(!n||!te)){l("submitting"),J("");try{const V=await We.remoteMigrate(t,n.vmid,{target_cluster_id:te.cluster_id,target_endpoint_host:I||te.node_host,target_endpoint_port:te.node_port,target_endpoint_fingerprint:u||void 0,target_vmid:parseInt(E,10),target_bridge_map:M,target_storage_map:F,online:A,delete_source:K,bwlimit:W?parseInt(W,10):void 0});ge(V.upid),l("done"),s==null||s(V.upid)}catch(V){const ce=V instanceof Error?V.message:String(V);J(ce),l("error")}}};if(!e||!n)return null;const re=!!E&&/^\d+$/.test(E)&&!!y&&!!f&&y.disks.every(V=>!!S[V.key])&&y.nics.every(V=>!!N[V.key]),be=i==="endpoint"?!!te&&!!f&&!!I:i==="mappings"?re:!0;return r.jsxs("div",{onClick:()=>i!=="submitting"&&a(),style:Jg,children:[r.jsx("style",{children:Zg}),r.jsxs("div",{className:"rmm",onClick:V=>V.stopPropagation(),children:[r.jsx("div",{className:"rmm-eyebrow",children:o("rmm.eyebrow",{step:o(`rmm.step.${i}`)})}),r.jsx("h3",{className:"rmm-title",children:o("rmm.title",{vmid:n.vmid,name:n.name})}),i==="endpoint"&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"rmm-sub",children:o("rmm.endpoint.intro")}),r.jsx("label",{children:o("rmm.endpoint.target")}),r.jsx(Ua,{value:h,placeholder:o("rmm.endpoint.select"),options:c.map(V=>({value:Yi(V),label:`${V.cluster_name} @ ${V.node_host}:${V.node_port}`})),onChange:V=>Z(V)}),r.jsx("label",{children:o("rmm.endpoint.fp_label")}),r.jsx("input",{type:"text",value:u,onChange:V=>x(V.target.value),placeholder:b?o("rmm.endpoint.fp_fetching"):"AB:CD:…",spellCheck:!1,autoComplete:"off"}),te&&r.jsxs(r.Fragment,{children:[r.jsxs("label",{children:[o("rmm.endpoint.datapath")," ",r.jsx("span",{className:"hint",children:o("rmm.endpoint.datapath_hint")})]}),r.jsx(Ua,{value:I,disabled:j||!f,placeholder:j?o("rmm.endpoint.datapath_loading"):"",options:j?[]:!f||f.ips.length===0?[{value:te.node_host,label:`${te.node_host} (mgmt)`}]:f.ips.map(V=>({value:V.address,label:`${V.address} · ${V.iface} (${V.type})`})),onChange:V=>P(V)}),r.jsx("p",{className:"rmm-tip",children:o("rmm.endpoint.datapath_tip")})]}),q&&r.jsx("div",{className:"rmm-err",children:q}),r.jsxs("div",{className:"rmm-actions",children:[r.jsx("button",{className:"ghost",onClick:a,children:o("action.cancel")}),r.jsx("button",{className:"primary",disabled:!be,onClick:()=>l("mappings"),children:o("rmm.action.next")})]})]}),i==="mappings"&&te&&y&&f&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"rmm-sub",children:o("rmm.mappings.intro")}),r.jsxs("label",{children:[o("rmm.mappings.target_vmid")," ",r.jsx("span",{className:"hint",children:o("rmm.mappings.target_vmid_hint")})]}),r.jsx("input",{type:"text",inputMode:"numeric",value:E,onChange:V=>G(V.target.value)}),y.disks.length>0&&r.jsxs(r.Fragment,{children:[r.jsx("label",{children:o("rmm.mappings.disks")}),r.jsxs("div",{className:"rmm-maptable",children:[r.jsxs("div",{className:"rmm-maprow rmm-maphead",children:[r.jsx("span",{children:o("rmm.mappings.col_source")}),r.jsx("span",{children:o("rmm.mappings.col_size")}),r.jsx("span",{children:o("rmm.mappings.col_target_storage")})]}),y.disks.map(V=>r.jsxs("div",{className:"rmm-maprow",children:[r.jsx("code",{className:"rmm-mapkey",children:V.key}),r.jsxs("code",{className:"rmm-mapsrc",children:[V.storage," ",r.jsx("em",{children:V.size})]}),r.jsx(Ua,{value:S[V.key]||"",options:f.storages.map(ce=>({value:ce.storage,label:`${ce.storage} (${ce.type}, ${qg(ce.avail)} free)`})),onChange:ce=>C({...S,[V.key]:ce})})]},V.key))]})]}),y.nics.length>0&&r.jsxs(r.Fragment,{children:[r.jsx("label",{children:o("rmm.mappings.nics")}),r.jsxs("div",{className:"rmm-maptable",children:[r.jsxs("div",{className:"rmm-maprow rmm-maphead",children:[r.jsx("span",{children:o("rmm.mappings.col_source")}),r.jsx("span",{children:o("rmm.mappings.col_bridge")}),r.jsx("span",{children:o("rmm.mappings.col_target_bridge")})]}),y.nics.map(V=>r.jsxs("div",{className:"rmm-maprow",children:[r.jsx("code",{className:"rmm-mapkey",children:V.key}),r.jsxs("code",{className:"rmm-mapsrc",children:[V.bridge," ",r.jsx("em",{children:V.model})]}),r.jsx(Ua,{value:N[V.key]||"",options:f.bridges.map(ce=>({value:ce.iface,label:`${ce.iface}${ce.address?` (${ce.address})`:""}`})),onChange:ce=>L({...N,[V.key]:ce})})]},V.key))]})]}),r.jsxs("div",{className:"rmm-row",children:[r.jsxs("label",{className:"rmm-check",children:[r.jsx("input",{type:"checkbox",checked:A,onChange:V=>T(V.target.checked)}),r.jsx("span",{children:o("rmm.mappings.online")})]}),r.jsxs("label",{className:"rmm-check",children:[r.jsx("input",{type:"checkbox",checked:K,onChange:V=>O(V.target.checked)}),r.jsx("span",{children:o("rmm.mappings.delete_source")})]})]}),r.jsx("label",{children:o("rmm.mappings.bwlimit")}),r.jsx("input",{type:"text",inputMode:"numeric",value:W,onChange:V=>B(V.target.value),placeholder:"0"}),q&&r.jsx("div",{className:"rmm-err",children:q}),r.jsxs("div",{className:"rmm-actions",children:[r.jsx("button",{className:"ghost",onClick:()=>l("endpoint"),children:o("rmm.action.back")}),r.jsx("button",{className:"primary danger",disabled:!be,onClick:()=>l("review"),children:o("rmm.action.review")})]})]}),i==="review"&&te&&r.jsxs(r.Fragment,{children:[r.jsx(Qg,{vm:n,selected:te,clusterId:t,precheck:je,precheckLoading:X,onRun:ke,t:o}),r.jsx("p",{className:"rmm-sub",children:o("rmm.review.intro")}),r.jsxs("div",{className:"rmm-review",children:[r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.from")}),r.jsxs("code",{children:[t,"/",n.node,"/vm/",n.vmid," (",n.name,")"]})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.to")}),r.jsxs("code",{children:[te.cluster_id,"/",te.node_host,":",te.node_port," → vmid ",E]})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.data_path")}),r.jsx("code",{children:I})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.fingerprint")}),r.jsx("code",{className:"trunc",children:u||r.jsx("em",{children:o("rmm.review.fp_none")})})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.storage_map")}),r.jsx("code",{children:F||"<empty>"})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.bridge_map")}),r.jsx("code",{children:M||"<empty>"})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.online")}),r.jsx("code",{children:o(A?"rmm.review.online_yes":"rmm.review.online_no")})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.delete_source")}),r.jsx("code",{children:o(K?"rmm.review.delete_source_yes":"rmm.review.delete_source_no")})]}),r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.review.bandwidth")}),r.jsx("code",{children:W?`${W} KB/s`:o("rmm.review.unlimited")})]})]}),r.jsxs("div",{className:"rmm-actions",children:[r.jsx("button",{className:"ghost",onClick:()=>l("mappings"),children:o("rmm.action.back")}),r.jsx("button",{className:"primary danger",disabled:X||je!==null&&!je.ok,onClick:Y,children:o("rmm.action.start")})]})]}),i==="submitting"&&r.jsxs("div",{className:"rmm-spin",children:[r.jsx("div",{className:"rmm-spin-ring"}),r.jsx("div",{children:o("rmm.submitting")})]}),i==="done"&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"rmm-sub",style:{color:"#00ff88"},children:o("rmm.done.msg")}),r.jsxs("div",{className:"rmm-review",children:[r.jsxs("div",{children:[r.jsx("span",{children:o("rmm.done.upid")}),r.jsx("code",{className:"trunc",style:{userSelect:"all"},children:z})]}),r.jsxs("div",{children:[r.jsx("span",{}),r.jsx("span",{style:{color:"var(--text-dim)"},children:o("rmm.done.hint")})]})]}),r.jsx("div",{className:"rmm-actions",children:r.jsx("button",{className:"primary",onClick:a,children:o("rmm.action.close")})})]}),i==="error"&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"rmm-err",style:{marginTop:16},children:q}),r.jsxs("div",{className:"rmm-actions",children:[r.jsx("button",{className:"ghost",onClick:()=>l("mappings"),children:o("rmm.action.back")}),r.jsx("button",{className:"primary",onClick:a,children:o("rmm.action.close")})]})]})]})]})}function Yi(e){return`${e.cluster_id}::${e.node_host}::${e.node_port}`}function Qg({vm:e,selected:t,clusterId:n,precheck:a,precheckLoading:s,onRun:o,t:i}){if(qo.useEffect(()=>{a===null&&!s&&o()},[]),s)return r.jsx("div",{className:"rmm-precheck loading",children:i("rmm.precheck.running")});if(a===null)return null;const l=a.blockers.length>0,c=a.warnings.length>0,d=l?"blockers":c?"warnings":"ok";return r.jsxs("div",{className:`rmm-precheck ${d}`,children:[l&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"rmm-precheck-head",children:i("rmm.precheck.blockers")}),r.jsx("ul",{children:a.blockers.map((h,g)=>r.jsx("li",{children:h},g))})]}),c&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"rmm-precheck-head",children:i("rmm.precheck.warnings")}),r.jsx("ul",{children:a.warnings.map((h,g)=>r.jsx("li",{children:h},g))})]}),!l&&!c&&r.jsx("div",{className:"rmm-precheck-head",children:i("rmm.precheck.ok")}),r.jsx("div",{className:"rmm-precheck-actions",children:r.jsx("button",{className:"ghost",onClick:o,children:i("rmm.action.precheck")})})]})}const Jg={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"rmmFade .18s ease"},Zg=`
...
`;function ex(e){if(!e)return"—";try{return new Date(e*1e3).toLocaleString()}catch{return String(e)}}function yf({open:e,cluster_id:t,vm:n,onClose:a}){const{t:s}=Ce(),o=Pr(),[i,l]=p.useState([]),[c,d]=p.useState(!1),[h,g]=p.useState(!1),[u,x]=p.useState(""),[b,k]=p.useState(""),[y,m]=p.useState(!1),[f,v]=p.useState(""),j=async()=>{if(n){d(!0),v("");try{const N=await We.listSnapshots(t,n.vmid);l((N.snapshots||[]).filter(L=>L.name!=="current"))}catch(N){v(N instanceof Error?N.message:String(N))}finally{d(!1)}}};if(p.useEffect(()=>{e&&(x(""),k(""),m(!1),v(""),j())},[e,t,n==null?void 0:n.vmid]),p.useEffect(()=>{if(!e)return;const N=L=>{L.key==="Escape"&&a()};return document.addEventListener("keydown",N),()=>document.removeEventListener("keydown",N)},[e,a]),!e||!n)return null;const w=async()=>{if(u){if(!/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(u)){v("snapshot name must match [a-zA-Z][a-zA-Z0-9_-]*");return}g(!0),v("");try{await We.createSnapshot(t,n.vmid,{snapname:u,description:b,vmstate:y}),x(""),k(""),m(!1),await j()}catch(N){v(N instanceof Error?N.message:String(N))}finally{g(!1)}}},S=async N=>{if(await o.confirm(s("snap.confirm_delete",{name:N.name}),{destructive:!0})){v("");try{await We.deleteSnapshot(t,n.vmid,N.name),await j()}catch(L){v(L instanceof Error?L.message:String(L))}}},C=async N=>{if(await o.confirm(s("snap.confirm_rollback",{name:N.name}),{destructive:!0})){v("");try{await We.rollbackSnapshot(t,n.vmid,N.name),await j()}catch(L){v(L instanceof Error?L.message:String(L))}}};return r.jsxs("div",{onClick:a,style:tx,children:[r.jsx("style",{children:rx}),r.jsxs("div",{className:"sm-modal",onClick:N=>N.stopPropagation(),children:[r.jsxs("div",{className:"sm-eyebrow",children:["// snapshots · ",t]}),r.jsx("h3",{className:"sm-title",children:s("snap.title",{vmid:n.vmid,name:n.name})}),r.jsxs("div",{className:"sm-create",children:[r.jsxs("div",{className:"sm-row",children:[r.jsx("label",{children:s("snap.name")}),r.jsx("input",{type:"text",value:u,onChange:N=>x(N.target.value),placeholder:"my-snap",spellCheck:!1})]}),r.jsxs("div",{className:"sm-row",children:[r.jsx("label",{children:s("snap.description")}),r.jsx("input",{type:"text",value:b,onChange:N=>k(N.target.value)})]}),r.jsxs("div",{className:"sm-row sm-check-row",children:[r.jsxs("label",{className:"sm-check",children:[r.jsx("input",{type:"checkbox",checked:y,onChange:N=>m(N.target.checked)}),r.jsx("span",{children:s("snap.include_state")})]}),r.jsx("button",{className:"sm-btn primary",disabled:h||!u,onClick:w,children:h?"…":s("snap.create")})]})]}),f&&r.jsx("div",{className:"sm-err",children:f}),r.jsxs("div",{className:"sm-list",children:[c&&r.jsx("div",{className:"sm-empty",children:"…"}),!c&&i.length===0&&r.jsx("div",{className:"sm-empty",children:s("snap.empty")}),!c&&i.map(N=>r.jsxs("div",{className:"sm-item",children:[r.jsxs("div",{className:"sm-item-head",children:[r.jsx("code",{className:"sm-name",children:N.name}),N.parent&&r.jsxs("span",{className:"sm-meta",children:[s("snap.parent"),": ",r.jsx("code",{children:N.parent})]}),r.jsxs("span",{className:"sm-meta",children:[s("snap.taken"),": ",ex(N.snaptime)]}),N.vmstate?r.jsx("span",{className:"sm-tag",children:"RAM"}):null]}),N.description&&r.jsx("div",{className:"sm-desc",children:N.description}),r.jsxs("div",{className:"sm-item-actions",children:[r.jsx("button",{className:"sm-btn ghost",onClick:()=>C(N),children:s("snap.rollback")}),r.jsx("button",{className:"sm-btn danger",onClick:()=>S(N),children:s("snap.delete")})]})]},N.name))]}),r.jsx("div",{className:"sm-actions",children:r.jsx("button",{className:"sm-btn ghost",onClick:a,children:s("action.close")})})]})]})}const tx={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"smFade .18s ease"},rx=`
...
`;function wf({open:e,cluster_id:t,vm:n,onClose:a}){const{t:s}=Ce(),[o,i]=p.useState([]),[l,c]=p.useState(!1),[d,h]=p.useState(""),[g,u]=p.useState("snapshot"),[x,b]=p.useState("zstd"),[k,y]=p.useState(""),[m,f]=p.useState(""),[v,j]=p.useState(!1);if(p.useEffect(()=>{!e||!n||(y(""),f(""),h(""),c(!0),We.getCluster(t).then(C=>{const L=Object.values(C.storages||{}).filter(I=>{var E;if(!((E=I.content)!=null&&E.includes("backup")))return!1;const P=I.allowed_nodes||[];return P.length>0&&!P.includes(n.node)||!I.shared&&I.node!==n.node?!1:I.enabled!==!1});i(L),L.length>0&&h(L[0].storage)}).catch(C=>y(C.message||String(C))).finally(()=>c(!1)))},[e,t,n==null?void 0:n.vmid,n==null?void 0:n.node]),p.useEffect(()=>{if(!e)return;const C=N=>{N.key==="Escape"&&!v&&a()};return document.addEventListener("keydown",C),()=>document.removeEventListener("keydown",C)},[e,v,a]),!e||!n)return null;const w=o.length>0,S=async()=>{if(d){j(!0),y("");try{const C=await We.triggerBackup(t,n.node,{vmid:n.vmid,storage:d,mode:g,compress:x});f(C.upid)}catch(C){y(C instanceof Error?C.message:String(C))}finally{j(!1)}}};return r.jsxs("div",{onClick:()=>!v&&a(),style:nx,children:[r.jsx("style",{children:ax}),r.jsxs("div",{className:"bm-modal",onClick:C=>C.stopPropagation(),children:[r.jsxs("div",{className:"bm-eyebrow",children:["// backup · ",t," · ",n.node]}),r.jsx("h3",{className:"bm-title",children:s("backup.title",{vmid:n.vmid,name:n.name})}),!m&&r.jsxs(r.Fragment,{children:[r.jsx("label",{children:s("backup.storage")}),l?r.jsx("div",{className:"bm-empty",children:"…"}):w?r.jsx("select",{value:d,onChange:C=>h(C.target.value),children:o.map(C=>r.jsxs("option",{value:C.storage,children:[C.storage," (",C.type,C.shared?", shared":"",")"]},C.storage))}):r.jsx("div",{className:"bm-err",children:s("backup.no_backup_storage")}),r.jsx("label",{children:s("backup.mode")}),r.jsxs("select",{value:g,onChange:C=>u(C.target.value),children:[r.jsx("option",{value:"snapshot",children:s("backup.mode_snapshot")}),r.jsx("option",{value:"suspend",children:s("backup.mode_suspend")}),r.jsx("option",{value:"stop",children:s("backup.mode_stop")})]}),r.jsx("label",{children:s("backup.compress")}),r.jsxs("select",{value:x,onChange:C=>b(C.target.value),children:[r.jsx("option",{value:"zstd",children:"zstd"}),r.jsx("option",{value:"lzo",children:"lzo"}),r.jsx("option",{value:"gzip",children:"gzip"}),r.jsx("option",{value:"0",children:"none"})]}),k&&r.jsx("div",{className:"bm-err",children:k}),r.jsxs("div",{className:"bm-actions",children:[r.jsx("button",{className:"bm-btn ghost",onClick:a,disabled:v,children:s("action.cancel")}),r.jsx("button",{className:"bm-btn primary",disabled:v||!d,onClick:S,children:v?"…":s("backup.start")})]})]}),m&&r.jsxs(r.Fragment,{children:[r.jsx("p",{className:"bm-ok",children:s("backup.started")}),r.jsx("div",{className:"bm-review",children:r.jsxs("div",{children:[r.jsx("span",{children:s("rmm.done.upid")}),r.jsx("code",{style:{userSelect:"all"},children:m})]})}),r.jsx("div",{className:"bm-actions",children:r.jsx("button",{className:"bm-btn primary",onClick:a,children:s("action.close")})})]})]})]})}const nx={position:"fixed",inset:0,zIndex:300,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"bmFade .18s ease"},ax=`
...
`,wp=e=>{if(!e||!isFinite(e))return"—";const t=["B","KB","MB","GB","TB"];let n=0,a=e;for(;a>=1024&&n<t.length-1;)a/=1024,n++;return`${a.toFixed(a>=100?0:a>=10?1:2)} ${t[n]}`},kp=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}`},jp=(e,t)=>{if(!e)return"—";const n=Math.floor(Date.now()/1e3)-e,a=Math.floor(n/86400);if(a===0)return t==="zh-TW"?"今天":"today";if(a===1)return t==="zh-TW"?"昨天":"yesterday";if(a<30)return t==="zh-TW"?`${a} 天前`:`${a}d ago`;const s=Math.floor(a/30);return t==="zh-TW"?`${s} 個月前`:`${s}mo ago`},Np=e=>{if(!e)return"unknown";const t=(Date.now()/1e3-e)/86400;return t>30?"stale":t>7?"aging":"fresh"};function sx({open:e,onClose:t,clusterId:n,vmid:a,vmName:s}){var k;const{t:o,language:i}=Ce(),[l,c]=p.useState([]),[d,h]=p.useState(!1),[g,u]=p.useState(null);if(p.useEffect(()=>{if(!e)return;let y=!0;return(async()=>{h(!0),u(null);try{const m=await fetch(`/api/clusters/${encodeURIComponent(n)}/vms/${a}/backups`,{credentials:"same-origin"});if(!m.ok){const v=await m.json().catch(()=>({}));throw new Error(v.error||`HTTP ${m.status}`)}const f=await m.json();y&&c(f.backups||[])}catch(m){y&&u(m.message||String(m))}finally{y&&h(!1)}})(),()=>{y=!1}},[e,n,a]),!e)return null;const x=l.reduce((y,m)=>y+(m.size||0),0),b=(k=l[0])==null?void 0:k.ctime;return r.jsx("div",{className:"bh-back",onClick:t,children:r.jsxs("div",{className:"bh-modal",onClick:y=>y.stopPropagation(),children:[r.jsxs("div",{className:"bh-head",children:[r.jsxs("div",{className:"bh-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),r.jsx("span",{children:o("bh.title")}),s&&r.jsxs("span",{className:"bh-target",children:[a," — ",s]})]}),r.jsx("button",{className:"bh-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"bh-stats",children:[r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.count")})," ",l.length]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.total_size")})," ",wp(x)]}),r.jsxs("div",{children:[r.jsx("span",{className:"lbl",children:o("bh.newest")})," ",b?kp(b):"—",b&&r.jsx("span",{className:`bh-age bh-age-${Np(b)}`,children:jp(b,i)})]})]}),r.jsxs("div",{className:"bh-body",children:[g&&r.jsx("div",{className:"bh-error",children:g}),d&&l.length===0&&r.jsx("div",{className:"bh-loading",children:o("bh.loading")}),!d&&l.length===0&&!g&&r.jsxs("div",{className:"bh-empty",children:[r.jsx("svg",{width:"32",height:"32",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M19 6l-2 14a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2L5 6M10 11v6M14 11v6"})}),r.jsx("div",{children:o("bh.empty")})]}),l.length>0&&r.jsxs("table",{className:"bh-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:o("bh.col.ctime")}),r.jsx("th",{children:o("bh.col.age")}),r.jsx("th",{children:o("bh.col.storage")}),r.jsx("th",{children:o("bh.col.node")}),r.jsx("th",{className:"num",children:o("bh.col.size")}),r.jsx("th",{children:o("bh.col.flags")}),r.jsx("th",{children:o("bh.col.notes")})]})}),r.jsx("tbody",{children:l.map(y=>{var m,f;return r.jsxs("tr",{children:[r.jsx("td",{children:kp(y.ctime)}),r.jsx("td",{children:r.jsx("span",{className:`bh-age bh-age-${Np(y.ctime)}`,children:jp(y.ctime,i)})}),r.jsx("td",{children:y.storage||"—"}),r.jsx("td",{children:y.node||"—"}),r.jsx("td",{className:"num",children:wp(y.size)}),r.jsxs("td",{children:[y.protected&&r.jsx("span",{className:"bh-flag protected",children:o("bh.protected")}),((m=y.verification)==null?void 0:m.state)==="ok"&&r.jsx("span",{className:"bh-flag verified",children:o("bh.verified")}),((f=y.verification)==null?void 0:f.state)==="failed"&&r.jsx("span",{className:"bh-flag failed",children:o("bh.verify_failed")})]}),r.jsx("td",{className:"bh-notes",title:y.notes,children:y.notes||""})]},y.volid)})})]})]}),r.jsx("style",{children:`
        ...
        `})]})})}const ox=/^(scsi|virtio|sata|ide)\d+$/,ix=/^net\d+$/,lx=/^(mp|rootfs)\d*$/,cx=e=>{const t=/size=([^,]+)/.exec(e);return t?t[1]:""},_p=e=>{const t={};if(!e)return t;const n=e.split(",");n[0]&&n[0].indexOf("=")<0&&(t._head=n[0],n.shift());for(const a of n){const s=a.indexOf("=");s>0&&(t[a.slice(0,s).trim()]=a.slice(s+1).trim())}return t};function dx({open:e,onClose:t,clusterId:n,node:a,vmid:s,kind:o,title:i}){const{t:l,language:c}=Ce(),[d,h]=p.useState(null),[g,u]=p.useState(!1),[x,b]=p.useState(null);p.useEffect(()=>{if(!e)return;let y=!0;return(async()=>{u(!0),b(null);try{const m=o==="qemu"?"qemu":"lxc",f=await fetch(`/api/clusters/${encodeURIComponent(n)}/nodes/${encodeURIComponent(a)}/${m}/${s}/config`,{credentials:"same-origin"});if(!f.ok){const j=await f.json().catch(()=>({}));throw new Error(j.error||`HTTP ${f.status}`)}const v=await f.json();y&&h(v.config||{})}catch(m){y&&b(m.message||String(m))}finally{y&&u(!1)}})(),()=>{y=!1}},[e,n,a,s,o]);const k=p.useMemo(()=>{if(!d)return null;const y=[],m=[],f=[],v=[],j=[],w=new Set(["name","hostname","cores","sockets","cpu","cpulimit","cpuunits","memory","balloon","shares","ostype","agent","boot","bios","machine","numa","tablet","onboot","protection","startup","arch","description","tags","unprivileged","features","parent","lock","swap","vga"]);for(const[S,C]of Object.entries(d)){const N=String(C);if(!(S.startsWith("digest")||S==="_error")){if(w.has(S)){y.push([S,N]);continue}if(ox.test(S)){const L=_p(N),I=L._head||N.split(",")[0],P=L.size||cx(N),E=Object.entries(L).filter(([G])=>G!=="_head"&&G!=="size");m.push({id:S,bus:S,volid:I,size:P,opts:E.map(([G,A])=>`${G}=${A}`).join(", ")});continue}if(lx.test(S)){f.push([S,N]);continue}if(ix.test(S)){const L=_p(N),I=(L._head||"").split("="),P=I[0]||"",E=I[1]||"";v.push({id:S,model:P||L.model||"",bridge:L.bridge||"",mac:E,vlan:L.tag||"",firewall:L.firewall||""});continue}j.push([S,N])}}return y.sort((S,C)=>S[0].localeCompare(C[0])),j.sort((S,C)=>S[0].localeCompare(C[0])),{general:y,disks:m,mounts:f,nics:v,other:j}},[d]);return e?r.jsx("div",{className:"vc-back",onClick:t,children:r.jsxs("div",{className:"vc-modal",onClick:y=>y.stopPropagation(),children:[r.jsxs("div",{className:"vc-head",children:[r.jsxs("div",{className:"vc-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),r.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}),r.jsx("span",{children:l("vmcfg.title")}),i&&r.jsx("span",{className:"vc-target",children:i})]}),r.jsx("button",{className:"vc-close",onClick:t,children:"×"})]}),r.jsxs("div",{className:"vc-body",children:[g&&!d&&r.jsx("div",{className:"vc-loading",children:l("vmcfg.loading")}),x&&r.jsx("div",{className:"vc-error",children:x}),k&&r.jsxs(r.Fragment,{children:[k.general.length>0&&r.jsx(Ia,{title:l("vmcfg.section.general"),children:r.jsx("div",{className:"vc-kv",children:k.general.map(([y,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:y}),r.jsx("span",{className:"vc-kv-val",children:m})]},y))})}),k.disks.length>0&&r.jsx(Ia,{title:l("vmcfg.section.disks"),children:r.jsxs("table",{className:"vc-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:l("vmcfg.col.bus")}),r.jsx("th",{children:l("vmcfg.col.volid")}),r.jsx("th",{children:l("vmcfg.col.size")}),r.jsx("th",{children:l("vmcfg.col.opts")})]})}),r.jsx("tbody",{children:k.disks.map(y=>r.jsxs("tr",{children:[r.jsx("td",{className:"vc-mono",children:y.bus}),r.jsx("td",{className:"vc-mono",children:y.volid}),r.jsx("td",{className:"vc-mono",children:y.size}),r.jsx("td",{className:"vc-mono vc-trunc",title:y.opts,children:y.opts})]},y.id))})]})}),k.nics.length>0&&r.jsx(Ia,{title:l("vmcfg.section.nics"),children:r.jsxs("table",{className:"vc-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:l("vmcfg.col.id")}),r.jsx("th",{children:l("vmcfg.col.model")}),r.jsx("th",{children:l("vmcfg.col.bridge")}),r.jsx("th",{children:l("vmcfg.col.mac")}),r.jsx("th",{children:l("vmcfg.col.vlan")}),r.jsx("th",{children:l("vmcfg.col.firewall")})]})}),r.jsx("tbody",{children:k.nics.map(y=>r.jsxs("tr",{children:[r.jsx("td",{className:"vc-mono",children:y.id}),r.jsx("td",{className:"vc-mono",children:y.model}),r.jsx("td",{className:"vc-mono",children:y.bridge}),r.jsx("td",{className:"vc-mono",children:y.mac}),r.jsx("td",{className:"vc-mono",children:y.vlan||"—"}),r.jsx("td",{className:"vc-mono",children:y.firewall==="1"?"on":"—"})]},y.id))})]})}),k.mounts.length>0&&r.jsx(Ia,{title:l("vmcfg.section.mounts"),children:r.jsx("div",{className:"vc-kv",children:k.mounts.map(([y,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:y}),r.jsx("span",{className:"vc-kv-val vc-trunc",title:m,children:m})]},y))})}),k.other.length>0&&r.jsx(Ia,{title:l("vmcfg.section.other"),children:r.jsx("div",{className:"vc-kv",children:k.other.map(([y,m])=>r.jsxs("div",{className:"vc-kv-row",children:[r.jsx("span",{className:"vc-kv-key",children:y}),r.jsx("span",{className:"vc-kv-val vc-trunc",title:m,children:m})]},y))})})]})]}),r.jsx("style",{children:`
...
`;var Lx={value:()=>{}};function Nf(){for(var e=0,t=arguments.length,n={},a;e<t;++e){if(!(a=arguments[e]+"")||a in n||/[\s.]/.test(a))throw new Error("illegal type: "+a);n[a]=[]}return new fo(n)}function fo(e){this._=e}function Ax(e,t){return e.trim().split(/^|\s+/).map(function(n){var a="",s=n.indexOf(".");if(s>=0&&(a=n.slice(s+1),n=n.slice(0,s)),n&&!t.hasOwnProperty(n))throw new Error("unknown type: "+n);return{type:n,name:a}})}fo.prototype=Nf.prototype={constructor:fo,on:function(e,t){var n=this._,a=Ax(e+"",n),s,o=-1,i=a.length;if(arguments.length<2){for(;++o<i;)if((s=(e=a[o]).type)&&(s=Ox(n[s],e.name)))return s;return}if(t!=null&&typeof t!="function")throw new Error("invalid callback: "+t);for(;++o<i;)if(s=(e=a[o]).type)n[s]=Mp(n[s],e.name,t);else if(t==null)for(s in n)n[s]=Mp(n[s],e.name,null);return this},copy:function(){var e={},t=this._;for(var n in t)e[n]=t[n].slice();return new fo(e)},call:function(e,t){if((s=arguments.length-2)>0)for(var n=new Array(s),a=0,s,o;a<s;++a)n[a]=arguments[a+2];if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(o=this._[e],a=0,s=o.length;a<s;++a)o[a].value.apply(t,n)},apply:function(e,t,n){if(!this._.hasOwnProperty(e))throw new Error("unknown type: "+e);for(var a=this._[e],s=0,o=a.length;s<o;++s)a[s].value.apply(t,n)}};function Ox(e,t){for(var n=0,a=e.length,s;n<a;++n)if((s=e[n]).name===t)return s.value}function Mp(e,t,n){for(var a=0,s=e.length;a<s;++a)if(e[a].name===t){e[a]=Lx,e=e.slice(0,a).concat(e.slice(a+1));break}return n!=null&&e.push({name:t,value:n}),e}var Xl="http://www.w3.org/1999/xhtml";const zp={svg:"http://www.w3.org/2000/svg",xhtml:Xl,xlink:"http://www.w3.org/1999/xlink",xml:"http://www.w3.org/XML/1998/namespace",xmlns:"http://www.w3.org/2000/xmlns/"};function mi(e){var t=e+="",n=t.indexOf(":");return n>=0&&(t=e.slice(0,n))!=="xmlns"&&(e=e.slice(n+1)),zp.hasOwnProperty(t)?{space:zp[t],local:e}:e}function Fx(e){return function(){var t=this.ownerDocument,n=this.namespaceURI;return n===Xl&&t.documentElement.namespaceURI===Xl?t.createElement(e):t.createElementNS(n,e)}}function Dx(e){return function(){return this.ownerDocument.createElementNS(e.space,e.local)}}function _f(e){var t=mi(e);return(t.local?Dx:Fx)(t)}function Bx(){}function Jc(e){return e==null?Bx:function(){return this.querySelector(e)}}function Wx(e){typeof e!="function"&&(e=Jc(e));for(var t=this._groups,n=t.length,a=new Array(n),s=0;s<n;++s)for(var o=t[s],i=o.length,l=a[s]=new Array(i),c,d,h=0;h<i;++h)(c=o[h])&&(d=e.call(c,c.__data__,h,o))&&("__data__"in c&&(d.__data__=c.__data__),l[h]=d);return new kr(a,this._parents)}function Ux(e){return e==null?[]:Array.isArray(e)?e:Array.from(e)}function Vx(){return[]}function Sf(e){return e==null?Vx:function(){return this.querySelectorAll(e)}}function Hx(e){return function(){return Ux(e.apply(this,arguments))}}function Yx(e){typeof e=="function"?e=Hx(e):e=Sf(e);for(var t=this._groups,n=t.length,a=[],s=[],o=0;o<n;++o)for(var i=t[o],l=i.length,c,d=0;d<l;++d)(c=i[d])&&(a.push(e.call(c,c.__data__,d,i)),s.push(c));return new kr(a,s)}function Cf(e){return function(){return this.matches(e)}}function Mf(e){return function(t){return t.matches(e)}}var Gx=Array.prototype.find;function Kx(e){return function(){return Gx.call(this.children,e)}}function Xx(){return this.firstElementChild}function qx(e){return this.select(e==null?Xx:Kx(typeof e=="function"?e:Mf(e)))}var Qx=Array.prototype.filter;function Jx(){return Array.from(this.children)}function Zx(e){return function(){return Qx.call(this.children,e)}}function ev(e){return this.selectAll(e==null?Jx:Zx(typeof e=="function"?e:Mf(e)))}function tv(e){typeof e!="function"&&(e=Cf(e));for(var t=this._groups,n=t.length,a=new Array(n),s=0;s<n;++s)for(var o=t[s],i=o.length,l=a[s]=[],c,d=0;d<i;++d)(c=o[d])&&e.call(c,c.__data__,d,o)&&l.push(c);return new kr(a,this._parents)}function zf(e){return new Array(e.length)}function rv(){return new kr(this._enter||this._groups.map(zf),this._parents)}function Wo(e,t){this.ownerDocument=e.ownerDocument,this.namespaceURI=e.namespaceURI,this._next=null,this._parent=e,this.__data__=t}Wo.prototype={constructor:Wo,appendChild:function(e){return this._parent.insertBefore(e,this._next)},insertBefore:function(e,t){return this._parent.insertBefore(e,t)},querySelector:function(e){return this._parent.querySelector(e)},querySelectorAll:function(e){return this._parent.querySelectorAll(e)}};function nv(e){return function(){return e}}function av(e,t,n,a,s,o){for(var i=0,l,c=t.length,d=o.length;i<d;++i)(l=t[i])?(l.__data__=o[i],a[i]=l):n[i]=new Wo(e,o[i]);for(;i<c;++i)(l=t[i])&&(s[i]=l)}function sv(e,t,n,a,s,o,i){var l,c,d=new Map,h=t.length,g=o.length,u=new Array(h),x;for(l=0;l<h;++l)(c=t[l])&&(u[l]=x=i.call(c,c.__data__,l,t)+"",d.has(x)?s[l]=c:d.set(x,c));for(l=0;l<g;++l)x=i.call(e,o[l],l,o)+"",(c=d.get(x))?(a[l]=c,c.__data__=o[l],d.delete(x)):n[l]=new Wo(e,o[l]);for(l=0;l<h;++l)(c=t[l])&&d.get(u[l])===c&&(s[l]=c)}function ov(e){return e.__data__}function iv(e,t){if(!arguments.length)return Array.from(this,ov);var n=t?sv:av,a=this._parents,s=this._groups;typeof e!="function"&&(e=nv(e));for(var o=s.length,i=new Array(o),l=new Array(o),c=new Array(o),d=0;d<o;++d){var h=a[d],g=s[d],u=g.length,x=lv(e.call(h,h&&h.__data__,d,a)),b=x.length,k=l[d]=new Array(b),y=i[d]=new Array(b),m=c[d]=new Array(u);n(h,g,k,y,m,x,t);for(var f=0,v=0,j,w;f<b;++f)if(j=k[f]){for(f>=v&&(v=f+1);!(w=y[v])&&++v<b;);j._next=w||null}}return i=new kr(i,a),i._enter=l,i._exit=c,i}function lv(e){return typeof e=="object"&&"length"in e?e:Array.from(e)}function cv(){return new kr(this._exit||this._groups.map(zf),this._parents)}function dv(e,t,n){var a=this.enter(),s=this,o=this.exit();return typeof e=="function"?(a=e(a),a&&(a=a.selection())):a=a.append(e+""),t!=null&&(s=t(s),s&&(s=s.selection())),n==null?o.remove():n(o),a&&s?a.merge(s).order():s}function pv(e){for(var t=e.selection?e.selection():e,n=this._groups,a=t._groups,s=n.length,o=a.length,i=Math.min(s,o),l=new Array(s),c=0;c<i;++c)for(var d=n[c],h=a[c],g=d.length,u=l[c]=new Array(g),x,b=0;b<g;++b)(x=d[b]||h[b])&&(u[b]=x);for(;c<s;++c)l[c]=n[c];return new kr(l,this._parents)}function uv(){for(var e=this._groups,t=-1,n=e.length;++t<n;)for(var a=e[t],s=a.length-1,o=a[s],i;--s>=0;)(i=a[s])&&(o&&i.compareDocumentPosition(o)^4&&o.parentNode.insertBefore(i,o),o=i);return this}function mv(e){e||(e=fv);function t(g,u){return g&&u?e(g.__data__,u.__data__):!g-!u}for(var n=this._groups,a=n.length,s=new Array(a),o=0;o<a;++o){for(var i=n[o],l=i.length,c=s[o]=new Array(l),d,h=0;h<l;++h)(d=i[h])&&(c[h]=d);c.sort(t)}return new kr(s,this._parents).order()}function fv(e,t){return e<t?-1:e>t?1:e>=t?0:NaN}function hv(){var e=arguments[0];return arguments[0]=this,e.apply(null,arguments),this}function gv(){return Array.from(this)}function xv(){for(var e=this._groups,t=0,n=e.length;t<n;++t)for(var a=e[t],s=0,o=a.length;s<o;++s){var i=a[s];if(i)return i}return null}function vv(){let e=0;for(const t of this)++e;return e}function bv(){return!this.node()}function yv(e){for(var t=this._groups,n=0,a=t.length;n<a;++n)for(var s=t[n],o=0,i=s.length,l;o<i;++o)(l=s[o])&&e.call(l,l.__data__,o,s);return this}function wv(e){return function(){this.removeAttribute(e)}}function kv(e){return function(){this.removeAttributeNS(e.space,e.local)}}function jv(e,t){return function(){this.setAttribute(e,t)}}function Nv(e,t){return function(){this.setAttributeNS(e.space,e.local,t)}}function _v(e,t){return function(){var n=t.apply(this,arguments);n==null?this.removeAttribute(e):this.setAttribute(e,n)}}function Sv(e,t){return function(){var n=t.apply(this,arguments);n==null?this.removeAttributeNS(e.space,e.local):this.setAttributeNS(e.space,e.local,n)}}function Cv(e,t){var n=mi(e);if(arguments.length<2){var a=this.node();return n.local?a.getAttributeNS(n.space,n.local):a.getAttribute(n)}return this.each((t==null?n.local?kv:wv:typeof t=="function"?n.local?Sv:_v:n.local?Nv:jv)(n,t))}function $f(e){return e.ownerDocument&&e.ownerDocument.defaultView||e.document&&e||e.defaultView}function Mv(e){return function(){this.style.removeProperty(e)}}function zv(e,t,n){return function(){this.style.setProperty(e,t,n)}}function $v(e,t,n){return function(){var a=t.apply(this,arguments);a==null?this.style.removeProperty(e):this.style.setProperty(e,a,n)}}function Ev(e,t,n){return arguments.length>1?this.each((t==null?Mv:typeof t=="function"?$v:zv)(e,t,n??"")):wa(this.node(),e)}function wa(e,t){return e.style.getPropertyValue(t)||$f(e).getComputedStyle(e,null).getPropertyValue(t)}function Tv(e){return function(){delete this[e]}}function Pv(e,t){return function(){this[e]=t}}function Rv(e,t){return function(){var n=t.apply(this,arguments);n==null?delete this[e]:this[e]=n}}function Iv(e,t){return arguments.length>1?this.each((t==null?Tv:typeof t=="function"?Rv:Pv)(e,t)):this.node()[e]}function Ef(e){return e.trim().split(/^|\s+/)}function Zc(e){return e.classList||new Tf(e)}function Tf(e){this._node=e,this._names=Ef(e.getAttribute("class")||"")}Tf.prototype={add:function(e){var t=this._names.indexOf(e);t<0&&(this._names.push(e),this._node.setAttribute("class",this._names.join(" ")))},remove:function(e){var t=this._names.indexOf(e);t>=0&&(this._names.splice(t,1),this._node.setAttribute("class",this._names.join(" ")))},contains:function(e){return this._names.indexOf(e)>=0}};function Pf(e,t){for(var n=Zc(e),a=-1,s=t.length;++a<s;)n.add(t[a])}function Rf(e,t){for(var n=Zc(e),a=-1,s=t.length;++a<s;)n.remove(t[a])}function Lv(e){return function(){Pf(this,e)}}function Av(e){return function(){Rf(this,e)}}function Ov(e,t){return function(){(t.apply(this,arguments)?Pf:Rf)(this,e)}}function Fv(e,t){var n=Ef(e+"");if(arguments.length<2){for(var a=Zc(this.node()),s=-1,o=n.length;++s<o;)if(!a.contains(n[s]))return!1;return!0}return this.each((typeof t=="function"?Ov:t?Lv:Av)(n,t))}function Dv(){this.textContent=""}function Bv(e){return function(){this.textContent=e}}function Wv(e){return function(){var t=e.apply(this,arguments);this.textContent=t??""}}function Uv(e){return arguments.length?this.each(e==null?Dv:(typeof e=="function"?Wv:Bv)(e)):this.node().textContent}function Vv(){this.innerHTML=""}function Hv(e){return function(){this.innerHTML=e}}function Yv(e){return function(){var t=e.apply(this,arguments);this.innerHTML=t??""}}function Gv(e){return arguments.length?this.each(e==null?Vv:(typeof e=="function"?Yv:Hv)(e)):this.node().innerHTML}function Kv(){this.nextSibling&&this.parentNode.appendChild(this)}function Xv(){return this.each(Kv)}function qv(){this.previousSibling&&this.parentNode.insertBefore(this,this.parentNode.firstChild)}function Qv(){return this.each(qv)}function Jv(e){var t=typeof e=="function"?e:_f(e);return this.select(function(){return this.appendChild(t.apply(this,arguments))})}function Zv(){return null}function eb(e,t){var n=typeof e=="function"?e:_f(e),a=t==null?Zv:typeof t=="function"?t:Jc(t);return this.select(function(){return this.insertBefore(n.apply(this,arguments),a.apply(this,arguments)||null)})}function tb(){var e=this.parentNode;e&&e.removeChild(this)}function rb(){return this.each(tb)}function nb(){var e=this.cloneNode(!1),t=this.parentNode;return t?t.insertBefore(e,this.nextSibling):e}function ab(){var e=this.cloneNode(!0),t=this.parentNode;return t?t.insertBefore(e,this.nextSibling):e}function sb(e){return this.select(e?ab:nb)}function ob(e){return arguments.length?this.property("__data__",e):this.node().__data__}function ib(e){return function(t){e.call(this,t,this.__data__)}}function lb(e){return e.trim().split(/^|\s+/).map(function(t){var n="",a=t.indexOf(".");return a>=0&&(n=t.slice(a+1),t=t.slice(0,a)),{type:t,name:n}})}function cb(e){return function(){var t=this.__on;if(t){for(var n=0,a=-1,s=t.length,o;n<s;++n)o=t[n],(!e.type||o.type===e.type)&&o.name===e.name?this.removeEventListener(o.type,o.listener,o.options):t[++a]=o;++a?t.length=a:delete this.__on}}}function db(e,t,n){return function(){var a=this.__on,s,o=ib(t);if(a){for(var i=0,l=a.length;i<l;++i)if((s=a[i]).type===e.type&&s.name===e.name){this.removeEventListener(s.type,s.listener,s.options),this.addEventListener(s.type,s.listener=o,s.options=n),s.value=t;return}}this.addEventListener(e.type,o,n),s={type:e.type,name:e.name,value:t,listener:o,options:n},a?a.push(s):this.__on=[s]}}function pb(e,t,n){var a=lb(e+""),s,o=a.length,i;if(arguments.length<2){var l=this.node().__on;if(l){for(var c=0,d=l.length,h;c<d;++c)for(s=0,h=l[c];s<o;++s)if((i=a[s]).type===h.type&&i.name===h.name)return h.value}return}for(l=t?db:cb,s=0;s<o;++s)this.each(l(a[s],t,n));return this}function If(e,t,n){var a=$f(e),s=a.CustomEvent;typeof s=="function"?s=new s(t,n):(s=a.document.createEvent("Event"),n?(s.initEvent(t,n.bubbles,n.cancelable),s.detail=n.detail):s.initEvent(t,!1,!1)),e.dispatchEvent(s)}function ub(e,t){return function(){return If(this,e,t)}}function mb(e,t){return function(){return If(this,e,t.apply(this,arguments))}}function fb(e,t){return this.each((typeof t=="function"?mb:ub)(e,t))}function*hb(){for(var e=this._groups,t=0,n=e.length;t<n;++t)for(var a=e[t],s=0,o=a.length,i;s<o;++s)(i=a[s])&&(yield i)}var gb=[null];function kr(e,t){this._groups=e,this._parents=t}function Ms(){return new kr([[document.documentElement]],gb)}function xb(){return this}kr.prototype=Ms.prototype={constructor:kr,select:Wx,selectAll:Yx,selectChild:qx,selectChildren:ev,filter:tv,data:iv,enter:rv,exit:cv,join:dv,merge:pv,selection:xb,order:uv,sort:mv,call:hv,nodes:gv,node:xv,size:vv,empty:bv,each:yv,attr:Cv,style:Ev,property:Iv,classed:Fv,text:Uv,html:Gv,raise:Xv,lower:Qv,append:Jv,insert:eb,remove:rb,clone:sb,datum:ob,on:pb,dispatch:fb,[Symbol.iterator]:hb};function ed(e,t,n){e.prototype=t.prototype=n,n.constructor=e}function Lf(e,t){var n=Object.create(e.prototype);for(var a in t)n[a]=t[a];return n}function zs(){}var bs=.7,Uo=1/bs,ma="\\s*([+-]?\\d+)\\s*",ys="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*",Tr="\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*",vb=/^#([0-9a-f]{3,8})$/,bb=new RegExp(`^rgb\\(${ma},${ma},${ma}\\)$`),yb=new RegExp(`^rgb\\(${Tr},${Tr},${Tr}\\)$`),wb=new RegExp(`^rgba\\(${ma},${ma},${ma},${ys}\\)$`),kb=new RegExp(`^rgba\\(${Tr},${Tr},${Tr},${ys}\\)$`),jb=new RegExp(`^hsl\\(${ys},${Tr},${Tr}\\)$`),Nb=new RegExp(`^hsla\\(${ys},${Tr},${Tr},${ys}\\)$`),$p={aliceblue:15792383,antiquewhite:16444375,aqua:65535,aquamarine:8388564,azure:15794175,beige:16119260,bisque:16770244,black:0,blanchedalmond:16772045,blue:255,blueviolet:9055202,brown:10824234,burlywood:14596231,cadetblue:6266528,chartreuse:8388352,chocolate:13789470,coral:16744272,cornflowerblue:6591981,cornsilk:16775388,crimson:14423100,cyan:65535,darkblue:139,darkcyan:35723,darkgoldenrod:12092939,darkgray:11119017,darkgreen:25600,darkgrey:11119017,darkkhaki:12433259,darkmagenta:9109643,darkolivegreen:5597999,darkorange:16747520,darkorchid:10040012,darkred:9109504,darksalmon:15308410,darkseagreen:9419919,darkslateblue:4734347,darkslategray:3100495,darkslategrey:3100495,darkturquoise:52945,darkviolet:9699539,deeppink:16716947,deepskyblue:49151,dimgray:6908265,dimgrey:6908265,dodgerblue:2003199,firebrick:11674146,floralwhite:16775920,forestgreen:2263842,fuchsia:16711935,gainsboro:14474460,ghostwhite:16316671,gold:16766720,goldenrod:14329120,gray:8421504,green:32768,greenyellow:11403055,grey:8421504,honeydew:15794160,hotpink:16738740,indianred:13458524,indigo:4915330,ivory:16777200,khaki:15787660,lavender:15132410,lavenderblush:16773365,lawngreen:8190976,lemonchiffon:16775885,lightblue:11393254,lightcoral:15761536,lightcyan:14745599,lightgoldenrodyellow:16448210,lightgray:13882323,lightgreen:9498256,lightgrey:13882323,lightpink:16758465,lightsalmon:16752762,lightseagreen:2142890,lightskyblue:8900346,lightslategray:7833753,lightslategrey:7833753,lightsteelblue:11584734,lightyellow:16777184,lime:65280,limegreen:3329330,linen:16445670,magenta:16711935,maroon:8388608,mediumaquamarine:6737322,mediumblue:205,mediumorchid:12211667,mediumpurple:9662683,mediumseagreen:3978097,mediumslateblue:8087790,mediumspringgreen:64154,mediumturquoise:4772300,mediumvioletred:13047173,midnightblue:1644912,mintcream:16121850,mistyrose:16770273,moccasin:16770229,navajowhite:16768685,navy:128,oldlace:16643558,olive:8421376,olivedrab:7048739,orange:16753920,orangered:16729344,orchid:14315734,palegoldenrod:15657130,palegreen:10025880,paleturquoise:11529966,palevioletred:14381203,papayawhip:16773077,peachpuff:16767673,peru:13468991,pink:16761035,plum:14524637,powderblue:11591910,purple:8388736,rebeccapurple:6697881,red:16711680,rosybrown:12357519,royalblue:4286945,saddlebrown:9127187,salmon:16416882,sandybrown:16032864,seagreen:3050327,seashell:16774638,sienna:10506797,silver:12632256,skyblue:8900331,slateblue:6970061,slategray:7372944,slategrey:7372944,snow:16775930,springgreen:65407,steelblue:4620980,tan:13808780,teal:32896,thistle:14204888,tomato:16737095,turquoise:4251856,violet:15631086,wheat:16113331,white:16777215,whitesmoke:16119285,yellow:16776960,yellowgreen:10145074};ed(zs,ws,{copy(e){return Object.assign(new this.constructor,this,e)},displayable(){return this.rgb().displayable()},hex:Ep,formatHex:Ep,formatHex8:_b,formatHsl:Sb,formatRgb:Tp,toString:Tp});function Ep(){return this.rgb().formatHex()}function _b(){return this.rgb().formatHex8()}function Sb(){return Af(this).formatHsl()}function Tp(){return this.rgb().formatRgb()}function ws(e){var t,n;return e=(e+"").trim().toLowerCase(),(t=vb.exec(e))?(n=t[1].length,t=parseInt(t[1],16),n===6?Pp(t):n===3?new Ht(t>>8&15|t>>4&240,t>>4&15|t&240,(t&15)<<4|t&15,1):n===8?Js(t>>24&255,t>>16&255,t>>8&255,(t&255)/255):n===4?Js(t>>12&15|t>>8&240,t>>8&15|t>>4&240,t>>4&15|t&240,((t&15)<<4|t&15)/255):null):(t=bb.exec(e))?new Ht(t[1],t[2],t[3],1):(t=yb.exec(e))?new Ht(t[1]*255/100,t[2]*255/100,t[3]*255/100,1):(t=wb.exec(e))?Js(t[1],t[2],t[3],t[4]):(t=kb.exec(e))?Js(t[1]*255/100,t[2]*255/100,t[3]*255/100,t[4]):(t=jb.exec(e))?Lp(t[1],t[2]/100,t[3]/100,1):(t=Nb.exec(e))?Lp(t[1],t[2]/100,t[3]/100,t[4]):$p.hasOwnProperty(e)?Pp($p[e]):e==="transparent"?new Ht(NaN,NaN,NaN,0):null}function Pp(e){return new Ht(e>>16&255,e>>8&255,e&255,1)}function Js(e,t,n,a){return a<=0&&(e=t=n=NaN),new Ht(e,t,n,a)}function Cb(e){return e instanceof zs||(e=ws(e)),e?(e=e.rgb(),new Ht(e.r,e.g,e.b,e.opacity)):new Ht}function ql(e,t,n,a){return arguments.length===1?Cb(e):new Ht(e,t,n,a??1)}function Ht(e,t,n,a){this.r=+e,this.g=+t,this.b=+n,this.opacity=+a}ed(Ht,ql,Lf(zs,{brighter(e){return e=e==null?Uo:Math.pow(Uo,e),new Ht(this.r*e,this.g*e,this.b*e,this.opacity)},darker(e){return e=e==null?bs:Math.pow(bs,e),new Ht(this.r*e,this.g*e,this.b*e,this.opacity)},rgb(){return this},clamp(){return new Ht(In(this.r),In(this.g),In(this.b),Vo(this.opacity))},displayable(){return-.5<=this.r&&this.r<255.5&&-.5<=this.g&&this.g<255.5&&-.5<=this.b&&this.b<255.5&&0<=this.opacity&&this.opacity<=1},hex:Rp,formatHex:Rp,formatHex8:Mb,formatRgb:Ip,toString:Ip}));function Rp(){return`#${Tn(this.r)}${Tn(this.g)}${Tn(this.b)}`}function Mb(){return`#${Tn(this.r)}${Tn(this.g)}${Tn(this.b)}${Tn((isNaN(this.opacity)?1:this.opacity)*255)}`}function Ip(){const e=Vo(this.opacity);return`${e===1?"rgb(":"rgba("}${In(this.r)}, ${In(this.g)}, ${In(this.b)}${e===1?")":`, ${e})`}`}function Vo(e){return isNaN(e)?1:Math.max(0,Math.min(1,e))}function In(e){return Math.max(0,Math.min(255,Math.round(e)||0))}function Tn(e){return e=In(e),(e<16?"0":"")+e.toString(16)}function Lp(e,t,n,a){return a<=0?e=t=n=NaN:n<=0||n>=1?e=t=NaN:t<=0&&(e=NaN),new vr(e,t,n,a)}function Af(e){if(e instanceof vr)return new vr(e.h,e.s,e.l,e.opacity);if(e instanceof zs||(e=ws(e)),!e)return new vr;if(e instanceof vr)return e;e=e.rgb();var t=e.r/255,n=e.g/255,a=e.b/255,s=Math.min(t,n,a),o=Math.max(t,n,a),i=NaN,l=o-s,c=(o+s)/2;return l?(t===o?i=(n-a)/l+(n<a)*6:n===o?i=(a-t)/l+2:i=(t-n)/l+4,l/=c<.5?o+s:2-o-s,i*=60):l=c>0&&c<1?0:i,new vr(i,l,c,e.opacity)}function zb(e,t,n,a){return arguments.length===1?Af(e):new vr(e,t,n,a??1)}function vr(e,t,n,a){this.h=+e,this.s=+t,this.l=+n,this.opacity=+a}ed(vr,zb,Lf(zs,{brighter(e){return e=e==null?Uo:Math.pow(Uo,e),new vr(this.h,this.s,this.l*e,this.opacity)},darker(e){return e=e==null?bs:Math.pow(bs,e),new vr(this.h,this.s,this.l*e,this.opacity)},rgb(){var e=this.h%360+(this.h<0)*360,t=isNaN(e)||isNaN(this.s)?0:this.s,n=this.l,a=n+(n<.5?n:1-n)*t,s=2*n-a;return new Ht(Xi(e>=240?e-240:e+120,s,a),Xi(e,s,a),Xi(e<120?e+240:e-120,s,a),this.opacity)},clamp(){return new vr(Ap(this.h),Zs(this.s),Zs(this.l),Vo(this.opacity))},displayable(){return(0<=this.s&&this.s<=1||isNaN(this.s))&&0<=this.l&&this.l<=1&&0<=this.opacity&&this.opacity<=1},formatHsl(){const e=Vo(this.opacity);return`${e===1?"hsl(":"hsla("}${Ap(this.h)}, ${Zs(this.s)*100}%, ${Zs(this.l)*100}%${e===1?")":`, ${e})`}`}}));function Ap(e){return e=(e||0)%360,e<0?e+360:e}function Zs(e){return Math.max(0,Math.min(1,e||0))}function Xi(e,t,n){return(e<60?t+(n-t)*e/60:e<180?n:e<240?t+(n-t)*(240-e)/60:t)*255}const Of=e=>()=>e;function $b(e,t){return function(n){return e+n*t}}function Eb(e,t,n){return e=Math.pow(e,n),t=Math.pow(t,n)-e,n=1/n,function(a){return Math.pow(e+a*t,n)}}function Tb(e){return(e=+e)==1?Ff:function(t,n){return n-t?Eb(t,n,e):Of(isNaN(t)?n:t)}}function Ff(e,t){var n=t-e;return n?$b(e,n):Of(isNaN(e)?t:e)}const Op=function e(t){var n=Tb(t);function a(s,o){var i=n((s=ql(s)).r,(o=ql(o)).r),l=n(s.g,o.g),c=n(s.b,o.b),d=Ff(s.opacity,o.opacity);return function(h){return s.r=i(h),s.g=l(h),s.b=c(h),s.opacity=d(h),s+""}}return a.gamma=e,a}(1);function rn(e,t){return e=+e,t=+t,function(n){return e*(1-n)+t*n}}var Ql=/[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g,qi=new RegExp(Ql.source,"g");function Pb(e){return function(){return e}}function Rb(e){return function(t){return e(t)+""}}function Ib(e,t){var n=Ql.lastIndex=qi.lastIndex=0,a,s,o,i=-1,l=[],c=[];for(e=e+"",t=t+"";(a=Ql.exec(e))&&(s=qi.exec(t));)(o=s.index)>n&&(o=t.slice(n,o),l[i]?l[i]+=o:l[++i]=o),(a=a[0])===(s=s[0])?l[i]?l[i]+=s:l[++i]=s:(l[++i]=null,c.push({i,x:rn(a,s)})),n=qi.lastIndex;return n<t.length&&(o=t.slice(n),l[i]?l[i]+=o:l[++i]=o),l.length<2?c[0]?Rb(c[0].x):Pb(t):(t=c.length,function(d){for(var h=0,g;h<t;++h)l[(g=c[h]).i]=g.x(d);return l.join("")})}var Fp=180/Math.PI,Jl={translateX:0,translateY:0,rotate:0,skewX:0,scaleX:1,scaleY:1};function Df(e,t,n,a,s,o){var i,l,c;return(i=Math.sqrt(e*e+t*t))&&(e/=i,t/=i),(c=e*n+t*a)&&(n-=e*c,a-=t*c),(l=Math.sqrt(n*n+a*a))&&(n/=l,a/=l,c/=l),e*a<t*n&&(e=-e,t=-t,c=-c,i=-i),{translateX:s,translateY:o,rotate:Math.atan2(t,e)*Fp,skewX:Math.atan(c)*Fp,scaleX:i,scaleY:l}}var eo;function Lb(e){const t=new(typeof DOMMatrix=="function"?DOMMatrix:WebKitCSSMatrix)(e+"");return t.isIdentity?Jl:Df(t.a,t.b,t.c,t.d,t.e,t.f)}function Ab(e){return e==null||(eo||(eo=document.createElementNS("http://www.w3.org/2000/svg","g")),eo.setAttribute("transform",e),!(e=eo.transform.baseVal.consolidate()))?Jl:(e=e.matrix,Df(e.a,e.b,e.c,e.d,e.e,e.f))}function Bf(e,t,n,a){function s(d){return d.length?d.pop()+" ":""}function o(d,h,g,u,x,b){if(d!==g||h!==u){var k=x.push("translate(",null,t,null,n);b.push({i:k-4,x:rn(d,g)},{i:k-2,x:rn(h,u)})}else(g||u)&&x.push("translate("+g+t+u+n)}function i(d,h,g,u){d!==h?(d-h>180?h+=360:h-d>180&&(d+=360),u.push({i:g.push(s(g)+"rotate(",null,a)-2,x:rn(d,h)})):h&&g.push(s(g)+"rotate("+h+a)}function l(d,h,g,u){d!==h?u.push({i:g.push(s(g)+"skewX(",null,a)-2,x:rn(d,h)}):h&&g.push(s(g)+"skewX("+h+a)}function c(d,h,g,u,x,b){if(d!==g||h!==u){var k=x.push(s(x)+"scale(",null,",",null,")");b.push({i:k-4,x:rn(d,g)},{i:k-2,x:rn(h,u)})}else(g!==1||u!==1)&&x.push(s(x)+"scale("+g+","+u+")")}return function(d,h){var g=[],u=[];return d=e(d),h=e(h),o(d.translateX,d.translateY,h.translateX,h.translateY,g,u),i(d.rotate,h.rotate,g,u),l(d.skewX,h.skewX,g,u),c(d.scaleX,d.scaleY,h.scaleX,h.scaleY,g,u),d=h=null,function(x){for(var b=-1,k=u.length,y;++b<k;)g[(y=u[b]).i]=y.x(x);return g.join("")}}}var Ob=Bf(Lb,"px, ","px)","deg)"),Fb=Bf(Ab,", ",")",")"),ka=0,Va=0,La=0,Wf=1e3,Ho,Ha,Yo=0,Bn=0,fi=0,ks=typeof performance=="object"&&performance.now?performance:Date,Uf=typeof window=="object"&&window.requestAnimationFrame?window.requestAnimationFrame.bind(window):function(e){setTimeout(e,17)};function td(){return Bn||(Uf(Db),Bn=ks.now()+fi)}function Db(){Bn=0}function Go(){this._call=this._time=this._next=null}Go.prototype=Vf.prototype={constructor:Go,restart:function(e,t,n){if(typeof e!="function")throw new TypeError("callback is not a function");n=(n==null?td():+n)+(t==null?0:+t),!this._next&&Ha!==this&&(Ha?Ha._next=this:Ho=this,Ha=this),this._call=e,this._time=n,Zl()},stop:function(){this._call&&(this._call=null,this._time=1/0,Zl())}};function Vf(e,t,n){var a=new Go;return a.restart(e,t,n),a}function Bb(){td(),++ka;for(var e=Ho,t;e;)(t=Bn-e._time)>=0&&e._call.call(void 0,t),e=e._next;--ka}function Dp(){Bn=(Yo=ks.now())+fi,ka=Va=0;try{Bb()}finally{ka=0,Ub(),Bn=0}}function Wb(){var e=ks.now(),t=e-Yo;t>Wf&&(fi-=t,Yo=e)}function Ub(){for(var e,t=Ho,n,a=1/0;t;)t._call?(a>t._time&&(a=t._time),e=t,t=t._next):(n=t._next,t._next=null,t=e?e._next=n:Ho=n);Ha=e,Zl(a)}function Zl(e){if(!ka){Va&&(Va=clearTimeout(Va));var t=e-Bn;t>24?(e<1/0&&(Va=setTimeout(Dp,e-ks.now()-fi)),La&&(La=clearInterval(La))):(La||(Yo=ks.now(),La=setInterval(Wb,Wf)),ka=1,Uf(Dp))}}function Bp(e,t,n){var a=new Go;return t=t==null?0:+t,a.restart(s=>{a.stop(),e(s+t)},t,n),a}var Vb=Nf("start","end","cancel","interrupt"),Hb=[],Hf=0,Wp=1,ec=2,ho=3,Up=4,tc=5,go=6;function hi(e,t,n,a,s,o){var i=e.__transition;if(!i)e.__transition={};else if(n in i)return;Yb(e,n,{name:t,index:a,group:s,on:Vb,tween:Hb,time:o.time,delay:o.delay,duration:o.duration,ease:o.ease,timer:null,state:Hf})}function rd(e,t){var n=jr(e,t);if(n.state>Hf)throw new Error("too late; already scheduled");return n}function Rr(e,t){var n=jr(e,t);if(n.state>ho)throw new Error("too late; already running");return n}function jr(e,t){var n=e.__transition;if(!n||!(n=n[t]))throw new Error("transition not found");return n}function Yb(e,t,n){var a=e.__transition,s;a[t]=n,n.timer=Vf(o,0,n.time);function o(d){n.state=Wp,n.timer.restart(i,n.delay,n.time),n.delay<=d&&i(d-n.delay)}function i(d){var h,g,u,x;if(n.state!==Wp)return c();for(h in a)if(x=a[h],x.name===n.name){if(x.state===ho)return Bp(i);x.state===Up?(x.state=go,x.timer.stop(),x.on.call("interrupt",e,e.__data__,x.index,x.group),delete a[h]):+h<t&&(x.state=go,x.timer.stop(),x.on.call("cancel",e,e.__data__,x.index,x.group),delete a[h])}if(Bp(function(){n.state===ho&&(n.state=Up,n.timer.restart(l,n.delay,n.time),l(d))}),n.state=ec,n.on.call("start",e,e.__data__,n.index,n.group),n.state===ec){for(n.state=ho,s=new Array(u=n.tween.length),h=0,g=-1;h<u;++h)(x=n.tween[h].value.call(e,e.__data__,n.index,n.group))&&(s[++g]=x);s.length=g+1}}function l(d){for(var h=d<n.duration?n.ease.call(null,d/n.duration):(n.timer.restart(c),n.state=tc,1),g=-1,u=s.length;++g<u;)s[g].call(e,h);n.state===tc&&(n.on.call("end",e,e.__data__,n.index,n.group),c())}function c(){n.state=go,n.timer.stop(),delete a[t];for(var d in a)return;delete e.__transition}}function Gb(e,t){var n=e.__transition,a,s,o=!0,i;if(n){t=t==null?null:t+"";for(i in n){if((a=n[i]).name!==t){o=!1;continue}s=a.state>ec&&a.state<tc,a.state=go,a.timer.stop(),a.on.call(s?"interrupt":"cancel",e,e.__data__,a.index,a.group),delete n[i]}o&&delete e.__transition}}function Kb(e){return this.each(function(){Gb(this,e)})}function Xb(e,t){var n,a;return function(){var s=Rr(this,e),o=s.tween;if(o!==n){a=n=o;for(var i=0,l=a.length;i<l;++i)if(a[i].name===t){a=a.slice(),a.splice(i,1);break}}s.tween=a}}function qb(e,t,n){var a,s;if(typeof n!="function")throw new Error;return function(){var o=Rr(this,e),i=o.tween;if(i!==a){s=(a=i).slice();for(var l={name:t,value:n},c=0,d=s.length;c<d;++c)if(s[c].name===t){s[c]=l;break}c===d&&s.push(l)}o.tween=s}}function Qb(e,t){var n=this._id;if(e+="",arguments.length<2){for(var a=jr(this.node(),n).tween,s=0,o=a.length,i;s<o;++s)if((i=a[s]).name===e)return i.value;return null}return this.each((t==null?Xb:qb)(n,e,t))}function nd(e,t,n){var a=e._id;return e.each(function(){var s=Rr(this,a);(s.value||(s.value={}))[t]=n.apply(this,arguments)}),function(s){return jr(s,a).value[t]}}function Yf(e,t){var n;return(typeof t=="number"?rn:t instanceof ws?Op:(n=ws(t))?(t=n,Op):Ib)(e,t)}function Jb(e){return function(){this.removeAttribute(e)}}function Zb(e){return function(){this.removeAttributeNS(e.space,e.local)}}function e1(e,t,n){var a,s=n+"",o;return function(){var i=this.getAttribute(e);return i===s?null:i===a?o:o=t(a=i,n)}}function t1(e,t,n){var a,s=n+"",o;return function(){var i=this.getAttributeNS(e.space,e.local);return i===s?null:i===a?o:o=t(a=i,n)}}function r1(e,t,n){var a,s,o;return function(){var i,l=n(this),c;return l==null?void this.removeAttribute(e):(i=this.getAttribute(e),c=l+"",i===c?null:i===a&&c===s?o:(s=c,o=t(a=i,l)))}}function n1(e,t,n){var a,s,o;return function(){var i,l=n(this),c;return l==null?void this.removeAttributeNS(e.space,e.local):(i=this.getAttributeNS(e.space,e.local),c=l+"",i===c?null:i===a&&c===s?o:(s=c,o=t(a=i,l)))}}function a1(e,t){var n=mi(e),a=n==="transform"?Fb:Yf;return this.attrTween(e,typeof t=="function"?(n.local?n1:r1)(n,a,nd(this,"attr."+e,t)):t==null?(n.local?Zb:Jb)(n):(n.local?t1:e1)(n,a,t))}function s1(e,t){return function(n){this.setAttribute(e,t.call(this,n))}}function o1(e,t){return function(n){this.setAttributeNS(e.space,e.local,t.call(this,n))}}function i1(e,t){var n,a;function s(){var o=t.apply(this,arguments);return o!==a&&(n=(a=o)&&o1(e,o)),n}return s._value=t,s}function l1(e,t){var n,a;function s(){var o=t.apply(this,arguments);return o!==a&&(n=(a=o)&&s1(e,o)),n}return s._value=t,s}function c1(e,t){var n="attr."+e;if(arguments.length<2)return(n=this.tween(n))&&n._value;if(t==null)return this.tween(n,null);if(typeof t!="function")throw new Error;var a=mi(e);return this.tween(n,(a.local?i1:l1)(a,t))}function d1(e,t){return function(){rd(this,e).delay=+t.apply(this,arguments)}}function p1(e,t){return t=+t,function(){rd(this,e).delay=t}}function u1(e){var t=this._id;return arguments.length?this.each((typeof e=="function"?d1:p1)(t,e)):jr(this.node(),t).delay}function m1(e,t){return function(){Rr(this,e).duration=+t.apply(this,arguments)}}function f1(e,t){return t=+t,function(){Rr(this,e).duration=t}}function h1(e){var t=this._id;return arguments.length?this.each((typeof e=="function"?m1:f1)(t,e)):jr(this.node(),t).duration}function g1(e,t){if(typeof t!="function")throw new Error;return function(){Rr(this,e).ease=t}}function x1(e){var t=this._id;return arguments.length?this.each(g1(t,e)):jr(this.node(),t).ease}function v1(e,t){return function(){var n=t.apply(this,arguments);if(typeof n!="function")throw new Error;Rr(this,e).ease=n}}function b1(e){if(typeof e!="function")throw new Error;return this.each(v1(this._id,e))}function y1(e){typeof e!="function"&&(e=Cf(e));for(var t=this._groups,n=t.length,a=new Array(n),s=0;s<n;++s)for(var o=t[s],i=o.length,l=a[s]=[],c,d=0;d<i;++d)(c=o[d])&&e.call(c,c.__data__,d,o)&&l.push(c);return new Gr(a,this._parents,this._name,this._id)}function w1(e){if(e._id!==this._id)throw new Error;for(var t=this._groups,n=e._groups,a=t.length,s=n.length,o=Math.min(a,s),i=new Array(a),l=0;l<o;++l)for(var c=t[l],d=n[l],h=c.length,g=i[l]=new Array(h),u,x=0;x<h;++x)(u=c[x]||d[x])&&(g[x]=u);for(;l<a;++l)i[l]=t[l];return new Gr(i,this._parents,this._name,this._id)}function k1(e){return(e+"").trim().split(/^|\s+/).every(function(t){var n=t.indexOf(".");return n>=0&&(t=t.slice(0,n)),!t||t==="start"})}function j1(e,t,n){var a,s,o=k1(t)?rd:Rr;return function(){var i=o(this,e),l=i.on;l!==a&&(s=(a=l).copy()).on(t,n),i.on=s}}function N1(e,t){var n=this._id;return arguments.length<2?jr(this.node(),n).on.on(e):this.each(j1(n,e,t))}function _1(e){return function(){var t=this.parentNode;for(var n in this.__transition)if(+n!==e)return;t&&t.removeChild(this)}}function S1(){return this.on("end.remove",_1(this._id))}function C1(e){var t=this._name,n=this._id;typeof e!="function"&&(e=Jc(e));for(var a=this._groups,s=a.length,o=new Array(s),i=0;i<s;++i)for(var l=a[i],c=l.length,d=o[i]=new Array(c),h,g,u=0;u<c;++u)(h=l[u])&&(g=e.call(h,h.__data__,u,l))&&("__data__"in h&&(g.__data__=h.__data__),d[u]=g,hi(d[u],t,n,u,d,jr(h,n)));return new Gr(o,this._parents,t,n)}function M1(e){var t=this._name,n=this._id;typeof e!="function"&&(e=Sf(e));for(var a=this._groups,s=a.length,o=[],i=[],l=0;l<s;++l)for(var c=a[l],d=c.length,h,g=0;g<d;++g)if(h=c[g]){for(var u=e.call(h,h.__data__,g,c),x,b=jr(h,n),k=0,y=u.length;k<y;++k)(x=u[k])&&hi(x,t,n,k,u,b);o.push(u),i.push(h)}return new Gr(o,i,t,n)}var z1=Ms.prototype.constructor;function $1(){return new z1(this._groups,this._parents)}function E1(e,t){var n,a,s;return function(){var o=wa(this,e),i=(this.style.removeProperty(e),wa(this,e));return o===i?null:o===n&&i===a?s:s=t(n=o,a=i)}}function Gf(e){return function(){this.style.removeProperty(e)}}function T1(e,t,n){var a,s=n+"",o;return function(){var i=wa(this,e);return i===s?null:i===a?o:o=t(a=i,n)}}function P1(e,t,n){var a,s,o;return function(){var i=wa(this,e),l=n(this),c=l+"";return l==null&&(c=l=(this.style.removeProperty(e),wa(this,e))),i===c?null:i===a&&c===s?o:(s=c,o=t(a=i,l))}}function R1(e,t){var n,a,s,o="style."+t,i="end."+o,l;return function(){var c=Rr(this,e),d=c.on,h=c.value[o]==null?l||(l=Gf(t)):void 0;(d!==n||s!==h)&&(a=(n=d).copy()).on(i,s=h),c.on=a}}function I1(e,t,n){var a=(e+="")=="transform"?Ob:Yf;return t==null?this.styleTween(e,E1(e,a)).on("end.style."+e,Gf(e)):typeof t=="function"?this.styleTween(e,P1(e,a,nd(this,"style."+e,t))).each(R1(this._id,e)):this.styleTween(e,T1(e,a,t),n).on("end.style."+e,null)}function L1(e,t,n){return function(a){this.style.setProperty(e,t.call(this,a),n)}}function A1(e,t,n){var a,s;function o(){var i=t.apply(this,arguments);return i!==s&&(a=(s=i)&&L1(e,i,n)),a}return o._value=t,o}function O1(e,t,n){var a="style."+(e+="");if(arguments.length<2)return(a=this.tween(a))&&a._value;if(t==null)return this.tween(a,null);if(typeof t!="function")throw new Error;return this.tween(a,A1(e,t,n??""))}function F1(e){return function(){this.textContent=e}}function D1(e){return function(){var t=e(this);this.textContent=t??""}}function B1(e){return this.tween("text",typeof e=="function"?D1(nd(this,"text",e)):F1(e==null?"":e+""))}function W1(e){return function(t){this.textContent=e.call(this,t)}}function U1(e){var t,n;function a(){var s=e.apply(this,arguments);return s!==n&&(t=(n=s)&&W1(s)),t}return a._value=e,a}function V1(e){var t="text";if(arguments.length<1)return(t=this.tween(t))&&t._value;if(e==null)return this.tween(t,null);if(typeof e!="function")throw new Error;return this.tween(t,U1(e))}function H1(){for(var e=this._name,t=this._id,n=Kf(),a=this._groups,s=a.length,o=0;o<s;++o)for(var i=a[o],l=i.length,c,d=0;d<l;++d)if(c=i[d]){var h=jr(c,t);hi(c,e,n,d,i,{time:h.time+h.delay+h.duration,delay:0,duration:h.duration,ease:h.ease})}return new Gr(a,this._parents,e,n)}function Y1(){var e,t,n=this,a=n._id,s=n.size();return new Promise(function(o,i){var l={value:i},c={value:function(){--s===0&&o()}};n.each(function(){var d=Rr(this,a),h=d.on;h!==e&&(t=(e=h).copy(),t._.cancel.push(l),t._.interrupt.push(l),t._.end.push(c)),d.on=t}),s===0&&o()})}var G1=0;function Gr(e,t,n,a){this._groups=e,this._parents=t,this._name=n,this._id=a}function Kf(){return++G1}var Ar=Ms.prototype;Gr.prototype={constructor:Gr,select:C1,selectAll:M1,selectChild:Ar.selectChild,selectChildren:Ar.selectChildren,filter:y1,merge:w1,selection:$1,transition:H1,call:Ar.call,nodes:Ar.nodes,node:Ar.node,size:Ar.size,empty:Ar.empty,each:Ar.each,on:N1,attr:a1,attrTween:c1,style:I1,styleTween:O1,text:B1,textTween:V1,remove:S1,tween:Qb,delay:u1,duration:h1,ease:x1,easeVarying:b1,end:Y1,[Symbol.iterator]:Ar[Symbol.iterator]};function K1(e){return((e*=2)<=1?e*e*e:(e-=2)*e*e+2)/2}var X1={time:null,delay:0,duration:250,ease:K1};function q1(e,t){for(var n;!(n=e.__transition)||!(n=n[t]);)if(!(e=e.parentNode))throw new Error(`transition ${t} not found`);return n}function Q1(e){var t,n;e instanceof Gr?(t=e._id,e=e._name):(t=Kf(),(n=X1).time=td(),e=e==null?null:e+"");for(var a=this._groups,s=a.length,o=0;o<s;++o)for(var i=a[o],l=i.length,c,d=0;d<l;++d)(c=i[d])&&hi(c,e,t,d,i,n||q1(c,t));return new Gr(a,this._parents,e,t)}Ms.prototype.interrupt=Kb;Ms.prototype.transition=Q1;function J1(e){var t=0,n=e.children,a=n&&n.length;if(!a)t=1;else for(;--a>=0;)t+=n[a].value;e.value=t}function Z1(){return this.eachAfter(J1)}function ey(e,t){let n=-1;for(const a of this)e.call(t,a,++n,this);return this}function ty(e,t){for(var n=this,a=[n],s,o,i=-1;n=a.pop();)if(e.call(t,n,++i,this),s=n.children)for(o=s.length-1;o>=0;--o)a.push(s[o]);return this}function ry(e,t){for(var n=this,a=[n],s=[],o,i,l,c=-1;n=a.pop();)if(s.push(n),o=n.children)for(i=0,l=o.length;i<l;++i)a.push(o[i]);for(;n=s.pop();)e.call(t,n,++c,this);return this}function ny(e,t){let n=-1;for(const a of this)if(e.call(t,a,++n,this))return a}function ay(e){return this.eachAfter(function(t){for(var n=+e(t.data)||0,a=t.children,s=a&&a.length;--s>=0;)n+=a[s].value;t.value=n})}function sy(e){return this.eachBefore(function(t){t.children&&t.children.sort(e)})}function oy(e){for(var t=this,n=iy(t,e),a=[t];t!==n;)t=t.parent,a.push(t);for(var s=a.length;e!==n;)a.splice(s,0,e),e=e.parent;return a}function iy(e,t){if(e===t)return e;var n=e.ancestors(),a=t.ancestors(),s=null;for(e=n.pop(),t=a.pop();e===t;)s=e,e=n.pop(),t=a.pop();return s}function ly(){for(var e=this,t=[e];e=e.parent;)t.push(e);return t}function cy(){return Array.from(this)}function dy(){var e=[];return this.eachBefore(function(t){t.children||e.push(t)}),e}function py(){var e=this,t=[];return e.each(function(n){n!==e&&t.push({source:n.parent,target:n})}),t}function*uy(){var e=this,t,n=[e],a,s,o;do for(t=n.reverse(),n=[];e=t.pop();)if(yield e,a=e.children)for(s=0,o=a.length;s<o;++s)n.push(a[s]);while(n.length)}function ad(e,t){e instanceof Map?(e=[void 0,e],t===void 0&&(t=hy)):t===void 0&&(t=fy);for(var n=new Ko(e),a,s=[n],o,i,l,c;a=s.pop();)if((i=t(a.data))&&(c=(i=Array.from(i)).length))for(a.children=i,l=c-1;l>=0;--l)s.push(o=i[l]=new Ko(i[l])),o.parent=a,o.depth=a.depth+1;return n.eachBefore(xy)}function my(){return ad(this).eachBefore(gy)}function fy(e){return e.children}function hy(e){return Array.isArray(e)?e[1]:null}function gy(e){e.data.value!==void 0&&(e.value=e.data.value),e.data=e.data.data}function xy(e){var t=0;do e.height=t;while((e=e.parent)&&e.height<++t)}function Ko(e){this.data=e,this.depth=this.height=0,this.parent=null}Ko.prototype=ad.prototype={constructor:Ko,count:Z1,each:ey,eachAfter:ry,eachBefore:ty,find:ny,sum:ay,sort:sy,path:oy,ancestors:ly,descendants:cy,leaves:dy,links:py,copy:my,[Symbol.iterator]:uy};function vy(e){if(typeof e!="function")throw new Error;return e}function Aa(){return 0}function Oa(e){return function(){return e}}function by(e){e.x0=Math.round(e.x0),e.y0=Math.round(e.y0),e.x1=Math.round(e.x1),e.y1=Math.round(e.y1)}function yy(e,t,n,a,s){for(var o=e.children,i,l=-1,c=o.length,d=e.value&&(a-t)/e.value;++l<c;)i=o[l],i.y0=n,i.y1=s,i.x0=t,i.x1=t+=i.value*d}function wy(e,t,n,a,s){for(var o=e.children,i,l=-1,c=o.length,d=e.value&&(s-n)/e.value;++l<c;)i=o[l],i.x0=t,i.x1=a,i.y0=n,i.y1=n+=i.value*d}var ky=(1+Math.sqrt(5))/2;function jy(e,t,n,a,s,o){for(var i=[],l=t.children,c,d,h=0,g=0,u=l.length,x,b,k=t.value,y,m,f,v,j,w,S;h<u;){x=s-n,b=o-a;do y=l[g++].value;while(!y&&g<u);for(m=f=y,w=Math.max(b/x,x/b)/(k*e),S=y*y*w,j=Math.max(f/S,S/m);g<u;++g){if(y+=d=l[g].value,d<m&&(m=d),d>f&&(f=d),S=y*y*w,v=Math.max(f/S,S/m),v>j){y-=d;break}j=v}i.push(c={value:y,dice:x<b,children:l.slice(h,g)}),c.dice?yy(c,n,a,s,k?a+=b*y/k:o):wy(c,n,a,k?n+=x*y/k:s,o),k-=y,h=g}return i}const Xf=function e(t){function n(a,s,o,i,l){jy(t,a,s,o,i,l)}return n.ratio=function(a){return e((a=+a)>1?a:1)},n}(ky);function Ny(){var e=Xf,t=!1,n=1,a=1,s=[0],o=Aa,i=Aa,l=Aa,c=Aa,d=Aa;function h(u){return u.x0=u.y0=0,u.x1=n,u.y1=a,u.eachBefore(g),s=[0],t&&u.eachBefore(by),u}function g(u){var x=s[u.depth],b=u.x0+x,k=u.y0+x,y=u.x1-x,m=u.y1-x;y<b&&(b=y=(b+y)/2),m<k&&(k=m=(k+m)/2),u.x0=b,u.y0=k,u.x1=y,u.y1=m,u.children&&(x=s[u.depth+1]=o(u)/2,b+=d(u)-x,k+=i(u)-x,y-=l(u)-x,m-=c(u)-x,y<b&&(b=y=(b+y)/2),m<k&&(k=m=(k+m)/2),e(u,b,k,y,m))}return h.round=function(u){return arguments.length?(t=!!u,h):t},h.size=function(u){return arguments.length?(n=+u[0],a=+u[1],h):[n,a]},h.tile=function(u){return arguments.length?(e=vy(u),h):e},h.padding=function(u){return arguments.length?h.paddingInner(u).paddingOuter(u):h.paddingInner()},h.paddingInner=function(u){return arguments.length?(o=typeof u=="function"?u:Oa(+u),h):o},h.paddingOuter=function(u){return arguments.length?h.paddingTop(u).paddingRight(u).paddingBottom(u).paddingLeft(u):h.paddingTop()},h.paddingTop=function(u){return arguments.length?(i=typeof u=="function"?u:Oa(+u),h):i},h.paddingRight=function(u){return arguments.length?(l=typeof u=="function"?u:Oa(+u),h):l},h.paddingBottom=function(u){return arguments.length?(c=typeof u=="function"?u:Oa(+u),h):c},h.paddingLeft=function(u){return arguments.length?(d=typeof u=="function"?u:Oa(+u),h):d},h}function Ya(e,t,n){this.k=e,this.x=t,this.y=n}Ya.prototype={constructor:Ya,scale:function(e){return e===1?this:new Ya(this.k*e,this.x,this.y)},translate:function(e,t){return e===0&t===0?this:new Ya(this.k,this.x+this.k*e,this.y+this.k*t)},apply:function(e){return[e[0]*this.k+this.x,e[1]*this.k+this.y]},applyX:function(e){return e*this.k+this.x},applyY:function(e){return e*this.k+this.y},invert:function(e){return[(e[0]-this.x)/this.k,(e[1]-this.y)/this.k]},invertX:function(e){return(e-this.x)/this.k},invertY:function(e){return(e-this.y)/this.k},rescaleX:function(e){return e.copy().domain(e.range().map(this.invertX,this).map(e.invert,e))},rescaleY:function(e){return e.copy().domain(e.range().map(this.invertY,this).map(e.invert,e))},toString:function(){return"translate("+this.x+","+this.y+") scale("+this.k+")"}};Ya.prototype;const Vp={zfs:{main:"#00BCD4",glow:"rgba(0, 188, 212, 0.3)",gradient:["#00BCD4","#00838F"]},zfspool:{main:"#00BCD4",glow:"rgba(0, 188, 212, 0.3)",gradient:["#00BCD4","#00838F"]},nfs:{main:"#FF9800",glow:"rgba(255, 152, 0, 0.3)",gradient:["#FF9800","#E65100"]},pbs:{main:"#AB47BC",glow:"rgba(171, 71, 188, 0.3)",gradient:["#AB47BC","#7B1FA2"]},rbd:{main:"#FFC107",glow:"rgba(255, 193, 7, 0.3)",gradient:["#FFC107","#FF8F00"]},cephfs:{main:"#FFC107",glow:"rgba(255, 193, 7, 0.3)",gradient:["#FFC107","#FF8F00"]},lvm:{main:"#2196F3",glow:"rgba(33, 150, 243, 0.3)",gradient:["#2196F3","#1565C0"]},lvmthin:{main:"#2196F3",glow:"rgba(33, 150, 243, 0.3)",gradient:["#2196F3","#1565C0"]},iscsi:{main:"#03A9F4",glow:"rgba(3, 169, 244, 0.3)",gradient:["#03A9F4","#0277BD"]},glusterfs:{main:"#FF5722",glow:"rgba(255, 87, 34, 0.3)",gradient:["#FF5722","#D84315"]},dir:{main:"#607D8B",glow:"rgba(96, 125, 139, 0.3)",gradient:["#607D8B","#37474F"]},default:{main:"#00E5FF",glow:"rgba(0, 229, 255, 0.3)",gradient:["#00E5FF","#00ADB5"]}};function _y(e,t){if(e>=95)return{main:"#FF4081",glow:"rgba(255, 64, 129, 0.4)",gradient:["#FF4081","#D32F2F"]};if(e>=85)return{main:"#FFB74D",glow:"rgba(255, 183, 77, 0.35)",gradient:["#FFB74D","#F57C00"]};const n=(t==null?void 0:t.toLowerCase())||"default";return Vp[n]||Vp.default}function Hp(e){if(e===0)return"0 B";const t=1024,n=["B","KB","MB","GB","TB","PB"],a=Math.floor(Math.log(e)/Math.log(t));return parseFloat((e/Math.pow(t,a)).toFixed(1))+" "+n[a]}function Yp({name:e,usedBytes:t,totalBytes:n,type:a,isShared:s=!1,connectedNodes:o=[],nodeName:i,isOffline:l=!1,width:c=120,height:d=180,animationDelay:h=0,onClick:g,onHover:u}){const x=p.useRef(null),b=p.useRef(0),k=p.useRef([]),y=p.useRef(0),[m,f]=p.useState(!1),v=n>0?t/n*100:0,[j,w]=p.useState(0),[S,C]=p.useState(!1),[N,L]=p.useState(!0),I=p.useRef(null),P=p.useRef(0),E=1200,G=500;p.useEffect(()=>{const J=setTimeout(()=>{C(!0)},h);return()=>clearTimeout(J)},[h]),p.useEffect(()=>{if(!S)return;P.current=j,I.current=null;const J=P.current,z=v;if(Math.abs(J-z)<.1){w(z);return}const ge=N?E:G,je=Oe=>{I.current===null&&(I.current=Oe);const X=Oe-I.current,ue=Math.min(X/ge,1),te=(F=>1-Math.pow(1-F,3))(ue),Z=J+(z-J)*te;w(Z),ue<1?requestAnimationFrame(je):N&&L(!1)};requestAnimationFrame(je)},[v,S]);const A=j,T=v>=85,K=v>=95,O=_y(v,a),W=p.useCallback(J=>{const z=[];for(let ge=0;ge<J;ge++)z.push({x:Math.random()*c*.6+c*.2,y:d+Math.random()*d,radius:Math.random()*4+2,speed:Math.random()*1.5+.5,wobbleOffset:Math.random()*Math.PI*2,wobbleSpeed:Math.random()*.05+.02});return z},[c,d]);p.useEffect(()=>{const J=x.current;if(!J)return;const z=J.getContext("2d");if(!z)return;const ge=window.devicePixelRatio||1;J.width=c*ge,J.height=d*ge,z.scale(ge,ge);const je=T?15:5;k.current=W(je);const Oe=X=>{X-y.current,y.current=X;const ue=X*.001;z.clearRect(0,0,c,d);const ke=8,te=ke,Z=ke+20,F=c-ke*2,M=d-ke*2-40,Y=8,re=l?.05:A/100,be=M*re,V=Z+M-be,ce=z.createLinearGradient(te,Z,te,Z+M);ce.addColorStop(0,"#0a0a12"),ce.addColorStop(.5,"#050510"),ce.addColorStop(1,"#0a0a12"),z.fillStyle=ce,z.beginPath(),z.roundRect(te,Z,F,M,Y),z.fill(),z.save(),z.beginPath(),z.roundRect(te,Z,F,M,Y),z.clip();const me=12,pe=me*Math.sqrt(3);z.strokeStyle="rgba(0, 240, 255, 0.06)",z.lineWidth=.5;for(let oe=0;oe<M/pe+1;oe++)for(let ne=0;ne<F/(me*1.5)+1;ne++){const we=oe%2*me*.75,Me=te+ne*me*1.5+we,Ae=Z+oe*pe*.5;z.beginPath();for(let Nt=0;Nt<6;Nt++){const $t=Math.PI/3*Nt+Math.PI/6,le=Me+me*.4*Math.cos($t),Ue=Ae+me*.4*Math.sin($t);Nt===0?z.moveTo(le,Ue):z.lineTo(le,Ue)}z.closePath(),z.stroke()}z.restore();const ye=Z+ue*30%M;z.save(),z.beginPath(),z.roundRect(te,Z,F,M,Y),z.clip();const Fe=z.createLinearGradient(te,ye-15,te,ye+5);Fe.addColorStop(0,"transparent"),Fe.addColorStop(.5,"rgba(0, 240, 255, 0.15)"),Fe.addColorStop(1,"transparent"),z.fillStyle=Fe,z.fillRect(te,ye-15,F,20),z.restore(),z.strokeStyle="rgba(0, 240, 255, 0.2)",z.lineWidth=1;for(let oe=0;oe<=10;oe++){const ne=Z+M-M*oe/10,we=oe%5===0?12:6,Me=oe%5===0?.4:.2;z.strokeStyle=`rgba(0, 240, 255, ${Me})`,z.beginPath(),z.moveTo(te+2,ne),z.lineTo(te+2+we,ne),z.stroke(),z.beginPath(),z.moveTo(te+F-2,ne),z.lineTo(te+F-2-we,ne),z.stroke()}const Je=ue*50%M;for(let oe=0;oe<3;oe++){const ne=Z+(Je+oe*M/3)%M,we=.3+Math.sin(ue*3+oe)*.2;z.beginPath(),z.strokeStyle=`rgba(0, 240, 255, ${we})`,z.lineWidth=2,z.moveTo(te,ne),z.lineTo(te+4,ne),z.stroke(),z.beginPath(),z.moveTo(te+F,ne),z.lineTo(te+F-4,ne),z.stroke()}if(!l&&re>0){const oe=z.createLinearGradient(0,V,0,Z+M);oe.addColorStop(0,O.gradient[0]),oe.addColorStop(1,O.gradient[1]);const ne=T?6:3,we=.05,Me=T?.1:.05,Ae=Math.PI/3;z.save(),z.beginPath(),z.rect(te,Z,F,M),z.clip(),z.fillStyle=oe,z.beginPath(),z.moveTo(te,Z+M);for(let le=0;le<=F;le+=2){const Ue=Math.sin(le*we+ue*Me*60)*ne,Te=Math.sin(le*we*1.5+ue*Me*40+Ae)*(ne*.5),Ge=V+Ue+Te;le===0?z.moveTo(te+le,Ge):z.lineTo(te+le,Ge)}z.lineTo(te+F,Z+M),z.lineTo(te,Z+M),z.closePath(),z.fill(),z.strokeStyle=O.glow,z.lineWidth=2,z.shadowColor=O.main,z.shadowBlur=10,z.beginPath();for(let le=0;le<=F;le+=2){const Ue=Math.sin(le*we+ue*Me*60)*ne,Te=Math.sin(le*we*1.5+ue*Me*40+Ae)*(ne*.5),Ge=V+Ue+Te;le===0?z.moveTo(te+le,Ge):z.lineTo(te+le,Ge)}z.stroke(),z.shadowBlur=0,k.current.forEach((le,Ue)=>{if(le.y>V&&le.y<Z+M){const Te=Math.sin(ue*le.wobbleSpeed*60+le.wobbleOffset)*3;z.fillStyle=`rgba(255, 255, 255, ${.3+Math.random()*.2})`,z.beginPath(),z.arc(le.x+Te,le.y,le.radius,0,Math.PI*2),z.fill(),z.fillStyle="rgba(255, 255, 255, 0.5)",z.beginPath(),z.arc(le.x+Te-le.radius*.3,le.y-le.radius*.3,le.radius*.3,0,Math.PI*2),z.fill()}le.y-=le.speed*(T?2:1),le.y<V-10&&(le.y=Z+M+Math.random()*20,le.x=te+Math.random()*F*.6+F*.2)}),z.restore();const Nt=3;for(let le=0;le<Nt;le++){const Ue=te+F*(le+.5)/Nt,Te=ue*2+le*Math.PI*.7,Ge=(Math.sin(Te)*.5+.5)*.3;if(Ge>.1){const ft=z.createLinearGradient(Ue-8,V,Ue+8,Z+M);ft.addColorStop(0,"rgba(255, 255, 255, 0)"),ft.addColorStop(.3,`rgba(255, 255, 255, ${Ge})`),ft.addColorStop(.7,`rgba(255, 255, 255, ${Ge*.5})`),ft.addColorStop(1,"rgba(255, 255, 255, 0)"),z.fillStyle=ft,z.fillRect(Ue-8,V,16,be)}}const $t=Math.floor(re*8);for(let le=0;le<$t;le++){const Ue=le*137.5,Te=te+10+Ue*7%(F-20),ft=V+10+Ue*13%(be-20)+Math.sin(ue*2+Ue)*5,or=.4+Math.sin(ue*3+Ue)*.3;if(z.fillStyle=`rgba(255, 255, 255, ${or})`,z.beginPath(),z.arc(Te,ft,1.5,0,Math.PI*2),z.fill(),le>0&&le%3===0){const wt=(le-1)*137.5,Xt=te+10+wt*7%(F-20),Pe=V+10+wt*13%(be-20)+Math.sin(ue*2+wt)*5,Nr=Math.sqrt((Te-Xt)**2+(ft-Pe)**2);Nr<30&&(z.strokeStyle=`rgba(255, 255, 255, ${.1*(1-Nr/30)})`,z.lineWidth=.5,z.beginPath(),z.moveTo(Te,ft),z.lineTo(Xt,Pe),z.stroke())}}if(T){for(let le=0;le<8;le++){const Ue=te+F*.15+Math.random()*F*.7,Te=V-Math.random()*25,Ge=Math.random()*4+1;z.fillStyle=`rgba(255, 255, 255, ${.15+Math.random()*.15})`,z.beginPath(),z.arc(Ue,Te,Ge,0,Math.PI*2),z.fill()}Math.sin(ue*10)>.7&&(z.fillStyle="rgba(255, 100, 0, 0.05)",z.fillRect(te,Z,F,M))}}const Ye=l||K?"#ff0040":O.main,Xe=K?Math.sin(ue*5)*.3+.7:1;z.strokeStyle=Ye,z.lineWidth=3,z.shadowColor=Ye,z.shadowBlur=m?20:12*Xe,z.beginPath(),z.roundRect(te,Z,F,M,Y),z.stroke(),z.shadowBlur=0,z.strokeStyle=`${Ye}60`,z.lineWidth=1,z.beginPath(),z.roundRect(te+3,Z+3,F-6,M-6,Y-2),z.stroke();const fe=16,Se=3;z.strokeStyle=Ye,z.lineWidth=Se,z.shadowColor=Ye,z.shadowBlur=8,z.beginPath(),z.moveTo(te-2,Z+fe),z.lineTo(te-2,Z-2),z.lineTo(te+fe,Z-2),z.stroke(),z.beginPath(),z.moveTo(te+F-fe,Z-2),z.lineTo(te+F+2,Z-2),z.lineTo(te+F+2,Z+fe),z.stroke(),z.beginPath(),z.moveTo(te-2,Z+M-fe),z.lineTo(te-2,Z+M+2),z.lineTo(te+fe,Z+M+2),z.stroke(),z.beginPath(),z.moveTo(te+F-fe,Z+M+2),z.lineTo(te+F+2,Z+M+2),z.lineTo(te+F+2,Z+M-fe),z.stroke(),z.shadowBlur=0;const H=2+(Math.sin(ue*4)*.5+.5);if(z.fillStyle=Ye,z.shadowColor=Ye,z.shadowBlur=6,[[te-2,Z-2],[te+F+2,Z-2],[te-2,Z+M+2],[te+F+2,Z+M+2]].forEach(([oe,ne])=>{z.beginPath(),z.arc(oe,ne,H,0,Math.PI*2),z.fill()}),z.shadowBlur=0,!l){const ne=te+F+6,we=M,Me=we*(A/100);z.fillStyle="rgba(0, 20, 40, 0.8)",z.fillRect(ne,Z,4,we);const Ae=z.createLinearGradient(0,Z+we-Me,0,Z+we);Ae.addColorStop(0,O.main),Ae.addColorStop(1,O.gradient[1]),z.fillStyle=Ae,z.fillRect(ne,Z+we-Me,4,Me),z.strokeStyle=`${Ye}40`,z.lineWidth=1,z.strokeRect(ne,Z,4,we)}if(l){z.strokeStyle="#ff0040",z.lineWidth=2,z.beginPath();const oe=te+F*.3,ne=Z+M*.3;z.moveTo(oe,ne),z.lineTo(oe+10,ne+15),z.lineTo(oe+5,ne+25),z.lineTo(oe+15,ne+40),z.stroke(),z.beginPath(),z.moveTo(oe+10,ne+15),z.lineTo(oe+20,ne+20),z.stroke()}b.current=requestAnimationFrame(Oe)};return b.current=requestAnimationFrame(Oe),()=>{cancelAnimationFrame(b.current)}},[c,d,A,T,K,l,O,m,W]);const B=()=>{f(!0),u==null||u(!0)},q=()=>{f(!1),u==null||u(!1)};return r.jsxs("div",{className:`liquid-tank ${s?"shared":"local"} ${K?"critical":""} ${l?"offline":""}`,onClick:g,onMouseEnter:B,onMouseLeave:q,children:[r.jsxs("div",{className:"tank-header",children:[r.jsx("div",{className:`tank-name-tag ${l?"offline":""}`,style:l?void 0:{color:O.main,background:`${O.main}15`,borderColor:`${O.main}50`},children:e}),r.jsx("div",{className:`tank-type-tag type-${a.toLowerCase()}`,children:a})]}),r.jsx("canvas",{ref:x,style:{width:c,height:d-50,display:"block"}}),r.jsxs("div",{className:"tank-stats",children:[r.jsx("div",{className:`tank-percent ${K?"critical":T?"warning":""}`,style:{color:l?"#FF4081":O.main,textShadow:l?"none":`0 0 10px ${O.glow}`},children:l?"OFFLINE":`${v.toFixed(1)}%`}),r.jsxs("div",{className:"tank-capacity",children:[Hp(t)," / ",Hp(n)]})]}),s&&o.length>0&&r.jsx("div",{className:"tank-nodes",children:o.map((J,z)=>r.jsx("span",{className:"node-tag",children:J},z))}),!s&&i&&r.jsx("div",{className:"tank-node-label",children:i}),r.jsx("style",{children:`
      ...
      `})]})}function Sy({percent:e,usedBytes:t,totalBytes:n,duration:a=1200}){const[s,o]=p.useState(0),i=p.useRef(0),l=p.useRef(null),c=p.useRef(0);p.useEffect(()=>{c.current=s,l.current=null;const x=b=>{l.current===null&&(l.current=b);const k=b-l.current,y=Math.min(k/a,1),m=y===1?1:1-Math.pow(2,-10*y),f=c.current+(e-c.current)*m;o(f),y<1&&(i.current=requestAnimationFrame(x))};return i.current=requestAnimationFrame(x),()=>cancelAnimationFrame(i.current)},[e,a]);const h=s>=90?"#ff0040":s>=70?"#ff6b00":"#00f0ff",g=40,u=[];for(let x=0;x<g;x++){const b=x/g*100,k=b<s,y=x%4===0;u.push({index:x,isActive:k,isMajor:y,percent:b})}return r.jsxs("div",{className:"scifi-indicator",children:[r.jsx("div",{className:"indicator-left",children:r.jsxs("div",{className:"indicator-bytes",children:[r.jsx("span",{className:"used",style:{color:h},children:Ie(t)}),r.jsx("span",{className:"separator",children:"/"}),r.jsx("span",{className:"total",children:Ie(n)})]})}),r.jsxs("div",{className:"indicator-bar-container",children:[r.jsxs("div",{className:"indicator-bar",children:[r.jsx("div",{className:"segments-container",children:u.map(x=>r.jsx("div",{className:`segment ${x.isActive?"active":""} ${x.isMajor?"major":""}`,style:{"--segment-color":x.isActive?h:"rgba(60, 80, 100, 0.3)",animationDelay:x.isActive?`${x.index*20}ms`:"0ms"}},x.index))}),r.jsx("div",{className:"indicator-glow",style:{width:`${s}%`,background:`linear-gradient(90deg, transparent, ${h}40)`,boxShadow:`0 0 20px ${h}60, 0 0 40px ${h}30`}}),r.jsx("div",{className:"indicator-pointer",style:{left:`${s}%`,borderColor:`transparent transparent ${h} transparent`,filter:`drop-shadow(0 0 4px ${h})`}}),r.jsx("div",{className:"indicator-scanline"})]}),r.jsx("div",{className:"indicator-accent",style:{background:h}})]}),r.jsx("div",{className:"indicator-right",children:r.jsxs("div",{className:"indicator-percent",style:{color:h},children:[s.toFixed(1),r.jsx("span",{className:"percent-symbol",children:"%"})]})})]})}const Cy=["rbd","cephfs","nfs","iscsi","glusterfs","zfs-over-iscsi","pbs"];function My({vm:e,position:t,onClose:n}){var m,f,v,j,w;const{t:a,language:s}=Ce(),o=p.useRef(null),[i,l]=p.useState(null),d=e.status==="running"?"#00ff88":"#ff6b00",h=e.type==="lxc",g=e.disks||[],u=s==="zh-TW",x=((m=e.disk)==null?void 0:m.total_bytes)>0?e.disk.used_bytes/e.disk.total_bytes*100:0,b=x>=90?"#ff0040":x>=70?"#ff6b00":"#00f0ff",k=u?e.status==="running"?"運作中":e.status==="stopped"?"已停止":e.status.toUpperCase():e.status.toUpperCase();p.useEffect(()=>{if(!o.current)return;const C=o.current.getBoundingClientRect(),N=C.width,L=C.height,I=window.innerWidth,P=window.innerHeight,E=15,{cellX:G,cellY:A,cellTop:T,cellBottom:K,cellLeft:O,cellRight:W}=t;let B=0,q=0,J=G,z=A;W+E+N<I?(B=W+E,q=Math.max(E,Math.min(P-L-E,A-L/2)),J=W,z=A):O-E-N>0?(B=O-E-N,q=Math.max(E,Math.min(P-L-E,A-L/2)),J=O,z=A):T-E-L>0?(B=Math.max(E,Math.min(I-N-E,G-N/2)),q=T-E-L,J=G,z=T):(B=Math.max(E,Math.min(I-N-E,G-N/2)),q=K+E,J=G,z=K);let ge=B,je=q+L/2;B>W?(ge=B,je=Math.max(q,Math.min(q+L,z))):B+N<O?(ge=B+N,je=Math.max(q,Math.min(q+L,z))):q+L<T?(ge=Math.max(B,Math.min(B+N,J)),je=q+L):(ge=Math.max(B,Math.min(B+N,J)),je=q),l({x:B,y:q,lineStart:{x:J,y:z},lineEnd:{x:ge,y:je}})},[t]);const y=i?(()=>{const S=i.lineEnd.x-i.lineStart.x,C=i.lineEnd.y-i.lineStart.y,N=Math.sqrt(S*S+C*C),L=Math.atan2(C,S)*(180/Math.PI);return{width:`${N}px`,transform:`rotate(${L}deg)`,left:`${i.lineStart.x}px`,top:`${i.lineStart.y}px`}})():null;return r.jsxs(r.Fragment,{children:[i&&y&&r.jsx("div",{className:"popup-connector-line",style:y}),r.jsxs("div",{ref:o,className:"vm-disk-popup",style:{left:(i==null?void 0:i.x)??-9999,top:(i==null?void 0:i.y)??-9999,opacity:i?1:0,transform:"none"},onClick:S=>S.stopPropagation(),children:[r.jsxs("div",{className:"popup-header",children:[r.jsxs("div",{className:"popup-title",children:[r.jsx("span",{className:"vm-icon",children:e.type==="qemu"?"VM":"CT"}),r.jsx("span",{className:"vm-name",children:e.name}),r.jsxs("span",{className:"vm-id",children:["#",e.vmid]})]}),r.jsx("button",{className:"popup-close",onClick:n,children:"×"})]}),r.jsxs("div",{className:"popup-status",children:[r.jsx("span",{className:"status-dot",style:{background:d}}),r.jsx("span",{className:"status-text",style:{color:d},children:k}),r.jsxs("span",{className:"node-info",children:["@ ",e.node]})]}),r.jsxs("div",{className:"popup-section",children:[r.jsxs("div",{className:"section-label",children:[u?"磁碟":"DISK",g.length>1?u?"":"S":""," (",g.length||1,")"]}),g.length>0?r.jsx("div",{className:"disk-list",children:g.map((S,C)=>r.jsxs("div",{className:"disk-item",children:[r.jsxs("div",{className:"disk-device",children:[r.jsx("span",{className:"device-name",children:S.device}),r.jsx("span",{className:"device-format",children:S.format})]}),r.jsxs("div",{className:"disk-info",children:[r.jsx("span",{className:"disk-storage",children:S.storage}),r.jsx("span",{className:"disk-size",children:Ie(S.size)})]})]},C))}):r.jsx("div",{className:"disk-summary",children:r.jsxs("div",{className:"disk-summary-row",children:[r.jsx("span",{className:"disk-label",children:u?"配置容量":"Allocated"}),r.jsx("span",{className:"disk-value",children:Ie(((f=e.disk)==null?void 0:f.total_bytes)||0)})]})}),h&&r.jsxs("div",{className:"disk-usage-section",children:[r.jsxs("div",{className:"disk-summary-row",children:[r.jsx("span",{className:"disk-label",children:u?"已使用":"Used"}),r.jsx("span",{className:"disk-value",children:Ie(((v=e.disk)==null?void 0:v.used_bytes)||0)})]}),r.jsxs("div",{className:"disk-summary-row",children:[r.jsx("span",{className:"disk-label",children:u?"使用率":"Usage"}),r.jsxs("span",{className:"disk-value",style:{color:b},children:[x.toFixed(1),"%"]})]}),r.jsx("div",{className:"disk-bar",children:r.jsx("div",{className:"disk-bar-fill",style:{width:`${x}%`,background:b}})})]})]}),r.jsxs("div",{className:"popup-metrics",children:[r.jsxs("div",{className:"metric-item",children:[r.jsx("span",{className:"metric-label",children:"CPU"}),r.jsxs("span",{className:"metric-value",children:[((j=e.cpu)==null?void 0:j.cores)||0," ",u?"核心":"cores"]})]}),r.jsxs("div",{className:"metric-item",children:[r.jsx("span",{className:"metric-label",children:u?"記憶體":"Memory"}),r.jsx("span",{className:"metric-value",children:Ie(((w=e.memory)==null?void 0:w.total_bytes)||0)})]})]})]})]})}function zy({data:e,width:t,height:n,isInitialLoad:a=!1,onVMClick:s}){const[o,i]=p.useState(null),l=p.useRef(null),c=p.useMemo(()=>{if(e.length===0||t===0||n===0)return[];const d={name:"root",children:e.map(x=>({name:x.vm.name,value:x.value,vm:x.vm}))},h=ad(d).sum(x=>x.value||0).sort((x,b)=>(b.value||0)-(x.value||0));return Ny().size([t,n]).paddingInner(3).paddingOuter(2).round(!0).tile(Xf.ratio(1))(h).leaves().map(x=>({x:x.x0,y:x.y0,width:x.x1-x.x0,height:x.y1-x.y0,vm:x.data.vm,value:x.value||0}))},[e,t,n]);return c.length===0?r.jsx("div",{className:"no-storage",children:"No VM disk data available"}):r.jsxs("svg",{ref:l,width:t,height:n,className:"d3-treemap",children:[r.jsxs("defs",{children:[r.jsx("pattern",{id:"scanlinePattern",width:"4",height:"4",patternUnits:"userSpaceOnUse",children:r.jsx("line",{x1:"0",y1:"0",x2:"4",y2:"0",stroke:"rgba(0, 255, 200, 0.5)",strokeWidth:"1"})}),r.jsxs("linearGradient",{id:"energyPulse",x1:"0%",y1:"0%",x2:"100%",y2:"100%",children:[r.jsx("stop",{offset:"0%",stopColor:"rgba(0, 255, 200, 0.8)",children:r.jsx("animate",{attributeName:"stop-color",values:"rgba(0, 255, 200, 0.8);rgba(0, 200, 255, 0.8);rgba(180, 100, 255, 0.8);rgba(0, 255, 200, 0.8)",dur:"3s",repeatCount:"indefinite"})}),r.jsx("stop",{offset:"100%",stopColor:"rgba(0, 200, 255, 0.4)",children:r.jsx("animate",{attributeName:"stop-color",values:"rgba(0, 200, 255, 0.4);rgba(180, 100, 255, 0.4);rgba(0, 255, 200, 0.4);rgba(0, 200, 255, 0.4)",dur:"3s",repeatCount:"indefinite"})})]}),r.jsxs("filter",{id:"nodeGlow",x:"-50%",y:"-50%",width:"200%",height:"200%",children:[r.jsx("feGaussianBlur",{stdDeviation:"3",result:"blur"}),r.jsx("feComposite",{in:"SourceGraphic",in2:"blur",operator:"over"})]})]}),c.map((d,h)=>{var L;const g=((L=d.vm.disk)==null?void 0:L.total_bytes)||1,u=d.vm.status==="running",x=o===`${d.vm.node}-${d.vm.vmid}`,b=d.width>15&&d.height>12,k=d.width>40&&d.height>25,y=d.width>50&&d.height>40,m=d.width>60&&d.height>55,f=Math.max(...c.map(I=>I.value)),v=d.value/f,j=()=>u?v>.7?"rgba(0, 255, 200, 0.15)":v>.4?"rgba(0, 200, 255, 0.12)":v>.2?"rgba(180, 0, 255, 0.1)":"rgba(255, 0, 180, 0.08)":"rgba(30, 35, 50, 0.6)",w=()=>u?v>.7?"rgba(0, 255, 200, 0.9)":v>.4?"rgba(0, 200, 255, 0.85)":v>.2?"rgba(180, 100, 255, 0.8)":"rgba(255, 80, 200, 0.75)":"rgba(60, 70, 90, 0.5)",S=()=>u?v>.7?"rgba(0, 255, 200, 0.4)":v>.4?"rgba(0, 200, 255, 0.35)":v>.2?"rgba(180, 100, 255, 0.3)":"rgba(255, 80, 200, 0.25)":"transparent",C=()=>u?v>.7?"rgba(0, 255, 220, 1)":v>.4?"rgba(100, 220, 255, 1)":v>.2?"rgba(200, 160, 255, 1)":"rgba(255, 150, 220, 1)":"rgba(100, 110, 130, 0.7)",N=a?h*30:0;return r.jsxs("g",{transform:`translate(${d.x}, ${d.y})`,onMouseEnter:()=>i(`${d.vm.node}-${d.vm.vmid}`),onMouseLeave:()=>i(null),onClick:I=>{if(I.stopPropagation(),s){const P=I.clientX,E=I.clientY,G=d.width/2,A=d.height/2;s(d.vm,{cellX:P,cellY:E,cellWidth:d.width,cellHeight:d.height,cellTop:E-A,cellBottom:E+A,cellLeft:P-G,cellRight:P+G})}},className:a?"treemap-node-enter":"",style:{cursor:"pointer","--anim-delay":`${N}ms`},children:[r.jsx("title",{children:`${d.vm.name} (#${d.vm.vmid})
Status: ${d.vm.status}
Allocated: ${Ie(g)}`}),u&&r.jsx("rect",{width:d.width,height:d.height,fill:"none",stroke:S(),strokeWidth:3,rx:4,ry:4,className:"glow-pulse",style:{filter:"blur(4px)",opacity:x?1:.6}}),u&&d.width>30&&d.height>25&&r.jsx("rect",{width:d.width,height:d.height,fill:"none",stroke:w(),strokeWidth:1,strokeDasharray:"8 4",rx:4,ry:4,className:"data-stream",style:{opacity:.5}}),r.jsx("rect",{className:"main-cell",width:d.width,height:d.height,fill:j(),stroke:w(),strokeWidth:x?2:1,rx:4,ry:4,style:{filter:x?`drop-shadow(0 0 12px ${S()}) drop-shadow(0 0 4px ${w()})`:`drop-shadow(0 0 3px ${S()})`,transition:"all 0.2s ease"}}),u&&d.width>20&&d.height>15&&r.jsx("line",{x1:2,y1:2,x2:Math.min(d.width*.4,30),y2:2,stroke:w(),strokeWidth:1,opacity:.6}),u&&d.width>50&&d.height>40&&r.jsxs(r.Fragment,{children:[r.jsx("path",{d:`M ${d.width-8} ${d.height-2} L ${d.width-2} ${d.height-2} L ${d.width-2} ${d.height-8}`,fill:"none",stroke:w(),strokeWidth:1,opacity:.4,className:"circuit-line"}),r.jsx("circle",{cx:d.width-5,cy:d.height-5,r:2,fill:w(),opacity:.8,className:"energy-dot"})]}),u&&r.jsx("rect",{x:0,y:0,width:d.width,height:d.height,fill:"url(#scanlinePattern)",opacity:.15,rx:4,ry:4,style:{pointerEvents:"none"}}),b&&!k&&r.jsx("text",{x:d.width/2,y:d.height/2,textAnchor:"middle",dominantBaseline:"middle",fill:C(),fontSize:Math.min(10,Math.max(7,d.width/6)),fontFamily:"var(--font-mono)",fontWeight:600,style:{textShadow:u?`0 0 6px ${S()}`:"none"},children:d.vm.name.slice(0,Math.max(1,Math.min(3,Math.floor(d.width/10))))}),k&&(()=>{const I=d.width,P=d.height,E=Math.min(16,Math.max(9,Math.min(I/8,P/5))),G=Math.min(12,Math.max(8,Math.min(I/10,P/7))),A=Math.min(10,Math.max(7,Math.min(I/12,P/8))),T=Math.floor((I-8)/(E*.6)),K=d.vm.name.length>T?d.vm.name.slice(0,Math.max(1,T-1))+"…":d.vm.name,O=E+(y?G+2:0)+(m?A+2:0),W=(P-O)/2+E/2;return r.jsxs(r.Fragment,{children:[r.jsx("text",{x:I/2,y:W,textAnchor:"middle",dominantBaseline:"middle",fill:C(),fontSize:E,fontFamily:"var(--font-mono)",fontWeight:600,style:{textShadow:u?`0 0 8px ${S()}`:"none",filter:u?`drop-shadow(0 0 2px ${S()})`:"none"},children:K}),y&&r.jsx("text",{x:I/2,y:W+E*.8+2,textAnchor:"middle",dominantBaseline:"middle",fill:u?"rgba(180, 200, 220, 0.8)":"rgba(100, 110, 130, 0.6)",fontSize:G,fontFamily:"var(--font-mono)",children:Ie(g)}),m&&r.jsxs("text",{x:I/2,y:W+E*.8+(y?G*.8+4:2),textAnchor:"middle",dominantBaseline:"middle",fill:C(),fontSize:A,fontFamily:"var(--font-mono)",fontWeight:700,style:{filter:u?`drop-shadow(0 0 3px ${S()})`:"none"},children:["#",d.vm.vmid]})]})})()]},`${d.vm.node}-${d.vm.vmid}`)})]})}function $y({vmDiskData:e,totals:t,storages:n}){const{t:a,language:s}=Ce(),o=p.useRef(null),[i,l]=p.useState({width:0,height:0}),[c,d]=p.useState(!0),[h,g]=p.useState(null);p.useEffect(()=>{const x=()=>{if(o.current){const k=o.current.getBoundingClientRect();l({width:k.width,height:k.height})}};x();const b=new ResizeObserver(x);return o.current&&b.observe(o.current),()=>b.disconnect()},[]),p.useEffect(()=>{if(c&&e.length>0){const x=setTimeout(()=>{d(!1)},e.length*30+500);return()=>clearTimeout(x)}},[c,e.length]);const u=p.useMemo(()=>e.map(x=>{var b;return{vm:x,value:((b=x.disk)==null?void 0:b.total_bytes)||0}}).filter(x=>x.value>0),[e]);return r.jsxs("div",{className:"treemap-container",children:[r.jsxs("div",{className:"treemap-header",children:[r.jsx("h3",{className:"treemap-title font-display",children:"VM DISK ALLOCATION TREEMAP"}),r.jsxs("div",{className:"treemap-stats",children:[r.jsxs("span",{children:[e.length," VMs"]}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsxs("span",{children:["Total Allocated: ",Ie(e.reduce((x,b)=>{var k;return x+(((k=b.disk)==null?void 0:k.total_bytes)||0)},0))]})]})]}),r.jsx("div",{ref:o,className:"treemap-grid",onClick:()=>g(null),children:i.width>0&&i.height>0&&r.jsx(zy,{data:u,width:i.width,height:i.height,isInitialLoad:c,onVMClick:(x,b)=>g({vm:x,position:b})})}),h&&r.jsx(My,{vm:h.vm,position:h.position,onClose:()=>g(null)}),r.jsxs("div",{className:"treemap-legend",children:[r.jsxs("div",{className:"legend-item",children:[r.jsx("span",{className:"legend-color running"}),r.jsx("span",{children:a("vm.running")})]}),r.jsxs("div",{className:"legend-item",children:[r.jsx("span",{className:"legend-color stopped"}),r.jsx("span",{children:a("vm.stopped")})]}),r.jsx("div",{className:"legend-note",children:s==="zh-TW"?"方塊大小 = 磁碟配置容量":"Block size = Disk allocation"})]})]})}function Ey({storage:e,position:t,sourcePos:n,onClose:a,onManage:s}){const{t:o}=Ce();if(!e||!t)return null;const i=e.totalBytes>0?e.usedBytes/e.totalBytes*100:0,l=n||{x:t.x-20,y:t.y+50},c={x:t.x,y:t.y+50};return r.jsxs(r.Fragment,{children:[r.jsxs("svg",{className:"tooltip-connector",style:{position:"fixed",top:0,left:0,width:"100%",height:"100%",pointerEvents:"none",zIndex:999},children:[r.jsx("defs",{children:r.jsxs("linearGradient",{id:"lineGradient",x1:"0%",y1:"0%",x2:"100%",y2:"0%",children:[r.jsx("stop",{offset:"0%",stopColor:"rgba(80, 140, 180, 0)",stopOpacity:"0"}),r.jsx("stop",{offset:"30%",stopColor:"rgba(80, 160, 200, 0.6)",stopOpacity:"1"}),r.jsx("stop",{offset:"100%",stopColor:"rgba(80, 160, 200, 0.6)",stopOpacity:"1"})]})}),r.jsx("line",{x1:l.x,y1:l.y,x2:c.x,y2:c.y,stroke:"url(#lineGradient)",strokeWidth:"1",className:"connector-line"}),r.jsx("circle",{cx:c.x,cy:c.y,r:"3",fill:"rgba(80, 180, 200, 0.7)",className:"connector-dot"})]}),r.jsxs("div",{className:"storage-tooltip",style:{left:t.x,top:t.y},children:[r.jsx("div",{className:"tooltip-grid"}),r.jsx("div",{className:"tooltip-scan-line"}),r.jsx("div",{className:"tooltip-corner tl"}),r.jsx("div",{className:"tooltip-corner tr"}),r.jsx("div",{className:"tooltip-corner bl"}),r.jsx("div",{className:"tooltip-corner br"}),r.jsxs("div",{className:"tooltip-header",children:[r.jsx("span",{className:"tooltip-name",children:e.name}),r.jsx("button",{className:"tooltip-close",onClick:a,children:"×"})]}),r.jsx("div",{className:"tooltip-type-row",children:r.jsx("span",{className:`tooltip-badge ${e.isShared?"shared":"local"}`,children:e.isShared?o("storage.filter_shared"):o("storage.filter_local")})}),r.jsxs("div",{className:"tooltip-content",children:[r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("table.type"),":"]}),r.jsx("span",{children:e.type.toUpperCase()})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("storage.content"),":"]}),r.jsx("div",{className:"tooltip-labels",children:e.content.map((d,h)=>r.jsx("span",{className:"tooltip-label",children:d},h))})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.used"),":"]}),r.jsx("span",{children:Ie(e.usedBytes)})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.total"),":"]}),r.jsx("span",{children:Ie(e.totalBytes)})]}),r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("metric.usage"),":"]}),r.jsx("span",{className:`text-${_e(i)}`,children:ct(i,1)})]}),e.isShared&&e.connectedNodes.length>0&&r.jsxs("div",{className:"tooltip-row",children:[r.jsxs("span",{children:[o("cluster.nodes"),":"]}),r.jsx("div",{className:"tooltip-labels",children:e.connectedNodes.map((d,h)=>r.jsx("span",{className:"tooltip-label node",children:d},h))})]})]}),s&&r.jsx("div",{className:"tooltip-actions",children:r.jsxs("button",{className:"tooltip-action-btn",onClick:d=>{d.stopPropagation(),s(e)},children:[r.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M3 6h18M3 12h18M3 18h12"})}),r.jsx("span",{children:o("storage.manage")})]})})]})]})}function Ty({cluster:e,clusters:t}){const{t:n,language:a}=Ce(),[s,o]=p.useState(()=>{if(typeof window>"u")return"tanks";const T=window.location.pathname.split("/").filter(Boolean)[1];return T==="treemap"||T==="tanks"?T:"tanks"});p.useEffect(()=>{if(typeof window>"u")return;const T=window.location.pathname.split("/").filter(Boolean);if(T[0]!=="storage"||T.length>=4)return;const K=`/storage/${s}`;window.location.pathname!==K&&window.history.replaceState(null,"",K)},[s]),p.useEffect(()=>{const T=()=>{const K=window.location.pathname.split("/").filter(Boolean);if(K[0]!=="storage"||K.length>=4)return;const O=K[1];(O==="tanks"||O==="treemap")&&o(O)};return window.addEventListener("popstate",T),()=>window.removeEventListener("popstate",T)},[]);const[i,l]=p.useState("all"),[c,d]=p.useState(""),[h,g]=p.useState(null),[u,x]=p.useState(null),[b,k]=p.useState(null),[y,m]=p.useState(null),[f,v]=p.useState(null),j=p.useCallback(T=>{let K=(e==null?void 0:e.id)||"",O="";if(T.isShared)O=T.connectedNodes[0]||"";else{const B=T.nodeInstances.find(q=>q.active)||T.nodeInstances[0];O=(B==null?void 0:B.node)||""}if(!K&&t){for(const[B,q]of Object.entries(t))if(q.nodes&&q.nodes[O]){K=B;break}}if(!K||!O)return;const W=`/storage/${encodeURIComponent(K)}/${encodeURIComponent(O)}/${encodeURIComponent(T.name)}`;window.history.pushState(null,"",W),window.dispatchEvent(new PopStateEvent("popstate")),x(null),k(null),m(null),v(null)},[e,t]),w=p.useCallback((T,K)=>{T.preventDefault(),T.stopPropagation();const O=Math.min(T.clientX,window.innerWidth-180),W=Math.min(T.clientY,window.innerHeight-80);v({x:O,y:W,storage:K})},[]),S=!e&&t&&Object.keys(t).length>0,C=p.useMemo(()=>{const T=[],K=(O,W)=>{Object.values(O.vms).forEach(B=>{var q;(q=B.disk)!=null&&q.total_bytes&&B.disk.total_bytes>0&&!B.template&&T.push({...B,clusterName:W})})};return S?Object.entries(t).forEach(([O,W])=>{K(W,W.name||O)}):e&&K(e,e.name||""),T.sort((O,W)=>{var B,q;return(((B=W.disk)==null?void 0:B.total_bytes)||0)-(((q=O.disk)==null?void 0:q.total_bytes)||0)})},[e,t,S]),{sharedStorages:N,localStoragesByNode:L,allNodes:I,totals:P,warnings:E}=p.useMemo(()=>{const T=new Map;let K=0,O=0,W=0;const B=new Set,q=X=>{Object.values(X.storages).forEach(ue=>{B.add(ue.node);const ke=ue.storage;T.has(ke)||T.set(ke,{name:ue.storage,type:ue.type,content:ue.content,allowedNodes:ue.allowed_nodes||[],nodes:[]}),T.get(ke).nodes.push({node:ue.node,totalBytes:ue.disk.total_bytes,usedBytes:ue.disk.used_bytes,active:ue.enabled!==!1})})};S?Object.values(t).forEach(X=>q(X)):e&&q(e);const J=[],z={};B.forEach(X=>{z[X]=[]}),T.forEach(X=>{const ue=Cy.includes(X.type),ke=X.nodes[0].totalBytes,te=X.nodes.length>1&&ke>0&&X.nodes.every(Z=>Math.abs(Z.totalBytes-ke)/ke<.01);if(ue||te){const Z=X.nodes[0],F=X.allowedNodes.length>0?X.allowedNodes:X.nodes.map(M=>M.node);J.push({name:X.name,type:X.type,content:X.content,isShared:!0,totalBytes:Z.totalBytes,usedBytes:Z.usedBytes,connectedNodes:F,nodeInstances:X.nodes})}else X.nodes.forEach(Z=>{z[Z.node]||(z[Z.node]=[]),z[Z.node].push({name:X.name,type:X.type,content:X.content,isShared:!1,totalBytes:Z.totalBytes,usedBytes:Z.usedBytes,connectedNodes:[],nodeInstances:[Z]})})});const ge=X=>{if(i==="local"&&X.isShared||i==="shared"&&!X.isShared)return!1;if(c){const ue=c.toLowerCase();if(!X.name.toLowerCase().includes(ue)&&!X.type.toLowerCase().includes(ue))return!1}return!0},je=J.filter(ge).sort((X,ue)=>X.name.localeCompare(ue.name)),Oe={};return Object.entries(z).forEach(([X,ue])=>{const ke=ue.filter(ge).sort((te,Z)=>te.name.localeCompare(Z.name));ke.length>0&&(Oe[X]=ke)}),je.forEach(X=>{(X.totalBytes>0?X.usedBytes/X.totalBytes*100:0)>=85&&W++,K+=X.usedBytes,O+=X.totalBytes}),Object.values(Oe).flat().forEach(X=>{(X.totalBytes>0?X.usedBytes/X.totalBytes*100:0)>=85&&W++,K+=X.usedBytes,O+=X.totalBytes}),{sharedStorages:je,localStoragesByNode:Oe,allNodes:Array.from(B).sort(),totals:{totalUsed:K,totalCapacity:O},warnings:W}},[e,t,S,i,c]),G=(T,K)=>{if(u&&u.name===T.name&&u.isShared===T.isShared){x(null),k(null),m(null);return}const O=K.getBoundingClientRect(),W=240,B=200,q=O.top+O.height/2;let J=O.right+30,z=!1;J+W>window.innerWidth&&(J=O.left-W-30,z=!0);let ge=O.top;ge+B>window.innerHeight&&(ge=window.innerHeight-B-10),ge<10&&(ge=10),x(T),k({x:J,y:ge}),m({x:z?O.left:O.right,y:q})};if(!e&&!S)return r.jsx("div",{className:"storage-vault empty",children:r.jsxs("div",{className:"empty-message",children:[r.jsx("span",{className:"loading-spinner"}),r.jsx("span",{children:n("cluster.select")})]})});const A=P.totalCapacity>0?P.totalUsed/P.totalCapacity*100:0;return r.jsxs("div",{className:"storage-vault",children:[r.jsx("div",{className:"grid-floor"}),r.jsxs("div",{className:"vault-header",children:[r.jsxs("div",{className:"header-title-section",children:[r.jsxs("h1",{className:"vault-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"5",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 5v14c0 1.66 3.58 3 8 3s8-1.34 8-3V5"}),r.jsx("path",{d:"M4 12c0 1.66 3.58 3 8 3s8-1.34 8-3"}),r.jsx("ellipse",{cx:"12",cy:"19",rx:"3",ry:"1",fill:"currentColor",opacity:"0.3"})]}),n("storage.title")]}),r.jsxs("div",{className:"vault-stats",children:[r.jsx("span",{className:"stat-item",children:n("storage.count",{n:N.length+Object.values(L).flat().length})}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsx("span",{className:"stat-item",children:n("storage.shared_count",{n:N.length})}),r.jsx("span",{className:"stat-divider",children:"|"}),r.jsx("span",{className:"stat-item",children:n("storage.local_count",{n:Object.values(L).flat().length})}),E>0&&r.jsxs(r.Fragment,{children:[r.jsx("span",{className:"stat-divider",children:"|"}),r.jsxs("span",{className:"stat-warning",children:["⚠️ ",E," ",n("settings.warning")]})]})]})]}),r.jsxs("div",{className:"header-controls",children:[r.jsxs("div",{className:"search-box",children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"11",cy:"11",r:"8"}),r.jsx("path",{d:"M21 21l-4.35-4.35"})]}),r.jsx("input",{type:"text",placeholder:n("storage.search"),value:c,onChange:T=>d(T.target.value)})]}),r.jsxs("div",{className:"filter-tabs",children:[r.jsx("button",{className:`filter-tab ${i==="all"?"active":""}`,onClick:()=>l("all"),children:n("storage.filter_all")}),r.jsx("button",{className:`filter-tab ${i==="shared"?"active":""}`,onClick:()=>l("shared"),children:n("storage.filter_shared")}),r.jsx("button",{className:`filter-tab ${i==="local"?"active":""}`,onClick:()=>l("local"),children:n("storage.filter_local")})]}),r.jsxs("div",{className:"view-toggle",children:[r.jsx("button",{className:`view-btn ${s==="tanks"?"active":""}`,onClick:()=>o("tanks"),title:a==="zh-TW"?"能量槽檢視":"Tank view",children:r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"7",height:"18",rx:"2"}),r.jsx("rect",{x:"14",y:"8",width:"7",height:"13",rx:"2"})]})}),r.jsx("button",{className:`view-btn ${s==="treemap"?"active":""}`,onClick:()=>o("treemap"),title:a==="zh-TW"?"VM 矩陣檢視":"VM Treemap",children:r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"10",height:"8"}),r.jsx("rect",{x:"15",y:"3",width:"6",height:"5"}),r.jsx("rect",{x:"15",y:"10",width:"6",height:"6"}),r.jsx("rect",{x:"3",y:"13",width:"10",height:"8"})]})})]})]})]}),r.jsxs("div",{className:"summary-indicator-container",children:[r.jsx("div",{className:"indicator-title",children:n("storage.total_capacity")}),r.jsx(Sy,{percent:A,usedBytes:P.totalUsed,totalBytes:P.totalCapacity,duration:1500})]}),r.jsx("div",{className:"vault-content",children:s==="treemap"?r.jsx($y,{vmDiskData:C,totals:P,storages:[...N.map(T=>T.name),...Object.values(L).flat().map(T=>T.name)]}):r.jsxs("div",{className:"tanks-layout",children:[(i==="all"||i==="shared")&&N.length>0&&r.jsxs("div",{className:"storage-section shared-section",children:[r.jsxs("div",{className:"section-header",children:[r.jsxs("div",{className:"section-title shared",children:[r.jsxs("svg",{className:"section-icon",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"})]}),r.jsx("span",{children:n("storage.section_shared")})]}),r.jsx("span",{className:"section-count shared",children:n(N.length>1?"storage.storages_plural":"storage.storages_count",{n:N.length})})]}),r.jsx("div",{className:"tanks-grid shared-grid",children:N.map((T,K)=>r.jsx("div",{onClick:O=>G(T,O.currentTarget),onContextMenu:O=>w(O,T),style:{cursor:"pointer"},children:r.jsx(Yp,{name:T.name,usedBytes:T.usedBytes,totalBytes:T.totalBytes,type:T.type,isShared:!0,connectedNodes:T.connectedNodes,width:140,height:220,animationDelay:K*80})},T.name))})]}),(i==="all"||i==="local")&&Object.keys(L).length>0&&r.jsxs("div",{className:"storage-section local-section",children:[r.jsxs("div",{className:"section-header",children:[r.jsxs("div",{className:"section-title local",children:[r.jsxs("svg",{className:"section-icon",width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"4",width:"20",height:"16",rx:"2"}),r.jsx("path",{d:"M6 8h.01M6 12h.01M6 16h.01M10 8h8M10 12h8M10 16h8"})]}),r.jsx("span",{children:n("storage.section_local")})]}),r.jsxs("span",{className:"section-count local",children:[n(Object.values(L).flat().length>1?"storage.storages_plural":"storage.storages_count",{n:Object.values(L).flat().length})," ",n(Object.keys(L).length>1?"storage.across_nodes_plural":"storage.across_nodes",{n:Object.keys(L).length})]})]}),r.jsx("div",{className:"tanks-grid local-grid",children:(()=>{let T=N.length;return Object.entries(L).sort(([K],[O])=>K.localeCompare(O)).flatMap(([K,O])=>O.map(W=>{const B=W.nodeInstances[0],q=T++;return r.jsx("div",{onClick:J=>G(W,J.currentTarget),onContextMenu:J=>w(J,W),style:{cursor:"pointer"},children:r.jsx(Yp,{name:W.name,usedBytes:B.usedBytes,totalBytes:B.totalBytes,type:W.type,isShared:!1,nodeName:K,isOffline:!B.active,width:120,height:200,animationDelay:q*80})},`${K}-${W.name}`)}))})()})]}),N.length===0&&Object.keys(L).length===0&&r.jsx("div",{className:"no-storage",children:c?r.jsxs("span",{children:[n("error.no_data"),': "',c,'"']}):r.jsx("span",{children:n("error.no_data")})})]})}),r.jsx(Ey,{storage:u,position:b,sourcePos:y,onClose:()=>{x(null),k(null),m(null)},onManage:j}),f&&r.jsxs(r.Fragment,{children:[r.jsx("div",{className:"storage-ctx-shield",onClick:()=>v(null),onContextMenu:T=>{T.preventDefault(),v(null)}}),r.jsx("div",{className:"storage-ctx-menu",style:{left:f.x,top:f.y},onClick:T=>T.stopPropagation(),children:r.jsxs("button",{className:"storage-ctx-item",onClick:()=>{j(f.storage),v(null)},children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"})]}),r.jsx("span",{children:n("storage.content")})]})})]}),r.jsx("style",{children:`
        .storage-vault {
          position: relative;
          width: 100%;
          height: 100%;
      ...
      `})]})}const Py=["backup","iso","vztmpl","snippets","import","images","rootdir"],Ry=new Set(["rbd","lvm","lvmthin","zfspool","zfs","iscsi","iscsidirect"]);function Iy({clusterId:e,node:t,storageName:n,clusters:a}){var Se,De;const{t:s,language:o}=Ce(),i=Pr(),l=Sa(),c=p.useMemo(()=>{var we,Me;const H=a==null?void 0:a[e];if(!H)return null;const oe=H.storages||{};let ne=oe[`${t}/${n}`]||oe[n];if(!ne){for(const Ae of Object.values(oe))if(Ae&&Ae.storage===n){ne=Ae;break}}return ne?{clusterName:H.name||e,type:ne.type||"",content:ne.content||[],total:((we=ne.disk)==null?void 0:we.total_bytes)||0,used:((Me=ne.disk)==null?void 0:Me.used_bytes)||0,shared:!!ne.shared}:null},[a,e,n,t]),d=c?Ry.has(c.type):!1,h=((Se=l.user)==null?void 0:Se.role_global)==="operator"||((De=l.user)==null?void 0:De.role_global)==="admin"||!l.authEnforced,g=p.useMemo(()=>{if(!c)return[];const H=new Set(c.content);return Py.filter(oe=>H.has(oe))},[c]),[u,x]=p.useState(null);p.useEffect(()=>{u&&g.includes(u)||g.length>0&&x(g[0])},[g,u]);const[b,k]=p.useState([]),[y,m]=p.useState(!1),[f,v]=p.useState(null),[j,w]=p.useState(0),[S,C]=p.useState(!1),[N,L]=p.useState(null),[I,P]=p.useState(0),[E,G]=p.useState(!1),[A,T]=p.useState(null),[K,O]=p.useState(!1),[W,B]=p.useState(""),[q,J]=p.useState(""),[z,ge]=p.useState(""),[je,Oe]=p.useState(""),[X,ue]=p.useState(!0),[ke,te]=p.useState(!1),[Z,F]=p.useState(null),[M,Y]=p.useState(""),[re,be]=p.useState("ctime"),[V,ce]=p.useState("desc"),me=H=>{re===H?ce(oe=>oe==="asc"?"desc":"asc"):(be(H),ce(H==="name"||H==="format"||H==="notes"?"asc":"desc")),ye(!0),setTimeout(()=>ye(!1),600)},[pe,ye]=p.useState(!1);p.useEffect(()=>{if(!u)return;let H=!1;m(!0),v(null);const oe=`/api/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/storage/${encodeURIComponent(n)}/content?type=${u}`;return fetch(oe,{credentials:"same-origin"}).then(async ne=>{if(!ne.ok){const Me=await ne.text().catch(()=>"");throw new Error(`HTTP ${ne.status}: ${Me.slice(0,200)}`)}const we=await ne.json();H||k(Array.isArray(we.items)?we.items:[])}).catch(ne=>{H||v(String((ne==null?void 0:ne.message)||ne))}).finally(()=>{H||m(!1)}),()=>{H=!0}},[u,j,e,t,n]);const Fe=()=>{window.history.pushState(null,"","/storage"),window.dispatchEvent(new PopStateEvent("popstate"))},Je=async H=>{if(!(!h||d||!await i.confirm(o==="zh-TW"?`確定要刪除「${Kn(H.volid)}」？此操作無法復原。`:`Delete "${Kn(H.volid)}"? This cannot be undone.`,{title:o==="zh-TW"?"刪除確認":"Delete confirmation",destructive:!0})))try{const ne=`/api/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/storage/${encodeURIComponent(n)}/content/`+encodeURIComponent(H.volid),we=await fetch(ne,{method:"DELETE",credentials:"same-origin"});if(!we.ok){const Me=await we.text().catch(()=>"");throw new Error(`HTTP ${we.status}: ${Me.slice(0,200)}`)}k(Me=>Me.filter(Ae=>Ae.volid!==H.volid)),w(Me=>Me+1)}catch(ne){await i.alert(o==="zh-TW"?`刪除失敗：${ne}`:`Delete failed: ${ne}`,{title:o==="zh-TW"?"錯誤":"Error"})}},Ye=p.useMemo(()=>{let H=b;const oe=M.trim().toLowerCase();return oe&&(H=b.filter(we=>Kn(we.volid).toLowerCase().includes(oe)||(we.format||"").toLowerCase().includes(oe)||(we.notes||"").toLowerCase().includes(oe))),H.slice().sort((we,Me)=>{let Ae=0;switch(re){case"name":Ae=Kn(we.volid).localeCompare(Kn(Me.volid));break;case"ctime":Ae=(we.ctime||0)-(Me.ctime||0);break;case"format":Ae=(we.format||"").localeCompare(Me.format||"");break;case"size":Ae=(we.size||0)-(Me.size||0);break;case"vmid":Ae=(we.vmid??-1)-(Me.vmid??-1);break;case"notes":Ae=(we.notes||"").localeCompare(Me.notes||"");break}return V==="asc"?Ae:-Ae})},[b,M,re,V]),Xe=H=>re===H?V==="asc"?"▲":"▼":"";if(!c)return r.jsxs("div",{className:"storage-detail-loading",children:[r.jsx("div",{className:"vm-thumb-spinner"}),r.jsx("span",{children:o==="zh-TW"?"載入中…":"Loading…"})]});const fe=c.total>0?c.used/c.total*100:0;return r.jsxs("div",{className:"storage-detail",children:[r.jsxs("div",{className:"storage-detail-header",children:[r.jsxs("button",{className:"back-btn",onClick:Fe,title:o==="zh-TW"?"返回儲存清單":"Back to storage list",children:[r.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M15 18l-6-6 6-6"})}),r.jsx("span",{children:o==="zh-TW"?"返回":"Back"})]}),r.jsxs("div",{className:"storage-detail-title",children:[r.jsx("span",{className:"breadcrumb",children:c.clusterName}),r.jsx("span",{className:"breadcrumb-sep",children:"/"}),r.jsx("span",{className:"breadcrumb",children:t}),r.jsx("span",{className:"breadcrumb-sep",children:"/"}),r.jsx("h1",{className:"storage-name font-display",children:n}),r.jsx("span",{className:`storage-type-badge ${d?"block":"file"}`,children:c.type.toUpperCase()}),c.shared&&r.jsx("span",{className:"storage-shared-badge",children:o==="zh-TW"?"共享":"SHARED"})]}),r.jsxs("div",{className:"storage-detail-stats",children:[r.jsxs("div",{className:"stat",children:[r.jsx("span",{className:"stat-label",children:s("metric.used")}),r.jsxs("span",{className:`stat-val text-${_e(fe)}`,children:[Ie(c.used)," / ",Ie(c.total)]})]}),r.jsxs("div",{className:"stat",children:[r.jsx("span",{className:"stat-label",children:s("metric.usage")}),r.jsx("span",{className:`stat-val text-${_e(fe)}`,children:ct(fe,1)})]})]})]}),r.jsx("div",{className:"storage-detail-tabs",children:g.length===0?r.jsx("span",{className:"no-tabs",children:o==="zh-TW"?"此儲存沒有可管理的內容類型":"No manageable content types on this storage"}):g.map(H=>r.jsxs("button",{className:`storage-tab tab-${H} ${u===H?"active":""}`,onClick:()=>x(H),children:[r.jsx("span",{className:"tab-icon","aria-hidden":!0,children:Ly(H)}),r.jsx("span",{children:Qi(H,o)})]},H))}),r.jsxs("div",{className:"storage-detail-toolbar",children:[r.jsxs("div",{className:"search-box",children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"11",cy:"11",r:"8"}),r.jsx("path",{d:"M21 21l-4.35-4.35"})]}),r.jsx("input",{type:"text",placeholder:o==="zh-TW"?"搜尋名稱 / 格式 / 備註":"Search name / format / notes",value:M,onChange:H=>Y(H.target.value)})]}),!d&&h&&r.jsxs(r.Fragment,{children:[r.jsxs("button",{className:"action-btn",onClick:()=>C(!0),title:o==="zh-TW"?"從本機上傳檔案到此儲存":"Upload a local file to this storage",children:[r.jsx("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:r.jsx("path",{d:"M12 5v14M5 12l7-7 7 7"})}),r.jsx("span",{children:o==="zh-TW"?"上傳":"Upload"})]}),r.jsxs("button",{className:"action-btn",onClick:()=>O(!0),title:o==="zh-TW"?"伺服器端從 URL 下載到此儲存（PVE download-url）":"Server-side download to this storage (PVE download-url)",children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 12a9 9 0 11-9-9"}),r.jsx("path",{d:"M21 3v6h-6"})]}),r.jsx("span",{children:o==="zh-TW"?"從網址下載":"From URL"})]})]}),d&&r.jsx("span",{className:"readonly-hint",children:o==="zh-TW"?"此儲存為區塊級（VM 磁碟），僅供瀏覽":"Block-level storage (VM disks) — list only"}),r.jsxs("button",{className:"action-btn ghost",onClick:()=>w(H=>H+1),title:o==="zh-TW"?"重新整理":"Refresh",children:[r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M23 4v6h-6"}),r.jsx("path",{d:"M20.49 15a9 9 0 11-2.12-9.36L23 10"})]}),r.jsx("span",{children:o==="zh-TW"?"重新整理":"Refresh"})]})]}),r.jsxs("div",{className:"storage-detail-list",children:[r.jsx("div",{className:"tab-scan-line"}),y&&b.length===0&&r.jsxs("div",{className:"storage-detail-loading",children:[r.jsx("div",{className:"vm-thumb-spinner"}),r.jsx("span",{children:o==="zh-TW"?"載入中…":"Loading…"})]}),f&&r.jsx("div",{className:"storage-detail-error",children:r.jsxs("span",{children:[o==="zh-TW"?"錯誤：":"Error: ",f]})}),!y&&!f&&Ye.length===0&&r.jsx("div",{className:"storage-detail-empty",children:r.jsx("span",{children:o==="zh-TW"?"此分類無內容":"No items in this category"})}),Ye.length>0&&r.jsxs("table",{className:"storage-content-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{className:`sortable ${re==="name"?"sorted":""}`,onClick:()=>me("name"),children:r.jsxs("span",{children:[o==="zh-TW"?"名稱":"Name",Xe("name")&&r.jsx("span",{className:"sort-indicator",children:Xe("name")})]})}),r.jsx("th",{className:`sortable ${re==="ctime"?"sorted":""}`,onClick:()=>me("ctime"),children:r.jsxs("span",{children:[o==="zh-TW"?"日期":"Date",Xe("ctime")&&r.jsx("span",{className:"sort-indicator",children:Xe("ctime")})]})}),r.jsx("th",{className:`sortable ${re==="format"?"sorted":""}`,onClick:()=>me("format"),children:r.jsxs("span",{children:[o==="zh-TW"?"格式":"Format",Xe("format")&&r.jsx("span",{className:"sort-indicator",children:Xe("format")})]})}),r.jsx("th",{className:`num sortable ${re==="size"?"sorted":""}`,onClick:()=>me("size"),children:r.jsxs("span",{children:[o==="zh-TW"?"大小":"Size",Xe("size")&&r.jsx("span",{className:"sort-indicator",children:Xe("size")})]})}),u==="backup"&&r.jsx("th",{className:`num sortable ${re==="vmid"?"sorted":""}`,onClick:()=>me("vmid"),children:r.jsxs("span",{children:["VMID",Xe("vmid")&&r.jsx("span",{className:"sort-indicator",children:Xe("vmid")})]})}),u==="backup"&&r.jsx("th",{className:`sortable ${re==="notes"?"sorted":""}`,onClick:()=>me("notes"),children:r.jsxs("span",{children:[o==="zh-TW"?"備註":"Notes",Xe("notes")&&r.jsx("span",{className:"sort-indicator",children:Xe("notes")})]})}),!d&&h&&r.jsx("th",{className:"actions",children:o==="zh-TW"?"動作":"Actions"})]})}),r.jsx("tbody",{children:Ye.map(H=>{const oe=qf(H.format),ne=Ay(H.size);return r.jsxs("tr",{className:pe?"sort-animating":"",children:[r.jsxs("td",{className:"name-cell",title:H.volid,children:[r.jsx("span",{className:"file-icon","aria-hidden":!0,children:Oy(H.format)}),r.jsx("span",{className:"file-name",children:Kn(H.volid)})]}),r.jsx("td",{className:"date-cell",children:H.ctime?Fy(H.ctime):"—"}),r.jsx("td",{children:H.format?r.jsx("span",{className:`format-badge ${oe}`,children:H.format}):r.jsx("span",{className:"muted",children:"—"})}),r.jsx("td",{className:`num size-${ne}`,children:H.size?Ie(H.size):"—"}),u==="backup"&&r.jsx("td",{className:"num",children:H.vmid!=null?r.jsxs("span",{className:"vmid-badge",children:["#",H.vmid]}):r.jsx("span",{className:"muted",children:"—"})}),u==="backup"&&r.jsx("td",{className:"notes-cell",title:H.notes||"",children:H.notes||r.jsx("span",{className:"muted",children:"—"})}),!d&&r.jsxs("td",{className:"actions",children:[r.jsx("a",{className:"action-btn-row",href:`/api/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/storage/${encodeURIComponent(n)}/download/`+encodeURIComponent(H.volid),download:!0,title:o==="zh-TW"?"下載到本機（SSH 串流）":"Download to local (SSH stream)",onClick:we=>we.stopPropagation(),children:r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4"}),r.jsx("polyline",{points:"7 10 12 15 17 10"}),r.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]})}),h&&r.jsx("button",{className:"action-btn-row danger",onClick:()=>Je(H),title:o==="zh-TW"?"刪除":"Delete",children:r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"3 6 5 6 21 6"}),r.jsx("path",{d:"M19 6l-2 14a2 2 0 01-2 2H9a2 2 0 01-2-2L5 6"}),r.jsx("path",{d:"M10 11v6M14 11v6"}),r.jsx("path",{d:"M9 6V4a2 2 0 012-2h2a2 2 0 012 2v2"})]})})]})]},H.volid)})})]})]},u||"none"),S&&r.jsx("div",{className:"url-dl-overlay",onClick:()=>!E&&C(!1),onDragOver:H=>H.preventDefault(),onDrop:H=>{var ne;if(H.preventDefault(),E)return;const oe=(ne=H.dataTransfer.files)==null?void 0:ne[0];oe&&L(oe)},children:r.jsxs("div",{className:"url-dl-frame",onClick:H=>H.stopPropagation(),children:[r.jsxs("div",{className:"url-dl-titlebar",children:[r.jsxs("span",{children:[o==="zh-TW"?"上傳到 ":"Upload to ",n]}),r.jsx("button",{className:"url-dl-close",onClick:()=>!E&&C(!1),children:"×"})]}),r.jsxs("div",{className:"url-dl-body",children:[r.jsx("p",{className:"url-dl-lead",children:o==="zh-TW"?`將檔案上傳到此儲存區的 ${Qi(u||"iso",o)} 分類。可拖曳檔案到此視窗。`:`Upload a file to this storage's ${Qi(u||"iso",o)} category. You can also drag-drop into this window.`}),r.jsx("label",{children:o==="zh-TW"?"檔案":"File"}),r.jsx("input",{type:"file",disabled:E,onChange:H=>{var oe;return L(((oe=H.target.files)==null?void 0:oe[0])||null)},style:{width:"100%",padding:"8px",background:"#02050b",border:"1px solid var(--border)",borderRadius:4,color:"var(--text-primary)",fontFamily:"var(--font-mono)",fontSize:13}}),N&&r.jsxs("div",{className:"url-dl-lead",style:{marginTop:8},children:[r.jsx("code",{children:N.name})," · ",r.jsxs("span",{children:[(N.size/(1024*1024)).toFixed(1)," MB"]})]}),E&&r.jsxs("div",{style:{marginTop:12},children:[r.jsx("div",{style:{height:6,background:"#02050b",borderRadius:3,border:"1px solid var(--border)",overflow:"hidden"},children:r.jsx("div",{style:{width:`${I}%`,height:"100%",background:"linear-gradient(90deg, var(--primary), #00b4ff)",transition:"width 0.2s ease",boxShadow:"0 0 8px rgba(0,240,255,0.5)"}})}),r.jsxs("div",{style:{marginTop:6,fontFamily:"var(--font-mono)",fontSize:12,color:"var(--text-secondary)"},children:[I.toFixed(1),"%"," ",o==="zh-TW"?"上傳中…":"Uploading…"]})]}),A&&r.jsx("div",{className:"url-dl-err",children:A})]}),r.jsxs("div",{className:"url-dl-actions",children:[r.jsx("button",{className:"action-btn ghost",onClick:()=>!E&&C(!1),disabled:E,children:o==="zh-TW"?"取消":"Cancel"}),r.jsx("button",{className:"action-btn primary",disabled:E||!N||!u,onClick:()=>{if(!N||!u)return;G(!0),T(null),P(0);const H=new FormData;H.append("content",u),H.append("filename",N,N.name);const oe=new XMLHttpRequest;oe.upload.onprogress=ne=>{ne.lengthComputable&&P(ne.loaded/ne.total*100)},oe.onload=()=>{G(!1),oe.status>=200&&oe.status<300?(C(!1),L(null),P(0),w(ne=>ne+1),i.alert(o==="zh-TW"?"上傳完成。檔案已派送到 PVE。":"Upload complete. File dispatched to PVE.",{title:o==="zh-TW"?"完成":"Done"})):T(`HTTP ${oe.status}: ${oe.responseText.slice(0,200)}`)},oe.onerror=()=>{G(!1),T(o==="zh-TW"?"網路錯誤":"Network error")},oe.open("POST",`/api/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/storage/${encodeURIComponent(n)}/upload`),oe.withCredentials=!0,oe.send(H)},children:E?o==="zh-TW"?"上傳中…":"Uploading…":o==="zh-TW"?"開始上傳":"Upload"})]})]})}),K&&r.jsx("div",{className:"url-dl-overlay",onClick:()=>!ke&&O(!1),children:r.jsxs("div",{className:"url-dl-frame",onClick:H=>H.stopPropagation(),children:[r.jsxs("div",{className:"url-dl-titlebar",children:[r.jsx("span",{children:o==="zh-TW"?"從網址下載":"Download from URL"}),r.jsx("button",{className:"url-dl-close",onClick:()=>!ke&&O(!1),children:"×"})]}),r.jsxs("div",{className:"url-dl-body",children:[r.jsx("p",{className:"url-dl-lead",children:o==="zh-TW"?`PVE 端伺服器會直接從這個網址抓檔到 ${n}，你的網路頻寬不會經手。`:`The PVE host will pull the file directly into ${n}; your bandwidth never carries it.`}),r.jsx("label",{children:o==="zh-TW"?"網址 (URL)":"URL"}),r.jsx("input",{type:"text",value:W,onChange:H=>B(H.target.value),placeholder:"https://example.com/debian-12.iso",spellCheck:!1,autoComplete:"off"}),r.jsx("label",{children:o==="zh-TW"?"檔名（儲存後）":"Filename (as stored)"}),r.jsx("input",{type:"text",value:q,onChange:H=>J(H.target.value),placeholder:"debian-12.iso",spellCheck:!1,autoComplete:"off"}),r.jsx("label",{children:o==="zh-TW"?"校驗 (選填)":"Checksum (optional)"}),r.jsxs("div",{className:"url-dl-row",children:[r.jsxs("select",{value:je,onChange:H=>Oe(H.target.value),className:"url-dl-algo",children:[r.jsx("option",{value:"",children:o==="zh-TW"?"— 演算法 —":"— algorithm —"}),r.jsx("option",{value:"sha256",children:"sha256"}),r.jsx("option",{value:"sha512",children:"sha512"}),r.jsx("option",{value:"md5",children:"md5"})]}),r.jsx("input",{type:"text",value:z,onChange:H=>ge(H.target.value),placeholder:o==="zh-TW"?"十六進位摘要":"hex digest",spellCheck:!1,autoComplete:"off"})]}),r.jsxs("label",{className:"url-dl-check",children:[r.jsx("input",{type:"checkbox",checked:X,onChange:H=>ue(H.target.checked)}),r.jsx("span",{children:o==="zh-TW"?"驗證來源 TLS 憑證（建議開啟）":"Verify source TLS certificate (recommended)"})]}),Z&&r.jsx("div",{className:"url-dl-err",children:Z})]}),r.jsxs("div",{className:"url-dl-actions",children:[r.jsx("button",{className:"action-btn ghost",onClick:()=>!ke&&O(!1),disabled:ke,children:o==="zh-TW"?"取消":"Cancel"}),r.jsx("button",{className:"action-btn primary",disabled:ke||!W||!q||!u,onClick:async()=>{if(u){te(!0),F(null);try{const H=await fetch(`/api/clusters/${encodeURIComponent(e)}/nodes/${encodeURIComponent(t)}/storage/${encodeURIComponent(n)}/download-url`,{method:"POST",credentials:"same-origin",headers:{"Content-Type":"application/json"},body:JSON.stringify({url:W,filename:q,content:u,checksum:z||void 0,checksum_algorithm:je||void 0,verify_certificates:X})});if(!H.ok){const oe=await H.text().catch(()=>"");throw new Error(`HTTP ${H.status}: ${oe.slice(0,200)}`)}O(!1),B(""),J(""),ge(""),Oe(""),setTimeout(()=>w(oe=>oe+1),1e3),await i.alert(o==="zh-TW"?"下載任務已派送。完成後檔案會出現在清單。":"Download task dispatched. The file will appear in the list when finished.",{title:o==="zh-TW"?"已派送":"Dispatched"})}catch(H){F(String(H instanceof Error?H.message:H))}finally{te(!1)}}},children:ke?o==="zh-TW"?"派送中…":"Dispatching…":o==="zh-TW"?"開始下載":"Start download"})]})]})}),r.jsx("style",{children:`
        .storage-detail {
          padding: var(--spacing-lg);
          height: 100%;
          display: flex;
      ...
      `})]})}const Uy={0:"crit",1:"crit",2:"crit",3:"err",4:"warn",5:"notice",6:"info",7:"debug"},Vy=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`};function Hy({open:e,onClose:t,clusterId:n}){const{t:a}=Ce(),[s,o]=p.useState([]),[i,l]=p.useState(!1),[c,d]=p.useState(null),[h,g]=p.useState(""),[u,x]=p.useState(!0),b=p.useRef(null),k=async()=>{if(n){l(!0),d(null);try{const f=await fetch(`/api/clusters/${encodeURIComponent(n)}/log?max=500`,{credentials:"same-origin"});if(!f.ok){const j=await f.json().catch(()=>({}));throw new Error(j.error||`HTTP ${f.status}`)}const v=await f.json();o(v.lines||[])}catch(f){d(f.message||String(f))}finally{l(!1)}}};p.useEffect(()=>{e&&k()},[e,n]),p.useEffect(()=>{if(!e||!u)return;const f=setInterval(k,5e3);return()=>clearInterval(f)},[e,u,n]);const y=h.trim().toLowerCase(),m=y?s.filter(f=>(f.msg||"").toLowerCase().includes(y)||(f.node||"").toLowerCase().includes(y)||(f.user||"").toLowerCase().includes(y)||(f.tag||"").toLowerCase().includes(y)):s;return e?r.jsx("div",{className:"cl-back",onClick:t,children:r.jsxs("div",{className:"cl-modal",onClick:f=>f.stopPropagation(),children:[r.jsxs("div",{className:"cl-head",children:[r.jsxs("div",{className:"cl-title",children:[r.jsxs("svg",{width:"20",height:"20",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"}),r.jsx("line",{x1:"9",y1:"13",x2:"15",y2:"13"}),r.jsx("line",{x1:"9",y1:"17",x2:"15",y2:"17"})]}),r.jsx("span",{children:a("clog.title")})]}),r.jsxs("div",{className:"cl-actions",children:[r.jsx("input",{className:"cl-filter",value:h,onChange:f=>g(f.target.value),placeholder:a("clog.filter_ph")}),r.jsxs("label",{className:"cl-auto",children:[r.jsx("input",{type:"checkbox",checked:u,onChange:f=>x(f.target.checked)}),a("tasks.auto_refresh")]}),r.jsxs("button",{className:"cl-btn",onClick:k,disabled:i,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:a("tasks.refresh")})]}),r.jsx("button",{className:"cl-close",onClick:t,children:"×"})]})]}),r.jsx("div",{className:"cl-meta",children:r.jsxs("span",{children:[m.length,h&&` / ${s.length}`]})}),r.jsxs("div",{className:"cl-body",ref:b,children:[c&&r.jsx("div",{className:"cl-error",children:c}),m.length===0&&!i&&r.jsx("div",{className:"cl-empty",children:a(h?"clog.no_match":"clog.empty")}),m.map((f,v)=>r.jsxs("div",{className:`cl-row cl-pri-${Uy[f.pri??6]||"info"}`,children:[r.jsx("span",{className:"cl-time",children:Vy(f.time)}),r.jsx("span",{className:"cl-node",children:f.node||"—"}),r.jsx("span",{className:"cl-user",children:f.user||""}),r.jsx("span",{className:"cl-tag",children:f.tag||""}),r.jsx("span",{className:"cl-msg",children:f.msg||""})]},f.n??v))]}),r.jsx("style",{children:`
        ...
        `})]})}):null}const Yy={running:"tasks.filter.running",ok:"tasks.filter.ok",error:"tasks.filter.error"},Qf=(e,t)=>{if(!e)return"—";const a=(t??Math.floor(Date.now()/1e3))-e;if(a<0)return"—";if(a<60)return`${a}s`;if(a<3600)return`${Math.floor(a/60)}m ${a%60}s`;const s=Math.floor(a/3600),o=Math.floor(a%3600/60);return`${s}h ${o}m`},Jf=e=>{if(!e)return"—";const t=new Date(e*1e3),n=a=>String(a).padStart(2,"0");return`${t.getFullYear()}-${n(t.getMonth()+1)}-${n(t.getDate())} ${n(t.getHours())}:${n(t.getMinutes())}:${n(t.getSeconds())}`},Gy=()=>{if(typeof window>"u")return{vmid:"",cluster:null};const e=new URLSearchParams(window.location.search);return{vmid:e.get("vmid")||"",cluster:e.get("cluster")}};function Ky({clusters:e,selectedCluster:t}){const{t:n,language:a}=Ce(),s=Pr(),o=p.useRef(Gy()),i=p.useMemo(()=>Object.keys(e),[e]),[l,c]=p.useState(()=>o.current.cluster&&e[o.current.cluster]?o.current.cluster:t&&t!=="__all__"&&e[t]?t:i[0]||"");p.useEffect(()=>{!t||t==="__all__"||e[t]&&t!==l&&c(t)},[t]);const[d,h]=p.useState(""),[g,u]=p.useState("all"),[x,b]=p.useState(o.current.vmid),[k,y]=p.useState(""),[m,f]=p.useState([]),[v,j]=p.useState([]),[w,S]=p.useState([]),[C,N]=p.useState(!1),[L,I]=p.useState(null),[P,E]=p.useState(!0),[G,A]=p.useState(null),[T,K]=p.useState(!1),O=p.useRef(new Set),W=p.useRef(new Map),B=p.useRef(!0),[q,J]=p.useState(new Set),[z,ge]=p.useState(new Set),je=p.useCallback(async(X=!1)=>{if(!l)return;N(!0),I(null);const ue=new URLSearchParams;d&&ue.set("type",d),g!=="all"&&ue.set("status",g),x&&ue.set("vmid",x),k&&ue.set("user",k),ue.set("limit","300"),X&&ue.set("force","1");try{const ke=await fetch(`/api/clusters/${encodeURIComponent(l)}/tasks?`+ue.toString(),{credentials:"same-origin"});if(!ke.ok){const Y=await ke.json().catch(()=>({}));throw new Error(Y.error||`HTTP ${ke.status}`)}const te=await ke.json(),Z=te.tasks||[],F=new Set,M=new Set;if(!B.current)for(const Y of Z)if(!O.current.has(Y.upid))F.add(Y.upid);else{const re=W.current.get(Y.upid);re&&re!==Y._status&&M.add(Y.upid)}for(const Y of Z)O.current.add(Y.upid),W.current.set(Y.upid,Y._status);O.current.size>5e3&&(O.current=new Set(Z.map(Y=>Y.upid)),W.current=new Map(Z.map(Y=>[Y.upid,Y._status]))),B.current=!1,f(Z),j(te.types||[]),S(te.users||[]),F.size>0&&(J(F),setTimeout(()=>J(new Set),900)),M.size>0&&(ge(M),setTimeout(()=>ge(new Set),900))}catch(ke){I(ke.message||String(ke))}finally{N(!1)}},[l,d,g,x,k]);p.useEffect(()=>{je(!1)},[je]),p.useEffect(()=>{if(!P)return;const X=setInterval(()=>je(!0),5e3);return()=>clearInterval(X)},[P,je]);const Oe=p.useMemo(()=>m.filter(X=>X._status==="running").length,[m]);return r.jsxs("div",{className:"pt-page",children:[r.jsxs("div",{className:"pt-header",children:[r.jsxs("div",{className:"pt-title-section",children:[r.jsxs("h1",{className:"pt-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M9 7h8M9 12h8M9 17h5"}),r.jsx("circle",{cx:"6",cy:"7",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"12",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"17",r:"1",fill:"currentColor"})]}),n("tasks.title")]}),r.jsx("div",{className:"pt-sub",children:n("tasks.subtitle")})]}),r.jsxs("div",{className:"pt-actions",children:[r.jsxs("label",{className:"pt-auto",children:[r.jsx("input",{type:"checkbox",checked:P,onChange:X=>E(X.target.checked)}),n("tasks.auto_refresh")]}),r.jsxs("button",{className:"pt-btn",onClick:()=>{const X=["starttime","endtime","duration_s","type","id","node","user","status","upid"],ue=m.map(Y=>[Y.starttime?new Date(Y.starttime*1e3).toISOString():"",Y.endtime?new Date(Y.endtime*1e3).toISOString():"",Y.starttime&&Y.endtime?String(Y.endtime-Y.starttime):"",Y.type||"",Y.id||"",Y.node||"",Y.user||"",Y._status,Y.upid]),ke=Y=>/[",\n]/.test(Y)?'"'+Y.replace(/"/g,'""')+'"':Y,te=[X.join(","),...ue.map(Y=>Y.map(ke).join(","))].join(`
`),Z=new Blob([te],{type:"text/csv;charset=utf-8"}),F=document.createElement("a");F.href=URL.createObjectURL(Z);const M=new Date().toISOString().replace(/[:.]/g,"-").slice(0,19);F.download=`pve-tasks-${l}-${M}.csv`,document.body.appendChild(F),F.click(),F.remove(),setTimeout(()=>URL.revokeObjectURL(F.href),1e3)},disabled:m.length===0,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"}),r.jsx("polyline",{points:"7 10 12 15 17 10"}),r.jsx("line",{x1:"12",y1:"15",x2:"12",y2:"3"})]}),r.jsx("span",{children:"CSV"})]}),r.jsxs("button",{className:"pt-btn",onClick:()=>K(!0),children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"}),r.jsx("polyline",{points:"14 2 14 8 20 8"}),r.jsx("line",{x1:"9",y1:"13",x2:"15",y2:"13"}),r.jsx("line",{x1:"9",y1:"17",x2:"15",y2:"17"})]}),r.jsx("span",{children:n("clog.button")})]}),r.jsxs("button",{className:"pt-btn",onClick:()=>je(!0),disabled:C,children:[r.jsxs("svg",{width:"13",height:"13",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("polyline",{points:"23 4 23 10 17 10"}),r.jsx("polyline",{points:"1 20 1 14 7 14"}),r.jsx("path",{d:"M3.51 9a9 9 0 0 1 14.85-3.36L23 10M1 14l4.64 4.36A9 9 0 0 0 20.49 15"})]}),r.jsx("span",{children:n("tasks.refresh")})]})]})]}),r.jsx(Hy,{open:T,clusterId:l,onClose:()=>K(!1)}),r.jsxs("div",{className:"pt-filters",children:[r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.cluster")}),r.jsx("select",{value:l,onChange:X=>c(X.target.value),children:i.map(X=>{var ue;return r.jsx("option",{value:X,children:((ue=e[X])==null?void 0:ue.name)||X},X)})})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.type")}),r.jsxs("select",{value:d,onChange:X=>h(X.target.value),children:[r.jsx("option",{value:"",children:n("tasks.filter.all")}),v.map(X=>r.jsx("option",{value:X,children:X},X))]})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.status")}),r.jsxs("select",{value:g,onChange:X=>u(X.target.value),children:[r.jsx("option",{value:"all",children:n("tasks.filter.all")}),r.jsx("option",{value:"running",children:n("tasks.filter.running")}),r.jsx("option",{value:"ok",children:n("tasks.filter.ok")}),r.jsx("option",{value:"error",children:n("tasks.filter.error")})]})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.vmid")}),r.jsx("input",{type:"text",inputMode:"numeric",value:x,onChange:X=>b(X.target.value.replace(/[^\d]/g,"")),placeholder:"e.g. 102"})]}),r.jsxs("label",{className:"pt-f",children:[r.jsx("span",{children:n("tasks.filter.user")}),r.jsxs("select",{value:k,onChange:X=>y(X.target.value),children:[r.jsx("option",{value:"",children:n("tasks.filter.all")}),w.map(X=>r.jsx("option",{value:X,children:X},X))]})]}),r.jsxs("span",{className:"pt-count",children:[m.length," / ",Oe?`${Oe} ${n("tasks.filter.running").toLowerCase()}`:""]})]}),L&&r.jsx("div",{className:"pt-error",children:L}),r.jsx("div",{className:"pt-tablewrap",children:r.jsxs("table",{className:"vm-table pt-table",children:[r.jsx("thead",{children:r.jsxs("tr",{children:[r.jsx("th",{children:n("tasks.col.starttime")}),r.jsx("th",{children:n("tasks.col.duration")}),r.jsx("th",{children:n("tasks.col.type")}),r.jsx("th",{children:n("tasks.col.target")}),r.jsx("th",{children:n("tasks.col.node")}),r.jsx("th",{children:n("tasks.col.user")}),r.jsx("th",{children:n("tasks.col.status")})]})}),r.jsxs("tbody",{children:[m.length===0&&!C&&r.jsx("tr",{children:r.jsx("td",{colSpan:7,className:"pt-empty",children:n("tasks.empty")})}),m.map(X=>{const ue=[X===G?"pt-active":"",q.has(X.upid)?"pt-new":""].filter(Boolean).join(" "),ke=["pt-st",`pt-st-${X._status}`,z.has(X.upid)?"pt-st-pulse":""].join(" ");return r.jsxs("tr",{className:ue,onClick:()=>A(X),children:[r.jsx("td",{className:"pt-mono",children:Jf(X.starttime)}),r.jsx("td",{className:"pt-mono",children:Qf(X.starttime,X.endtime)}),r.jsx("td",{children:r.jsx("span",{className:`pt-type pt-type-${X.type}`,children:X.type})}),r.jsx("td",{className:"pt-mono",children:X.id||"—"}),r.jsx("td",{className:"pt-mono",children:X.node}),r.jsx("td",{className:"pt-mono",children:X.user||"—"}),r.jsx("td",{children:r.jsx("span",{className:ke,children:n(Yy[X._status]||"tasks.filter.all")})})]},X.upid)})]})]})}),G&&r.jsx(Xy,{clusterId:l,task:G,onClose:()=>A(null),onCopyUpid:async()=>{try{await navigator.clipboard.writeText(G.upid),s.alert(a==="zh-TW"?"UPID 已複製":"UPID copied")}catch{}}}),r.jsx("style",{children:`
        .pt-page {
          padding: 24px 32px;
          height: 100%;
          display: flex; flex-direction: column;
...
`)})]})]}),r.jsx("style",{children:`
      ...
      `})]})}const Kp={critical:0,warning:1,info:2,ok:3};function qy({clusters:e,onNavigate:t}){const{t:n,language:a}=Ce(),[s,o]=p.useState({}),[i,l]=p.useState([]),[c,d]=p.useState([]),[h,g]=p.useState([]),[u,x]=p.useState([]),[b,k]=p.useState(0),y=p.useCallback(async()=>{const j={},w=[],S=[],C=[],N=[],L=[];for(const[I,P]of Object.entries(e)){const E=P.name||I;L.push((async()=>{try{const G=await fetch(`/api/clusters/${encodeURIComponent(I)}/tasks?status=error&limit=200`,{credentials:"same-origin"});if(G.ok){const A=await G.json(),T=Math.floor(Date.now()/1e3)-86400;j[I]=(A.tasks||[]).filter(K=>(K.starttime||0)>T).length}}catch{}})()),L.push((async()=>{try{const G=await fetch(`/api/clusters/${encodeURIComponent(I)}/ha/status`,{credentials:"same-origin"});if(G.ok){const A=await G.json();for(const T of A.resources||[]){const K=(T.state||T["request-state"]||"").toLowerCase();K&&K!=="started"&&K!=="stopped"&&C.push({cluster:E,clusterId:I,sid:T.sid||"",state:K,node:T.node||T.crm_state||""})}}}catch{}})()),L.push((async()=>{try{const G=await fetch(`/api/clusters/${encodeURIComponent(I)}/replication-jobs`,{credentials:"same-origin"});if(G.ok){const A=await G.json();for(const T of A.jobs||[])(T.error||T.fail_count&&Number(T.fail_count)>0)&&N.push({cluster:E,clusterId:I,sid:T.id||T.guest||"",error:T.error||`fail_count=${T.fail_count}`})}}catch{}})());for(const G of Object.keys(P.nodes||{}))L.push((async()=>{try{const A=await fetch(`/api/clusters/${encodeURIComponent(I)}/nodes/${encodeURIComponent(G)}/certificates`,{credentials:"same-origin"});if(A.ok){const K=(await A.json()).certificates||[];let O=null;for(const W of K){const B=W.notafter||W["notafter-formatted"];if(!B)continue;const q=typeof B=="number"?B:Date.parse(String(B))/1e3;!q||isNaN(q)||(!O||q<O.ts)&&(O={ts:q,subj:W.subject||W.filename||"cert"})}if(O){const W=Math.floor((O.ts-Date.now()/1e3)/86400);W<90&&w.push({cluster:E,clusterId:I,node:G,days:W,subject:O.subj})}}}catch{}})()),L.push((async()=>{try{const A=await fetch(`/api/clusters/${encodeURIComponent(I)}/nodes/${encodeURIComponent(G)}/updates`,{credentials:"same-origin"});if(A.ok){const T=await A.json();(T.count??0)>0&&S.push({cluster:E,clusterId:I,node:G,count:T.count})}}catch{}})())}await Promise.all(L),o(j),l(w),d(S),g(C),x(N),k(Date.now())},[e]);p.useEffect(()=>{y()},[y]),p.useEffect(()=>{const j=setInterval(y,6e4);return()=>clearInterval(j)},[y]);const m=p.useMemo(()=>{var w,S,C;const j=[];for(const[N,L]of Object.entries(e)){const I=L.name||N;for(const[G,A]of Object.entries(L.nodes||{})){const T=A;T.status&&T.status!=="online"&&j.push({sev:"critical",cluster:I,target:`node:${G}`,category:n("health.cat.node_down"),msg:a==="zh-TW"?`${G} 狀態 ${T.status}`:`${G} is ${T.status}`,navView:"cluster-core",navParams:{cluster:N}});const K=((w=T.cpu)==null?void 0:w.usage_percent)||0,O=((S=T.memory)==null?void 0:S.usage_percent)||0;K>92&&j.push({sev:"warning",cluster:I,target:`node:${G}`,category:n("health.cat.high_cpu"),msg:`${G} CPU ${K.toFixed(0)}%`,navView:"cluster-core",navParams:{cluster:N}}),O>92&&j.push({sev:"warning",cluster:I,target:`node:${G}`,category:n("health.cat.high_mem"),msg:`${G} ${a==="zh-TW"?"記憶體":"memory"} ${O.toFixed(0)}%`,navView:"cluster-core",navParams:{cluster:N}})}for(const[G,A]of Object.entries(L.storages||{})){const T=A,K=T.usage_percent??T.used_pct??0;K>=95?j.push({sev:"critical",cluster:I,target:`storage:${G}`,category:n("health.cat.storage_full"),msg:`${T.storage||G} ${K.toFixed(0)}% `+(a==="zh-TW"?"已用":"used"),navView:"storage",navParams:{cluster:N}}):K>=85&&j.push({sev:"warning",cluster:I,target:`storage:${G}`,category:n("health.cat.storage_high"),msg:`${T.storage||G} ${K.toFixed(0)}% `+(a==="zh-TW"?"已用":"used"),navView:"storage",navParams:{cluster:N}})}const P=L.ceph;if(P){const G=(P.status||((C=P.health)==null?void 0:C.status)||"").toUpperCase();G.includes("ERR")?j.push({sev:"critical",cluster:I,target:"ceph",category:n("health.cat.ceph_err"),msg:G,navView:"ceph-constellation",navParams:{cluster:N}}):G.includes("WARN")&&j.push({sev:"warning",cluster:I,target:"ceph",category:n("health.cat.ceph_warn"),msg:G,navView:"ceph-constellation",navParams:{cluster:N}})}const E=s[N]||0;E>0&&j.push({sev:E>=10?"warning":"info",cluster:I,target:"tasks",category:n("health.cat.task_failures"),msg:a==="zh-TW"?`過去 24h 共 ${E} 筆作業失敗`:`${E} task error(s) in the last 24h`,navView:"tasks",navParams:{cluster:N}})}for(const N of i){let L="info";if(N.days<0)L="critical";else if(N.days<14)L="critical";else if(N.days<30)L="warning";else if(N.days<60)L="info";else continue;j.push({sev:L,cluster:N.cluster,target:`cert:${N.node}`,category:N.days<0?n("health.cat.cert_expired"):n("health.cat.cert_expiring"),msg:a==="zh-TW"?`${N.node}: ${N.subject} (${N.days<0?`已過期 ${Math.abs(N.days)} 天`:`${N.days} 天`})`:`${N.node}: ${N.subject} (${N.days<0?`expired ${Math.abs(N.days)}d ago`:`${N.days}d`})`,navView:"cluster-core",navParams:{cluster:N.clusterId}})}for(const N of c)j.push({sev:N.count>=50?"warning":"info",cluster:N.cluster,target:`updates:${N.node}`,category:n("health.cat.updates"),msg:a==="zh-TW"?`${N.node}: ${N.count} 個套件待更新`:`${N.node}: ${N.count} package update(s) pending`,navView:"cluster-core",navParams:{cluster:N.clusterId}});for(const N of h){const L=N.state==="error"?"critical":"warning";j.push({sev:L,cluster:N.cluster,target:`ha:${N.sid}`,category:n("health.cat.ha"),msg:a==="zh-TW"?`${N.sid}: ${N.state}（節點 ${N.node||"?"}）`:`${N.sid}: ${N.state} (node ${N.node||"?"})`,navView:"cluster-core",navParams:{cluster:N.clusterId}})}for(const N of u)j.push({sev:"warning",cluster:N.cluster,target:`repl:${N.sid}`,category:n("health.cat.replication"),msg:`${N.sid}: ${N.error}`,navView:"cluster-core",navParams:{cluster:N.clusterId}});return j.sort((N,L)=>Kp[N.sev]-Kp[L.sev]),j},[e,s,i,c,h,u,a,n]),f=p.useMemo(()=>{const j={critical:0,warning:0,info:0,ok:0};for(const w of m)j[w.sev]++;return j},[m]),v=p.useMemo(()=>{let j=0,w=0,S=0,C=0,N=0,L=0,I=0;for(const P of Object.values(e)){for(const E of Object.values(P.nodes||{}))j++,E.status==="online"&&w++;for(const E of Object.values(P.vms||{}))E.type==="lxc"?(N++,E.status==="running"&&L++):(S++,E.status==="running"&&C++);I+=Object.keys(P.storages||{}).length}return{nodes:j,online:w,vms:S,running:C,cts:N,ctsRunning:L,storages:I}},[e]);return r.jsxs("div",{className:"hm-page",children:[r.jsxs("div",{className:"hm-header",children:[r.jsxs("div",{className:"title-section",children:[r.jsxs("h1",{className:"hm-title font-display",children:[r.jsxs("svg",{className:"title-icon",width:"24",height:"24",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),r.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),n("health.title")]}),r.jsxs("div",{className:"hm-sub",children:[n("health.subtitle"),b?` · ${n("health.updated")} ${new Date(b).toLocaleTimeString()}`:""]})]}),r.jsxs("div",{className:"hm-tally",children:[r.jsxs("span",{className:"hm-pill hm-pill-critical",children:[f.critical," ",n("health.sev.critical")]}),r.jsxs("span",{className:"hm-pill hm-pill-warning",children:[f.warning," ",n("health.sev.warning")]}),r.jsxs("span",{className:"hm-pill hm-pill-info",children:[f.info," ",n("health.sev.info")]})]})]}),r.jsxs("div",{className:"hm-stats",children:[r.jsxs("div",{className:"hm-stat",onClick:()=>t("cluster-core"),children:[r.jsxs("div",{className:"hm-stat-num",children:[v.online,r.jsxs("span",{className:"hm-stat-of",children:["/",v.nodes]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.nodes")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("holo-matrix"),children:[r.jsxs("div",{className:"hm-stat-num",children:[v.running,r.jsxs("span",{className:"hm-stat-of",children:["/",v.vms]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.vms")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("holo-matrix"),children:[r.jsxs("div",{className:"hm-stat-num",children:[v.ctsRunning,r.jsxs("span",{className:"hm-stat-of",children:["/",v.cts]})]}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.cts")})]}),r.jsxs("div",{className:"hm-stat",onClick:()=>t("storage"),children:[r.jsx("div",{className:"hm-stat-num",children:v.storages}),r.jsx("div",{className:"hm-stat-lbl",children:n("health.stat.storages")})]})]}),m.length===0?r.jsxs("div",{className:"hm-empty",children:[r.jsxs("svg",{width:"40",height:"40",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),r.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),r.jsx("div",{className:"hm-empty-title",children:n("health.empty.title")}),r.jsx("div",{className:"hm-empty-sub",children:n("health.empty.sub")})]}):r.jsx("div",{className:"hm-grid",children:m.map((j,w)=>r.jsxs("div",{className:`hm-card hm-card-${j.sev}`,onClick:()=>{var S;return j.navView&&t(j.navView,{cluster:(S=j.navParams)==null?void 0:S.cluster})},children:[r.jsxs("div",{className:"hm-card-head",children:[r.jsx("span",{className:"hm-card-sev",children:j.sev.toUpperCase()}),r.jsx("span",{className:"hm-card-cluster",children:j.cluster})]}),r.jsx("div",{className:"hm-card-cat",children:j.category}),r.jsx("div",{className:"hm-card-msg",children:j.msg})]},w))}),r.jsx("style",{children:`
        .hm-page {
      ...
      `})]})}function Zy({clusters:e,onNavigate:t}){const{t:n,language:a}=Ce(),[s,o]=p.useState(!1),[i,l]=p.useState(""),[c,d]=p.useState(0),h=p.useRef(null),g=p.useRef(null);p.useEffect(()=>{const y=m=>{if((m.metaKey||m.ctrlKey)&&m.key.toLowerCase()==="k"){m.preventDefault(),o(f=>!f);return}m.key==="Escape"&&s&&o(!1)};return window.addEventListener("keydown",y),()=>window.removeEventListener("keydown",y)},[s]),p.useEffect(()=>{s?setTimeout(()=>{var y;return(y=h.current)==null?void 0:y.focus()},30):(l(""),d(0))},[s]);const u=(y,m)=>{if(!m)return 0;const f=y.toLowerCase(),v=m.toLowerCase();if(f===v)return 100;if(f.startsWith(v))return 80;if(f.indexOf(" "+v)>=0)return 70;const w=f.indexOf(v);return w>=0?50-Math.min(20,w):0},x=p.useMemo(()=>{const y=i.trim();if(!y)return[];const m=[];for(const[f,v]of Object.entries(e)){const j=v.name||f;for(const w of Object.values(v.vms||{})){const S=w.type==="lxc",C=`${w.vmid} ${w.name||""} ${w.node||""} ${j}`,N=Math.max(u(String(w.vmid),y),u(w.name||"",y),u(C,y));N>0&&m.push({kind:S?"ct":"vm",cluster:f,clusterName:j,name:`${S?"CT":"VM"} ${w.vmid} — ${w.name||"(unnamed)"}`,meta:`${j} · ${w.node||"?"} · ${w.status||"unknown"}`,score:N+(w.status==="running"?2:0),go:()=>{t("holo-matrix",{cluster:f})}})}for(const w of Object.values(v.nodes||{})){const S=Math.max(u(w.node||"",y),u(`${w.node} ${j}`,y));S>0&&m.push({kind:"node",cluster:f,clusterName:j,name:w.node,meta:`${j} · ${w.status||"?"} · ${w.vm_count||0}+${w.ct_count||0}`,score:S,go:()=>t("cluster-core",{cluster:f})})}for(const w of Object.values(v.storages||{})){const S=Math.max(u(w.storage||"",y),u(`${w.storage} ${w.node||""} ${j}`,y));S>0&&m.push({kind:"storage",cluster:f,clusterName:j,name:w.storage,meta:`${j} · ${w.node||"?"} · ${w.type||""}`,score:S,go:()=>t("storage",{cluster:f})})}}return m.sort((f,v)=>v.score-f.score),m.slice(0,30)},[i,e,t]);if(p.useEffect(()=>{d(0)},[i]),p.useEffect(()=>{const y=g.current;if(!y)return;const m=y.querySelector(`[data-idx="${c}"]`);m==null||m.scrollIntoView({block:"nearest"})},[c]),!s)return null;const b=y=>{if(y.key==="ArrowDown")y.preventDefault(),d(m=>Math.min(x.length-1,m+1));else if(y.key==="ArrowUp")y.preventDefault(),d(m=>Math.max(0,m-1));else if(y.key==="Enter"){y.preventDefault();const m=x[c];m&&(m.go(),o(!1))}},k=y=>y==="vm"||y==="ct"?r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"3",width:"20",height:"14",rx:"2"}),r.jsx("line",{x1:"8",y1:"21",x2:"16",y2:"21"}),r.jsx("line",{x1:"12",y1:"17",x2:"12",y2:"21"})]}):y==="node"?r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"2",width:"20",height:"8",rx:"2"}),r.jsx("rect",{x:"2",y:"14",width:"20",height:"8",rx:"2"}),r.jsx("circle",{cx:"6",cy:"6",r:"1",fill:"currentColor"})]}):r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"5",rx:"9",ry:"3"}),r.jsx("path",{d:"M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"}),r.jsx("path",{d:"M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"})]});return r.jsx("div",{className:"cp-back",onClick:()=>o(!1),children:r.jsxs("div",{className:"cp-modal",onClick:y=>y.stopPropagation(),children:[r.jsxs("div",{className:"cp-input-row",children:[r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"11",cy:"11",r:"8"}),r.jsx("path",{d:"M21 21l-4.35-4.35"})]}),r.jsx("input",{ref:h,value:i,placeholder:n("cmdk.placeholder"),onChange:y=>l(y.target.value),onKeyDown:b}),r.jsx("span",{className:"cp-hint",children:"↑↓ ⏎"}),r.jsx("button",{className:"cp-x",onClick:()=>o(!1),children:"×"})]}),r.jsxs("div",{className:"cp-list",ref:g,children:[x.length===0&&i&&r.jsx("div",{className:"cp-empty",children:n("cmdk.empty")}),x.length===0&&!i&&r.jsx("div",{className:"cp-empty",children:n("cmdk.tip")}),x.map((y,m)=>r.jsxs("div",{"data-idx":m,className:`cp-item ${m===c?"cp-active":""}`,onClick:()=>{y.go(),o(!1)},onMouseEnter:()=>d(m),children:[r.jsx("span",{className:`cp-kind cp-kind-${y.kind}`,children:k(y.kind)}),r.jsx("span",{className:"cp-name",children:y.name}),r.jsx("span",{className:"cp-meta",children:y.meta})]},`${y.kind}:${y.cluster}:${y.name}:${m}`))]}),r.jsxs("div",{className:"cp-foot",children:[r.jsx("span",{className:"cp-foot-key",children:"⌘K"}),r.jsx("span",{children:n("cmdk.toggle")})]}),r.jsx("style",{children:`
        ...
        `})]})})}function e2({open:e,cluster_id:t,kind:n,title:a,body:s,label:o,onClose:i,onSaved:l}){const{t:c}=Ce(),[d,h]=p.useState(""),[g,u]=p.useState(!1),[x,b]=p.useState(""),k=p.useRef(null);if(p.useEffect(()=>{e&&(h(""),b(""),u(!1),setTimeout(()=>{var m;return(m=k.current)==null?void 0:m.focus()},50))},[e]),p.useEffect(()=>{if(!e)return;const m=f=>{f.key==="Escape"&&!g&&i()};return document.addEventListener("keydown",m),()=>document.removeEventListener("keydown",m)},[e,g,i]),!e)return null;const y=async()=>{if(d){u(!0),b("");try{await We.setClusterSecret(t,n,d),l()}catch(m){b(m instanceof Error?m.message:String(m)),u(!1)}}};return r.jsxs("div",{onClick:()=>!g&&i(),style:t2,children:[r.jsx("style",{children:r2}),r.jsxs("div",{className:"ssm-modal",onClick:m=>m.stopPropagation(),children:[r.jsxs("div",{className:"ssm-eyebrow",children:["// secret · ",t]}),r.jsx("h3",{className:"ssm-title",children:a}),r.jsx("p",{className:"ssm-body",children:s}),r.jsx("label",{children:o}),r.jsx("input",{ref:k,type:"password",value:d,onChange:m=>h(m.target.value),onKeyDown:m=>{m.key==="Enter"&&y()},autoComplete:"new-password",spellCheck:!1}),x&&r.jsx("div",{className:"ssm-err",children:x}),r.jsxs("div",{className:"ssm-actions",children:[r.jsx("button",{className:"ghost",onClick:i,disabled:g,children:c("action.cancel")}),r.jsx("button",{className:"primary",onClick:y,disabled:g||!d,children:g?"…":c("action.save")})]})]})]})}const t2={position:"fixed",inset:0,zIndex:400,background:"rgba(0,0,0,.78)",backdropFilter:"blur(6px)",display:"flex",alignItems:"center",justifyContent:"center",padding:24,animation:"ssmFade .18s ease"},r2=`
...
`;function n2({onClose:e,clusters:t}){const{t:n,language:a,setLanguage:s}=Ce(),o=Pr(),[i,l]=p.useState(null),[c,d]=p.useState(!0),[h,g]=p.useState(!1),[u,x]=p.useState(null),[b,k]=p.useState(!1),[y,m]=p.useState("ui"),[f,v]=p.useState(!0),[j,w]=p.useState("cyberpunk"),[S,C]=p.useState("command-center"),[N,L]=p.useState(100),[I,P]=p.useState("all"),[E,G]=p.useState(85),[A,T]=p.useState("vmid"),[K,O]=p.useState("node"),[W,B]=p.useState("node"),[q,J]=p.useState("asc"),[z,ge]=p.useState({}),[je,Oe]=p.useState(!0),[X,ue]=p.useState(80),[ke,te]=p.useState(95),[Z,F]=p.useState(85),[M,Y]=p.useState(95),[re,be]=p.useState(80),[V,ce]=p.useState(95),[me,pe]=p.useState(50),[ye,Fe]=p.useState(100),[Je,Ye]=p.useState(5),[Xe,fe]=p.useState(10),[Se,De]=p.useState("0.0.0.0"),[H,oe]=p.useState(8098),[ne,we]=p.useState(!1),[Me,Ae]=p.useState(8086),[Nt,$t]=p.useState("disabled"),[le,Ue]=p.useState(null),[Te,Ge]=p.useState({}),ft=()=>{k(!0),setTimeout(()=>e(),400)};p.useEffect(()=>{or()},[]);const or=async()=>{var Q,Ze,it,ht,et,dt,vt,wn,kn,jn,Nn,Xr,_n,qt,Ir,Sn,tt,qr,Qr,Jr,ze,$e,rt,Re,Ke,Qt,at,gt,_r,Dt,Lr,Jt,Zt,Vn,Et;try{d(!0);const Ne=await We.getConfig();l(Ne),v(((Q=Ne.ui)==null?void 0:Q.animations_enabled)??!0),w(((Ze=Ne.ui)==null?void 0:Ze.theme)??"cyberpunk"),C(((it=Ne.ui)==null?void 0:it.default_view)??"command-center"),L(((ht=Ne.ui)==null?void 0:ht.particle_count)??100),P(((et=Ne.ui)==null?void 0:et.vm_matrix_default_filter)??"all"),G(((dt=Ne.ui)==null?void 0:dt.matrix_card_width)??85),T(((vt=Ne.ui)==null?void 0:vt.matrix_sort_by)??"vmid"),O(((wn=Ne.ui)==null?void 0:wn.matrix_group_by)??"node"),B(((kn=Ne.ui)==null?void 0:kn.matrix_group_sort_by)??"node"),J(((jn=Ne.ui)==null?void 0:jn.matrix_group_sort_order)??"asc"),localStorage.setItem("vm_matrix_default_filter",((Nn=Ne.ui)==null?void 0:Nn.vm_matrix_default_filter)??"all"),localStorage.setItem("matrix_card_width",String(((Xr=Ne.ui)==null?void 0:Xr.matrix_card_width)??85)),localStorage.setItem("matrix_sort_by",((_n=Ne.ui)==null?void 0:_n.matrix_sort_by)??"vmid"),localStorage.setItem("matrix_group_by",((qt=Ne.ui)==null?void 0:qt.matrix_group_by)??"node"),localStorage.setItem("matrix_group_sort_by",((Ir=Ne.ui)==null?void 0:Ir.matrix_group_sort_by)??"node"),localStorage.setItem("matrix_group_sort_order",((Sn=Ne.ui)==null?void 0:Sn.matrix_group_sort_order)??"asc");const Hn={};(tt=Ne.clusters)==null||tt.forEach(ir=>{Hn[ir.id]={enabled:ir.enabled!==!1,poll_interval:ir.poll_interval||5,static_refresh_interval:ir.static_refresh_interval||60}}),ge(Hn),Oe(((qr=Ne.alerts)==null?void 0:qr.enabled)??!0),ue(((Qr=Ne.alerts)==null?void 0:Qr.cpu_warning)??80),te(((Jr=Ne.alerts)==null?void 0:Jr.cpu_critical)??95),F(((ze=Ne.alerts)==null?void 0:ze.memory_warning)??85),Y((($e=Ne.alerts)==null?void 0:$e.memory_critical)??95),be(((rt=Ne.alerts)==null?void 0:rt.disk_warning)??80),ce(((Re=Ne.alerts)==null?void 0:Re.disk_critical)??95),pe(((Ke=Ne.alerts)==null?void 0:Ke.diskio_warning)??50),Fe(((Qt=Ne.alerts)==null?void 0:Qt.diskio_critical)??100),Ye(((at=Ne.alerts)==null?void 0:at.iowait_warning)??5),fe(((gt=Ne.alerts)==null?void 0:gt.iowait_critical)??10),localStorage.setItem("iowait_warning",String(((_r=Ne.alerts)==null?void 0:_r.iowait_warning)??5)),localStorage.setItem("iowait_critical",String(((Dt=Ne.alerts)==null?void 0:Dt.iowait_critical)??10)),De(((Lr=Ne.server)==null?void 0:Lr.host)??"0.0.0.0"),oe(((Jt=Ne.server)==null?void 0:Jt.http_port)??8098),we(((Zt=Ne.server)==null?void 0:Zt.influx_enabled)??!1),Ae(((Vn=Ne.server)==null?void 0:Vn.influx_port)??8086),$t(((Et=Ne.console)==null?void 0:Et.mode)||"disabled");const $s={};(Ne.clusters||[]).forEach(ir=>{$s[ir.id]=!!(ir.auth&&ir.auth.password&&ir.auth.password.length>0)}),Ge($s)}catch(Ne){x(String(Ne))}finally{d(!1)}},wt=async()=>{var Q;try{g(!0),localStorage.setItem("matrix_card_width",String(E)),localStorage.setItem("matrix_sort_by",A),localStorage.setItem("matrix_group_by",K),localStorage.setItem("vm_matrix_default_filter",I),localStorage.setItem("matrix_group_sort_by",W),localStorage.setItem("matrix_group_sort_order",q),localStorage.setItem("iowait_warning",String(Je)),localStorage.setItem("iowait_critical",String(Xe));const Ze=(Q=i==null?void 0:i.clusters)==null?void 0:Q.map(it=>{var ht,et,dt;return{...it,enabled:((ht=z[it.id])==null?void 0:ht.enabled)!==!1,poll_interval:((et=z[it.id])==null?void 0:et.poll_interval)||it.poll_interval,static_refresh_interval:((dt=z[it.id])==null?void 0:dt.static_refresh_interval)||it.static_refresh_interval}});await We.updateConfig({server:{host:Se,http_port:H,influx_enabled:ne,influx_port:Me},console:{mode:Nt},ui:{default_view:S,theme:j,language:a,animations_enabled:f,particle_count:N,vm_matrix_default_filter:I,matrix_card_width:E,matrix_sort_by:A,matrix_group_by:K,matrix_group_sort_by:W,matrix_group_sort_order:q},alerts:{enabled:je,cpu_warning:X,cpu_critical:ke,memory_warning:Z,memory_critical:M,disk_warning:re,disk_critical:V,diskio_warning:me,diskio_critical:ye,iowait_warning:Je,iowait_critical:Xe},clusters:Ze}),e()}catch(Ze){x(String(Ze))}finally{g(!1)}},Xt=Q=>{ge(Ze=>{var it;return{...Ze,[Q]:{...Ze[Q],enabled:!((it=Ze[Q])!=null&&it.enabled)}}})},Pe=(Q,Ze,it)=>{ge(ht=>({...ht,[Q]:{...ht[Q],[Ze]:it}}))};p.useEffect(()=>{const Q=Ze=>{Ze.key==="Escape"&&!b&&ft()};return window.addEventListener("keydown",Q),()=>window.removeEventListener("keydown",Q)},[b]);const Nr=[{id:"ui",labelKey:"settings.tab_ui",icon:r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M3 9h18"})]})},{id:"clusters",labelKey:"settings.tab_clusters",icon:r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"7",height:"7"}),r.jsx("rect",{x:"14",y:"3",width:"7",height:"7"}),r.jsx("rect",{x:"3",y:"14",width:"7",height:"7"}),r.jsx("rect",{x:"14",y:"14",width:"7",height:"7"})]})},{id:"alerts",labelKey:"settings.tab_alerts",icon:r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"}),r.jsx("line",{x1:"12",y1:"9",x2:"12",y2:"13"}),r.jsx("line",{x1:"12",y1:"17",x2:"12.01",y2:"17"})]})},{id:"server",labelKey:"settings.tab_server",icon:r.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"2",width:"20",height:"8",rx:"2"}),r.jsx("rect",{x:"2",y:"14",width:"20",height:"8",rx:"2"}),r.jsx("line",{x1:"6",y1:"6",x2:"6.01",y2:"6"}),r.jsx("line",{x1:"6",y1:"18",x2:"6.01",y2:"18"})]})}];return r.jsxs("div",{className:`settings-overlay ${b?"exiting":""}`,onClick:Q=>Q.target===Q.currentTarget&&!b&&ft(),children:[r.jsxs("div",{className:`settings-panel panel ${b?"exiting":""}`,children:[r.jsx("div",{className:"settings-scanline"}),r.jsxs("div",{className:"settings-header",children:[r.jsx("h2",{className:"settings-title font-display",children:n("settings.title")}),r.jsx("button",{className:"settings-close",onClick:ft,children:"×"})]}),r.jsx("div",{className:"settings-tabs",children:Nr.map(Q=>r.jsxs("button",{className:`settings-tab ${y===Q.id?"active":""}`,onClick:()=>m(Q.id),children:[Q.icon,r.jsx("span",{children:n(Q.labelKey)})]},Q.id))}),r.jsx("div",{className:"settings-content",children:c?r.jsxs("div",{className:"settings-loading",children:[r.jsx("span",{className:"loading-spinner"}),r.jsx("span",{children:n("loading.data")})]}):u?r.jsx("div",{className:"settings-error",children:r.jsx("span",{children:u})}):r.jsxs(r.Fragment,{children:[y==="ui"&&r.jsxs("div",{className:"tab-content",children:[r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.default_view")}),r.jsx("div",{className:"radio-group",children:[{id:"command-center",labelKey:"nav.command_center"},{id:"cluster-core",labelKey:"nav.cluster_core"},{id:"holo-matrix",labelKey:"nav.holo_matrix"},{id:"radar-scan",labelKey:"nav.radar_scan"},{id:"storage",labelKey:"nav.storage"},{id:"ceph-constellation",labelKey:"nav.ceph"}].map(Q=>r.jsxs("label",{className:`radio-option ${S===Q.id?"active":""}`,children:[r.jsx("input",{type:"radio",name:"defaultView",value:Q.id,checked:S===Q.id,onChange:()=>C(Q.id)}),r.jsx("span",{className:"radio-label",children:n(Q.labelKey)})]},Q.id))})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.vm_matrix_filter")}),r.jsx("div",{className:"radio-group",children:["all","running","stopped"].map(Q=>r.jsxs("label",{className:`radio-option ${I===Q?"active":""}`,children:[r.jsx("input",{type:"radio",name:"vmFilter",value:Q,checked:I===Q,onChange:()=>P(Q)}),r.jsx("span",{className:"radio-label",children:n(`settings.filter_${Q}`)})]},Q))})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.matrix_card_width")}),r.jsxs("div",{className:"input-row",children:[r.jsx("input",{type:"number",className:"input-field",value:E,onChange:Q=>G(Number(Q.target.value)),min:60,max:200}),r.jsx("span",{className:"input-hint",children:"60-200 px"})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.matrix_sort_by")}),r.jsx("div",{className:"radio-group",children:["vmid","name","load"].map(Q=>r.jsxs("label",{className:`radio-option ${A===Q?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixSortBy",value:Q,checked:A===Q,onChange:()=>T(Q)}),r.jsx("span",{className:"radio-label",children:n(`settings.sort_${Q}`)})]},Q))})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.matrix_group_by")}),r.jsx("div",{className:"radio-group",children:["none","node","type","tag"].map(Q=>r.jsxs("label",{className:`radio-option ${K===Q?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixGroupBy",value:Q,checked:K===Q,onChange:()=>O(Q)}),r.jsx("span",{className:"radio-label",children:n(`matrix.group_${Q}`)})]},Q))})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.matrix_group_sort")}),r.jsxs("div",{className:"settings-row",children:[r.jsxs("div",{className:"settings-item",children:[r.jsx("label",{children:n("settings.sort_by")}),r.jsxs("div",{className:"radio-group inline",children:[r.jsxs("label",{className:`radio-option ${W==="node"?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixGroupSortBy",value:"node",checked:W==="node",onChange:()=>B("node")}),r.jsx("span",{className:"radio-label",children:n("settings.sort_node")})]}),r.jsxs("label",{className:`radio-option ${W==="cluster"?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixGroupSortBy",value:"cluster",checked:W==="cluster",onChange:()=>B("cluster")}),r.jsx("span",{className:"radio-label",children:n("settings.sort_cluster")})]})]})]}),r.jsxs("div",{className:"settings-item",children:[r.jsx("label",{children:n("settings.sort_order")}),r.jsxs("div",{className:"radio-group inline",children:[r.jsxs("label",{className:`radio-option ${q==="asc"?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixGroupSortOrder",value:"asc",checked:q==="asc",onChange:()=>J("asc")}),r.jsx("span",{className:"radio-label",children:n("settings.sort_asc")})]}),r.jsxs("label",{className:`radio-option ${q==="desc"?"active":""}`,children:[r.jsx("input",{type:"radio",name:"matrixGroupSortOrder",value:"desc",checked:q==="desc",onChange:()=>J("desc")}),r.jsx("span",{className:"radio-label",children:n("settings.sort_desc")})]})]})]})]})]})]}),y==="clusters"&&i&&r.jsx("div",{className:"tab-content",children:r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.cluster_management")}),r.jsx("p",{className:"section-hint",children:n("settings.cluster_hint")}),r.jsx("div",{className:"cluster-list-full",children:i.clusters.map(Q=>{var et,dt;const Ze=t==null?void 0:t[Q.id],it=(Ze==null?void 0:Ze.name)||Q.name||Q.id,ht=z[Q.id]||{enabled:!0,poll_interval:5,static_refresh_interval:60};return r.jsxs("div",{className:`cluster-card ${ht.enabled?"":"disabled-cluster"}`,children:[r.jsxs("div",{className:"cluster-card-header",children:[r.jsxs("label",{className:"cluster-toggle",onClick:vt=>vt.stopPropagation(),children:[r.jsx("input",{type:"checkbox",checked:ht.enabled,onChange:()=>Xt(Q.id)}),r.jsx("span",{className:"cluster-toggle-switch"})]}),r.jsx("span",{className:`cluster-status ${ht.enabled?"enabled":"disabled"}`}),r.jsx("span",{className:"cluster-name",children:it}),r.jsxs("span",{className:"cluster-id",children:["(",Q.id,")"]})]}),r.jsxs("div",{className:"cluster-card-body",children:[r.jsxs("div",{className:"cluster-setting",children:[r.jsx("label",{children:n("settings.poll_interval")}),r.jsx("input",{type:"number",className:"input-field-sm",value:ht.poll_interval,onChange:vt=>Pe(Q.id,"poll_interval",Number(vt.target.value)),min:1,max:60})]}),r.jsxs("div",{className:"cluster-setting",children:[r.jsx("label",{children:n("settings.static_refresh")}),r.jsx("input",{type:"number",className:"input-field-sm",value:ht.static_refresh_interval,onChange:vt=>Pe(Q.id,"static_refresh_interval",Number(vt.target.value)),min:30,max:600})]})]}),r.jsxs("div",{className:"cluster-card-info",children:[r.jsx("span",{children:n("settings.nodes_count",{n:((et=Q.nodes)==null?void 0:et.length)||0})}),r.jsxs("span",{children:[n("settings.auth"),": ",((dt=Q.auth)==null?void 0:dt.user)||"N/A"]})]}),r.jsxs("div",{className:"cluster-secret-row",children:[r.jsx("span",{className:"secret-label",children:n("settings.cluster_pve_password")}),r.jsx("span",{className:`secret-status ${Te[Q.id]?"set":"unset"}`,children:Te[Q.id]?n("settings.secret_set"):n("settings.secret_unset")}),r.jsx("button",{type:"button",className:"secret-btn primary",onClick:()=>Ue(Q.id),children:Te[Q.id]?n("settings.secret_replace"):n("settings.secret_set_btn")}),Te[Q.id]&&r.jsx("button",{type:"button",className:"secret-btn ghost",onClick:async()=>{if(await o.confirm(n("settings.secret_confirm_clear",{id:Q.id}),{destructive:!0}))try{await We.deleteClusterSecret(Q.id,"pve_password"),Ge(vt=>({...vt,[Q.id]:!1}))}catch(vt){await o.alert(String(vt))}},children:n("settings.secret_clear")})]})]},Q.id)})})]})}),y==="alerts"&&r.jsxs("div",{className:"tab-content",children:[r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.cpu_threshold")}),r.jsxs("div",{className:"threshold-row",children:[r.jsxs("div",{className:"threshold-item warning",children:[r.jsxs("label",{children:[n("settings.warning")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:X,onChange:Q=>ue(Number(Q.target.value)),min:0,max:100})]}),r.jsxs("div",{className:"threshold-item danger",children:[r.jsxs("label",{children:[n("settings.critical")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:ke,onChange:Q=>te(Number(Q.target.value)),min:0,max:100})]})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.memory_threshold")}),r.jsxs("div",{className:"threshold-row",children:[r.jsxs("div",{className:"threshold-item warning",children:[r.jsxs("label",{children:[n("settings.warning")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:Z,onChange:Q=>F(Number(Q.target.value)),min:0,max:100})]}),r.jsxs("div",{className:"threshold-item danger",children:[r.jsxs("label",{children:[n("settings.critical")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:M,onChange:Q=>Y(Number(Q.target.value)),min:0,max:100})]})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.disk_threshold")}),r.jsxs("div",{className:"threshold-row",children:[r.jsxs("div",{className:"threshold-item warning",children:[r.jsxs("label",{children:[n("settings.warning")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:re,onChange:Q=>be(Number(Q.target.value)),min:0,max:100})]}),r.jsxs("div",{className:"threshold-item danger",children:[r.jsxs("label",{children:[n("settings.critical")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:V,onChange:Q=>ce(Number(Q.target.value)),min:0,max:100})]})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.diskio_threshold")}),r.jsxs("div",{className:"threshold-row",children:[r.jsxs("div",{className:"threshold-item warning",children:[r.jsx("label",{children:n("settings.warning")}),r.jsx("input",{type:"number",className:"input-field-sm",value:me,onChange:Q=>pe(Number(Q.target.value)),min:0,max:1e4})]}),r.jsxs("div",{className:"threshold-item danger",children:[r.jsx("label",{children:n("settings.critical")}),r.jsx("input",{type:"number",className:"input-field-sm",value:ye,onChange:Q=>Fe(Number(Q.target.value)),min:0,max:1e4})]})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.iowait_threshold")}),r.jsxs("div",{className:"threshold-row",children:[r.jsxs("div",{className:"threshold-item warning",children:[r.jsxs("label",{children:[n("settings.warning")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:Je,onChange:Q=>Ye(Number(Q.target.value)),min:0,max:100})]}),r.jsxs("div",{className:"threshold-item danger",children:[r.jsxs("label",{children:[n("settings.critical")," (%)"]}),r.jsx("input",{type:"number",className:"input-field-sm",value:Xe,onChange:Q=>fe(Number(Q.target.value)),min:0,max:100})]})]})]})]}),y==="server"&&r.jsxs("div",{className:"tab-content",children:[r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.http_server")}),r.jsxs("div",{className:"input-group",children:[r.jsxs("div",{className:"input-row",children:[r.jsx("label",{children:n("settings.host")}),r.jsx("input",{type:"text",className:"input-field",value:Se,onChange:Q=>De(Q.target.value)})]}),r.jsxs("div",{className:"input-row",children:[r.jsx("label",{children:n("settings.port")}),r.jsx("input",{type:"number",className:"input-field",value:H,onChange:Q=>oe(Number(Q.target.value)),min:1,max:65535})]})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.influx_integration")}),r.jsxs("label",{className:"toggle-option",children:[r.jsx("input",{type:"checkbox",checked:ne,onChange:Q=>we(Q.target.checked)}),r.jsx("span",{className:"toggle-switch"}),r.jsx("span",{className:"toggle-label",children:n(ne?"settings.enabled":"settings.disabled")})]}),ne&&r.jsxs("div",{className:"input-row",style:{marginTop:"var(--spacing-sm)"},children:[r.jsx("label",{children:n("settings.influx_port")}),r.jsx("input",{type:"number",className:"input-field",value:Me,onChange:Q=>Ae(Number(Q.target.value)),min:1,max:65535})]})]}),r.jsxs("div",{className:"settings-section",children:[r.jsx("h3",{className:"section-title",children:n("settings.console_section")}),r.jsxs("div",{className:"input-row",children:[r.jsx("label",{children:n("settings.console_mode")}),r.jsx(Ua,{className:"full",value:Nt,onChange:$t,options:[{value:"disabled",label:n("settings.console_mode_disabled")},{value:"stored",label:n("settings.console_mode_stored")},{value:"prompt",label:n("settings.console_mode_prompt")}]})]}),r.jsxs("div",{className:"server-note",style:{marginTop:"var(--spacing-sm)"},children:[r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 16v-4M12 8h.01"})]}),r.jsx("span",{children:n("settings.console_mode_hint")})]})]}),r.jsx("div",{className:"settings-section",children:r.jsxs("div",{className:"server-note",children:[r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 16v-4M12 8h.01"})]}),r.jsx("span",{children:n("settings.server_restart_note")})]})})]})]})}),r.jsxs("div",{className:"settings-footer",children:[r.jsxs("div",{className:"settings-footer-left",children:[r.jsxs("div",{className:"settings-version",children:[r.jsx("span",{className:"version-label",children:n("settings.version")}),r.jsxs("span",{className:"version-number",children:["v","0.3.15"]})]}),r.jsxs("div",{className:"settings-author",children:[r.jsx("span",{className:"author-label",children:"by"}),r.jsx("span",{className:"author-name",children:"Jason Cheng"}),r.jsx("span",{className:"author-org",children:"(Jason Tools)"})]})]}),r.jsxs("div",{className:"settings-actions",children:[r.jsx("button",{className:"btn",onClick:ft,children:n("action.cancel")}),r.jsx("button",{className:"btn btn-primary",onClick:wt,disabled:h||b,children:n(h?"action.saving":"action.save")})]})]}),r.jsx("div",{className:"corner-decoration top-left"}),r.jsx("div",{className:"corner-decoration top-right"}),r.jsx("div",{className:"corner-decoration bottom-left"}),r.jsx("div",{className:"corner-decoration bottom-right"})]}),r.jsx(e2,{open:le!==null,cluster_id:le||"",kind:"pve_password",title:n("settings.secret_pw_title",{id:le||""}),body:n("settings.secret_pw_body"),label:n("settings.secret_pw_label"),onClose:()=>Ue(null),onSaved:()=>{le&&Ge(Q=>({...Q,[le]:!0})),Ue(null)}}),r.jsx("style",{children:`
        .settings-overlay {
          position: fixed;
          inset: 0;
      ...
      `})]})}const Wt={Command:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M12 6v6l4 2"})]}),Server:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"2",y:"2",width:"20",height:"8",rx:"2"}),r.jsx("rect",{x:"2",y:"14",width:"20",height:"8",rx:"2"}),r.jsx("circle",{cx:"6",cy:"6",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"18",r:"1",fill:"currentColor"})]}),Matrix:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M3 9h18M3 15h18M9 3v18M15 3v18"})]}),Radar:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("circle",{cx:"12",cy:"12",r:"6"}),r.jsx("circle",{cx:"12",cy:"12",r:"2"}),r.jsx("path",{d:"M12 2v4M12 18v4"})]}),Storage:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"5",rx:"9",ry:"3"}),r.jsx("path",{d:"M21 12c0 1.66-4 3-9 3s-9-1.34-9-3"}),r.jsx("path",{d:"M3 5v14c0 1.66 4 3 9 3s9-1.34 9-3V5"})]}),Ceph:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"1.5",children:[r.jsx("circle",{cx:"12",cy:"12",r:"3"}),r.jsx("circle",{cx:"12",cy:"12",r:"9",strokeDasharray:"3 2"}),r.jsx("circle",{cx:"12",cy:"3",r:"1.5",fill:"currentColor"}),r.jsx("circle",{cx:"19.5",cy:"8",r:"1.5",fill:"currentColor"}),r.jsx("circle",{cx:"19.5",cy:"16",r:"1.5",fill:"currentColor"}),r.jsx("circle",{cx:"12",cy:"21",r:"1.5",fill:"currentColor"}),r.jsx("circle",{cx:"4.5",cy:"16",r:"1.5",fill:"currentColor"}),r.jsx("circle",{cx:"4.5",cy:"8",r:"1.5",fill:"currentColor"}),r.jsx("path",{d:"M12 6v3M12 15v3",strokeWidth:"1"}),r.jsx("path",{d:"M14.5 10.5L17 8.5",strokeWidth:"1"}),r.jsx("path",{d:"M14.5 13.5L17 15.5",strokeWidth:"1"}),r.jsx("path",{d:"M9.5 10.5L7 8.5",strokeWidth:"1"}),r.jsx("path",{d:"M9.5 13.5L7 15.5",strokeWidth:"1"})]}),Tasks:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"3",y:"3",width:"18",height:"18",rx:"2"}),r.jsx("path",{d:"M9 7h8M9 12h8M9 17h5"}),r.jsx("circle",{cx:"6",cy:"7",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"12",r:"1",fill:"currentColor"}),r.jsx("circle",{cx:"6",cy:"17",r:"1",fill:"currentColor"})]}),Health:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M22 11.08V12a10 10 0 1 1-5.93-9.14"}),r.jsx("polyline",{points:"22 4 12 14.01 9 11.01"})]}),Backup:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("ellipse",{cx:"12",cy:"6",rx:"8",ry:"3"}),r.jsx("path",{d:"M4 6v6c0 1.66 3.58 3 8 3s8-1.34 8-3V6"}),r.jsx("path",{d:"M4 12v6c0 1.66 3.58 3 8 3s8-1.34 8-3v-6"})]}),Settings:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("path",{d:"M12 15a3 3 0 1 0 0-6 3 3 0 0 0 0 6z"}),r.jsx("path",{d:"M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 0 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 0 1-4 0v-.09A1.65 1.65 0 0 0 9 19.4a1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 0 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 0 1 0-4h.09A1.65 1.65 0 0 0 4.6 9a1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 0 1 2.83-2.83l.06.06a1.65 1.65 0 0 0 1.82.33H9a1.65 1.65 0 0 0 1-1.51V3a2 2 0 0 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 0 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82V9a1.65 1.65 0 0 0 1.51 1H21a2 2 0 0 1 0 4h-.09a1.65 1.65 0 0 0-1.51 1z"})]}),Pause:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("rect",{x:"6",y:"4",width:"4",height:"16",rx:"1"}),r.jsx("rect",{x:"14",y:"4",width:"4",height:"16",rx:"1"})]}),Play:()=>r.jsx("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",stroke:"none",children:r.jsx("polygon",{points:"6,4 20,12 6,20"})}),Language:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"none",stroke:"currentColor",strokeWidth:"2",children:[r.jsx("circle",{cx:"12",cy:"12",r:"10"}),r.jsx("path",{d:"M2 12h20M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"})]}),MoreHorizontal:()=>r.jsxs("svg",{width:"16",height:"16",viewBox:"0 0 24 24",fill:"currentColor",stroke:"none",children:[r.jsx("circle",{cx:"5",cy:"12",r:"2"}),r.jsx("circle",{cx:"12",cy:"12",r:"2"}),r.jsx("circle",{cx:"19",cy:"12",r:"2"})]})},eu=[{view:"command-center",icon:Wt.Command,labelKey:"nav.command_center",shortcut:"D"},{view:"cluster-core",icon:Wt.Server,labelKey:"nav.cluster_core",shortcut:"N"},{view:"holo-matrix",icon:Wt.Matrix,labelKey:"nav.holo_matrix",shortcut:"M"},{view:"radar-scan",icon:Wt.Radar,labelKey:"nav.radar_scan",shortcut:"R"},{view:"storage",icon:Wt.Storage,labelKey:"nav.storage",shortcut:"S"},{view:"ceph-constellation",icon:Wt.Ceph,labelKey:"nav.ceph",shortcut:"C"},{view:"tasks",icon:Wt.Tasks,labelKey:"nav.tasks",shortcut:"T"},{view:"health",icon:Wt.Health,labelKey:"nav.health",shortcut:"H"},{view:"backups",icon:Wt.Backup,labelKey:"nav.backups",shortcut:"B"}],c2={d:"command-center",n:"cluster-core",m:"holo-matrix",r:"radar-scan",s:"storage",c:"ceph-constellation",t:"tasks",h:"health",b:"backups"},d2={"command-center":"/","cluster-core":"/nodes","holo-matrix":"/matrix","radar-scan":"/radar","ceph-constellation":"/ceph",storage:"/storage",tasks:"/tasks",health:"/health",backups:"/backups",settings:"/settings",users:"/users"},Zi={"/":"command-center","/overview":"command-center","/nodes":"cluster-core","/matrix":"holo-matrix","/radar":"radar-scan","/ceph":"ceph-constellation","/storage":"storage","/tasks":"tasks","/health":"health","/backups":"backups","/settings":"settings","/users":"users"};function tu(){const e=(typeof window<"u"?window.location.pathname:"/")||"/",t=e!=="/"&&e.endsWith("/")?e.slice(0,-1):e;if(Zi[t])return Zi[t];const n="/"+(t.split("/").filter(Boolean)[0]||"");return Zi[n]||"command-center"}function p2(){var G;const{t:e,language:t,setLanguage:n}=Ce(),[a,s]=p.useState(()=>tu());p.useEffect(()=>{const A=d2[a];if(!A)return;const T=window.location.pathname||"/",K="/"+(T.split("/").filter(Boolean)[0]||""),O="/"+(A.split("/").filter(Boolean)[0]||"");T==="/"&&A==="/"||T!=="/"&&A!=="/"&&K===O||window.history.pushState(null,"",A)},[a]),p.useEffect(()=>{const A=()=>s(tu());return window.addEventListener("popstate",A),()=>window.removeEventListener("popstate",A)},[]);const[o,i]=p.useState({}),[l,c]=p.useState(()=>{try{return localStorage.getItem("jt-proxense-selected-cluster")||"__all__"}catch{return"__all__"}}),[d,h]=p.useState(!1),g=Sa(),[u,x]=p.useState(0),[b,k]=p.useState(!1),[y,m]=p.useState(null),[f,v]=p.useState(!1),[j,w]=p.useState(!1),{connected:S,connecting:C,send:N}=zg({onMessage:p.useCallback(A=>{b||(i(A),x(Date.now()/1e3))},[b])});p.useEffect(()=>{let A=!0;const T=()=>document.visibilityState!=="hidden"&&document.hasFocus(),K=()=>{const O=T();if(O!==A){A=O,document.body.setAttribute("data-app-visible",O?"true":"false");try{O?(N({type:"resume"}),N({type:"refresh"})):N({type:"pause"})}catch{}}};return document.body.setAttribute("data-app-visible",T()?"true":"false"),document.addEventListener("visibilitychange",K),window.addEventListener("focus",K),window.addEventListener("blur",K),()=>{document.removeEventListener("visibilitychange",K),window.removeEventListener("focus",K),window.removeEventListener("blur",K)}},[N]);const L=p.useCallback(()=>{m(b?"resuming":"pausing"),setTimeout(()=>{k(A=>!A),setTimeout(()=>m(null),500)},300)},[b]),I=l==="__all__"?null:o[l]||null,P=p.useMemo(()=>{const A=Object.values(o);return{total_clusters:A.length,total_nodes:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.node_count)||0)},0),total_nodes_online:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.nodes_online)||0)},0),total_vms:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.vm_count)||0)},0),total_vms_running:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.vms_running)||0)},0),total_cts:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.ct_count)||0)},0),total_cts_running:A.reduce((T,K)=>{var O;return T+(((O=K.summary)==null?void 0:O.cts_running)||0)},0),clusters:A.map(T=>T.summary).filter(Boolean)}},[o]);p.useEffect(()=>{try{localStorage.setItem("jt-proxense-selected-cluster",l)}catch{}},[l]),p.useEffect(()=>{Object.keys(o).length>0&&l!=="__all__"&&(o[l]||c("__all__"))},[o,l]),p.useEffect(()=>{window.dispatchEvent(new Event("resize"))},[]),p.useEffect(()=>{We.getConfig().then(A=>{A!=null&&A.ui&&(A.ui.vm_matrix_default_filter&&localStorage.setItem("vm_matrix_default_filter",A.ui.vm_matrix_default_filter),A.ui.matrix_card_width&&localStorage.setItem("matrix_card_width",String(A.ui.matrix_card_width)),A.ui.matrix_sort_by&&localStorage.setItem("matrix_sort_by",A.ui.matrix_sort_by))}).catch(()=>{})},[]),p.useEffect(()=>{if(!f)return;const A=()=>v(!1);return document.addEventListener("click",A),()=>document.removeEventListener("click",A)},[f]),p.useEffect(()=>{if(!j)return;const A=()=>w(!1);return document.addEventListener("click",A),()=>document.removeEventListener("click",A)},[j]),p.useEffect(()=>{const A=T=>{if(T.target instanceof HTMLInputElement||T.target instanceof HTMLTextAreaElement)return;const K=T.key.toLowerCase();if(K===" "||T.code==="Space"){T.preventDefault(),L();return}if(!T.ctrlKey&&!T.metaKey&&!T.altKey){const O=c2[K];if(O){T.preventDefault(),s(O);return}}(T.ctrlKey||T.metaKey)&&K==="s"&&(T.preventDefault(),h(O=>!O))};return window.addEventListener("keydown",A),()=>window.removeEventListener("keydown",A)},[L]);const E=()=>{const A=l==="__all__";switch(a){case"command-center":return r.jsx(gp,{clusters:o,globalSummary:P,isPaused:b,onSelectCluster:T=>{c(T),s("cluster-core")}});case"cluster-core":return r.jsx(Ug,{cluster:I,clusters:A?o:void 0,onSelectVM:()=>s("holo-matrix"),onNavigateToVMMatrix:T=>{c(T),s("holo-matrix")},isPaused:b});case"holo-matrix":return r.jsx(hx,{cluster:I,clusters:A?o:void 0});case"radar-scan":return r.jsx(yx,{cluster:I,clusters:A?o:void 0,isPaused:b});case"storage":return r.jsx(Dy,{cluster:I,clusters:A?o:void 0});case"ceph-constellation":return r.jsx(Ix,{cluster:I,clusters:A?o:void 0,isPaused:b});case"users":return r.jsx(By,{});case"tasks":return r.jsx(Ky,{clusters:o,selectedCluster:l});case"health":return r.jsx(qy,{clusters:o,onNavigate:(T,K)=>{K!=null&&K.cluster&&c(K.cluster),s(T)}});case"backups":return r.jsx(Jy,{clusters:o,selectedCluster:l});default:return r.jsx(gp,{clusters:o,globalSummary:P,isPaused:b,onSelectCluster:T=>{c(T),s("cluster-core")}})}};return r.jsxs("div",{className:`app-container ${b?"animations-paused":""}`,children:[r.jsx(a2,{isPaused:b}),r.jsx(Zy,{clusters:o,onNavigate:(A,T)=>{T!=null&&T.cluster&&c(T.cluster),s(A)}}),r.jsxs("header",{className:"header-bar",children:[r.jsxs("div",{className:"header-logo",children:[r.jsx("img",{src:"/assets/logo.png",alt:"JT-PROXENSE",className:"header-logo-img"}),r.jsx("span",{className:`status-dot ${S?"connected":C?"connecting":"disconnected"}`,title:e(S?"status.connected":C?"status.connecting":"status.disconnected")}),r.jsx(o2,{timestamp:u,connected:S})]}),r.jsxs("nav",{className:"header-center",children:[r.jsxs("div",{className:"nav-tabs",children:[eu.map(({view:A,icon:T,labelKey:K,shortcut:O},W)=>r.jsxs("button",{className:`nav-tab nav-tab-${W} ${a===A?"active":""}`,onClick:()=>s(A),title:`${e(K)} [${O}]`,children:[r.jsx(T,{}),r.jsx("span",{children:e(K)}),r.jsx("span",{className:"nav-shortcut",children:O})]},A)),r.jsxs("div",{className:"nav-more-wrapper",children:[r.jsx("button",{className:"nav-tab nav-more-btn",onClick:A=>{A.stopPropagation(),w(!j)},title:e("nav.more"),children:r.jsx(Wt.MoreHorizontal,{})}),j&&r.jsx("div",{className:"nav-more-dropdown",onClick:A=>A.stopPropagation(),children:eu.map(({view:A,icon:T,labelKey:K,shortcut:O},W)=>r.jsxs("button",{className:`nav-more-option nav-more-option-${W} ${a===A?"active":""}`,onClick:()=>{s(A),w(!1)},children:[r.jsx(T,{}),r.jsx("span",{children:e(K)}),r.jsx("span",{className:"nav-shortcut",children:O})]},A))})]})]}),Object.keys(o).length>0&&r.jsx(i2,{clusters:o,value:l,onChange:c,disabled:a==="command-center"})]}),r.jsxs("div",{className:"header-right",children:[r.jsxs("button",{className:`btn btn-icon pause-btn ${b?"paused":""} ${y||""}`,onClick:L,title:`${e(b?"status.paused":"status.live")} [Space]`,children:[r.jsx("div",{className:"pause-btn-inner",children:b?r.jsx(Wt.Play,{}):r.jsx(Wt.Pause,{})}),r.jsx("div",{className:"pause-fx"})]}),r.jsxs("div",{className:"lang-menu-wrapper",children:[r.jsx("button",{className:"btn btn-icon",onClick:A=>{A.stopPropagation(),v(!f)},title:e("settings.language"),children:r.jsx(Wt.Language,{})}),f&&r.jsxs("div",{className:"lang-dropdown",onClick:A=>A.stopPropagation(),children:[r.jsxs("button",{className:`lang-option ${t==="en"?"active":""}`,onClick:()=>{n("en"),v(!1)},children:[r.jsx("span",{className:"lang-flag",children:"EN"}),r.jsx("span",{children:"English"})]}),r.jsxs("button",{className:`lang-option ${t==="zh-TW"?"active":""}`,onClick:()=>{n("zh-TW"),v(!1)},children:[r.jsx("span",{className:"lang-flag",children:"繁"}),r.jsx("span",{children:"繁體中文"})]})]})]}),r.jsx(l2,{user:g.user,onLogout:g.logout}),(!g.authEnforced||((G=g.user)==null?void 0:G.role_global)==="admin")&&r.jsx("button",{className:"btn btn-icon",onClick:()=>h(!0),title:e("settings.title"),children:r.jsx(Wt.Settings,{})})]})]}),r.jsx("main",{className:"main-content",children:r.jsx("div",{className:"view-container",children:E()},a)}),d&&r.jsx(n2,{onClose:()=>h(!1),clusters:o}),y&&r.jsxs("div",{className:`pause-overlay ${y}`,children:[r.jsx("div",{className:"pause-glitch-lines",children:[...Array(20)].map((A,T)=>r.jsx("div",{className:"glitch-line",style:{animationDelay:`${T*.05}s`}},T))}),r.jsx("div",{className:"pause-status-text",children:y==="pausing"?"FREEZING DATA STREAM":"RESUMING DATA STREAM"}),r.jsx("div",{className:"pause-scan-ring"})]})]})}function u2(){return r.jsx(_g,{children:r.jsx(Sg,{children:r.jsx(p2,{})})})}el.createRoot(document.getElementById("root")).render(r.jsx(qo.StrictMode,{children:r.jsx(u2,{})}));
