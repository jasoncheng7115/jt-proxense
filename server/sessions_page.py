...
<head>
    ...
    <style>
        ...
        *{box-sizing:border-box}
        ...
        .container{max-width:1300px;margin:0 auto;padding:24px 32px;position:relative;z-index:2;animation:fadeIn .35s ease}
...
<div class="container">
    <header class="page-header">
        <div class="title-section">
            ...
            <div class="page-sub" id="status">{{T_LOADING}}</div>
        </div>
        <nav class="top">
            <a href="/"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 12l9-9 9 9M5 10v10h14V10"/></svg>{{T_NAV_DASHBOARD}}</a>
            <a href="/audit"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>{{T_NAV_AUDIT}}</a>
            <a href="/account"><svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M20 21v-2a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v2"/><circle cx="12" cy="7" r="4"/></svg>{{T_NAV_ACCOUNT}}</a>
        </nav>
    </header>
